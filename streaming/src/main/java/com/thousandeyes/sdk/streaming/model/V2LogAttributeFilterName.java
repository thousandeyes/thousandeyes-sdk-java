...
/**
 * Gets or Sets V2LogAttributeFilterName
 */
public enum V2LogAttributeFilterName {
  
  ACCOUNT_NAME("thousandeyes.account.name"),
  
  ACTIVITYLOG_RESOURCES("thousandeyes.activitylog.resources"),
  
  STREAM_NAME("thousandeyes.stream.name"),
  
  USER_ADDRESS("thousandeyes.user.address"),
  
  USER_EMAIL("thousandeyes.user.email"),
  
  USER_ID("thousandeyes.user.id"),
  
  USER_NAME("thousandeyes.user.name"),
  
  UNKNOWN("unknown");

  private String value;

  V2LogAttributeFilterName(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static V2LogAttributeFilterName fromValue(String value) {
    for (V2LogAttributeFilterName b : V2LogAttributeFilterName.values()) {
