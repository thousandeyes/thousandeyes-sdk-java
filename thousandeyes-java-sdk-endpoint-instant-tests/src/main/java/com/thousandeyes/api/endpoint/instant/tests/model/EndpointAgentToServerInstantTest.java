...
import com.thousandeyes.api.endpoint.instant.tests.model.EndpointTestAgentSelectorType;
...
import com.thousandeyes.api.endpoint.instant.JSON;

/**
 * EndpointAgentToServerInstantTest
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2023-12-18T17:52:55.295420Z[Europe/Lisbon]")
public class EndpointAgentToServerInstantTest {
  ...
  * @throws IOException if the JSON Element is invalid with respect to EndpointAgentToServerInstantTest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EndpointAgentToServerInstantTest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EndpointAgentToServerInstantTest is not found in the empty JSON string", EndpointAgentToServerInstantTest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EndpointAgentToServerInstantTest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EndpointAgentToServerInstantTest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EndpointAgentToServerInstantTest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EndpointAgentToServerInstantTest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EndpointAgentToServerInstantTest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EndpointAgentToServerInstantTest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EndpointAgentToServerInstantTest.class));

       return (TypeAdapter<T>) new TypeAdapter<EndpointAgentToServerInstantTest>() {
           @Override
           public void write(JsonWriter out, EndpointAgentToServerInstantTest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EndpointAgentToServerInstantTest read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of EndpointAgentToServerInstantTest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EndpointAgentToServerInstantTest
  * @throws IOException if the JSON string is invalid with respect to EndpointAgentToServerInstantTest
  */
  public static EndpointAgentToServerInstantTest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EndpointAgentToServerInstantTest.class);
  }

 /**
  * Convert an instance of EndpointAgentToServerInstantTest to an JSON string
  *
  * @return JSON string
  */
