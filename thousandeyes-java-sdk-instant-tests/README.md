...
- Build date: 2024-02-07T22:58:18.001552Z[Europe/Lisbon]
...
```groovy
compile "com.thousandeyes.api:thousandeyes-java-sdk-instant-tests:7.0.0-SNAPSHOT"
```
...
- `target/thousandeyes-java-sdk-instant-tests-7.0.0-SNAPSHOT.jar`
- `target/lib/*.jar`
