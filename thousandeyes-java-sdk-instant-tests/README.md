# thousandeyes-java-sdk-instant-tests

Instant Tests API
- API version: 7.0.0
  - Build date: 2023-12-20T12:21:05.783040Z[Europe/Lisbon]
...
<dependency>
  ...
  <artifactId>thousandeyes-java-sdk-instant-tests</artifactId>
...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'thousandeyes-java-sdk-instant-tests' jar has been published to maven central.
    mavenLocal()       // Needed if the 'thousandeyes-java-sdk-instant-tests' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "org.openapitools:thousandeyes-java-sdk-instant-tests:7.0.0"
  }
```
...
* `target/thousandeyes-java-sdk-instant-tests-7.0.0.jar`
* `target/lib/*.jar`
