...
import com.thousandeyes.api.instant.tests.model.AgentToServerInstantTest;
import com.thousandeyes.api.instant.tests.model.AgentToServerInstantTestRequest;
...
public class AgentToServerApi {
    ...
    /**
     * Build call for postInstantAgentToServer
     ...
     */
    public okhttp3.Call postInstantAgentToServerCall(AgentToServerInstantTestRequest agentToServerInstantTestRequest, String aid, List<Expand> expand, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = agentToServerInstantTestRequest;

        // create path and map variables
        String localVarPath = "/v7/tests/agent-to-server/instant";
    ...
    private okhttp3.Call postInstantAgentToServerValidateBeforeCall(AgentToServerInstantTestRequest agentToServerInstantTestRequest, String aid, List<Expand> expand, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'agentToServerInstantTestRequest' is set
        if (agentToServerInstantTestRequest == null) {
            throw new ApiException("Missing the required parameter 'agentToServerInstantTestRequest' when calling postInstantAgentToServer(Async)");
        }

        return postInstantAgentToServerCall(agentToServerInstantTestRequest, aid, expand, _callback);
    ...
    public AgentToServerInstantTest postInstantAgentToServer(AgentToServerInstantTestRequest agentToServerInstantTestRequest, String aid, List<Expand> expand) throws ApiException {
        ApiResponse<AgentToServerInstantTest> localVarResp = postInstantAgentToServerWithHttpInfo(agentToServerInstantTestRequest, aid, expand);
    ...
    public ApiResponse<AgentToServerInstantTest> postInstantAgentToServerWithHttpInfo(AgentToServerInstantTestRequest agentToServerInstantTestRequest, String aid, List<Expand> expand) throws ApiException {
        okhttp3.Call localVarCall = postInstantAgentToServerValidateBeforeCall(agentToServerInstantTestRequest, aid, expand, null);
        Type localVarReturnType = new TypeToken<AgentToServerInstantTest>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Create agent-to-server instant test (asynchronously)
     * Creates and runs a new agent-to-server instant test.
     * @param agentToServerInstantTestRequest  (required)
     * @param aid A unique identifier associated with your account group. You can retrieve your &#x60;AccountGroupId&#x60; from the &#x60;/account-groups&#x60; endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response. (optional)
     * @param expand (Optional) Indicates if the test sub-resources should be expanded. Defaults to no expansion. To expand the &#x60;agents&#x60; sub-resource, use the query &#x60;?expand&#x3D;agent&#x60;. (optional)
     ...
     */
    public okhttp3.Call postInstantAgentToServerAsync(AgentToServerInstantTestRequest agentToServerInstantTestRequest, String aid, List<Expand> expand, final ApiCallback<AgentToServerInstantTest> _callback) throws ApiException {

        okhttp3.Call localVarCall = postInstantAgentToServerValidateBeforeCall(agentToServerInstantTestRequest, aid, expand, _callback);
        Type localVarReturnType = new TypeToken<AgentToServerInstantTest>(){}.getType();
