...
public class HttpServerInstantTestRequest {
  ...
  * @throws IOException if the JSON Element is invalid with respect to HttpServerInstantTestRequest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HttpServerInstantTestRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in HttpServerInstantTestRequest is not found in the empty JSON string", HttpServerInstantTestRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!HttpServerInstantTestRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `HttpServerInstantTestRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : HttpServerInstantTestRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!HttpServerInstantTestRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'HttpServerInstantTestRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<HttpServerInstantTestRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(HttpServerInstantTestRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<HttpServerInstantTestRequest>() {
           @Override
           public void write(JsonWriter out, HttpServerInstantTestRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public HttpServerInstantTestRequest read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of HttpServerInstantTestRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of HttpServerInstantTestRequest
  * @throws IOException if the JSON string is invalid with respect to HttpServerInstantTestRequest
  */
  public static HttpServerInstantTestRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, HttpServerInstantTestRequest.class);
  }

 /**
  * Convert an instance of HttpServerInstantTestRequest to an JSON string
  *
  * @return JSON string
  */
