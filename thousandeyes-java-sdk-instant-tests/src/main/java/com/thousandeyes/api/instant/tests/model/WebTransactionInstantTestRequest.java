...
public class WebTransactionInstantTestRequest {
  ...
  * @throws IOException if the JSON Element is invalid with respect to WebTransactionInstantTestRequest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebTransactionInstantTestRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebTransactionInstantTestRequest is not found in the empty JSON string", WebTransactionInstantTestRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebTransactionInstantTestRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebTransactionInstantTestRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebTransactionInstantTestRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebTransactionInstantTestRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebTransactionInstantTestRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebTransactionInstantTestRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebTransactionInstantTestRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<WebTransactionInstantTestRequest>() {
           @Override
           public void write(JsonWriter out, WebTransactionInstantTestRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebTransactionInstantTestRequest read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebTransactionInstantTestRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebTransactionInstantTestRequest
  * @throws IOException if the JSON string is invalid with respect to WebTransactionInstantTestRequest
  */
  public static WebTransactionInstantTestRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebTransactionInstantTestRequest.class);
  }

 /**
  * Convert an instance of WebTransactionInstantTestRequest to an JSON string
  *
  * @return JSON string
  */
