...
import com.thousandeyes.api.instant.tests.model.AgentToAgentInstantTest;
import com.thousandeyes.api.instant.tests.model.AgentToAgentInstantTestRequest;
...
public class AgentToAgentApi {
    ...
    /**
     * Build call for postInstantTestAgentToAgent
     ...
     */
    public okhttp3.Call postInstantTestAgentToAgentCall(AgentToAgentInstantTestRequest agentToAgentInstantTestRequest, String aid, List<Expand> expand, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = agentToAgentInstantTestRequest;

        // create path and map variables
        String localVarPath = "/v7/tests/agent-to-agent/instant";
    ...
    private okhttp3.Call postInstantTestAgentToAgentValidateBeforeCall(AgentToAgentInstantTestRequest agentToAgentInstantTestRequest, String aid, List<Expand> expand, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'agentToAgentInstantTestRequest' is set
        if (agentToAgentInstantTestRequest == null) {
            throw new ApiException("Missing the required parameter 'agentToAgentInstantTestRequest' when calling postInstantTestAgentToAgent(Async)");
        }

        return postInstantTestAgentToAgentCall(agentToAgentInstantTestRequest, aid, expand, _callback);
    ...
    public AgentToAgentInstantTest postInstantTestAgentToAgent(AgentToAgentInstantTestRequest agentToAgentInstantTestRequest, String aid, List<Expand> expand) throws ApiException {
        ApiResponse<AgentToAgentInstantTest> localVarResp = postInstantTestAgentToAgentWithHttpInfo(agentToAgentInstantTestRequest, aid, expand);
    ...
    public ApiResponse<AgentToAgentInstantTest> postInstantTestAgentToAgentWithHttpInfo(AgentToAgentInstantTestRequest agentToAgentInstantTestRequest, String aid, List<Expand> expand) throws ApiException {
        okhttp3.Call localVarCall = postInstantTestAgentToAgentValidateBeforeCall(agentToAgentInstantTestRequest, aid, expand, null);
        Type localVarReturnType = new TypeToken<AgentToAgentInstantTest>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Create agent-to-agent instant test (asynchronously)
     * Creates and runs a new agent-to-agent instant test.
     * @param agentToAgentInstantTestRequest  (required)
     * @param aid A unique identifier associated with your account group. You can retrieve your &#x60;AccountGroupId&#x60; from the &#x60;/account-groups&#x60; endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response. (optional)
     * @param expand (Optional) Indicates if the test sub-resources should be expanded. Defaults to no expansion. To expand the &#x60;agents&#x60; sub-resource, use the query &#x60;?expand&#x3D;agent&#x60;. (optional)
     ...
     */
    public okhttp3.Call postInstantTestAgentToAgentAsync(AgentToAgentInstantTestRequest agentToAgentInstantTestRequest, String aid, List<Expand> expand, final ApiCallback<AgentToAgentInstantTest> _callback) throws ApiException {

        okhttp3.Call localVarCall = postInstantTestAgentToAgentValidateBeforeCall(agentToAgentInstantTestRequest, aid, expand, _callback);
        Type localVarReturnType = new TypeToken<AgentToAgentInstantTest>(){}.getType();
