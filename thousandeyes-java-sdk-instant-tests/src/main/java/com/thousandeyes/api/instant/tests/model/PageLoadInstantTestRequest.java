...
public class PageLoadInstantTestRequest {
  ...
  **/
  ...
  public PageLoadInstantTestRequest links(UnexpandedInstantTestLinks links) {
  ...
  * @throws IOException if the JSON Element is invalid with respect to PageLoadInstantTestRequest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PageLoadInstantTestRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PageLoadInstantTestRequest is not found in the empty JSON string", PageLoadInstantTestRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PageLoadInstantTestRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PageLoadInstantTestRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PageLoadInstantTestRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PageLoadInstantTestRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PageLoadInstantTestRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PageLoadInstantTestRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PageLoadInstantTestRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PageLoadInstantTestRequest>() {
           @Override
           public void write(JsonWriter out, PageLoadInstantTestRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PageLoadInstantTestRequest read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PageLoadInstantTestRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PageLoadInstantTestRequest
  * @throws IOException if the JSON string is invalid with respect to PageLoadInstantTestRequest
  */
  public static PageLoadInstantTestRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PageLoadInstantTestRequest.class);
  }

 /**
  * Convert an instance of PageLoadInstantTestRequest to an JSON string
  *
  * @return JSON string
  */
