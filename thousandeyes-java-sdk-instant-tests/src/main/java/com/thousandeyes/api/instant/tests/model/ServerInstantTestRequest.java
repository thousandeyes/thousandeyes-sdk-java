...
import com.thousandeyes.api.instant.tests.model.FtpServerRequestType;
...
public class ServerInstantTestRequest {
  ...
  * @throws IOException if the JSON Element is invalid with respect to ServerInstantTestRequest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ServerInstantTestRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServerInstantTestRequest is not found in the empty JSON string", ServerInstantTestRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ServerInstantTestRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ServerInstantTestRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServerInstantTestRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServerInstantTestRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServerInstantTestRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServerInstantTestRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServerInstantTestRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ServerInstantTestRequest>() {
           @Override
           public void write(JsonWriter out, ServerInstantTestRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ServerInstantTestRequest read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ServerInstantTestRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServerInstantTestRequest
  * @throws IOException if the JSON string is invalid with respect to ServerInstantTestRequest
  */
  public static ServerInstantTestRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServerInstantTestRequest.class);
  }

 /**
  * Convert an instance of ServerInstantTestRequest to an JSON string
  *
  * @return JSON string
  */
