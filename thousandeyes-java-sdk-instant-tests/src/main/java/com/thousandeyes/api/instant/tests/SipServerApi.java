...
import com.thousandeyes.api.instant.tests.model.SipServerInstantTest;
import com.thousandeyes.api.instant.tests.model.SipServerInstantTestRequest;
import java.net.URI;
...
public class SipServerApi {
    ...
    /**
     * Build call for postInstantSIPServer
     ...
     */
    public okhttp3.Call postInstantSIPServerCall(SipServerInstantTestRequest sipServerInstantTestRequest, String aid, List<Expand> expand, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = sipServerInstantTestRequest;

        // create path and map variables
        String localVarPath = "/v7/tests/sip-server/instant";
    ...
    private okhttp3.Call postInstantSIPServerValidateBeforeCall(SipServerInstantTestRequest sipServerInstantTestRequest, String aid, List<Expand> expand, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'sipServerInstantTestRequest' is set
        if (sipServerInstantTestRequest == null) {
            throw new ApiException("Missing the required parameter 'sipServerInstantTestRequest' when calling postInstantSIPServer(Async)");
        }

        return postInstantSIPServerCall(sipServerInstantTestRequest, aid, expand, _callback);
    ...
    public SipServerInstantTest postInstantSIPServer(SipServerInstantTestRequest sipServerInstantTestRequest, String aid, List<Expand> expand) throws ApiException {
        ApiResponse<SipServerInstantTest> localVarResp = postInstantSIPServerWithHttpInfo(sipServerInstantTestRequest, aid, expand);
    ...
    public ApiResponse<SipServerInstantTest> postInstantSIPServerWithHttpInfo(SipServerInstantTestRequest sipServerInstantTestRequest, String aid, List<Expand> expand) throws ApiException {
        okhttp3.Call localVarCall = postInstantSIPServerValidateBeforeCall(sipServerInstantTestRequest, aid, expand, null);
        Type localVarReturnType = new TypeToken<SipServerInstantTest>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Create SIP server instant test (asynchronously)
     * Creates and runs a new SIP server instant test.
     * @param sipServerInstantTestRequest  (required)
     * @param aid A unique identifier associated with your account group. You can retrieve your &#x60;AccountGroupId&#x60; from the &#x60;/account-groups&#x60; endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response. (optional)
     * @param expand (Optional) Indicates if the test sub-resources should be expanded. Defaults to no expansion. To expand the &#x60;agents&#x60; sub-resource, use the query &#x60;?expand&#x3D;agent&#x60;. (optional)
     ...
     */
    public okhttp3.Call postInstantSIPServerAsync(SipServerInstantTestRequest sipServerInstantTestRequest, String aid, List<Expand> expand, final ApiCallback<SipServerInstantTest> _callback) throws ApiException {

        okhttp3.Call localVarCall = postInstantSIPServerValidateBeforeCall(sipServerInstantTestRequest, aid, expand, _callback);
        Type localVarReturnType = new TypeToken<SipServerInstantTest>(){}.getType();
