...
public class DnsTraceApiTest {
     ...
     */
    @Test
    public void postInstantDnsTraceTest() throws ApiException {
        DnsTraceInstantTestRequest dnsTraceInstantTestRequest = null;
        String aid = null;
        List<Expand> expand = null;
        DnsTraceInstantTest response = api.postInstantDnsTrace(dnsTraceInstantTestRequest, aid, expand);
