...
public class DnsServerApiTest {
     ...
     */
    @Test
    public void postInstantDnsServerTest() throws ApiException {
        DnsServerInstantTestRequest dnsServerInstantTestRequest = null;
        String aid = null;
        List<Expand> expand = null;
        DnsServerInstantTest response = api.postInstantDnsServer(dnsServerInstantTestRequest, aid, expand);
