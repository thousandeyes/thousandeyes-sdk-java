...
public class VoiceApiTest {
     ...
     */
    @Test
    public void postInstantVoiceTest() throws ApiException {
        VoiceInstantTestRequest voiceInstantTestRequest = null;
        String aid = null;
        List<Expand> expand = null;
        VoiceInstantTest response = api.postInstantVoice(voiceInstantTestRequest, aid, expand);
