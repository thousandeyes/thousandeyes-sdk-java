...
public class HttpPageLoadApiTest {
     ...
     */
    @Test
    public void postInstantHTTPPageLoadTest() throws ApiException {
        PageLoadInstantTestRequest pageLoadInstantTestRequest = null;
        String aid = null;
        List<Expand> expand = null;
        PageLoadInstantTest response = api.postInstantHTTPPageLoad(pageLoadInstantTestRequest, aid, expand);
