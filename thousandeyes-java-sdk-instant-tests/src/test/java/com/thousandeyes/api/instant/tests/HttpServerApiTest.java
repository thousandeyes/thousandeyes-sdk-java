...
public class HttpServerApiTest {
     ...
     */
    @Test
    public void postInstantHTTPServerTest() throws ApiException {
        HttpServerInstantTestRequest httpServerInstantTestRequest = null;
        String aid = null;
        List<Expand> expand = null;
        HttpServerInstantTest response = api.postInstantHTTPServer(httpServerInstantTestRequest, aid, expand);
