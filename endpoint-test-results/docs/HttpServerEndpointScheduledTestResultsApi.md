...
| [**getSingleTestFilteredHttpServerScheduledTestResultsWithHttpInfo**](HttpServerEndpointScheduledTestResultsApi.md#getSingleTestFilteredHttpServerScheduledTestResultsWithHttpInfo) | **POST** /endpoint/test-results/scheduled-tests/{testId}/http-server/filter | Filter HTTP server result for a scheduled test |
