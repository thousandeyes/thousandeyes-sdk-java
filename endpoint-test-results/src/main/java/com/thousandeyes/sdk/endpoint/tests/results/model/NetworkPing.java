...
@JsonPropertyOrder({
  ...
  NetworkPing.JSON_PROPERTY_LOSS,
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.avgRtt, networkPing.avgRtt) &&
        ...
        Objects.equals(this.loss, networkPing.loss) &&
  ...
  public static class ModelBuilder {
    ...
    private NetworkPing instance;

    public ModelBuilder() {
      this(new NetworkPing());
    }

    protected ModelBuilder(NetworkPing instance) {
      this.instance = instance;
    }

    public NetworkPing.ModelBuilder avgRtt(Integer avgRtt) {
      this.instance.avgRtt = avgRtt;
      return this;
    }
    public NetworkPing.ModelBuilder maxRtt(Integer maxRtt) {
      this.instance.maxRtt = maxRtt;
      return this;
    }
    public NetworkPing.ModelBuilder loss(Double loss) {
      this.instance.loss = loss;
      return this;
    }
    public NetworkPing.ModelBuilder meanDevRtt(Integer meanDevRtt) {
      this.instance.meanDevRtt = meanDevRtt;
      return this;
    }
    public NetworkPing.ModelBuilder minRtt(Integer minRtt) {
      this.instance.minRtt = minRtt;
      return this;
    }
    public NetworkPing.ModelBuilder pktsReceived(Integer pktsReceived) {
      this.instance.pktsReceived = pktsReceived;
      return this;
    }
    public NetworkPing.ModelBuilder pktsSent(Integer pktsSent) {
      this.instance.pktsSent = pktsSent;
      return this;
    }
    public NetworkPing.ModelBuilder error(String error) {
      this.instance.error = error;
      return this;
    }
    public NetworkPing.ModelBuilder infoFlags(List<String> infoFlags) {
      this.instance.infoFlags = infoFlags;
      return this;
    }

    /**
     * Returns a built NetworkPing instance.
     *
     * <p>The builder is not reusable.</p>
     */
    public NetworkPing build() {
      try {
   ...
   */
  public static NetworkPing.ModelBuilder builder() {
    return new NetworkPing.ModelBuilder();
  }

  /**
   * Create a builder with a shallow copy of this instance.
   */
  public NetworkPing.ModelBuilder toBuilder() {
    NetworkPing.ModelBuilder builder = new NetworkPing.ModelBuilder()
      .avgRtt(getAvgRtt())
      .maxRtt(getMaxRtt())
      .loss(getLoss())
