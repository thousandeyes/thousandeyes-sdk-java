...
public class NetworkDynamicTestsResultsApi {
   ...
   */
  public NetworkDynamicTestResults filterDynamicTestNetworkResults(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor, DynamicTestsDataRoundSearch dynamicTestsDataRoundSearch) throws ApiException {
    ApiResponse<NetworkDynamicTestResults> response = filterDynamicTestNetworkResultsWithHttpInfo(testId, aid, window, startDate, endDate, cursor, dynamicTestsDataRoundSearch);
   ...
   * @param cursor (Optional) Opaque cursor used for pagination. Clients should use &#x60;next&#x60; value from &#x60;_links&#x60; instead of this parameter. (optional)
   * @param dynamicTestsDataRoundSearch Tests data search filters. (optional)
   * @return ApiResponse&lt;NetworkDynamicTestResults&gt;
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<NetworkDynamicTestResults> filterDynamicTestNetworkResultsWithHttpInfo(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor, DynamicTestsDataRoundSearch dynamicTestsDataRoundSearch) throws ApiException {
    filterDynamicTestNetworkResultsValidateRequest(testId);

    var requestBuilder = filterDynamicTestNetworkResultsRequestBuilder(testId, aid, window, startDate, endDate, cursor, dynamicTestsDataRoundSearch);

    return apiClient.send(requestBuilder.build(), NetworkDynamicTestResults.class);
  }
  ...
  private ApiRequest.ApiRequestBuilder filterDynamicTestNetworkResultsRequestBuilder(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor, DynamicTestsDataRoundSearch dynamicTestsDataRoundSearch) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public PathVisDetailDynamicTestResults getDynamicTestPathVisAgentRoundResults(String testId, String agentId, String roundId, String aid) throws ApiException {
    ApiResponse<PathVisDetailDynamicTestResults> response = getDynamicTestPathVisAgentRoundResultsWithHttpInfo(testId, agentId, roundId, aid);
    return response.getData();
  }
   ...
   * @param roundId Round ID (required)
   * @param aid A unique identifier associated with your account group. You can retrieve your &#x60;AccountGroupId&#x60; from the &#x60;/account-groups&#x60; endpoint. Note that you must be assigned to the target account group. Specifying this parameter without being assigned to the target account group will result in an error response. (optional)
   * @return ApiResponse&lt;PathVisDetailDynamicTestResults&gt;
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<PathVisDetailDynamicTestResults> getDynamicTestPathVisAgentRoundResultsWithHttpInfo(String testId, String agentId, String roundId, String aid) throws ApiException {
    ...
    return apiClient.send(requestBuilder.build(), PathVisDetailDynamicTestResults.class);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public PathVisDynamicTestResults getDynamicTestPathVisResults(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor) throws ApiException {
    ApiResponse<PathVisDynamicTestResults> response = getDynamicTestPathVisResultsWithHttpInfo(testId, aid, window, startDate, endDate, cursor);
    return response.getData();
  }
   ...
   * @param endDate Defaults to current time the request is made. Use with the &#x60;startDate&#x60; parameter. Include the complete time (hours, minutes, and seconds) in UTC time zone, following the ISO 8601 date-time format. See the example for reference. Please note that this parameter can&#39;t be used with &#x60;window&#x60;. (optional)
   * @param cursor (Optional) Opaque cursor used for pagination. Clients should use &#x60;next&#x60; value from &#x60;_links&#x60; instead of this parameter. (optional)
   * @return ApiResponse&lt;PathVisDynamicTestResults&gt;
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<PathVisDynamicTestResults> getDynamicTestPathVisResultsWithHttpInfo(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor) throws ApiException {
    ...
    return apiClient.send(requestBuilder.build(), PathVisDynamicTestResults.class);
  }
