...
public class WebHttpServerScheduledTestResultsApi {
   ...
   * @param cursor (Optional) Opaque cursor used for pagination. Clients should use &#x60;next&#x60; value from &#x60;_links&#x60; instead of this parameter. (optional)
   * @param expand This parameter is optional and determines whether to expand resources related to test results. By default, no expansion occurs when this query parameter is omitted. To expand a specific resource, such as \&quot;header,\&quot; append &#x60;?expand&#x3D;header&#x60; to the query. (optional
   * @param httpTestsDataRoundsSearch Test data search filters. (optional)
   * @return HttpMultiTestResults
   * @throws ApiException if fails to make API call
   */
  public HttpMultiTestResults getMultiTestFilteredHttpServerScheduledTestResults(String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor, List<Expand> expand, HttpTestsDataRoundsSearch httpTestsDataRoundsSearch) throws ApiException {
    ApiResponse<HttpMultiTestResults> response = getMultiTestFilteredHttpServerScheduledTestResultsWithHttpInfo(aid, window, startDate, endDate, cursor, expand, httpTestsDataRoundsSearch);
    return response.getData();
  }
   ...
   * @param expand This parameter is optional and determines whether to expand resources related to test results. By default, no expansion occurs when this query parameter is omitted. To expand a specific resource, such as \&quot;header,\&quot; append &#x60;?expand&#x3D;header&#x60; to the query. (optional
   * @param httpTestsDataRoundsSearch Test data search filters. (optional)
   * @return ApiResponse&lt;HttpMultiTestResults&gt;
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<HttpMultiTestResults> getMultiTestFilteredHttpServerScheduledTestResultsWithHttpInfo(String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor, List<Expand> expand, HttpTestsDataRoundsSearch httpTestsDataRoundsSearch) throws ApiException {
    getMultiTestFilteredHttpServerScheduledTestResultsValidateRequest();

    var requestBuilder = getMultiTestFilteredHttpServerScheduledTestResultsRequestBuilder(aid, window, startDate, endDate, cursor, expand, httpTestsDataRoundsSearch);

    return apiClient.send(requestBuilder.build(), HttpMultiTestResults.class);
  }

  private void getMultiTestFilteredHttpServerScheduledTestResultsValidateRequest() throws ApiException {
  }

  private ApiRequest.ApiRequestBuilder getMultiTestFilteredHttpServerScheduledTestResultsRequestBuilder(String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor, List<Expand> expand, HttpTestsDataRoundsSearch httpTestsDataRoundsSearch) throws ApiException {
    ApiRequest.ApiRequestBuilder requestBuilder = ApiRequest.builder()
            .method("POST");
    ...
    requestBuilder.header("Accept", List.of("application/hal+json, application/json, application/problem+json"));
    requestBuilder.header("User-Agent", List.of(Config.USER_AGENT));
    requestBuilder.requestBody(httpTestsDataRoundsSearch);
    return requestBuilder;
  }
}
