...
public class AgentToServerTest {
  ...
  * @throws IOException if the JSON Element is invalid with respect to AgentToServerTest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AgentToServerTest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AgentToServerTest is not found in the empty JSON string", AgentToServerTest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AgentToServerTest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AgentToServerTest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AgentToServerTest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AgentToServerTest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AgentToServerTest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AgentToServerTest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AgentToServerTest.class));

       return (TypeAdapter<T>) new TypeAdapter<AgentToServerTest>() {
           @Override
           public void write(JsonWriter out, AgentToServerTest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AgentToServerTest read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of AgentToServerTest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AgentToServerTest
  * @throws IOException if the JSON string is invalid with respect to AgentToServerTest
  */
  public static AgentToServerTest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AgentToServerTest.class);
  }

 /**
  * Convert an instance of AgentToServerTest to an JSON string
  *
  * @return JSON string
  */
