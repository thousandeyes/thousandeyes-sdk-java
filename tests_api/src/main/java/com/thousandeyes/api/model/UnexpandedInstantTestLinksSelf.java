...
public class UnexpandedInstantTestLinksSelf {
  ...
  * @throws IOException if the JSON Element is invalid with respect to UnexpandedInstantTestLinksSelf
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UnexpandedInstantTestLinksSelf.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UnexpandedInstantTestLinksSelf is not found in the empty JSON string", UnexpandedInstantTestLinksSelf.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UnexpandedInstantTestLinksSelf.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UnexpandedInstantTestLinksSelf` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UnexpandedInstantTestLinksSelf.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UnexpandedInstantTestLinksSelf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UnexpandedInstantTestLinksSelf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UnexpandedInstantTestLinksSelf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UnexpandedInstantTestLinksSelf.class));

       return (TypeAdapter<T>) new TypeAdapter<UnexpandedInstantTestLinksSelf>() {
           @Override
           public void write(JsonWriter out, UnexpandedInstantTestLinksSelf value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UnexpandedInstantTestLinksSelf read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UnexpandedInstantTestLinksSelf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UnexpandedInstantTestLinksSelf
  * @throws IOException if the JSON string is invalid with respect to UnexpandedInstantTestLinksSelf
  */
  public static UnexpandedInstantTestLinksSelf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UnexpandedInstantTestLinksSelf.class);
  }

 /**
  * Convert an instance of UnexpandedInstantTestLinksSelf to an JSON string
  *
  * @return JSON string
  */
