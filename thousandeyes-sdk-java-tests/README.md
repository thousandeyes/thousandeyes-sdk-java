...
- Build date: 2024-04-16T16:28:26.640956+01:00[Europe/Lisbon]
...
```groovy
compile "com.thousandeyes.api:thousandeyes-sdk-java-tests:7.0.0-SNAPSHOT"
```
...
- `target/thousandeyes-sdk-java-tests-7.0.0-SNAPSHOT.jar`
- `target/lib/*.jar`
