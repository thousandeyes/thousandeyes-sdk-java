...
public class UnexpandedWebTransactionTest {
  ...
  **/
  ...
  public UnexpandedWebTransactionTest links(UnexpandedInstantTestLinks links) {
    this.links = links;
    return this;
  }
