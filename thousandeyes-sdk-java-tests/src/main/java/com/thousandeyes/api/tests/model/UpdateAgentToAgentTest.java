...
public class UpdateAgentToAgentTest {
  ...
  **/
  ...
  public UpdateAgentToAgentTest addItem(String alertRulesItem) {
  ...
  **/
  ...
  public UpdateAgentToAgentTest addItem(String labelsItem) {
    if (this.labels == null) {
  ...
  **/
  ...
  public UpdateAgentToAgentTest addItem(String sharedWithAccountsItem) {
  ...
  **/
  ...
  public UpdateAgentToAgentTest addItem(AgentRequest agentsItem) {
    if (this.agents == null) {
  ...
  **/
  ...
  public UpdateAgentToAgentTest addItem(String monitorsItem) {
