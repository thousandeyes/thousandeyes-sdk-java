...
public class UpdateDnsTraceTest {
  ...
  **/
  ...
  public UpdateDnsTraceTest addItem(String alertRulesItem) {
  ...
  **/
  ...
  public UpdateDnsTraceTest addItem(String labelsItem) {
    if (this.labels == null) {
  ...
  **/
  ...
  public UpdateDnsTraceTest addItem(String sharedWithAccountsItem) {
  ...
  **/
  ...
  public UpdateDnsTraceTest addItem(AgentRequest agentsItem) {
    if (this.agents == null) {
