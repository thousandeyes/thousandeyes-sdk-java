...
public class DnsServerApi {
  ...
  public GetDNSServerTests200Response getDNSServerTests(String aid) throws ApiException {
    ApiResponse<GetDNSServerTests200Response> response = getDNSServerTestsWithHttpInfo(aid);
    return response.getData();
  }
  ...
  public ApiResponse<GetDNSServerTests200Response> getDNSServerTestsWithHttpInfo(String aid) throws ApiException {
    ...
    return apiClient.send(requestBuilder.build(), GetDNSServerTests200Response.class);
  }
