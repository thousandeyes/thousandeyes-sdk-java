...
@JsonPropertyOrder({
  ...
  HttpServerTests.JSON_PROPERTY_LINKS
})
...
public class HttpServerTests {
  ...
  public HttpServerTests addItem(UnexpandedHttpServerTest testsItem) {
    if (this.tests == null) {
  ...
  **/
  ...
  public HttpServerTests links(SelfLinks links) {
    this.links = links;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this HttpServerTests object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tests, httpServerTests.tests) &&
        Objects.equals(this.links, httpServerTests.links);
  }
