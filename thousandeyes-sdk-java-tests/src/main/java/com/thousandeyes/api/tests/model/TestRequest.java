...
public class TestRequest {
  ...
  public TestRequest addItem(String labelsItem) {
    if (this.labels == null) {
  ...
  **/
  ...
  public TestRequest addItem(String sharedWithAccountsItem) {
  ...
  **/
  ...
  public TestRequest addItem(String alertRulesItem) {
  ...
  **/
  ...
  public TestRequest addItem(AgentRequest agentsItem) {
    if (this.agents == null) {
