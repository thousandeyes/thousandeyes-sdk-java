...
@JsonPropertyOrder({
  ...
  DnsTraceTests.JSON_PROPERTY_LINKS
})
...
public class DnsTraceTests {
  ...
  public DnsTraceTests addItem(UnexpandedDnsTraceTest testsItem) {
    if (this.tests == null) {
  ...
  **/
  ...
  public DnsTraceTests links(SelfLinks links) {
    this.links = links;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tests, dnsTraceTests.tests) &&
        Objects.equals(this.links, dnsTraceTests.links);
  }
