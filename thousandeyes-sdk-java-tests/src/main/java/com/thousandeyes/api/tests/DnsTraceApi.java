...
public class DnsTraceApi {
  ...
  public GetDnsTraceTests200Response getDnsTraceTests(String aid) throws ApiException {
    ApiResponse<GetDnsTraceTests200Response> response = getDnsTraceTestsWithHttpInfo(aid);
    return response.getData();
  }
  ...
  public ApiResponse<GetDnsTraceTests200Response> getDnsTraceTestsWithHttpInfo(String aid) throws ApiException {
    ...
    return apiClient.send(requestBuilder.build(), GetDnsTraceTests200Response.class);
  }
