...
public class UpdateDnsSecTest {
  ...
  **/
  ...
  public UpdateDnsSecTest addItem(String alertRulesItem) {
  ...
  **/
  ...
  public UpdateDnsSecTest links(TestLinks links) {
    this.links = links;
    return this;
  }
  ...
  **/
  ...
  public UpdateDnsSecTest addItem(String labelsItem) {
    if (this.labels == null) {
  ...
  **/
  ...
  public UpdateDnsSecTest addItem(String sharedWithAccountsItem) {
  ...
  **/
  ...
  public UpdateDnsSecTest addItem(AgentRequest agentsItem) {
    if (this.agents == null) {
