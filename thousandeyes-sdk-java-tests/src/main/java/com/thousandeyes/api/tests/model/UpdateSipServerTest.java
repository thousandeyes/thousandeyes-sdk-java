...
public class UpdateSipServerTest {
  ...
  **/
  ...
  public UpdateSipServerTest addItem(String alertRulesItem) {
  ...
  **/
  ...
  public UpdateSipServerTest addItem(String labelsItem) {
    if (this.labels == null) {
  ...
  **/
  ...
  public UpdateSipServerTest addItem(String sharedWithAccountsItem) {
  ...
  **/
  ...
  public UpdateSipServerTest addItem(AgentRequest agentsItem) {
    if (this.agents == null) {
