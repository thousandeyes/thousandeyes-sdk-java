...
public class GetDnsTraceTests200Response {
  ...
  public GetDnsTraceTests200Response tests(List<UnexpandedDnsTraceTest> tests) {
    this.tests = tests;
    return this;
  }

  public GetDnsTraceTests200Response addTestsItem(UnexpandedDnsTraceTest testsItem) {
    if (this.tests == null) {
  ...
  **/
  ...
  /**
   * Return true if this getDnsTraceTests_200_response object is equal to o.
   */
  @Override
