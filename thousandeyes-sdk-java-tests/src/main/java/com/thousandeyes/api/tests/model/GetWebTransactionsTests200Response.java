...
public class GetWebTransactionsTests200Response {
  ...
  public GetWebTransactionsTests200Response tests(List<UnexpandedWebTransactionTest> tests) {
    this.tests = tests;
    return this;
  }

  public GetWebTransactionsTests200Response addTestsItem(UnexpandedWebTransactionTest testsItem) {
    if (this.tests == null) {
