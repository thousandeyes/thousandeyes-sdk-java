...
/**
 * Gets or Sets ExpandUsageOptions
 */
public enum ExpandUsageOptions {
  ...
  ExpandUsageOptions(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static ExpandUsageOptions fromValue(String value) {
    for (ExpandUsageOptions b : ExpandUsageOptions.values()) {
