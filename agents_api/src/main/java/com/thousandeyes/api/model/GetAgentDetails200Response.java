...
public class GetAgentDetails200Response {
  ...
  public GetAgentDetails200Response() {
  }
  ...
  **/
  ...
  public GetAgentDetails200Response agentName(String agentName) {
  ...
  **/
  ...
  public GetAgentDetails200Response agentType(CloudEnterpriseAgentType agentType) {
  ...
  **/
  ...
  public GetAgentDetails200Response enabled(Boolean enabled) {
  ...
  **/
  ...
  public GetAgentDetails200Response accountGroups(List<AccountGroup> accountGroups) {
    
    this.accountGroups = accountGroups;
    return this;
  }

  public GetAgentDetails200Response addAccountGroupsItem(AccountGroup accountGroupsItem) {
  ...
  **/
  ...
  public GetAgentDetails200Response ipv6Policy(EnterpriseAgentIpv6Policy ipv6Policy) {
  ...
  **/
  ...
  public GetAgentDetails200Response agentState(EnterpriseAgentState agentState) {
  ...
  **/
  ...
  public GetAgentDetails200Response keepBrowserCache(Boolean keepBrowserCache) {
  ...
  **/
  ...
  public GetAgentDetails200Response targetForTests(String targetForTests) {
  ...
  **/
  ...
  public GetAgentDetails200Response localResolutionPrefixes(List<String> localResolutionPrefixes) {
    
    this.localResolutionPrefixes = localResolutionPrefixes;
    return this;
  }

  public GetAgentDetails200Response addLocalResolutionPrefixesItem(String localResolutionPrefixesItem) {
  ...
  **/
  ...
  public GetAgentDetails200Response tests(List<SimpleTest> tests) {
    
    this.tests = tests;
    return this;
  }

  public GetAgentDetails200Response addTestsItem(SimpleTest testsItem) {
    if (this.tests == null) {
  ...
  **/
  ...
  public GetAgentDetails200Response notificationRules(List<NotificationRules> notificationRules) {
    
    this.notificationRules = notificationRules;
    return this;
  }

  public GetAgentDetails200Response addNotificationRulesItem(NotificationRules notificationRulesItem) {
  ...
  **/
  ...
  public GetAgentDetails200Response links(SelfLinksLinks links) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GetAgentDetails200Response getAgentDetails200Response = (GetAgentDetails200Response) o;
    return Objects.equals(this.ipAddresses, getAgentDetails200Response.ipAddresses) &&
        Objects.equals(this.publicIpAddresses, getAgentDetails200Response.publicIpAddresses) &&
        Objects.equals(this.network, getAgentDetails200Response.network) &&
        Objects.equals(this.agentId, getAgentDetails200Response.agentId) &&
        Objects.equals(this.agentName, getAgentDetails200Response.agentName) &&
        Objects.equals(this.agentType, getAgentDetails200Response.agentType) &&
        Objects.equals(this.location, getAgentDetails200Response.location) &&
        Objects.equals(this.countryId, getAgentDetails200Response.countryId) &&
        Objects.equals(this.enabled, getAgentDetails200Response.enabled) &&
        Objects.equals(this.verifySslCertificates, getAgentDetails200Response.verifySslCertificates) &&
        Objects.equals(this.clusterMembers, getAgentDetails200Response.clusterMembers) &&
        Objects.equals(this.utilization, getAgentDetails200Response.utilization) &&
        Objects.equals(this.accountGroups, getAgentDetails200Response.accountGroups) &&
        Objects.equals(this.prefix, getAgentDetails200Response.prefix) &&
        Objects.equals(this.ipv6Policy, getAgentDetails200Response.ipv6Policy) &&
        Objects.equals(this.errorDetails, getAgentDetails200Response.errorDetails) &&
        Objects.equals(this.hostname, getAgentDetails200Response.hostname) &&
        Objects.equals(this.lastSeen, getAgentDetails200Response.lastSeen) &&
        Objects.equals(this.agentState, getAgentDetails200Response.agentState) &&
        Objects.equals(this.keepBrowserCache, getAgentDetails200Response.keepBrowserCache) &&
        Objects.equals(this.createdDate, getAgentDetails200Response.createdDate) &&
        Objects.equals(this.targetForTests, getAgentDetails200Response.targetForTests) &&
        Objects.equals(this.localResolutionPrefixes, getAgentDetails200Response.localResolutionPrefixes) &&
        Objects.equals(this.interfaceIpMappings, getAgentDetails200Response.interfaceIpMappings) &&
        Objects.equals(this.tests, getAgentDetails200Response.tests) &&
        Objects.equals(this.notificationRules, getAgentDetails200Response.notificationRules) &&
        Objects.equals(this.labels, getAgentDetails200Response.labels) &&
        Objects.equals(this.links, getAgentDetails200Response.links);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetAgentDetails200Response {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to GetAgentDetails200Response
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetAgentDetails200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetAgentDetails200Response is not found in the empty JSON string", GetAgentDetails200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetAgentDetails200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetAgentDetails200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetAgentDetails200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetAgentDetails200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetAgentDetails200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetAgentDetails200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetAgentDetails200Response>() {
           @Override
           public void write(JsonWriter out, GetAgentDetails200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetAgentDetails200Response read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of GetAgentDetails200Response given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetAgentDetails200Response
  * @throws IOException if the JSON string is invalid with respect to GetAgentDetails200Response
  */
  public static GetAgentDetails200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetAgentDetails200Response.class);
  }

 /**
  * Convert an instance of GetAgentDetails200Response to an JSON string
  *
  * @return JSON string
  */
