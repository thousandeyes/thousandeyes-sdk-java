...
import com.thousandeyes.api.endpoint.tests.model.DynamicTestHasPathTraceInSession;
import com.thousandeyes.api.endpoint.tests.model.DynamicTestIsEnabled;
import com.thousandeyes.api.endpoint.tests.model.DynamicTestNetworkMeasurements;
import com.thousandeyes.api.endpoint.tests.model.DynamicTestTcpProbeMode;
...
public class GetDynamicTestDetail200Response {
  ...
  private DynamicTestIsEnabled isEnabled;
  ...
  private DynamicTestHasPathTraceInSession hasPathTraceInSession;
  ...
  private DynamicTestNetworkMeasurements networkMeasurements;
  ...
  private DynamicTestTcpProbeMode tcpProbeMode;
  ...
  **/
  ...
  public GetDynamicTestDetail200Response isEnabled(DynamicTestIsEnabled isEnabled) {
  ...
  **/
  @javax.annotation.Nullable
  public DynamicTestIsEnabled getIsEnabled() {
    return isEnabled;
  }


  public void setIsEnabled(DynamicTestIsEnabled isEnabled) {
    this.isEnabled = isEnabled;
  }


  public GetDynamicTestDetail200Response hasPathTraceInSession(DynamicTestHasPathTraceInSession hasPathTraceInSession) {
  ...
  **/
  @javax.annotation.Nullable
  public DynamicTestHasPathTraceInSession getHasPathTraceInSession() {
    return hasPathTraceInSession;
  }


  public void setHasPathTraceInSession(DynamicTestHasPathTraceInSession hasPathTraceInSession) {
    this.hasPathTraceInSession = hasPathTraceInSession;
  }
  ...
  **/
  ...
  public GetDynamicTestDetail200Response networkMeasurements(DynamicTestNetworkMeasurements networkMeasurements) {
  ...
  **/
  @javax.annotation.Nullable
  public DynamicTestNetworkMeasurements getNetworkMeasurements() {
    return networkMeasurements;
  }


  public void setNetworkMeasurements(DynamicTestNetworkMeasurements networkMeasurements) {
    this.networkMeasurements = networkMeasurements;
  }
  ...
  **/
  ...
  public GetDynamicTestDetail200Response tcpProbeMode(DynamicTestTcpProbeMode tcpProbeMode) {
  ...
  **/
  @javax.annotation.Nullable
  public DynamicTestTcpProbeMode getTcpProbeMode() {
    return tcpProbeMode;
  }


  public void setTcpProbeMode(DynamicTestTcpProbeMode tcpProbeMode) {
    this.tcpProbeMode = tcpProbeMode;
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("isEnabled") != null && !jsonObj.get("isEnabled").isJsonNull()) {
        DynamicTestIsEnabled.validateJsonElement(jsonObj.get("isEnabled"));
      }
      ...
      if (jsonObj.get("hasPathTraceInSession") != null && !jsonObj.get("hasPathTraceInSession").isJsonNull()) {
        DynamicTestHasPathTraceInSession.validateJsonElement(jsonObj.get("hasPathTraceInSession"));
      }
      ...
      if (jsonObj.get("networkMeasurements") != null && !jsonObj.get("networkMeasurements").isJsonNull()) {
        DynamicTestNetworkMeasurements.validateJsonElement(jsonObj.get("networkMeasurements"));
      }
      ...
      if (jsonObj.get("tcpProbeMode") != null && !jsonObj.get("tcpProbeMode").isJsonNull()) {
        DynamicTestTcpProbeMode.validateJsonElement(jsonObj.get("tcpProbeMode"));
      }
