...
public class ApiOutageFilter {
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the optional field `outageScope`
      if (jsonObj.get("outageScope") != null && !jsonObj.get("outageScope").isJsonNull()) {
        OutageScope.validateJsonElement(jsonObj.get("outageScope"));
      }
