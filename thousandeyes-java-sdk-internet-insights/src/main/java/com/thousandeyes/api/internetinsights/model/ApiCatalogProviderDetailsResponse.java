...
import com.thousandeyes.api.internetinsights.model.ApiAsn;
import com.thousandeyes.api.internetinsights.model.ApiCatalogProviderDetailsLocationsInner;
...
public class ApiCatalogProviderDetailsResponse {
  ...
  * @throws IOException if the JSON Element is invalid with respect to ApiCatalogProviderDetailsResponse
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApiCatalogProviderDetailsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApiCatalogProviderDetailsResponse is not found in the empty JSON string", ApiCatalogProviderDetailsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApiCatalogProviderDetailsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApiCatalogProviderDetailsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApiCatalogProviderDetailsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApiCatalogProviderDetailsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApiCatalogProviderDetailsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApiCatalogProviderDetailsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ApiCatalogProviderDetailsResponse>() {
           @Override
           public void write(JsonWriter out, ApiCatalogProviderDetailsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApiCatalogProviderDetailsResponse read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ApiCatalogProviderDetailsResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ApiCatalogProviderDetailsResponse
  * @throws IOException if the JSON string is invalid with respect to ApiCatalogProviderDetailsResponse
  */
  public static ApiCatalogProviderDetailsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApiCatalogProviderDetailsResponse.class);
  }

 /**
  * Convert an instance of ApiCatalogProviderDetailsResponse to an JSON string
  *
  * @return JSON string
  */
