# thousandeyes-java-sdk-internet-insights

Internet Insights API
- API version: 7.0.0
  - Build date: 2023-12-18T17:52:52.307887Z[Europe/Lisbon]
...
<dependency>
  ...
  <artifactId>thousandeyes-java-sdk-internet-insights</artifactId>
...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'thousandeyes-java-sdk-internet-insights' jar has been published to maven central.
    mavenLocal()       // Needed if the 'thousandeyes-java-sdk-internet-insights' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "org.openapitools:thousandeyes-java-sdk-internet-insights:7.0.0"
  }
```
...
* `target/thousandeyes-java-sdk-internet-insights-7.0.0.jar`
* `target/lib/*.jar`
