...
public class AlertsApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public Alerts getAlerts(String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, BigDecimal max, State state) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<Alerts> getAlertsWithHttpInfo(String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, BigDecimal max, State state) throws ApiException {
