...
public class AlertRulesApiTest {
                  ...
                  "_links" : {
                    "self" : {
                      ...
                      "title" : "title"
                                  ...
                                  """;
        CreateAlertRule201Response mappedResponse = 
                mapper.readValue(responseBodyJson, CreateAlertRule201Response.class);
    ...
    @Test
    public void getAlertRuleDetailsRequestAndResponseDeserializationTest()
            throws JsonProcessingException 
    {
                  ...
                  "_links" : {
                    "self" : {
                      ...
                      "title" : "title"
                                  ...
                                  """;
        GetAlertRuleDetails200Response mappedResponse = 
                mapper.readValue(responseBodyJson, GetAlertRuleDetails200Response.class);
        assertNotNull(mappedResponse);
    }
        ...
        String responseBodyJson = """
                {
                  ...
                  "alertRules" : [ {
                    ...
                    "ruleId" : "127094"
                                  ...
                                  """;
        GetAlertsRules200Response mappedResponse = 
                mapper.readValue(responseBodyJson, GetAlertsRules200Response.class);
        assertNotNull(mappedResponse);
    }
