# thousandeyes-java-sdk-tests

Tests API
- API version: 7.0.0
  - Build date: 2023-12-18T17:52:56.680950Z[Europe/Lisbon]
...
<dependency>
  ...
  <artifactId>thousandeyes-java-sdk-tests</artifactId>
...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'thousandeyes-java-sdk-tests' jar has been published to maven central.
    mavenLocal()       // Needed if the 'thousandeyes-java-sdk-tests' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "org.openapitools:thousandeyes-java-sdk-tests:7.0.0"
  }
```
...
* `target/thousandeyes-java-sdk-tests-7.0.0.jar`
* `target/lib/*.jar`
