...
- Build date: 2024-02-07T22:58:23.827774Z[Europe/Lisbon]
...
```groovy
compile "com.thousandeyes.api:thousandeyes-java-sdk-tests:7.0.0-SNAPSHOT"
```
...
- `target/thousandeyes-java-sdk-tests-7.0.0-SNAPSHOT.jar`
- `target/lib/*.jar`
...
*DnssecApi* | [**getDnsSecTestsWithHttpInfo**](docs/DnssecApi.md#getDnsSecTestsWithHttpInfo) | **GET** /v7/tests/dnssec | List DNS Sec tests
