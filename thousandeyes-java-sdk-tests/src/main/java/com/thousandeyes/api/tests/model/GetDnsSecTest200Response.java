...
public class GetDnsSecTest200Response {
  ...
  public GetDnsSecTest200Response() {
  }
  ...
  public GetDnsSecTest200Response interval(TestInterval interval) {
  ...
  **/
  ...
  public GetDnsSecTest200Response alertsEnabled(Boolean alertsEnabled) {
  ...
  **/
  ...
  public GetDnsSecTest200Response enabled(Boolean enabled) {
  ...
  **/
  ...
  public GetDnsSecTest200Response alertRules(List<AlertRule> alertRules) {
    
    this.alertRules = alertRules;
    return this;
  }

  public GetDnsSecTest200Response addAlertRulesItem(AlertRule alertRulesItem) {
  ...
  **/
  ...
  public GetDnsSecTest200Response description(String description) {
  ...
  **/
  ...
  public GetDnsSecTest200Response testName(String testName) {
  ...
  **/
  ...
  public GetDnsSecTest200Response links(SelfLinksLinks links) {
  ...
  **/
  ...
  public GetDnsSecTest200Response domain(String domain) {
  ...
  **/
  ...
  public GetDnsSecTest200Response dnsQueryClass(DnsQueryClass dnsQueryClass) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GetDnsSecTest200Response getDnsSecTest200Response = (GetDnsSecTest200Response) o;
    return Objects.equals(this.interval, getDnsSecTest200Response.interval) &&
        Objects.equals(this.alertsEnabled, getDnsSecTest200Response.alertsEnabled) &&
        Objects.equals(this.enabled, getDnsSecTest200Response.enabled) &&
        Objects.equals(this.alertRules, getDnsSecTest200Response.alertRules) &&
        Objects.equals(this.createdBy, getDnsSecTest200Response.createdBy) &&
        Objects.equals(this.createdDate, getDnsSecTest200Response.createdDate) &&
        Objects.equals(this.description, getDnsSecTest200Response.description) &&
        Objects.equals(this.liveShare, getDnsSecTest200Response.liveShare) &&
        Objects.equals(this.modifiedBy, getDnsSecTest200Response.modifiedBy) &&
        Objects.equals(this.modifiedDate, getDnsSecTest200Response.modifiedDate) &&
        Objects.equals(this.savedEvent, getDnsSecTest200Response.savedEvent) &&
        Objects.equals(this.testId, getDnsSecTest200Response.testId) &&
        Objects.equals(this.testName, getDnsSecTest200Response.testName) &&
        Objects.equals(this.type, getDnsSecTest200Response.type) &&
        Objects.equals(this.links, getDnsSecTest200Response.links) &&
        Objects.equals(this.labels, getDnsSecTest200Response.labels) &&
        Objects.equals(this.sharedWithAccounts, getDnsSecTest200Response.sharedWithAccounts) &&
        Objects.equals(this.agents, getDnsSecTest200Response.agents) &&
        Objects.equals(this.domain, getDnsSecTest200Response.domain) &&
        Objects.equals(this.dnsQueryClass, getDnsSecTest200Response.dnsQueryClass);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetDnsSecTest200Response {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to GetDnsSecTest200Response
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetDnsSecTest200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetDnsSecTest200Response is not found in the empty JSON string", GetDnsSecTest200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetDnsSecTest200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetDnsSecTest200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetDnsSecTest200Response.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetDnsSecTest200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetDnsSecTest200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetDnsSecTest200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetDnsSecTest200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetDnsSecTest200Response>() {
           @Override
           public void write(JsonWriter out, GetDnsSecTest200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetDnsSecTest200Response read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of GetDnsSecTest200Response given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetDnsSecTest200Response
  * @throws IOException if the JSON string is invalid with respect to GetDnsSecTest200Response
  */
  public static GetDnsSecTest200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetDnsSecTest200Response.class);
  }

 /**
  * Convert an instance of GetDnsSecTest200Response to an JSON string
  *
  * @return JSON string
  */
