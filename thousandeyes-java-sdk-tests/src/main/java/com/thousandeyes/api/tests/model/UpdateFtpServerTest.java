...
public class UpdateFtpServerTest {
  ...
  * @throws IOException if the JSON Element is invalid with respect to UpdateFtpServerTest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateFtpServerTest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateFtpServerTest is not found in the empty JSON string", UpdateFtpServerTest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateFtpServerTest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateFtpServerTest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateFtpServerTest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateFtpServerTest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateFtpServerTest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateFtpServerTest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateFtpServerTest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateFtpServerTest>() {
           @Override
           public void write(JsonWriter out, UpdateFtpServerTest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateFtpServerTest read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UpdateFtpServerTest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UpdateFtpServerTest
  * @throws IOException if the JSON string is invalid with respect to UpdateFtpServerTest
  */
  public static UpdateFtpServerTest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateFtpServerTest.class);
  }

 /**
  * Convert an instance of UpdateFtpServerTest to an JSON string
  *
  * @return JSON string
  */
