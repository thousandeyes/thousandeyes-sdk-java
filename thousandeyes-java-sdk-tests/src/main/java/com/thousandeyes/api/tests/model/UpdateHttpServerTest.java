...
public class UpdateHttpServerTest {
  ...
  * @throws IOException if the JSON Element is invalid with respect to UpdateHttpServerTest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateHttpServerTest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateHttpServerTest is not found in the empty JSON string", UpdateHttpServerTest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateHttpServerTest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateHttpServerTest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateHttpServerTest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateHttpServerTest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateHttpServerTest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateHttpServerTest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateHttpServerTest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateHttpServerTest>() {
           @Override
           public void write(JsonWriter out, UpdateHttpServerTest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateHttpServerTest read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UpdateHttpServerTest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UpdateHttpServerTest
  * @throws IOException if the JSON string is invalid with respect to UpdateHttpServerTest
  */
  public static UpdateHttpServerTest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateHttpServerTest.class);
  }

 /**
  * Convert an instance of UpdateHttpServerTest to an JSON string
  *
  * @return JSON string
  */
