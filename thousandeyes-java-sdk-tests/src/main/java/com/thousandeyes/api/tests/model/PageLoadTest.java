...
public class PageLoadTest {
  ...
  * @throws IOException if the JSON Element is invalid with respect to PageLoadTest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PageLoadTest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PageLoadTest is not found in the empty JSON string", PageLoadTest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PageLoadTest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PageLoadTest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PageLoadTest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PageLoadTest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PageLoadTest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PageLoadTest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PageLoadTest.class));

       return (TypeAdapter<T>) new TypeAdapter<PageLoadTest>() {
           @Override
           public void write(JsonWriter out, PageLoadTest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PageLoadTest read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PageLoadTest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PageLoadTest
  * @throws IOException if the JSON string is invalid with respect to PageLoadTest
  */
  public static PageLoadTest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PageLoadTest.class);
  }

 /**
  * Convert an instance of PageLoadTest to an JSON string
  *
  * @return JSON string
  */
