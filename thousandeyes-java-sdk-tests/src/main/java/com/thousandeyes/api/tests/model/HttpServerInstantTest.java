...
public class HttpServerInstantTest {
  ...
  **/
  ...
  public HttpServerInstantTest links(UnexpandedInstantTestLinks links) {
  ...
  * @throws IOException if the JSON Element is invalid with respect to HttpServerInstantTest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HttpServerInstantTest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in HttpServerInstantTest is not found in the empty JSON string", HttpServerInstantTest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!HttpServerInstantTest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `HttpServerInstantTest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : HttpServerInstantTest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!HttpServerInstantTest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'HttpServerInstantTest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<HttpServerInstantTest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(HttpServerInstantTest.class));

       return (TypeAdapter<T>) new TypeAdapter<HttpServerInstantTest>() {
           @Override
           public void write(JsonWriter out, HttpServerInstantTest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public HttpServerInstantTest read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of HttpServerInstantTest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of HttpServerInstantTest
  * @throws IOException if the JSON string is invalid with respect to HttpServerInstantTest
  */
  public static HttpServerInstantTest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, HttpServerInstantTest.class);
  }

 /**
  * Convert an instance of HttpServerInstantTest to an JSON string
  *
  * @return JSON string
  */
