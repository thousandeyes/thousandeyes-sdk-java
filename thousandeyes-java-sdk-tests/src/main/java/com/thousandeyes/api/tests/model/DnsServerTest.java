...
public class DnsServerTest {
  ...
  **/
  ...
  public DnsServerTest links(UnexpandedInstantTestLinks links) {
  ...
  * @throws IOException if the JSON Element is invalid with respect to DnsServerTest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DnsServerTest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DnsServerTest is not found in the empty JSON string", DnsServerTest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DnsServerTest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DnsServerTest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DnsServerTest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DnsServerTest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DnsServerTest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DnsServerTest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DnsServerTest.class));

       return (TypeAdapter<T>) new TypeAdapter<DnsServerTest>() {
           @Override
           public void write(JsonWriter out, DnsServerTest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DnsServerTest read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of DnsServerTest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DnsServerTest
  * @throws IOException if the JSON string is invalid with respect to DnsServerTest
  */
  public static DnsServerTest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DnsServerTest.class);
  }

 /**
  * Convert an instance of DnsServerTest to an JSON string
  *
  * @return JSON string
  */
