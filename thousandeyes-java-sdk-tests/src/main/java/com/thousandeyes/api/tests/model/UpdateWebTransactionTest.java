...
public class UpdateWebTransactionTest {
  ...
  * @throws IOException if the JSON Element is invalid with respect to UpdateWebTransactionTest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateWebTransactionTest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateWebTransactionTest is not found in the empty JSON string", UpdateWebTransactionTest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateWebTransactionTest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateWebTransactionTest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateWebTransactionTest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateWebTransactionTest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateWebTransactionTest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateWebTransactionTest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateWebTransactionTest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateWebTransactionTest>() {
           @Override
           public void write(JsonWriter out, UpdateWebTransactionTest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateWebTransactionTest read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UpdateWebTransactionTest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UpdateWebTransactionTest
  * @throws IOException if the JSON string is invalid with respect to UpdateWebTransactionTest
  */
  public static UpdateWebTransactionTest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateWebTransactionTest.class);
  }

 /**
  * Convert an instance of UpdateWebTransactionTest to an JSON string
  *
  * @return JSON string
  */
