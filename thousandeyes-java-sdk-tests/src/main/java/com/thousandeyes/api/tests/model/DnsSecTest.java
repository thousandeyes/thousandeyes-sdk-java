...
public class DnsSecTest {
  ...
  * @throws IOException if the JSON Element is invalid with respect to DnsSecTest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DnsSecTest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DnsSecTest is not found in the empty JSON string", DnsSecTest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DnsSecTest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DnsSecTest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DnsSecTest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DnsSecTest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DnsSecTest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DnsSecTest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DnsSecTest.class));

       return (TypeAdapter<T>) new TypeAdapter<DnsSecTest>() {
           @Override
           public void write(JsonWriter out, DnsSecTest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DnsSecTest read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of DnsSecTest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DnsSecTest
  * @throws IOException if the JSON string is invalid with respect to DnsSecTest
  */
  public static DnsSecTest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DnsSecTest.class);
  }

 /**
  * Convert an instance of DnsSecTest to an JSON string
  *
  * @return JSON string
  */
