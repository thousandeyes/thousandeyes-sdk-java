...
public class WebTransactionInstantTest {
  ...
  * @throws IOException if the JSON Element is invalid with respect to WebTransactionInstantTest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebTransactionInstantTest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebTransactionInstantTest is not found in the empty JSON string", WebTransactionInstantTest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebTransactionInstantTest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebTransactionInstantTest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebTransactionInstantTest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebTransactionInstantTest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebTransactionInstantTest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebTransactionInstantTest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebTransactionInstantTest.class));

       return (TypeAdapter<T>) new TypeAdapter<WebTransactionInstantTest>() {
           @Override
           public void write(JsonWriter out, WebTransactionInstantTest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebTransactionInstantTest read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebTransactionInstantTest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebTransactionInstantTest
  * @throws IOException if the JSON string is invalid with respect to WebTransactionInstantTest
  */
  public static WebTransactionInstantTest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebTransactionInstantTest.class);
  }

 /**
  * Convert an instance of WebTransactionInstantTest to an JSON string
  *
  * @return JSON string
  */
