...
<a id="deleteAgentToAgentTest"></a>
# **deleteAgentToAgentTest**
> deleteAgentToAgentTest(testId, aid)
...
<a id="getAgentToAgentTest"></a>
# **getAgentToAgentTest**
> GetAgentToAgentTest200Response getAgentToAgentTest(testId, aid, expand)
...
public class Example {
  public static void main(String[] args) {
    ...
    List<Expand> expand = Arrays.asList(); // List<Expand> | Optional parameter on whether or not to expand the test sub-resources. By default no expansion is going to take place if the query parameter is not present. If the user wishes to expand the `agents` sub-resource, they need to pass the `?expand=agent` query.
    try {
      GetAgentToAgentTest200Response result = apiInstance.getAgentToAgentTest(testId, aid, expand);
      System.out.println(result);
    } catch (ApiException e) {
...
<a id="updateAgentToAgentTest"></a>
# **updateAgentToAgentTest**
> GetAgentToAgentTest200Response updateAgentToAgentTest(testId, updateAgentToAgentTest, aid, expand)
...
public class Example {
  public static void main(String[] args) {
    ...
    List<Expand> expand = Arrays.asList(); // List<Expand> | Optional parameter on whether or not to expand the test sub-resources. By default no expansion is going to take place if the query parameter is not present. If the user wishes to expand the `agents` sub-resource, they need to pass the `?expand=agent` query.
    try {
      GetAgentToAgentTest200Response result = apiInstance.updateAgentToAgentTest(testId, updateAgentToAgentTest, aid, expand);
      System.out.println(result);
    } catch (ApiException e) {
