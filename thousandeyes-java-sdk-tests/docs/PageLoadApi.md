...
<a id="deletePageLoadTest"></a>
# **deletePageLoadTest**
> deletePageLoadTest(testId, aid)
...
<a id="getPageLoadTest"></a>
# **getPageLoadTest**
> GetPageLoadTest200Response getPageLoadTest(testId, aid, expand)
...
public class Example {
  public static void main(String[] args) {
    ...
    List<Expand> expand = Arrays.asList(); // List<Expand> | Optional parameter on whether or not to expand the test sub-resources. By default no expansion is going to take place if the query parameter is not present. If the user wishes to expand the `agents` sub-resource, they need to pass the `?expand=agent` query.
    try {
      GetPageLoadTest200Response result = apiInstance.getPageLoadTest(testId, aid, expand);
      System.out.println(result);
    } catch (ApiException e) {
...
[**GetPageLoadTest200Response**](GetPageLoadTest200Response.md)
...
<a id="updatePageLoadTest"></a>
# **updatePageLoadTest**
> GetPageLoadTest200Response updatePageLoadTest(testId, updatePageLoadTest, aid, expand)
...
public class Example {
  public static void main(String[] args) {
    ...
    List<Expand> expand = Arrays.asList(); // List<Expand> | Optional parameter on whether or not to expand the test sub-resources. By default no expansion is going to take place if the query parameter is not present. If the user wishes to expand the `agents` sub-resource, they need to pass the `?expand=agent` query.
    try {
      GetPageLoadTest200Response result = apiInstance.updatePageLoadTest(testId, updatePageLoadTest, aid, expand);
      System.out.println(result);
    } catch (ApiException e) {
