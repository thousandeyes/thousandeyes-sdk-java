...
<a id="createFtpServerTest"></a>
# **createFtpServerTest**
> FtpServerTest createFtpServerTest(updateFtpServerTest, aid, expand)
...
import com.thousandeyes.api.tests.FtpServerApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling FtpServerApi#createFtpServerTest");
...
|------------- | ------------- | ------------- | -------------|
| **updateFtpServerTest** | [**UpdateFtpServerTest**](UpdateFtpServerTest.md)|  | |
...
<a id="deleteFTPServerTest"></a>
# **deleteFTPServerTest**
> deleteFTPServerTest(testId, aid)
...
<a id="getFtpServerTest"></a>
# **getFtpServerTest**
> GetFtpServerTest200Response getFtpServerTest(testId, aid, expand)
...
public class Example {
  public static void main(String[] args) {
    ...
    List<Expand> expand = Arrays.asList(); // List<Expand> | Optional parameter on whether or not to expand the test sub-resources. By default no expansion is going to take place if the query parameter is not present. If the user wishes to expand the `agents` sub-resource, they need to pass the `?expand=agent` query.
    try {
      GetFtpServerTest200Response result = apiInstance.getFtpServerTest(testId, aid, expand);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling FtpServerApi#getFtpServerTest");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
[**GetFtpServerTest200Response**](GetFtpServerTest200Response.md)
...
<a id="updateFtpServerTest"></a>
# **updateFtpServerTest**
> GetFtpServerTest200Response updateFtpServerTest(testId, updateFtpServerTest, aid, expand)
...
public class Example {
  public static void main(String[] args) {
    ...
    List<Expand> expand = Arrays.asList(); // List<Expand> | Optional parameter on whether or not to expand the test sub-resources. By default no expansion is going to take place if the query parameter is not present. If the user wishes to expand the `agents` sub-resource, they need to pass the `?expand=agent` query.
    try {
      GetFtpServerTest200Response result = apiInstance.updateFtpServerTest(testId, updateFtpServerTest, aid, expand);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling FtpServerApi#updateFtpServerTest");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
