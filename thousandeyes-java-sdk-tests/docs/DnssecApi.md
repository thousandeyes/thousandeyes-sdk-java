...
<a id="deleteDnsSecTest"></a>
# **deleteDnsSecTest**
> deleteDnsSecTest(testId, aid)
...
<a id="getDnsSecTest"></a>
# **getDnsSecTest**
> GetDnsSecTest200Response getDnsSecTest(testId, aid, expand)
...
public class Example {
  public static void main(String[] args) {
    ...
    List<Expand> expand = Arrays.asList(); // List<Expand> | Optional parameter on whether or not to expand the test sub-resources. By default no expansion is going to take place if the query parameter is not present. If the user wishes to expand the `agents` sub-resource, they need to pass the `?expand=agent` query.
    try {
      GetDnsSecTest200Response result = apiInstance.getDnsSecTest(testId, aid, expand);
      System.out.println(result);
    } catch (ApiException e) {
...
<a id="updateDnsSecTest"></a>
# **updateDnsSecTest**
> GetDnsSecTest200Response updateDnsSecTest(testId, updateDnsSecTest, aid, expand)
...
public class Example {
  public static void main(String[] args) {
    ...
    List<Expand> expand = Arrays.asList(); // List<Expand> | Optional parameter on whether or not to expand the test sub-resources. By default no expansion is going to take place if the query parameter is not present. If the user wishes to expand the `agents` sub-resource, they need to pass the `?expand=agent` query.
    try {
      GetDnsSecTest200Response result = apiInstance.updateDnsSecTest(testId, updateDnsSecTest, aid, expand);
      System.out.println(result);
    } catch (ApiException e) {
