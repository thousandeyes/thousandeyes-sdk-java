...
<a id="deleteBgpTest"></a>
# **deleteBgpTest**
> deleteBgpTest(testId, aid)
...
<a id="getBgpTest"></a>
# **getBgpTest**
> GetBgpTest200Response getBgpTest(testId, aid, expand)
...
public class Example {
  public static void main(String[] args) {
    ...
    List<Expand> expand = Arrays.asList(); // List<Expand> | Optional parameter on whether or not to expand the test sub-resources. By default no expansion is going to take place if the query parameter is not present. If the user wishes to expand the `agents` sub-resource, they need to pass the `?expand=agent` query.
    try {
      GetBgpTest200Response result = apiInstance.getBgpTest(testId, aid, expand);
      System.out.println(result);
    } catch (ApiException e) {
...
[**GetBgpTest200Response**](GetBgpTest200Response.md)
...
<a id="updateBgpTest"></a>
# **updateBgpTest**
> GetBgpTest200Response updateBgpTest(testId, updateBgpTest, aid, expand)
...
public class Example {
  public static void main(String[] args) {
    ...
    List<Expand> expand = Arrays.asList(); // List<Expand> | Optional parameter on whether or not to expand the test sub-resources. By default no expansion is going to take place if the query parameter is not present. If the user wishes to expand the `agents` sub-resource, they need to pass the `?expand=agent` query.
    try {
      GetBgpTest200Response result = apiInstance.updateBgpTest(testId, updateBgpTest, aid, expand);
      System.out.println(result);
    } catch (ApiException e) {
