...
import com.thousandeyes.sdk.account.management.admin.model.UserAccountGroup;
 ...
 */
@JsonPropertyOrder({
  CreatedAccountGroup.JSON_PROPERTY_AID,
  CreatedAccountGroup.JSON_PROPERTY_ACCOUNT_GROUP_NAME,
...
public class CreatedAccountGroup {
  ...
  public CreatedAccountGroup() { 
  }

  public CreatedAccountGroup aid(String aid) {
    this.aid = aid;
    return this;
  }
  ...
  **/
  ...
  public CreatedAccountGroup accountGroupName(String accountGroupName) {
  ...
  **/
  ...
  public CreatedAccountGroup isCurrentAccountGroup(Boolean isCurrentAccountGroup) {
  ...
  **/
  ...
  public CreatedAccountGroup isDefaultAccountGroup(Boolean isDefaultAccountGroup) {
  ...
  **/
  ...
  public CreatedAccountGroup organizationName(String organizationName) {
  ...
  **/
  ...
  public CreatedAccountGroup addUsersItem(UserAccountGroup usersItem) {
    if (this.users == null) {
  ...
  **/
  ...
  public CreatedAccountGroup links(SelfLinks links) {
    this.links = links;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this CreatedAccountGroup object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    CreatedAccountGroup createdAccountGroup = (CreatedAccountGroup) o;
    return Objects.equals(this.aid, createdAccountGroup.aid) &&
        Objects.equals(this.accountGroupName, createdAccountGroup.accountGroupName) &&
  ...
  public String toString() {
    ...
    sb.append("class CreatedAccountGroup {\n");
