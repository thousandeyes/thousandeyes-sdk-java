...
import com.thousandeyes.sdk.account.management.administrative.model.TestInterval;
import com.thousandeyes.sdk.account.management.administrative.model.TestLinks;
import com.thousandeyes.sdk.account.management.administrative.model.TestType;
...
public class SimpleTest extends HashMap<String, Object> {
  ...
  **/
  ...
  public SimpleTest links(TestLinks links) {
    this.links = links;
    return this;
  }
  ...
  **/
  ...
  public static class ModelBuilder {
    ...
    protected ModelBuilder(SimpleTest instance) {
      this.instance = instance;
    }

    public SimpleTest.ModelBuilder interval(TestInterval interval) {
      this.instance.setInterval(interval);
      return this;
    }
    public SimpleTest.ModelBuilder alertsEnabled(Boolean alertsEnabled) {
      this.instance.setAlertsEnabled(alertsEnabled);
      return this;
    }
    public SimpleTest.ModelBuilder enabled(Boolean enabled) {
      this.instance.setEnabled(enabled);
      return this;
    }
    public SimpleTest.ModelBuilder createdBy(String createdBy) {
      this.instance.createdBy = createdBy;
      return this;
    }
    public SimpleTest.ModelBuilder createdDate(OffsetDateTime createdDate) {
      this.instance.createdDate = createdDate;
      return this;
    }
    public SimpleTest.ModelBuilder description(String description) {
      this.instance.setDescription(description);
      return this;
    }
    public SimpleTest.ModelBuilder liveShare(Boolean liveShare) {
      this.instance.liveShare = liveShare;
      return this;
    }
    public SimpleTest.ModelBuilder modifiedBy(String modifiedBy) {
      this.instance.modifiedBy = modifiedBy;
      return this;
    }
    public SimpleTest.ModelBuilder modifiedDate(OffsetDateTime modifiedDate) {
      this.instance.modifiedDate = modifiedDate;
      return this;
    }
    public SimpleTest.ModelBuilder savedEvent(Boolean savedEvent) {
      this.instance.savedEvent = savedEvent;
      return this;
    }
    public SimpleTest.ModelBuilder testId(String testId) {
      this.instance.testId = testId;
      return this;
    }
    public SimpleTest.ModelBuilder testName(String testName) {
      this.instance.setTestName(testName);
      return this;
    }
    public SimpleTest.ModelBuilder type(TestType type) {
      this.instance.setType(type);
      return this;
    }
    public SimpleTest.ModelBuilder links(TestLinks links) {
      this.instance.setLinks(links);
      return this;
    }

    /**
     * Returns a built SimpleTest instance.
     *
   ...
   */
  public static SimpleTest.ModelBuilder builder() {
    return new SimpleTest.ModelBuilder();
  }

  /**
   * Create a builder with a shallow copy of this instance.
   */
  public SimpleTest.ModelBuilder toBuilder() {
    SimpleTest.ModelBuilder builder = new SimpleTest.ModelBuilder()
