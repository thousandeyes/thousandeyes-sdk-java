 ...
 */
@JsonPropertyOrder({
  DynamicTestLinksSelf.JSON_PROPERTY_HREF,
  DynamicTestLinksSelf.JSON_PROPERTY_TEMPLATED,
  DynamicTestLinksSelf.JSON_PROPERTY_TYPE,
  DynamicTestLinksSelf.JSON_PROPERTY_DEPRECATION,
  DynamicTestLinksSelf.JSON_PROPERTY_NAME,
  DynamicTestLinksSelf.JSON_PROPERTY_PROFILE,
...
public class DynamicTestLinksSelf {
  ...
  **/
  ...
  /**
   * Return true if this DynamicTestLinks_self object is equal to o.
   */
  @Override
