...
public class ScheduledTestsHttpServerApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public EndpointHttpServerTests getEndpointHttpserverTestsList(String aid) throws ApiException {
    ApiResponse<EndpointHttpServerTests> response = getEndpointHttpserverTestsListWithHttpInfo(aid);
    return response.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<EndpointHttpServerTests> getEndpointHttpserverTestsListWithHttpInfo(String aid) throws ApiException {
