...
import com.thousandeyes.api.endpoint.tests.utils.Config;
...
import com.thousandeyes.api.endpoint.tests.model.EndpointAgentToServerTests;
...
public class ScheduledTestsAgentToServerApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public EndpointAgentToServerTests getEndpointAgentToServerTestsList(String aid) throws ApiException {
    ApiResponse<EndpointAgentToServerTests> response = getEndpointAgentToServerTestsListWithHttpInfo(aid);
    return response.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<EndpointAgentToServerTests> getEndpointAgentToServerTestsListWithHttpInfo(String aid) throws ApiException {
