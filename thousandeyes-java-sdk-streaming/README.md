...
- API version: 7.0.0
  - Build date: 2023-12-20T12:21:01.156542Z[Europe/Lisbon]
...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'thousandeyes-java-sdk-streaming' jar has been published to maven central.
    mavenLocal()       // Needed if the 'thousandeyes-java-sdk-streaming' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "org.openapitools:thousandeyes-java-sdk-streaming:7.0.0"
  }
```
...
* `target/thousandeyes-java-sdk-streaming-7.0.0.jar`
* `target/lib/*.jar`
