 ...
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2023-12-18T17:52:51.866982Z[Europe/Lisbon]")
public class CreateStreamResponse {
  ...
  * @throws IOException if the JSON Element is invalid with respect to CreateStreamResponse
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateStreamResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateStreamResponse is not found in the empty JSON string", CreateStreamResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateStreamResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateStreamResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("type") != null && !jsonObj.get("type").isJsonNull()) {
        StreamType.validateJsonElement(jsonObj.get("type"));
      }
      ...
      if (jsonObj.get("auditOperation") != null && !jsonObj.get("auditOperation").isJsonNull()) {
        AuditOperation.validateJsonElement(jsonObj.get("auditOperation"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateStreamResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateStreamResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateStreamResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateStreamResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateStreamResponse>() {
           @Override
           public void write(JsonWriter out, CreateStreamResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateStreamResponse read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CreateStreamResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateStreamResponse
  * @throws IOException if the JSON string is invalid with respect to CreateStreamResponse
  */
  public static CreateStreamResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateStreamResponse.class);
  }

 /**
  * Convert an instance of CreateStreamResponse to an JSON string
  *
  * @return JSON string
  */
