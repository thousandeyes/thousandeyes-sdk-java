# thousandeyes-java-sdk-credentials

Credentials API
- API version: 7.0.0
  - Build date: 2023-12-20T14:43:28.663365Z[Europe/Lisbon]
...
<dependency>
  ...
  <artifactId>thousandeyes-java-sdk-credentials</artifactId>
...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'thousandeyes-java-sdk-credentials' jar has been published to maven central.
    mavenLocal()       // Needed if the 'thousandeyes-java-sdk-credentials' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "org.openapitools:thousandeyes-java-sdk-credentials:7.0.0"
  }
```
...
* `target/thousandeyes-java-sdk-credentials-7.0.0.jar`
* `target/lib/*.jar`
