...
| **prefixes** | [**List&lt;String&gt;**](String.md) | Prefix CIDR filters. Repeat the parameter to filter by multiple prefixes. | [optional] |
| **originAses** | [**List&lt;Long&gt;**](Long.md) | Origin AS filters. Repeat the parameter to filter by multiple ASNs. | [optional] |
| **asPaths** | [**List&lt;String&gt;**](String.md) | AS path filters, expressed as a space-separated list of ASNs. Repeat the parameter to filter by multiple AS paths. | [optional] |
| **rpkiStatuses** | [**List&lt;BgpRpkiStatus&gt;**](BgpRpkiStatus.md) | RPKI status filters. | [optional] |
| **updateType** | [**List&lt;BgpUpdateType&gt;**](BgpUpdateType.md) | BGP update type filters. | [optional] |
| **monitorIds** | [**List&lt;String&gt;**](String.md) | BGP monitor ID filters. Repeat the parameter to filter by multiple monitors. Get &#x60;monitorId&#x60; from the &#x60;/monitors&#x60; endpoint. | [optional] |
