...
public class DnsTraceTestResultsApi {
   ...
   */
  public Paginator<DnsTraceTestResult, DnsTraceTestResults> getTestDnsTraceResultsPaginated(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate) {
    return new Paginator<>(cursor -> getTestDnsTraceResults(testId, aid, window, startDate, endDate, cursor),
   ...
   */
  public DnsTraceTestResults getTestDnsTraceResults(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor) throws ApiException {
    ApiResponse<DnsTraceTestResults> response = getTestDnsTraceResultsWithHttpInfo(testId, aid, window, startDate, endDate, cursor);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<DnsTraceTestResults> getTestDnsTraceResultsWithHttpInfo(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor) throws ApiException {
    getTestDnsTraceResultsValidateRequest(testId);

    var requestBuilder = getTestDnsTraceResultsRequestBuilder(testId, aid, window, startDate, endDate, cursor);
  ...
  private ApiRequest.ApiRequestBuilder getTestDnsTraceResultsRequestBuilder(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor) throws ApiException {
