...
public class WebFtpServerTestResultsApi {
   ...
   */
  public Paginator<FtpServerTestResult, FtpServerTestResults> getTestFtpServerResultsPaginated(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate) {
    return new Paginator<>(cursor -> getTestFtpServerResults(testId, aid, window, startDate, endDate, cursor),
   ...
   */
  public FtpServerTestResults getTestFtpServerResults(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor) throws ApiException {
    ApiResponse<FtpServerTestResults> response = getTestFtpServerResultsWithHttpInfo(testId, aid, window, startDate, endDate, cursor);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<FtpServerTestResults> getTestFtpServerResultsWithHttpInfo(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor) throws ApiException {
    getTestFtpServerResultsValidateRequest(testId);

    var requestBuilder = getTestFtpServerResultsRequestBuilder(testId, aid, window, startDate, endDate, cursor);
  ...
  private ApiRequest.ApiRequestBuilder getTestFtpServerResultsRequestBuilder(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor) throws ApiException {
