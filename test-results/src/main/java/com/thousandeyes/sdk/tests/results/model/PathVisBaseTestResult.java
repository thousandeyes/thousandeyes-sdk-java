...
public class PathVisBaseTestResult {
  ...
  **/
  ...
  public PathVisBaseTestResult agent(TestResultAgent agent) {
    this.agent = agent;
    return this;
  }
  ...
  **/
  ...
  public static class ModelBuilder {
    ...
    private PathVisBaseTestResult instance;

    public ModelBuilder() {
      this(new PathVisBaseTestResult());
    }

    protected ModelBuilder(PathVisBaseTestResult instance) {
      this.instance = instance;
    }

    public PathVisBaseTestResult.ModelBuilder date(OffsetDateTime date) {
      this.instance.date = date;
      return this;
    }
    public PathVisBaseTestResult.ModelBuilder roundId(Integer roundId) {
      this.instance.roundId = roundId;
      return this;
    }
    public PathVisBaseTestResult.ModelBuilder links(TestResultAppLinks links) {
      this.instance.setLinks(links);
      return this;
    }
    public PathVisBaseTestResult.ModelBuilder startTime(Integer startTime) {
      this.instance.startTime = startTime;
      return this;
    }
    public PathVisBaseTestResult.ModelBuilder endTime(Integer endTime) {
      this.instance.endTime = endTime;
      return this;
    }
    public PathVisBaseTestResult.ModelBuilder agent(TestResultAgent agent) {
      this.instance.setAgent(agent);
      return this;
    }
    public PathVisBaseTestResult.ModelBuilder server(String server) {
      this.instance.server = server;
      return this;
    }
    public PathVisBaseTestResult.ModelBuilder serverIp(String serverIp) {
      this.instance.serverIp = serverIp;
      return this;
    }
    public PathVisBaseTestResult.ModelBuilder sourceIp(String sourceIp) {
      this.instance.sourceIp = sourceIp;
      return this;
    }
    public PathVisBaseTestResult.ModelBuilder sourcePrefix(String sourcePrefix) {
      this.instance.sourcePrefix = sourcePrefix;
      return this;
    }
    public PathVisBaseTestResult.ModelBuilder targetIsProxy(Boolean targetIsProxy) {
      this.instance.targetIsProxy = targetIsProxy;
      return this;
    }
    public PathVisBaseTestResult.ModelBuilder direction(PathVisDirection direction) {
      this.instance.setDirection(direction);
      return this;
    }

    /**
     * Returns a built PathVisBaseTestResult instance.
     *
     * <p>The builder is not reusable.</p>
     */
    public PathVisBaseTestResult build() {
      try {
   ...
   */
  public static PathVisBaseTestResult.ModelBuilder builder() {
    return new PathVisBaseTestResult.ModelBuilder();
  }

  /**
   * Create a builder with a shallow copy of this instance.
   */
  public PathVisBaseTestResult.ModelBuilder toBuilder() {
    PathVisBaseTestResult.ModelBuilder builder = new PathVisBaseTestResult.ModelBuilder()
      .date(getDate())
      .roundId(getRoundId())
      .links(getLinks())
