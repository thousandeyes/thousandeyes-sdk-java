...
public class DnssecTestResultsApi {
   ...
   */
  public Paginator<DnssecTestResult, DnssecTestResults> getTestDnsSecResultsPaginated(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate) {
    return new Paginator<>(cursor -> getTestDnsSecResults(testId, aid, window, startDate, endDate, cursor),
