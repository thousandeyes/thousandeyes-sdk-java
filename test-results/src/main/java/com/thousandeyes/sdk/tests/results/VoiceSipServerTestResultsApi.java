...
public class VoiceSipServerTestResultsApi {
   ...
   */
  public Paginator<SipServerTestResult, SipServerTestResults> getTestSipServerResultsPaginated(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate) {
    return new Paginator<>(cursor -> getTestSipServerResults(testId, aid, window, startDate, endDate, cursor),
   ...
   */
  public SipServerTestResults getTestSipServerResults(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor) throws ApiException {
    ApiResponse<SipServerTestResults> response = getTestSipServerResultsWithHttpInfo(testId, aid, window, startDate, endDate, cursor);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<SipServerTestResults> getTestSipServerResultsWithHttpInfo(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor) throws ApiException {
    getTestSipServerResultsValidateRequest(testId);

    var requestBuilder = getTestSipServerResultsRequestBuilder(testId, aid, window, startDate, endDate, cursor);
  ...
  private ApiRequest.ApiRequestBuilder getTestSipServerResultsRequestBuilder(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor) throws ApiException {
