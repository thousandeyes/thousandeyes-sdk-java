...
public class VoiceRtpServerTestResultsApi {
   ...
   */
  public Paginator<RtpStreamTestResult, RtpStreamTestResults> getTestRtpServerResultsPaginated(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate) {
    return new Paginator<>(cursor -> getTestRtpServerResults(testId, aid, window, startDate, endDate, cursor),
   ...
   */
  public RtpStreamTestResults getTestRtpServerResults(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor) throws ApiException {
    ApiResponse<RtpStreamTestResults> response = getTestRtpServerResultsWithHttpInfo(testId, aid, window, startDate, endDate, cursor);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<RtpStreamTestResults> getTestRtpServerResultsWithHttpInfo(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor) throws ApiException {
    getTestRtpServerResultsValidateRequest(testId);

    var requestBuilder = getTestRtpServerResultsRequestBuilder(testId, aid, window, startDate, endDate, cursor);
  ...
  private ApiRequest.ApiRequestBuilder getTestRtpServerResultsRequestBuilder(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor) throws ApiException {
