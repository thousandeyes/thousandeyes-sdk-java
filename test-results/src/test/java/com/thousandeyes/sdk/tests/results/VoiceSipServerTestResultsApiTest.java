...
/**
 * Request and Response model deserialization tests for VoiceSipServerTestResultsApi
 */
@WireMockTest
public class VoiceSipServerTestResultsApiTest {
    ...
    public static void setup(WireMockRuntimeInfo wireMockRuntimeInfo) {
        ApiClient client = NativeApiClient.builder()
                                ...
                                .bearerToken(TOKEN)
                                .build();
        api = new VoiceSipServerTestResultsApi(client);
    }
            ...
            throws JsonProcessingException, ApiException
    {
        ...
        var path = "/test-results/{testId}/sip-server";
