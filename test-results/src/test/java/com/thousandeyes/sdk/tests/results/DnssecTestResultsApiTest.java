...
/**
 * Request and Response model deserialization tests for DnssecTestResultsApi
 */
@WireMockTest
public class DnssecTestResultsApiTest {
    private static final String TOKEN = "valid-token";
    private static final String BEARER_TOKEN = "Bearer %s".formatted(TOKEN);
    private static DnssecTestResultsApi api;
    ...
    public static void setup(WireMockRuntimeInfo wireMockRuntimeInfo) {
        ApiClient client = NativeApiClient.builder()
                                ...
                                .bearerToken(TOKEN)
                                .build();
        api = new DnssecTestResultsApi(client);
    }
            ...
            throws JsonProcessingException, ApiException
    {
        ...
        var path = "/test-results/{testId}/dnssec";
