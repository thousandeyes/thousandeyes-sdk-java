...
| [**getTestRtpServerResultsWithHttpInfo**](VoiceRtpServerTestResultsApi.md#getTestRtpServerResultsWithHttpInfo) | **GET** /test-results/{testId}/rtp-server | Retrieve RTP server test metrics |
...
public class Example {
    public static void main(String[] args) {
        ...
        VoiceRtpServerTestResultsApi apiInstance = new VoiceRtpServerTestResultsApi(defaultClient);
