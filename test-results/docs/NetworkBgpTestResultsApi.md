...
| [**getTestBgpResultsWithHttpInfo**](NetworkBgpTestResultsApi.md#getTestBgpResultsWithHttpInfo) | **GET** /test-results/{testId}/bgp | Get BGP test results |
...
| [**getTestBgpRoutesPrefixRoundResultsWithHttpInfo**](NetworkBgpTestResultsApi.md#getTestBgpRoutesPrefixRoundResultsWithHttpInfo) | **GET** /test-results/{testId}/bgp/routes/prefix/{prefixId}/round/{roundId} | Get BGP route test results by prefix |
...
public class Example {
    public static void main(String[] args) {
        ...
        NetworkBgpTestResultsApi apiInstance = new NetworkBgpTestResultsApi(defaultClient);
