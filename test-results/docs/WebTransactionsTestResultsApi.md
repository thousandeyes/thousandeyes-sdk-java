...
| [**getTestWebTransactionAgentRoundResultsWithHttpInfo**](WebTransactionsTestResultsApi.md#getTestWebTransactionAgentRoundResultsWithHttpInfo) | **GET** /test-results/{testId}/web-transactions/agent/{agentId}/round/{roundId} | Get web transactions test results by agent and round |
