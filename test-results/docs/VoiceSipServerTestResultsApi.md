...
> SipServerTestResults getTestSipServerResults(GetTestSipServerResultsRequest)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            VoiceSipServerTestResultsApi.GetTestSipServerResultsRequest request = VoiceSipServerTestResultsApi.GetTestSipServerResultsRequest.builder()
                .testId(testId)
                .aid(aid)
                .window(window)
                .startDate(startDate)
                ...
                .cursor(cursor)
                .build();
            SipServerTestResults result = apiInstance.getTestSipServerResults(request);
...
|------------- | ------------- | ------------- | -------------|
| request | [**GetTestSipServerResultsRequest**](VoiceSipServerTestResultsApi.md#GetTestSipServerResultsRequest)|-|-|
...
> ApiResponse<SipServerTestResults> getTestSipServerResults getTestSipServerResultsWithHttpInfo(GetTestSipServerResultsRequest)
    ...
    public static void main(String[] args) {
        ...
        try {
            VoiceSipServerTestResultsApi.GetTestSipServerResultsRequest request = VoiceSipServerTestResultsApi.GetTestSipServerResultsRequest.builder()
                ...
                .cursor(cursor)
                .build();
            ApiResponse<SipServerTestResults> response = apiInstance.getTestSipServerResultsWithHttpInfo(request);
...
<a id="GetTestSipServerResultsRequest"></a>
## GetTestSipServerResultsRequest
### Properties
