...
> FtpServerTestResults getTestFtpServerResults(GetTestFtpServerResultsRequest)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            WebFtpServerTestResultsApi.GetTestFtpServerResultsRequest request = WebFtpServerTestResultsApi.GetTestFtpServerResultsRequest.builder()
                .testId(testId)
                .aid(aid)
                .window(window)
                .startDate(startDate)
                ...
                .cursor(cursor)
                .build();
            FtpServerTestResults result = apiInstance.getTestFtpServerResults(request);
...
|------------- | ------------- | ------------- | -------------|
| request | [**GetTestFtpServerResultsRequest**](WebFtpServerTestResultsApi.md#GetTestFtpServerResultsRequest)|-|-|
...
## getTestFtpServerResultsWithHttpInfo

> ApiResponse<FtpServerTestResults> getTestFtpServerResults getTestFtpServerResultsWithHttpInfo(GetTestFtpServerResultsRequest)
    ...
    public static void main(String[] args) {
        ...
        try {
            WebFtpServerTestResultsApi.GetTestFtpServerResultsRequest request = WebFtpServerTestResultsApi.GetTestFtpServerResultsRequest.builder()
                ...
                .cursor(cursor)
                .build();
            ApiResponse<FtpServerTestResults> response = apiInstance.getTestFtpServerResultsWithHttpInfo(request);
...
<a id="GetTestFtpServerResultsRequest"></a>
## GetTestFtpServerResultsRequest
### Properties
