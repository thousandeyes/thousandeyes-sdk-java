...
| [**getTestHttpServerResultsWithHttpInfo**](WebHttpServerTestResultsApi.md#getTestHttpServerResultsWithHttpInfo) | **GET** /test-results/{testId}/http-server | Get HTTP server test results |



## getTestHttpServerResults

> HttpTestResults getTestHttpServerResults(GetTestHttpServerResultsRequest)
...
import com.thousandeyes.sdk.tests.results.WebHttpServerTestResultsApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        WebHttpServerTestResultsApi apiInstance = new WebHttpServerTestResultsApi(defaultClient);
        ...
        try {
            WebHttpServerTestResultsApi.GetTestHttpServerResultsRequest request = WebHttpServerTestResultsApi.GetTestHttpServerResultsRequest.builder()
                .testId(testId)
                .aid(aid)
                .window(window)
                .startDate(startDate)
                ...
                .expand(expand)
                .build();
            HttpTestResults result = apiInstance.getTestHttpServerResults(request);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling WebHttpServerTestResultsApi#getTestHttpServerResults");
...
|------------- | ------------- | ------------- | -------------|
| request | [**GetTestHttpServerResultsRequest**](WebHttpServerTestResultsApi.md#GetTestHttpServerResultsRequest)|-|-|
...
> ApiResponse<HttpTestResults> getTestHttpServerResults getTestHttpServerResultsWithHttpInfo(GetTestHttpServerResultsRequest)
    ...
    public static void main(String[] args) {
        ...
        try {
            WebHttpServerTestResultsApi.GetTestHttpServerResultsRequest request = WebHttpServerTestResultsApi.GetTestHttpServerResultsRequest.builder()
                ...
                .expand(expand)
                .build();
            ApiResponse<HttpTestResults> response = apiInstance.getTestHttpServerResultsWithHttpInfo(request);
...
<a id="GetTestHttpServerResultsRequest"></a>
## GetTestHttpServerResultsRequest
### Properties
