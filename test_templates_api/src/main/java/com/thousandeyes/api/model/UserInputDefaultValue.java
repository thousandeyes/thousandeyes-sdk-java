...
public class UserInputDefaultValue extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UserInputDefaultValue.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UserInputDefaultValue' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UserInputDefaultValue>() {
                @Override
                public void write(JsonWriter out, UserInputDefaultValue value) throws IOException {
                ...
                @Override
                public UserInputDefaultValue read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        UserInputDefaultValue ret = new UserInputDefaultValue();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for UserInputDefaultValue: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UserInputDefaultValue() {
        super("oneOf", Boolean.FALSE);
    }

    public UserInputDefaultValue(BigDecimal o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public UserInputDefaultValue(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UserInputDefaultValue.schemas;
    }
  ...
  * @throws IOException if the JSON Element is invalid with respect to UserInputDefaultValue
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for UserInputDefaultValue with oneOf schemas: BigDecimal, String. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
    }
  }

 /**
  * Create an instance of UserInputDefaultValue given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UserInputDefaultValue
  * @throws IOException if the JSON string is invalid with respect to UserInputDefaultValue
  */
  public static UserInputDefaultValue fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserInputDefaultValue.class);
  }

 /**
  * Convert an instance of UserInputDefaultValue to an JSON string
  *
  * @return JSON string
  */
