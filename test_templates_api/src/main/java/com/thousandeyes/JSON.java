...
public class JSON {
...

    {
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.thousandeyes.api.model.ApiError.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.thousandeyes.api.model.BadRequestError.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.thousandeyes.api.model.DeployTestTemplate.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.thousandeyes.api.model.DeployTestTemplateTests.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.thousandeyes.api.model.DeployTestTemplateUserInputValues.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.thousandeyes.api.model.Link.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.thousandeyes.api.model.NotFoundError.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.thousandeyes.api.model.TestTemplate.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.thousandeyes.api.model.TestTemplateCollection.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.thousandeyes.api.model.TestTemplateCollectionLinks.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.thousandeyes.api.model.TestTemplateCollectionLinksSelf.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.thousandeyes.api.model.TestTemplateUpsert.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.thousandeyes.api.model.UnauthorizedError.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.thousandeyes.api.model.UserInput.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.thousandeyes.api.model.UserInputDefaultValue.CustomTypeAdapterFactory());
