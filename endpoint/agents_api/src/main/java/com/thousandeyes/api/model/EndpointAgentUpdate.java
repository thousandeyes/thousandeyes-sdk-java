...
public class EndpointAgentUpdate {
  ...
  public EndpointAgentUpdate(
     String name, 
     List<AgentLicenseType> licenseType
  ) {
    this();
    this.name = name;
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("licenseType") != null && !jsonObj.get("licenseType").isJsonNull() && !jsonObj.get("licenseType").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `licenseType` to be an array in the JSON string but got `%s`", jsonObj.get("licenseType").toString()));
      }
  }
