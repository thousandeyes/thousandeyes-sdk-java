...
public class EndpointAgent {
  ...
  **/
  ...
  public EndpointAgent aid(EndpointAgentAid aid) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, aid, name, computerName, osVersion, platform, kernelVersion, manufacturer, model, lastSeen, status, deleted, version, createdAt, numberOfClients, publicIP, location, clients, totalMemory, agentType, vpnProfiles, networkInterfaceProfiles, asnDetails, licenseType, tcpDriverAvailable, npcapVersion);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to EndpointAgent
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EndpointAgent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EndpointAgent is not found in the empty JSON string", EndpointAgent.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EndpointAgent.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EndpointAgent` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EndpointAgent.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EndpointAgent' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EndpointAgent> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EndpointAgent.class));

       return (TypeAdapter<T>) new TypeAdapter<EndpointAgent>() {
           @Override
           public void write(JsonWriter out, EndpointAgent value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EndpointAgent read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of EndpointAgent given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EndpointAgent
  * @throws IOException if the JSON string is invalid with respect to EndpointAgent
  */
  public static EndpointAgent fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EndpointAgent.class);
  }

 /**
  * Convert an instance of EndpointAgent to an JSON string
  *
  * @return JSON string
  */
