...
public class JSON {
...

    {
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.thousandeyes.api.model.V7EndpointLabelsPost201Response.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.thousandeyes.api.model.V7EndpointLabelsPostRequest.CustomTypeAdapterFactory());
