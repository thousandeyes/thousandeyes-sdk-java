...
public class EndpointRealUserTest {
  ...
  * @throws IOException if the JSON Element is invalid with respect to EndpointRealUserTest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EndpointRealUserTest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EndpointRealUserTest is not found in the empty JSON string", EndpointRealUserTest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EndpointRealUserTest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EndpointRealUserTest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EndpointRealUserTest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EndpointRealUserTest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EndpointRealUserTest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EndpointRealUserTest.class));

       return (TypeAdapter<T>) new TypeAdapter<EndpointRealUserTest>() {
           @Override
           public void write(JsonWriter out, EndpointRealUserTest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EndpointRealUserTest read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of EndpointRealUserTest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EndpointRealUserTest
  * @throws IOException if the JSON string is invalid with respect to EndpointRealUserTest
  */
  public static EndpointRealUserTest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EndpointRealUserTest.class);
  }

 /**
  * Convert an instance of EndpointRealUserTest to an JSON string
  *
  * @return JSON string
  */
