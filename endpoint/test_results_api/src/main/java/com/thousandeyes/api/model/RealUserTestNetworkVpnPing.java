...
public class RealUserTestNetworkVpnPing {
  ...
  * @throws IOException if the JSON Element is invalid with respect to RealUserTestNetworkVpnPing
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RealUserTestNetworkVpnPing.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RealUserTestNetworkVpnPing is not found in the empty JSON string", RealUserTestNetworkVpnPing.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RealUserTestNetworkVpnPing.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RealUserTestNetworkVpnPing` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RealUserTestNetworkVpnPing.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RealUserTestNetworkVpnPing' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RealUserTestNetworkVpnPing> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RealUserTestNetworkVpnPing.class));

       return (TypeAdapter<T>) new TypeAdapter<RealUserTestNetworkVpnPing>() {
           @Override
           public void write(JsonWriter out, RealUserTestNetworkVpnPing value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RealUserTestNetworkVpnPing read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of RealUserTestNetworkVpnPing given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RealUserTestNetworkVpnPing
  * @throws IOException if the JSON string is invalid with respect to RealUserTestNetworkVpnPing
  */
  public static RealUserTestNetworkVpnPing fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RealUserTestNetworkVpnPing.class);
  }

 /**
  * Convert an instance of RealUserTestNetworkVpnPing to an JSON string
  *
  * @return JSON string
  */
