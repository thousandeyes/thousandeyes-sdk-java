...
public class MultiTestIdTestsDataRoundsSearch {
  ...
  * @throws IOException if the JSON Element is invalid with respect to MultiTestIdTestsDataRoundsSearch
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MultiTestIdTestsDataRoundsSearch.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MultiTestIdTestsDataRoundsSearch is not found in the empty JSON string", MultiTestIdTestsDataRoundsSearch.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MultiTestIdTestsDataRoundsSearch.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MultiTestIdTestsDataRoundsSearch` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("searchFilters") != null && !jsonObj.get("searchFilters").isJsonNull()) {
        MultiTestIdTestsDataSearchFilter.validateJsonElement(jsonObj.get("searchFilters"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MultiTestIdTestsDataRoundsSearch.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MultiTestIdTestsDataRoundsSearch' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MultiTestIdTestsDataRoundsSearch> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MultiTestIdTestsDataRoundsSearch.class));

       return (TypeAdapter<T>) new TypeAdapter<MultiTestIdTestsDataRoundsSearch>() {
           @Override
           public void write(JsonWriter out, MultiTestIdTestsDataRoundsSearch value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MultiTestIdTestsDataRoundsSearch read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of MultiTestIdTestsDataRoundsSearch given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MultiTestIdTestsDataRoundsSearch
  * @throws IOException if the JSON string is invalid with respect to MultiTestIdTestsDataRoundsSearch
  */
  public static MultiTestIdTestsDataRoundsSearch fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MultiTestIdTestsDataRoundsSearch.class);
  }

 /**
  * Convert an instance of MultiTestIdTestsDataRoundsSearch to an JSON string
  *
  * @return JSON string
  */
