...
public class PostFetchDynamicTestResultMetrics200Response {
  ...
  * @throws IOException if the JSON Element is invalid with respect to PostFetchDynamicTestResultMetrics200Response
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostFetchDynamicTestResultMetrics200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostFetchDynamicTestResultMetrics200Response is not found in the empty JSON string", PostFetchDynamicTestResultMetrics200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostFetchDynamicTestResultMetrics200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostFetchDynamicTestResultMetrics200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("results") != null && !jsonObj.get("results").isJsonNull()) {
        ...
        if (jsonArrayresults != null) {
          ...
          for (int i = 0; i < jsonArrayresults.size(); i++) {
            NetworkDynamicTestResult.validateJsonElement(jsonArrayresults.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostFetchDynamicTestResultMetrics200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostFetchDynamicTestResultMetrics200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostFetchDynamicTestResultMetrics200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostFetchDynamicTestResultMetrics200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<PostFetchDynamicTestResultMetrics200Response>() {
           @Override
           public void write(JsonWriter out, PostFetchDynamicTestResultMetrics200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostFetchDynamicTestResultMetrics200Response read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PostFetchDynamicTestResultMetrics200Response given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PostFetchDynamicTestResultMetrics200Response
  * @throws IOException if the JSON string is invalid with respect to PostFetchDynamicTestResultMetrics200Response
  */
  public static PostFetchDynamicTestResultMetrics200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostFetchDynamicTestResultMetrics200Response.class);
  }

 /**
  * Convert an instance of PostFetchDynamicTestResultMetrics200Response to an JSON string
  *
  * @return JSON string
  */
