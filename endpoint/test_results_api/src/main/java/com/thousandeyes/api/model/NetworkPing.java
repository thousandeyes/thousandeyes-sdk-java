...
public class NetworkPing {
  ...
  * @throws IOException if the JSON Element is invalid with respect to NetworkPing
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NetworkPing.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NetworkPing is not found in the empty JSON string", NetworkPing.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NetworkPing.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NetworkPing` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NetworkPing.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NetworkPing' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NetworkPing> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NetworkPing.class));

       return (TypeAdapter<T>) new TypeAdapter<NetworkPing>() {
           @Override
           public void write(JsonWriter out, NetworkPing value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NetworkPing read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of NetworkPing given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NetworkPing
  * @throws IOException if the JSON string is invalid with respect to NetworkPing
  */
  public static NetworkPing fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NetworkPing.class);
  }

 /**
  * Convert an instance of NetworkPing to an JSON string
  *
  * @return JSON string
  */
