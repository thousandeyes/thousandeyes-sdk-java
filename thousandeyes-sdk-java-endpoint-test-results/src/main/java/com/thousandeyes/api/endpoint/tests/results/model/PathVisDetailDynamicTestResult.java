...
import com.thousandeyes.api.endpoint.tests.results.model.DynamicTestWebex;
...
public class PathVisDetailDynamicTestResult {
  ...
  **/
  ...
  public PathVisDetailDynamicTestResult addItem(PathVisRoute pathTracesItem) {
  ...
  **/
  ...
  public PathVisDetailDynamicTestResult addItem(PathVisRoute vpnPathTracesItem) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(aid, agentId, roundId, serverIp, networkProfile, systemMetrics, originalTargetProfile, vpnProfile, asnDetails, server, sourceIp, sourcePrefix, pathTraces, vpnPathTraces, application, webex);
  }
