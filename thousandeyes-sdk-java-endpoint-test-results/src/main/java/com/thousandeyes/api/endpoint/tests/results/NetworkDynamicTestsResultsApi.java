...
public class NetworkDynamicTestsResultsApi {
   ...
   */
  public PathVisDynamicTestResults getDynamicTestResultNetworkPathvis(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor) throws ApiException {
    ApiResponse<PathVisDynamicTestResults> response = getDynamicTestResultNetworkPathvisWithHttpInfo(testId, aid, window, startDate, endDate, cursor);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<PathVisDynamicTestResults> getDynamicTestResultNetworkPathvisWithHttpInfo(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public PathVisDetailDynamicTestResults getDynamicTestResultPathvisAgentRound(String testId, String agentId, String roundId, String aid) throws ApiException {
    ApiResponse<PathVisDetailDynamicTestResults> response = getDynamicTestResultPathvisAgentRoundWithHttpInfo(testId, agentId, roundId, aid);
    return response.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<PathVisDetailDynamicTestResults> getDynamicTestResultPathvisAgentRoundWithHttpInfo(String testId, String agentId, String roundId, String aid) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public NetworkDynamicTestResults postFetchDynamicTestResultMetrics(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor, DynamicTestsDataRoundSearch dynamicTestsDataRoundSearch) throws ApiException {
    ApiResponse<NetworkDynamicTestResults> response = postFetchDynamicTestResultMetricsWithHttpInfo(testId, aid, window, startDate, endDate, cursor, dynamicTestsDataRoundSearch);
    return response.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<NetworkDynamicTestResults> postFetchDynamicTestResultMetricsWithHttpInfo(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor, DynamicTestsDataRoundSearch dynamicTestsDataRoundSearch) throws ApiException {
