...
public class SystemMetrics {
  ...
  @JsonCreator
  public SystemMetrics(
    @JsonProperty(JSON_PROPERTY_START_TIME_MS) BigDecimal startTimeMs, 
    @JsonProperty(JSON_PROPERTY_END_TIME_MS) BigDecimal endTimeMs, 
    @JsonProperty(JSON_PROPERTY_PHYSICAL_MEMORY_TOTAL_BYTES) BigDecimal physicalMemoryTotalBytes
  ) {
  this();
