...
public class NetworkDynamicTestResult {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(aid, agentId, roundId, serverIp, networkProfile, systemMetrics, originalTargetProfile, vpnProfile, avgLatency, errorDetails, jitter, isIcmpBlocked, loss, maxLatency, minLatency, application, webex);
  }
