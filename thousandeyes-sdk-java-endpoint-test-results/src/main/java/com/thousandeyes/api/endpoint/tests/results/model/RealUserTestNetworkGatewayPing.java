 ...
 */
@JsonPropertyOrder({
  RealUserTestNetworkGatewayPing.JSON_PROPERTY_AVG_RTT,
  RealUserTestNetworkGatewayPing.JSON_PROPERTY_MAX_RTT,
  RealUserTestNetworkGatewayPing.JSON_PROPERTY_MEAN_DEV_RTT,
  RealUserTestNetworkGatewayPing.JSON_PROPERTY_MIN_RTT,
  RealUserTestNetworkGatewayPing.JSON_PROPERTY_PKTS_RECEIVED,
  RealUserTestNetworkGatewayPing.JSON_PROPERTY_PKTS_SENT,
...
public class RealUserTestNetworkGatewayPing {
  ...
  **/
  ...
  /**
   * Return true if this RealUserTestNetwork_gatewayPing object is equal to o.
   */
  @Override
