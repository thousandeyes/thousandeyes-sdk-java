...
import com.thousandeyes.api.endpoint.tests.results.model.NetworkProxy;
...
public class NetworkProxyProfile {
  ...
  private List<NetworkProxy> proxies;
  ...
  **/
  ...
  public NetworkProxyProfile addItem(NetworkProxy proxiesItem) {
