...
public class PathVisDynamicTestResult {
  ...
  **/
  ...
  public PathVisDynamicTestResult addItem(PathVisEndpoint pathTracesItem) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(aid, agentId, roundId, serverIp, networkProfile, systemMetrics, originalTargetProfile, vpnProfile, asnDetails, server, sourceIp, sourcePrefix, application, webex, location, pathTraces);
  }
