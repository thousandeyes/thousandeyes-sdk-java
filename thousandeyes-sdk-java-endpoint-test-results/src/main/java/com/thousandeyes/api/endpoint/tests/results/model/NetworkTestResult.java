...
public class NetworkTestResult {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(aid, agentId, roundId, serverIp, networkProfile, systemMetrics, vpnProfile, avgLatency, errorDetails, jitter, isIcmpBlocked, loss, maxLatency, minLatency);
  }
