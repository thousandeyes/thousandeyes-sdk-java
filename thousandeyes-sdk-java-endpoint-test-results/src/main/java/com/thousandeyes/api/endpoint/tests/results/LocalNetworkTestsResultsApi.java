...
import com.thousandeyes.api.endpoint.tests.results.model.LocalNetworkResults;
import com.thousandeyes.api.endpoint.tests.results.model.LocalNetworkTopologyDetailResults;
import com.thousandeyes.api.endpoint.tests.results.model.LocalNetworkTopologyResults;
...
public class LocalNetworkTestsResultsApi {
   ...
   */
  public LocalNetworkTopologyDetailResults getEndpointLocalNetworkTopologyDetails(String networkTopologyId, String aid) throws ApiException {
    ApiResponse<LocalNetworkTopologyDetailResults> response = getEndpointLocalNetworkTopologyDetailsWithHttpInfo(networkTopologyId, aid);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<LocalNetworkTopologyDetailResults> getEndpointLocalNetworkTopologyDetailsWithHttpInfo(String networkTopologyId, String aid) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public LocalNetworkResults getEndpointLocalNetworks(String aid) throws ApiException {
    ApiResponse<LocalNetworkResults> response = getEndpointLocalNetworksWithHttpInfo(aid);
    return response.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<LocalNetworkResults> getEndpointLocalNetworksWithHttpInfo(String aid) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public LocalNetworkTopologyResults getEndpointLocalNetworksTopologies(String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor, EndpointNetworkTopologyResultRequest endpointNetworkTopologyResultRequest) throws ApiException {
    ApiResponse<LocalNetworkTopologyResults> response = getEndpointLocalNetworksTopologiesWithHttpInfo(aid, window, startDate, endDate, cursor, endpointNetworkTopologyResultRequest);
    return response.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<LocalNetworkTopologyResults> getEndpointLocalNetworksTopologiesWithHttpInfo(String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor, EndpointNetworkTopologyResultRequest endpointNetworkTopologyResultRequest) throws ApiException {
