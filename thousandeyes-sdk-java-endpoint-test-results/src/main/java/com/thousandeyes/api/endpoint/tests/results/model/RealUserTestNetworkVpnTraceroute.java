 ...
 */
@JsonPropertyOrder({
  RealUserTestNetworkVpnTraceroute.JSON_PROPERTY_DESTINATION,
  RealUserTestNetworkVpnTraceroute.JSON_PROPERTY_ERROR,
  RealUserTestNetworkVpnTraceroute.JSON_PROPERTY_INFO_FLAGS,
  RealUserTestNetworkVpnTraceroute.JSON_PROPERTY_INTERNAL_ERRORS,
  RealUserTestNetworkVpnTraceroute.JSON_PROPERTY_HOPS
})
...
public class RealUserTestNetworkVpnTraceroute {
  ...
  **/
  ...
  /**
   * Return true if this RealUserTestNetwork_vpnTraceroute object is equal to o.
   */
  @Override
