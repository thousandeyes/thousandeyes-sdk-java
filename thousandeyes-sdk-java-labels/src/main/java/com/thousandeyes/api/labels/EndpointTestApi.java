...
@jakarta.annotation.Generated(value = "com.thousandeyes.api.codegen.ThousandeyesJavaGenerator", date = "2024-05-17T09:32:26.026498+01:00[Europe/Lisbon]")
public class EndpointTestApi {
   ...
   */
  public LabelDetail createEndpointTestsLabel(String aid, LabelRequest labelRequest) throws ApiException {
    ApiResponse<LabelDetail> response = createEndpointTestsLabelWithHttpInfo(aid, labelRequest);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<LabelDetail> createEndpointTestsLabelWithHttpInfo(String aid, LabelRequest labelRequest) throws ApiException {
