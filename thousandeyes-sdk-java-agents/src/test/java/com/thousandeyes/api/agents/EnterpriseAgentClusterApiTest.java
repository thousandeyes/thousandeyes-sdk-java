...
public class EnterpriseAgentClusterApiTest {
    ...
    @Test
    public void assignEnterpriseAgentClusterRequestAndResponseDeserializationTest()
    ...
    @Test
    public void unassignEnterpriseAgentFromClusterRequestAndResponseDeserializationTest()
            throws JsonProcessingException 
    {
        String requestBodyJson = """
                {
        ...
        String responseBodyJson = """
                {
                  ...
                  "agents" : [ {
                    ...
                    "agentType" : "enterprise-cluster"
                                  ...
                                  """;
        GetAgents200Response mappedResponse = 
                mapper.readValue(responseBodyJson, GetAgents200Response.class);
        assertNotNull(mappedResponse);
    }
