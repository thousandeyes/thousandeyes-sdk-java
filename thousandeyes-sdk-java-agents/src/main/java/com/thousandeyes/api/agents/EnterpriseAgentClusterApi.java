...
@jakarta.annotation.Generated(value = "com.thousandeyes.api.codegen.ThousandeyesJavaGenerator", date = "2024-05-17T09:32:26.207493+01:00[Europe/Lisbon]")
public class EnterpriseAgentClusterApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public CloudEnterpriseAgents unassignEnterpriseAgentFromCluster(String agentId, AgentClusterUnassignRequest agentClusterUnassignRequest, String aid, List<AgentDetailsExpand> expand) throws ApiException {
    ApiResponse<CloudEnterpriseAgents> response = unassignEnterpriseAgentFromClusterWithHttpInfo(agentId, agentClusterUnassignRequest, aid, expand);
    return response.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<CloudEnterpriseAgents> unassignEnterpriseAgentFromClusterWithHttpInfo(String agentId, AgentClusterUnassignRequest agentClusterUnassignRequest, String aid, List<AgentDetailsExpand> expand) throws ApiException {
