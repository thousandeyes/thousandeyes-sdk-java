...
import com.thousandeyes.api.agents.model.AssignEnterpriseAgentClusterRequest;
import com.thousandeyes.api.agents.model.Error;
import com.thousandeyes.api.agents.model.GetAgents200Response;
import com.thousandeyes.api.agents.model.UnassignEnterpriseAgentFromClusterRequest;
...
public class EnterpriseAgentClusterApi {
   ...
   */
  public AgentDetails assignEnterpriseAgentCluster(String agentId, AssignEnterpriseAgentClusterRequest assignEnterpriseAgentClusterRequest, String aid, List<AgentDetailsExpand> expand) throws ApiException {
    ApiResponse<AgentDetails> response = assignEnterpriseAgentClusterWithHttpInfo(agentId, assignEnterpriseAgentClusterRequest, aid, expand);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<AgentDetails> assignEnterpriseAgentClusterWithHttpInfo(String agentId, AssignEnterpriseAgentClusterRequest assignEnterpriseAgentClusterRequest, String aid, List<AgentDetailsExpand> expand) throws ApiException {
    assignEnterpriseAgentClusterValidateRequest(agentId, assignEnterpriseAgentClusterRequest);

    var requestBuilder = assignEnterpriseAgentClusterRequestBuilder(agentId, assignEnterpriseAgentClusterRequest, aid, expand);

    return apiClient.send(requestBuilder.build(), AgentDetails.class);
  }

  private void assignEnterpriseAgentClusterValidateRequest(String agentId, AssignEnterpriseAgentClusterRequest assignEnterpriseAgentClusterRequest) throws ApiException {
      ...
      if (assignEnterpriseAgentClusterRequest == null) {
        throw new ApiException(400, "Missing the required parameter 'assignEnterpriseAgentClusterRequest' when calling assignEnterpriseAgentCluster");
      }
  }

  private ApiRequest.ApiRequestBuilder assignEnterpriseAgentClusterRequestBuilder(String agentId, AssignEnterpriseAgentClusterRequest assignEnterpriseAgentClusterRequest, String aid, List<AgentDetailsExpand> expand) throws ApiException {
  ...
  public GetAgents200Response unassignEnterpriseAgentFromCluster(String agentId, UnassignEnterpriseAgentFromClusterRequest unassignEnterpriseAgentFromClusterRequest, String aid, List<AgentDetailsExpand> expand) throws ApiException {
    ApiResponse<GetAgents200Response> response = unassignEnterpriseAgentFromClusterWithHttpInfo(agentId, unassignEnterpriseAgentFromClusterRequest, aid, expand);
    return response.getData();
  }
  ...
  public ApiResponse<GetAgents200Response> unassignEnterpriseAgentFromClusterWithHttpInfo(String agentId, UnassignEnterpriseAgentFromClusterRequest unassignEnterpriseAgentFromClusterRequest, String aid, List<AgentDetailsExpand> expand) throws ApiException {
    unassignEnterpriseAgentFromClusterValidateRequest(agentId, unassignEnterpriseAgentFromClusterRequest);

    var requestBuilder = unassignEnterpriseAgentFromClusterRequestBuilder(agentId, unassignEnterpriseAgentFromClusterRequest, aid, expand);

    return apiClient.send(requestBuilder.build(), GetAgents200Response.class);
  }

  private void unassignEnterpriseAgentFromClusterValidateRequest(String agentId, UnassignEnterpriseAgentFromClusterRequest unassignEnterpriseAgentFromClusterRequest) throws ApiException {
      // verify the required parameter 'agentId' is set
      if (agentId == null) {
      ...
      if (unassignEnterpriseAgentFromClusterRequest == null) {
        throw new ApiException(400, "Missing the required parameter 'unassignEnterpriseAgentFromClusterRequest' when calling unassignEnterpriseAgentFromCluster");
      }
  }

  private ApiRequest.ApiRequestBuilder unassignEnterpriseAgentFromClusterRequestBuilder(String agentId, UnassignEnterpriseAgentFromClusterRequest unassignEnterpriseAgentFromClusterRequest, String aid, List<AgentDetailsExpand> expand) throws ApiException {
    ApiRequest.ApiRequestBuilder requestBuilder = ApiRequest.builder()
            .method("POST");
