...
public class EnterpriseAgentDetail {
  ...
  **/
  ...
  public EnterpriseAgentDetail addItem(AccountGroup accountGroupsItem) {
  ...
  **/
  ...
  public EnterpriseAgentDetail addItem(String localResolutionPrefixesItem) {
  ...
  **/
  ...
  public EnterpriseAgentDetail addItem(SimpleTest testsItem) {
    if (this.tests == null) {
  ...
  **/
  ...
  public EnterpriseAgentDetail addItem(NotificationRules notificationRulesItem) {
