...
public class EnterpriseAgentResponseExpands {
  ...
  public EnterpriseAgentResponseExpands addItem(SimpleTest testsItem) {
    if (this.tests == null) {
  ...
  **/
  ...
  public EnterpriseAgentResponseExpands addItem(NotificationRules notificationRulesItem) {
