# thousandeyes-java-sdk-administrative

Administrative API
- API version: 7.0.0
  - Build date: 2023-12-20T14:43:29.770800Z[Europe/Lisbon]
...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'thousandeyes-java-sdk-administrative' jar has been published to maven central.
    mavenLocal()       // Needed if the 'thousandeyes-java-sdk-administrative' jar has been published to the local maven repo.
  }
...
* `target/thousandeyes-java-sdk-administrative-7.0.0.jar`
* `target/lib/*.jar`
