...
# **getUserEvents**
> GetUserEvents200Response getUserEvents(aid, window, startDate, endDate, cursor)
...
import com.thousandeyes.api.administrative.UserEventsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    UserEventsApi apiInstance = new UserEventsApi(defaultClient);
    ...
    try {
      GetUserEvents200Response result = apiInstance.getUserEvents(aid, window, startDate, endDate, cursor);
