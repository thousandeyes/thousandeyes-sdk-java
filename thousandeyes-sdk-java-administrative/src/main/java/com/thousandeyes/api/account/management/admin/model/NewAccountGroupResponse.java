 ...
 */
@JsonPropertyOrder({
  NewAccountGroupResponse.JSON_PROPERTY_AID,
  NewAccountGroupResponse.JSON_PROPERTY_ACCOUNT_GROUP_NAME,
  NewAccountGroupResponse.JSON_PROPERTY_IS_CURRENT_ACCOUNT_GROUP,
  NewAccountGroupResponse.JSON_PROPERTY_IS_DEFAULT_ACCOUNT_GROUP,
...
public class NewAccountGroupResponse {
  ...
  **/
  ...
  /**
   * Return true if this NewAccountGroupResponse object is equal to o.
   */
  @Override
