...
public class EnterpriseAgentData {
  ...
  private List<AccountGroup1> accountGroups = new ArrayList<>();
  ...
  **/
  ...
  public EnterpriseAgentData accountGroups(List<AccountGroup1> accountGroups) {
    this.accountGroups = accountGroups;
    return this;
  }

  public EnterpriseAgentData addAccountGroupsItem(AccountGroup1 accountGroupsItem) {
