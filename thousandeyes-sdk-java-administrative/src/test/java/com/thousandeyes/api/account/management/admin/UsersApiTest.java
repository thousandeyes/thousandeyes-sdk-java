...
public class UsersApiTest {
            ...
            throws JsonProcessingException 
    {
        String requestBodyJson = """
                {
                  ...
                  "email" : "userx@thousandeyes.com"
                                 ...
                                 """;
        UserRequestBody mappedRequest = 
                mapper.readValue(requestBodyJson, UserRequestBody.class);
        ...
        CreateUser201Response mappedResponse = 
                mapper.readValue(responseBodyJson, CreateUser201Response.class);
            ...
            throws JsonProcessingException 
    {
        ...
        GetUser200Response mappedResponse = 
                mapper.readValue(responseBodyJson, GetUser200Response.class);
        assertNotNull(mappedResponse);
    }
        ...
        String responseBodyJson = """
                {
                  ...
                  "users" : [ {
                    ...
                    "dateRegistered" : "2020-07-17T22:00:54Z"
                                  ...
                                  """;
        GetUsers200Response mappedResponse = 
                mapper.readValue(responseBodyJson, GetUsers200Response.class);
        assertNotNull(mappedResponse);
    }
