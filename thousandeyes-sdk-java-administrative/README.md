# thousandeyes-sdk-java-administrative
...
```groovy
compile "com.thousandeyes.api:thousandeyes-sdk-java-administrative:version"
```
...
- `target/thousandeyes-sdk-java-administrative-version.jar`
- `target/lib/*.jar`
