...
import com.thousandeyes.sdk.event.detection.model.TargetNetworkEventGrouping;
 ...
 */
@JsonPropertyOrder({
  TargetNetworkEventDetail.JSON_PROPERTY_ID,
  TargetNetworkEventDetail.JSON_PROPERTY_TYPE_NAME,
  TargetNetworkEventDetail.JSON_PROPERTY_STATE,
  TargetNetworkEventDetail.JSON_PROPERTY_START_DATE,
  TargetNetworkEventDetail.JSON_PROPERTY_END_DATE,
  TargetNetworkEventDetail.JSON_PROPERTY_SEVERITY,
  TargetNetworkEventDetail.JSON_PROPERTY_AID,
  TargetNetworkEventDetail.JSON_PROPERTY_SUMMARY,
  TargetNetworkEventDetail.JSON_PROPERTY_AGENT_TYPE,
  TargetNetworkEventDetail.JSON_PROPERTY_AFFECTED_TESTS,
  TargetNetworkEventDetail.JSON_PROPERTY_AFFECTED_TARGETS,
  TargetNetworkEventDetail.JSON_PROPERTY_AFFECTED_AGENTS,
  TargetNetworkEventDetail.JSON_PROPERTY_CAUSE,
  TargetNetworkEventDetail.JSON_PROPERTY_LINKS,
  TargetNetworkEventDetail.JSON_PROPERTY_TYPE,
  TargetNetworkEventDetail.JSON_PROPERTY_GROUPING
})
@jakarta.annotation.Generated(value = "com.thousandeyes.api.codegen.ThousandeyesJavaGenerator")
public class TargetNetworkEventDetail {
  ...
  private TargetNetworkEventGrouping grouping;

  public TargetNetworkEventDetail() { 
  }
  ...
  **/
  ...
  public TargetNetworkEventDetail state(EventState state) {
    this.state = state;
    return this;
  }
  ...
  **/
  ...
  public TargetNetworkEventDetail severity(EventAlertSeverity severity) {
  ...
  **/
  ...
  public TargetNetworkEventDetail aid(String aid) {
    this.aid = aid;
    return this;
  }
  ...
  **/
  ...
  public TargetNetworkEventDetail agentType(EventAgentType agentType) {
  ...
  **/
  ...
  public TargetNetworkEventDetail affectedTests(AffectedTests affectedTests) {
  ...
  **/
  ...
  public TargetNetworkEventDetail affectedTargets(AffectedTargets affectedTargets) {
  ...
  **/
  ...
  public TargetNetworkEventDetail affectedAgents(AffectedAgents affectedAgents) {
  ...
  **/
  ...
  public TargetNetworkEventDetail cause(Set<String> cause) {
    this.cause = cause;
    return this;
  }

  public TargetNetworkEventDetail addCauseItem(String causeItem) {
    if (this.cause == null) {
  ...
  **/
  ...
  public TargetNetworkEventDetail links(SelfLinks links) {
    this.links = links;
    return this;
  }
  ...
  **/
  ...
  public TargetNetworkEventDetail type(String type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public TargetNetworkEventDetail grouping(TargetNetworkEventGrouping grouping) {
  ...
  **/
  ...
  public TargetNetworkEventGrouping getGrouping() {
    return grouping;
  }
  ...
  @JsonProperty(JSON_PROPERTY_GROUPING)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setGrouping(TargetNetworkEventGrouping grouping) {
    this.grouping = grouping;
  }


  /**
   * Return true if this TargetNetworkEventDetail object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    TargetNetworkEventDetail targetNetworkEventDetail = (TargetNetworkEventDetail) o;
    return Objects.equals(this.id, targetNetworkEventDetail.id) &&
        Objects.equals(this.typeName, targetNetworkEventDetail.typeName) &&
        Objects.equals(this.state, targetNetworkEventDetail.state) &&
        Objects.equals(this.startDate, targetNetworkEventDetail.startDate) &&
        Objects.equals(this.endDate, targetNetworkEventDetail.endDate) &&
        Objects.equals(this.severity, targetNetworkEventDetail.severity) &&
        Objects.equals(this.aid, targetNetworkEventDetail.aid) &&
        Objects.equals(this.summary, targetNetworkEventDetail.summary) &&
        Objects.equals(this.agentType, targetNetworkEventDetail.agentType) &&
        Objects.equals(this.affectedTests, targetNetworkEventDetail.affectedTests) &&
        Objects.equals(this.affectedTargets, targetNetworkEventDetail.affectedTargets) &&
        Objects.equals(this.affectedAgents, targetNetworkEventDetail.affectedAgents) &&
        Objects.equals(this.cause, targetNetworkEventDetail.cause) &&
        Objects.equals(this.links, targetNetworkEventDetail.links) &&
        Objects.equals(this.type, targetNetworkEventDetail.type) &&
        Objects.equals(this.grouping, targetNetworkEventDetail.grouping);
  }
  ...
  public String toString() {
    ...
    sb.append("class TargetNetworkEventDetail {\n");
  ...
  public static class ModelBuilder {
    ...
    private TargetNetworkEventDetail instance;

    public ModelBuilder() {
      this(new TargetNetworkEventDetail());
    }

    protected ModelBuilder(TargetNetworkEventDetail instance) {
      this.instance = instance;
    }

    public TargetNetworkEventDetail.ModelBuilder id(UUID id) {
      this.instance.id = id;
      return this;
    }
    public TargetNetworkEventDetail.ModelBuilder typeName(String typeName) {
      this.instance.typeName = typeName;
      return this;
    }
    public TargetNetworkEventDetail.ModelBuilder state(EventState state) {
      this.instance.setState(state);
      return this;
    }
    public TargetNetworkEventDetail.ModelBuilder startDate(OffsetDateTime startDate) {
      this.instance.startDate = startDate;
      return this;
    }
    public TargetNetworkEventDetail.ModelBuilder endDate(OffsetDateTime endDate) {
      this.instance.endDate = endDate;
      return this;
    }
    public TargetNetworkEventDetail.ModelBuilder severity(EventAlertSeverity severity) {
      this.instance.setSeverity(severity);
      return this;
    }
    public TargetNetworkEventDetail.ModelBuilder aid(String aid) {
      this.instance.setAid(aid);
      return this;
    }
    public TargetNetworkEventDetail.ModelBuilder summary(String summary) {
      this.instance.summary = summary;
      return this;
    }
    public TargetNetworkEventDetail.ModelBuilder agentType(EventAgentType agentType) {
      this.instance.setAgentType(agentType);
      return this;
    }
    public TargetNetworkEventDetail.ModelBuilder affectedTests(AffectedTests affectedTests) {
      this.instance.setAffectedTests(affectedTests);
      return this;
    }
    public TargetNetworkEventDetail.ModelBuilder affectedTargets(AffectedTargets affectedTargets) {
      this.instance.setAffectedTargets(affectedTargets);
      return this;
    }
    public TargetNetworkEventDetail.ModelBuilder affectedAgents(AffectedAgents affectedAgents) {
      this.instance.setAffectedAgents(affectedAgents);
      return this;
    }
    public TargetNetworkEventDetail.ModelBuilder cause(Set<String> cause) {
      this.instance.setCause(cause);
      return this;
    }
    public TargetNetworkEventDetail.ModelBuilder links(SelfLinks links) {
      this.instance.setLinks(links);
      return this;
    }
    public TargetNetworkEventDetail.ModelBuilder type(String type) {
      this.instance.setType(type);
      return this;
    }
    public TargetNetworkEventDetail.ModelBuilder grouping(TargetNetworkEventGrouping grouping) {
      this.instance.setGrouping(grouping);
      return this;
    }

    /**
     * Returns a built TargetNetworkEventDetail instance.
     *
     * <p>The builder is not reusable.</p>
     */
    public TargetNetworkEventDetail build() {
      try {
   ...
   */
  public static TargetNetworkEventDetail.ModelBuilder builder() {
    return new TargetNetworkEventDetail.ModelBuilder();
  }

  /**
   * Create a builder with a shallow copy of this instance.
   */
  public TargetNetworkEventDetail.ModelBuilder toBuilder() {
    TargetNetworkEventDetail.ModelBuilder builder = new TargetNetworkEventDetail.ModelBuilder()
      .id(getId())
