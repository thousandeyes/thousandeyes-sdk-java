...
public class ApplicationEventDetail {
  ...
  **/
  ...
  public static class ModelBuilder {
    ...
    private ApplicationEventDetail instance;

    public ModelBuilder() {
      this(new ApplicationEventDetail());
    }

    protected ModelBuilder(ApplicationEventDetail instance) {
      this.instance = instance;
    }

    public ApplicationEventDetail.ModelBuilder id(UUID id) {
      this.instance.id = id;
      return this;
    }
    public ApplicationEventDetail.ModelBuilder typeName(String typeName) {
      this.instance.typeName = typeName;
      return this;
    }
    public ApplicationEventDetail.ModelBuilder state(EventState state) {
      this.instance.setState(state);
      return this;
    }
    public ApplicationEventDetail.ModelBuilder startDate(OffsetDateTime startDate) {
      this.instance.startDate = startDate;
      return this;
    }
    public ApplicationEventDetail.ModelBuilder endDate(OffsetDateTime endDate) {
      this.instance.endDate = endDate;
      return this;
    }
    public ApplicationEventDetail.ModelBuilder severity(EventAlertSeverity severity) {
      this.instance.setSeverity(severity);
      return this;
    }
    public ApplicationEventDetail.ModelBuilder aid(String aid) {
      this.instance.setAid(aid);
      return this;
    }
    public ApplicationEventDetail.ModelBuilder summary(String summary) {
      this.instance.summary = summary;
      return this;
    }
    public ApplicationEventDetail.ModelBuilder agentType(EventAgentType agentType) {
      this.instance.setAgentType(agentType);
      return this;
    }
    public ApplicationEventDetail.ModelBuilder affectedTests(AffectedTests affectedTests) {
      this.instance.setAffectedTests(affectedTests);
      return this;
    }
    public ApplicationEventDetail.ModelBuilder affectedTargets(AffectedTargets affectedTargets) {
      this.instance.setAffectedTargets(affectedTargets);
      return this;
    }
    public ApplicationEventDetail.ModelBuilder affectedAgents(AffectedAgents affectedAgents) {
      this.instance.setAffectedAgents(affectedAgents);
      return this;
    }
    public ApplicationEventDetail.ModelBuilder cause(Set<String> cause) {
      this.instance.setCause(cause);
      return this;
    }
    public ApplicationEventDetail.ModelBuilder links(SelfLinks links) {
      this.instance.setLinks(links);
      return this;
    }
    public ApplicationEventDetail.ModelBuilder type(String type) {
      this.instance.setType(type);
      return this;
    }
    public ApplicationEventDetail.ModelBuilder grouping(ApplicationEventGrouping grouping) {
      this.instance.setGrouping(grouping);
      return this;
    }

    /**
     * Returns a built ApplicationEventDetail instance.
     *
     * <p>The builder is not reusable.</p>
     */
    public ApplicationEventDetail build() {
      try {
   ...
   */
  public static ApplicationEventDetail.ModelBuilder builder() {
    return new ApplicationEventDetail.ModelBuilder();
  }

  /**
   * Create a builder with a shallow copy of this instance.
   */
  public ApplicationEventDetail.ModelBuilder toBuilder() {
    ApplicationEventDetail.ModelBuilder builder = new ApplicationEventDetail.ModelBuilder()
      .id(getId())
