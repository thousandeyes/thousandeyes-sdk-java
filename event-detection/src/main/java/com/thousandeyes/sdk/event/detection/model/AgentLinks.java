 ...
 */
@JsonPropertyOrder({
  AgentLinks.JSON_PROPERTY_AGENT
})
...
public class AgentLinks {
  ...
  public AgentLinks agent(Link agent) {
    this.agent = agent;
    return this;
  }
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_AGENT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAgent(Link agent) {
    this.agent = agent;
  }


  /**
   * Return true if this AgentLinks object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    AgentLinks agentLinks = (AgentLinks) o;
    return Objects.equals(this.agent, agentLinks.agent);
  }
