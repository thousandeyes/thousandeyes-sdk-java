...
import com.thousandeyes.sdk.event.detection.model.AgentBranchEventGrouping;
 ...
 */
@JsonPropertyOrder({
  AgentBranchEventDetail.JSON_PROPERTY_ID,
  AgentBranchEventDetail.JSON_PROPERTY_TYPE_NAME,
  AgentBranchEventDetail.JSON_PROPERTY_STATE,
  AgentBranchEventDetail.JSON_PROPERTY_START_DATE,
  AgentBranchEventDetail.JSON_PROPERTY_END_DATE,
  AgentBranchEventDetail.JSON_PROPERTY_SEVERITY,
  AgentBranchEventDetail.JSON_PROPERTY_AID,
  AgentBranchEventDetail.JSON_PROPERTY_SUMMARY,
  AgentBranchEventDetail.JSON_PROPERTY_AGENT_TYPE,
  AgentBranchEventDetail.JSON_PROPERTY_AFFECTED_TESTS,
  AgentBranchEventDetail.JSON_PROPERTY_AFFECTED_TARGETS,
  AgentBranchEventDetail.JSON_PROPERTY_AFFECTED_AGENTS,
  AgentBranchEventDetail.JSON_PROPERTY_CAUSE,
  AgentBranchEventDetail.JSON_PROPERTY_LINKS,
  AgentBranchEventDetail.JSON_PROPERTY_TYPE,
  AgentBranchEventDetail.JSON_PROPERTY_GROUPING
})
@jakarta.annotation.Generated(value = "com.thousandeyes.api.codegen.ThousandeyesJavaGenerator")
public class AgentBranchEventDetail {
  ...
  private AgentBranchEventGrouping grouping;

  public AgentBranchEventDetail() { 
  }
  ...
  **/
  ...
  public AgentBranchEventDetail state(EventState state) {
    this.state = state;
    return this;
  }
  ...
  **/
  ...
  public AgentBranchEventDetail severity(EventAlertSeverity severity) {
  ...
  **/
  ...
  public AgentBranchEventDetail aid(String aid) {
    this.aid = aid;
    return this;
  }
  ...
  **/
  ...
  public AgentBranchEventDetail agentType(EventAgentType agentType) {
  ...
  **/
  ...
  public AgentBranchEventDetail affectedTests(AffectedTests affectedTests) {
  ...
  **/
  ...
  public AgentBranchEventDetail affectedTargets(AffectedTargets affectedTargets) {
  ...
  **/
  ...
  public AgentBranchEventDetail affectedAgents(AffectedAgents affectedAgents) {
  ...
  **/
  ...
  public AgentBranchEventDetail cause(Set<String> cause) {
    this.cause = cause;
    return this;
  }

  public AgentBranchEventDetail addCauseItem(String causeItem) {
    if (this.cause == null) {
  ...
  **/
  ...
  public AgentBranchEventDetail links(SelfLinks links) {
    this.links = links;
    return this;
  }
  ...
  **/
  ...
  public AgentBranchEventDetail type(String type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public AgentBranchEventDetail grouping(AgentBranchEventGrouping grouping) {
  ...
  **/
  ...
  public AgentBranchEventGrouping getGrouping() {
    return grouping;
  }
  ...
  @JsonProperty(JSON_PROPERTY_GROUPING)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setGrouping(AgentBranchEventGrouping grouping) {
    this.grouping = grouping;
  }


  /**
   * Return true if this AgentBranchEventDetail object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    AgentBranchEventDetail agentBranchEventDetail = (AgentBranchEventDetail) o;
    return Objects.equals(this.id, agentBranchEventDetail.id) &&
        Objects.equals(this.typeName, agentBranchEventDetail.typeName) &&
        Objects.equals(this.state, agentBranchEventDetail.state) &&
        Objects.equals(this.startDate, agentBranchEventDetail.startDate) &&
        Objects.equals(this.endDate, agentBranchEventDetail.endDate) &&
        Objects.equals(this.severity, agentBranchEventDetail.severity) &&
        Objects.equals(this.aid, agentBranchEventDetail.aid) &&
        Objects.equals(this.summary, agentBranchEventDetail.summary) &&
        Objects.equals(this.agentType, agentBranchEventDetail.agentType) &&
        Objects.equals(this.affectedTests, agentBranchEventDetail.affectedTests) &&
        Objects.equals(this.affectedTargets, agentBranchEventDetail.affectedTargets) &&
        Objects.equals(this.affectedAgents, agentBranchEventDetail.affectedAgents) &&
        Objects.equals(this.cause, agentBranchEventDetail.cause) &&
        Objects.equals(this.links, agentBranchEventDetail.links) &&
        Objects.equals(this.type, agentBranchEventDetail.type) &&
        Objects.equals(this.grouping, agentBranchEventDetail.grouping);
  }
  ...
  public String toString() {
    ...
    sb.append("class AgentBranchEventDetail {\n");
  ...
  public static class ModelBuilder {
    ...
    private AgentBranchEventDetail instance;

    public ModelBuilder() {
      this(new AgentBranchEventDetail());
    }

    protected ModelBuilder(AgentBranchEventDetail instance) {
      this.instance = instance;
    }

    public AgentBranchEventDetail.ModelBuilder id(UUID id) {
      this.instance.id = id;
      return this;
    }
    public AgentBranchEventDetail.ModelBuilder typeName(String typeName) {
      this.instance.typeName = typeName;
      return this;
    }
    public AgentBranchEventDetail.ModelBuilder state(EventState state) {
      this.instance.setState(state);
      return this;
    }
    public AgentBranchEventDetail.ModelBuilder startDate(OffsetDateTime startDate) {
      this.instance.startDate = startDate;
      return this;
    }
    public AgentBranchEventDetail.ModelBuilder endDate(OffsetDateTime endDate) {
      this.instance.endDate = endDate;
      return this;
    }
    public AgentBranchEventDetail.ModelBuilder severity(EventAlertSeverity severity) {
      this.instance.setSeverity(severity);
      return this;
    }
    public AgentBranchEventDetail.ModelBuilder aid(String aid) {
      this.instance.setAid(aid);
      return this;
    }
    public AgentBranchEventDetail.ModelBuilder summary(String summary) {
      this.instance.summary = summary;
      return this;
    }
    public AgentBranchEventDetail.ModelBuilder agentType(EventAgentType agentType) {
      this.instance.setAgentType(agentType);
      return this;
    }
    public AgentBranchEventDetail.ModelBuilder affectedTests(AffectedTests affectedTests) {
      this.instance.setAffectedTests(affectedTests);
      return this;
    }
    public AgentBranchEventDetail.ModelBuilder affectedTargets(AffectedTargets affectedTargets) {
      this.instance.setAffectedTargets(affectedTargets);
      return this;
    }
    public AgentBranchEventDetail.ModelBuilder affectedAgents(AffectedAgents affectedAgents) {
      this.instance.setAffectedAgents(affectedAgents);
      return this;
    }
    public AgentBranchEventDetail.ModelBuilder cause(Set<String> cause) {
      this.instance.setCause(cause);
      return this;
    }
    public AgentBranchEventDetail.ModelBuilder links(SelfLinks links) {
      this.instance.setLinks(links);
      return this;
    }
    public AgentBranchEventDetail.ModelBuilder type(String type) {
      this.instance.setType(type);
      return this;
    }
    public AgentBranchEventDetail.ModelBuilder grouping(AgentBranchEventGrouping grouping) {
      this.instance.setGrouping(grouping);
      return this;
    }

    /**
     * Returns a built AgentBranchEventDetail instance.
     *
     * <p>The builder is not reusable.</p>
     */
    public AgentBranchEventDetail build() {
      try {
   ...
   */
  public static AgentBranchEventDetail.ModelBuilder builder() {
    return new AgentBranchEventDetail.ModelBuilder();
  }

  /**
   * Create a builder with a shallow copy of this instance.
   */
  public AgentBranchEventDetail.ModelBuilder toBuilder() {
    AgentBranchEventDetail.ModelBuilder builder = new AgentBranchEventDetail.ModelBuilder()
      .id(getId())
