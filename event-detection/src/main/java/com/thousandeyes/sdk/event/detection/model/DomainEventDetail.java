...
public class DomainEventDetail {
  ...
  **/
  ...
  public static class ModelBuilder {
    ...
    private DomainEventDetail instance;

    public ModelBuilder() {
      this(new DomainEventDetail());
    }

    protected ModelBuilder(DomainEventDetail instance) {
      this.instance = instance;
    }

    public DomainEventDetail.ModelBuilder id(UUID id) {
      this.instance.id = id;
      return this;
    }
    public DomainEventDetail.ModelBuilder typeName(String typeName) {
      this.instance.typeName = typeName;
      return this;
    }
    public DomainEventDetail.ModelBuilder state(EventState state) {
      this.instance.setState(state);
      return this;
    }
    public DomainEventDetail.ModelBuilder startDate(OffsetDateTime startDate) {
      this.instance.startDate = startDate;
      return this;
    }
    public DomainEventDetail.ModelBuilder endDate(OffsetDateTime endDate) {
      this.instance.endDate = endDate;
      return this;
    }
    public DomainEventDetail.ModelBuilder severity(EventAlertSeverity severity) {
      this.instance.setSeverity(severity);
      return this;
    }
    public DomainEventDetail.ModelBuilder aid(String aid) {
      this.instance.setAid(aid);
      return this;
    }
    public DomainEventDetail.ModelBuilder summary(String summary) {
      this.instance.summary = summary;
      return this;
    }
    public DomainEventDetail.ModelBuilder agentType(EventAgentType agentType) {
      this.instance.setAgentType(agentType);
      return this;
    }
    public DomainEventDetail.ModelBuilder affectedTests(AffectedTests affectedTests) {
      this.instance.setAffectedTests(affectedTests);
      return this;
    }
    public DomainEventDetail.ModelBuilder affectedTargets(AffectedTargets affectedTargets) {
      this.instance.setAffectedTargets(affectedTargets);
      return this;
    }
    public DomainEventDetail.ModelBuilder affectedAgents(AffectedAgents affectedAgents) {
      this.instance.setAffectedAgents(affectedAgents);
      return this;
    }
    public DomainEventDetail.ModelBuilder cause(Set<String> cause) {
      this.instance.setCause(cause);
      return this;
    }
    public DomainEventDetail.ModelBuilder links(SelfLinks links) {
      this.instance.setLinks(links);
      return this;
    }
    public DomainEventDetail.ModelBuilder type(String type) {
      this.instance.setType(type);
      return this;
    }
    public DomainEventDetail.ModelBuilder grouping(DomainEventGrouping grouping) {
      this.instance.setGrouping(grouping);
      return this;
    }

    /**
     * Returns a built DomainEventDetail instance.
     *
     * <p>The builder is not reusable.</p>
     */
    public DomainEventDetail build() {
      try {
   ...
   */
  public static DomainEventDetail.ModelBuilder builder() {
    return new DomainEventDetail.ModelBuilder();
  }

  /**
   * Create a builder with a shallow copy of this instance.
   */
  public DomainEventDetail.ModelBuilder toBuilder() {
    DomainEventDetail.ModelBuilder builder = new DomainEventDetail.ModelBuilder()
      .id(getId())
