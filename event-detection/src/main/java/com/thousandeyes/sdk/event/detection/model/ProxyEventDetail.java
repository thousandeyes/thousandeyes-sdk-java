...
import com.thousandeyes.sdk.event.detection.model.ProxyEventGrouping;
 ...
 */
@JsonPropertyOrder({
  ProxyEventDetail.JSON_PROPERTY_ID,
  ProxyEventDetail.JSON_PROPERTY_TYPE_NAME,
  ProxyEventDetail.JSON_PROPERTY_STATE,
  ProxyEventDetail.JSON_PROPERTY_START_DATE,
  ProxyEventDetail.JSON_PROPERTY_END_DATE,
  ProxyEventDetail.JSON_PROPERTY_SEVERITY,
  ProxyEventDetail.JSON_PROPERTY_AID,
  ProxyEventDetail.JSON_PROPERTY_SUMMARY,
  ProxyEventDetail.JSON_PROPERTY_AGENT_TYPE,
  ProxyEventDetail.JSON_PROPERTY_AFFECTED_TESTS,
  ProxyEventDetail.JSON_PROPERTY_AFFECTED_TARGETS,
  ProxyEventDetail.JSON_PROPERTY_AFFECTED_AGENTS,
  ProxyEventDetail.JSON_PROPERTY_CAUSE,
  ProxyEventDetail.JSON_PROPERTY_LINKS,
  ProxyEventDetail.JSON_PROPERTY_TYPE,
  ProxyEventDetail.JSON_PROPERTY_GROUPING
})
@jakarta.annotation.Generated(value = "com.thousandeyes.api.codegen.ThousandeyesJavaGenerator")
public class ProxyEventDetail {
  ...
  private ProxyEventGrouping grouping;

  public ProxyEventDetail() { 
  }
  ...
  **/
  ...
  public ProxyEventDetail state(EventState state) {
    this.state = state;
    return this;
  }
  ...
  **/
  ...
  public ProxyEventDetail severity(EventAlertSeverity severity) {
  ...
  **/
  ...
  public ProxyEventDetail aid(String aid) {
    this.aid = aid;
    return this;
  }
  ...
  **/
  ...
  public ProxyEventDetail agentType(EventAgentType agentType) {
  ...
  **/
  ...
  public ProxyEventDetail affectedTests(AffectedTests affectedTests) {
  ...
  **/
  ...
  public ProxyEventDetail affectedTargets(AffectedTargets affectedTargets) {
  ...
  **/
  ...
  public ProxyEventDetail affectedAgents(AffectedAgents affectedAgents) {
  ...
  **/
  ...
  public ProxyEventDetail cause(Set<String> cause) {
    this.cause = cause;
    return this;
  }

  public ProxyEventDetail addCauseItem(String causeItem) {
    if (this.cause == null) {
  ...
  **/
  ...
  public ProxyEventDetail links(SelfLinks links) {
    this.links = links;
    return this;
  }
  ...
  **/
  ...
  public ProxyEventDetail type(String type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public ProxyEventDetail grouping(ProxyEventGrouping grouping) {
  ...
  **/
  ...
  public ProxyEventGrouping getGrouping() {
    return grouping;
  }
  ...
  @JsonProperty(JSON_PROPERTY_GROUPING)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setGrouping(ProxyEventGrouping grouping) {
    this.grouping = grouping;
  }


  /**
   * Return true if this ProxyEventDetail object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ProxyEventDetail proxyEventDetail = (ProxyEventDetail) o;
    return Objects.equals(this.id, proxyEventDetail.id) &&
        Objects.equals(this.typeName, proxyEventDetail.typeName) &&
        Objects.equals(this.state, proxyEventDetail.state) &&
        Objects.equals(this.startDate, proxyEventDetail.startDate) &&
        Objects.equals(this.endDate, proxyEventDetail.endDate) &&
        Objects.equals(this.severity, proxyEventDetail.severity) &&
        Objects.equals(this.aid, proxyEventDetail.aid) &&
        Objects.equals(this.summary, proxyEventDetail.summary) &&
        Objects.equals(this.agentType, proxyEventDetail.agentType) &&
        Objects.equals(this.affectedTests, proxyEventDetail.affectedTests) &&
        Objects.equals(this.affectedTargets, proxyEventDetail.affectedTargets) &&
        Objects.equals(this.affectedAgents, proxyEventDetail.affectedAgents) &&
        Objects.equals(this.cause, proxyEventDetail.cause) &&
        Objects.equals(this.links, proxyEventDetail.links) &&
        Objects.equals(this.type, proxyEventDetail.type) &&
        Objects.equals(this.grouping, proxyEventDetail.grouping);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProxyEventDetail {\n");
  ...
  public static class ModelBuilder {
    ...
    private ProxyEventDetail instance;

    public ModelBuilder() {
      this(new ProxyEventDetail());
    }

    protected ModelBuilder(ProxyEventDetail instance) {
      this.instance = instance;
    }

    public ProxyEventDetail.ModelBuilder id(UUID id) {
      this.instance.id = id;
      return this;
    }
    public ProxyEventDetail.ModelBuilder typeName(String typeName) {
      this.instance.typeName = typeName;
      return this;
    }
    public ProxyEventDetail.ModelBuilder state(EventState state) {
      this.instance.setState(state);
      return this;
    }
    public ProxyEventDetail.ModelBuilder startDate(OffsetDateTime startDate) {
      this.instance.startDate = startDate;
      return this;
    }
    public ProxyEventDetail.ModelBuilder endDate(OffsetDateTime endDate) {
      this.instance.endDate = endDate;
      return this;
    }
    public ProxyEventDetail.ModelBuilder severity(EventAlertSeverity severity) {
      this.instance.setSeverity(severity);
      return this;
    }
    public ProxyEventDetail.ModelBuilder aid(String aid) {
      this.instance.setAid(aid);
      return this;
    }
    public ProxyEventDetail.ModelBuilder summary(String summary) {
      this.instance.summary = summary;
      return this;
    }
    public ProxyEventDetail.ModelBuilder agentType(EventAgentType agentType) {
      this.instance.setAgentType(agentType);
      return this;
    }
    public ProxyEventDetail.ModelBuilder affectedTests(AffectedTests affectedTests) {
      this.instance.setAffectedTests(affectedTests);
      return this;
    }
    public ProxyEventDetail.ModelBuilder affectedTargets(AffectedTargets affectedTargets) {
      this.instance.setAffectedTargets(affectedTargets);
      return this;
    }
    public ProxyEventDetail.ModelBuilder affectedAgents(AffectedAgents affectedAgents) {
      this.instance.setAffectedAgents(affectedAgents);
      return this;
    }
    public ProxyEventDetail.ModelBuilder cause(Set<String> cause) {
      this.instance.setCause(cause);
      return this;
    }
    public ProxyEventDetail.ModelBuilder links(SelfLinks links) {
      this.instance.setLinks(links);
      return this;
    }
    public ProxyEventDetail.ModelBuilder type(String type) {
      this.instance.setType(type);
      return this;
    }
    public ProxyEventDetail.ModelBuilder grouping(ProxyEventGrouping grouping) {
      this.instance.setGrouping(grouping);
      return this;
    }

    /**
     * Returns a built ProxyEventDetail instance.
     *
     * <p>The builder is not reusable.</p>
     */
    public ProxyEventDetail build() {
      try {
   ...
   */
  public static ProxyEventDetail.ModelBuilder builder() {
    return new ProxyEventDetail.ModelBuilder();
  }

  /**
   * Create a builder with a shallow copy of this instance.
   */
  public ProxyEventDetail.ModelBuilder toBuilder() {
    ProxyEventDetail.ModelBuilder builder = new ProxyEventDetail.ModelBuilder()
      .id(getId())
