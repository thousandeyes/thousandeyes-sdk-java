...
import com.thousandeyes.sdk.event.detection.model.DnsEventGrouping;
 ...
 */
@JsonPropertyOrder({
  DnsEventDetail.JSON_PROPERTY_ID,
  DnsEventDetail.JSON_PROPERTY_TYPE_NAME,
  DnsEventDetail.JSON_PROPERTY_STATE,
  DnsEventDetail.JSON_PROPERTY_START_DATE,
  DnsEventDetail.JSON_PROPERTY_END_DATE,
  DnsEventDetail.JSON_PROPERTY_SEVERITY,
  DnsEventDetail.JSON_PROPERTY_AID,
  DnsEventDetail.JSON_PROPERTY_SUMMARY,
  DnsEventDetail.JSON_PROPERTY_AGENT_TYPE,
  DnsEventDetail.JSON_PROPERTY_AFFECTED_TESTS,
  DnsEventDetail.JSON_PROPERTY_AFFECTED_TARGETS,
  DnsEventDetail.JSON_PROPERTY_AFFECTED_AGENTS,
  DnsEventDetail.JSON_PROPERTY_CAUSE,
  DnsEventDetail.JSON_PROPERTY_LINKS,
  DnsEventDetail.JSON_PROPERTY_TYPE,
  DnsEventDetail.JSON_PROPERTY_GROUPING
})
@jakarta.annotation.Generated(value = "com.thousandeyes.api.codegen.ThousandeyesJavaGenerator")
public class DnsEventDetail {
  ...
  private DnsEventGrouping grouping;

  public DnsEventDetail() { 
  }
  ...
  **/
  ...
  public DnsEventDetail state(EventState state) {
    this.state = state;
    return this;
  }
  ...
  **/
  ...
  public DnsEventDetail severity(EventAlertSeverity severity) {
  ...
  **/
  ...
  public DnsEventDetail aid(String aid) {
    this.aid = aid;
    return this;
  }
  ...
  **/
  ...
  public DnsEventDetail agentType(EventAgentType agentType) {
  ...
  **/
  ...
  public DnsEventDetail affectedTests(AffectedTests affectedTests) {
  ...
  **/
  ...
  public DnsEventDetail affectedTargets(AffectedTargets affectedTargets) {
  ...
  **/
  ...
  public DnsEventDetail affectedAgents(AffectedAgents affectedAgents) {
  ...
  **/
  ...
  public DnsEventDetail cause(Set<String> cause) {
    this.cause = cause;
    return this;
  }

  public DnsEventDetail addCauseItem(String causeItem) {
    if (this.cause == null) {
  ...
  **/
  ...
  public DnsEventDetail links(SelfLinks links) {
    this.links = links;
    return this;
  }
  ...
  **/
  ...
  public DnsEventDetail type(String type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public DnsEventDetail grouping(DnsEventGrouping grouping) {
  ...
  **/
  ...
  public DnsEventGrouping getGrouping() {
    return grouping;
  }
  ...
  @JsonProperty(JSON_PROPERTY_GROUPING)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setGrouping(DnsEventGrouping grouping) {
    this.grouping = grouping;
  }


  /**
   * Return true if this DnsEventDetail object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DnsEventDetail dnsEventDetail = (DnsEventDetail) o;
    return Objects.equals(this.id, dnsEventDetail.id) &&
        Objects.equals(this.typeName, dnsEventDetail.typeName) &&
        Objects.equals(this.state, dnsEventDetail.state) &&
        Objects.equals(this.startDate, dnsEventDetail.startDate) &&
        Objects.equals(this.endDate, dnsEventDetail.endDate) &&
        Objects.equals(this.severity, dnsEventDetail.severity) &&
        Objects.equals(this.aid, dnsEventDetail.aid) &&
        Objects.equals(this.summary, dnsEventDetail.summary) &&
        Objects.equals(this.agentType, dnsEventDetail.agentType) &&
        Objects.equals(this.affectedTests, dnsEventDetail.affectedTests) &&
        Objects.equals(this.affectedTargets, dnsEventDetail.affectedTargets) &&
        Objects.equals(this.affectedAgents, dnsEventDetail.affectedAgents) &&
        Objects.equals(this.cause, dnsEventDetail.cause) &&
        Objects.equals(this.links, dnsEventDetail.links) &&
        Objects.equals(this.type, dnsEventDetail.type) &&
        Objects.equals(this.grouping, dnsEventDetail.grouping);
  }
  ...
  public String toString() {
    ...
    sb.append("class DnsEventDetail {\n");
  ...
  public static class ModelBuilder {
    ...
    private DnsEventDetail instance;

    public ModelBuilder() {
      this(new DnsEventDetail());
    }

    protected ModelBuilder(DnsEventDetail instance) {
      this.instance = instance;
    }

    public DnsEventDetail.ModelBuilder id(UUID id) {
      this.instance.id = id;
      return this;
    }
    public DnsEventDetail.ModelBuilder typeName(String typeName) {
      this.instance.typeName = typeName;
      return this;
    }
    public DnsEventDetail.ModelBuilder state(EventState state) {
      this.instance.setState(state);
      return this;
    }
    public DnsEventDetail.ModelBuilder startDate(OffsetDateTime startDate) {
      this.instance.startDate = startDate;
      return this;
    }
    public DnsEventDetail.ModelBuilder endDate(OffsetDateTime endDate) {
      this.instance.endDate = endDate;
      return this;
    }
    public DnsEventDetail.ModelBuilder severity(EventAlertSeverity severity) {
      this.instance.setSeverity(severity);
      return this;
    }
    public DnsEventDetail.ModelBuilder aid(String aid) {
      this.instance.setAid(aid);
      return this;
    }
    public DnsEventDetail.ModelBuilder summary(String summary) {
      this.instance.summary = summary;
      return this;
    }
    public DnsEventDetail.ModelBuilder agentType(EventAgentType agentType) {
      this.instance.setAgentType(agentType);
      return this;
    }
    public DnsEventDetail.ModelBuilder affectedTests(AffectedTests affectedTests) {
      this.instance.setAffectedTests(affectedTests);
      return this;
    }
    public DnsEventDetail.ModelBuilder affectedTargets(AffectedTargets affectedTargets) {
      this.instance.setAffectedTargets(affectedTargets);
      return this;
    }
    public DnsEventDetail.ModelBuilder affectedAgents(AffectedAgents affectedAgents) {
      this.instance.setAffectedAgents(affectedAgents);
      return this;
    }
    public DnsEventDetail.ModelBuilder cause(Set<String> cause) {
      this.instance.setCause(cause);
      return this;
    }
    public DnsEventDetail.ModelBuilder links(SelfLinks links) {
      this.instance.setLinks(links);
      return this;
    }
    public DnsEventDetail.ModelBuilder type(String type) {
      this.instance.setType(type);
      return this;
    }
    public DnsEventDetail.ModelBuilder grouping(DnsEventGrouping grouping) {
      this.instance.setGrouping(grouping);
      return this;
    }

    /**
     * Returns a built DnsEventDetail instance.
     *
     * <p>The builder is not reusable.</p>
     */
    public DnsEventDetail build() {
      try {
   ...
   */
  public static DnsEventDetail.ModelBuilder builder() {
    return new DnsEventDetail.ModelBuilder();
  }

  /**
   * Create a builder with a shallow copy of this instance.
   */
  public DnsEventDetail.ModelBuilder toBuilder() {
    DnsEventDetail.ModelBuilder builder = new DnsEventDetail.ModelBuilder()
      .id(getId())
