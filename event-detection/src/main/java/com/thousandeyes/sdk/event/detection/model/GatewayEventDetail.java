...
import com.thousandeyes.sdk.event.detection.model.GatewayEventGrouping;
 ...
 */
@JsonPropertyOrder({
  GatewayEventDetail.JSON_PROPERTY_ID,
  GatewayEventDetail.JSON_PROPERTY_TYPE_NAME,
  GatewayEventDetail.JSON_PROPERTY_STATE,
  GatewayEventDetail.JSON_PROPERTY_START_DATE,
  GatewayEventDetail.JSON_PROPERTY_END_DATE,
  GatewayEventDetail.JSON_PROPERTY_SEVERITY,
  GatewayEventDetail.JSON_PROPERTY_AID,
  GatewayEventDetail.JSON_PROPERTY_SUMMARY,
  GatewayEventDetail.JSON_PROPERTY_AGENT_TYPE,
  GatewayEventDetail.JSON_PROPERTY_AFFECTED_TESTS,
  GatewayEventDetail.JSON_PROPERTY_AFFECTED_TARGETS,
  GatewayEventDetail.JSON_PROPERTY_AFFECTED_AGENTS,
  GatewayEventDetail.JSON_PROPERTY_CAUSE,
  GatewayEventDetail.JSON_PROPERTY_LINKS,
  GatewayEventDetail.JSON_PROPERTY_TYPE,
  GatewayEventDetail.JSON_PROPERTY_GROUPING
})
@jakarta.annotation.Generated(value = "com.thousandeyes.api.codegen.ThousandeyesJavaGenerator")
public class GatewayEventDetail {
  ...
  private GatewayEventGrouping grouping;

  public GatewayEventDetail() { 
  }
  ...
  **/
  ...
  public GatewayEventDetail state(EventState state) {
    this.state = state;
    return this;
  }
  ...
  **/
  ...
  public GatewayEventDetail severity(EventAlertSeverity severity) {
  ...
  **/
  ...
  public GatewayEventDetail aid(String aid) {
    this.aid = aid;
    return this;
  }
  ...
  **/
  ...
  public GatewayEventDetail agentType(EventAgentType agentType) {
  ...
  **/
  ...
  public GatewayEventDetail affectedTests(AffectedTests affectedTests) {
  ...
  **/
  ...
  public GatewayEventDetail affectedTargets(AffectedTargets affectedTargets) {
  ...
  **/
  ...
  public GatewayEventDetail affectedAgents(AffectedAgents affectedAgents) {
  ...
  **/
  ...
  public GatewayEventDetail cause(Set<String> cause) {
    this.cause = cause;
    return this;
  }

  public GatewayEventDetail addCauseItem(String causeItem) {
    if (this.cause == null) {
  ...
  **/
  ...
  public GatewayEventDetail links(SelfLinks links) {
    this.links = links;
    return this;
  }
  ...
  **/
  ...
  public GatewayEventDetail type(String type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public GatewayEventDetail grouping(GatewayEventGrouping grouping) {
  ...
  **/
  ...
  public GatewayEventGrouping getGrouping() {
    return grouping;
  }
  ...
  @JsonProperty(JSON_PROPERTY_GROUPING)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setGrouping(GatewayEventGrouping grouping) {
    this.grouping = grouping;
  }


  /**
   * Return true if this GatewayEventDetail object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    GatewayEventDetail gatewayEventDetail = (GatewayEventDetail) o;
    return Objects.equals(this.id, gatewayEventDetail.id) &&
        Objects.equals(this.typeName, gatewayEventDetail.typeName) &&
        Objects.equals(this.state, gatewayEventDetail.state) &&
        Objects.equals(this.startDate, gatewayEventDetail.startDate) &&
        Objects.equals(this.endDate, gatewayEventDetail.endDate) &&
        Objects.equals(this.severity, gatewayEventDetail.severity) &&
        Objects.equals(this.aid, gatewayEventDetail.aid) &&
        Objects.equals(this.summary, gatewayEventDetail.summary) &&
        Objects.equals(this.agentType, gatewayEventDetail.agentType) &&
        Objects.equals(this.affectedTests, gatewayEventDetail.affectedTests) &&
        Objects.equals(this.affectedTargets, gatewayEventDetail.affectedTargets) &&
        Objects.equals(this.affectedAgents, gatewayEventDetail.affectedAgents) &&
        Objects.equals(this.cause, gatewayEventDetail.cause) &&
        Objects.equals(this.links, gatewayEventDetail.links) &&
        Objects.equals(this.type, gatewayEventDetail.type) &&
        Objects.equals(this.grouping, gatewayEventDetail.grouping);
  }
  ...
  public String toString() {
    ...
    sb.append("class GatewayEventDetail {\n");
  ...
  public static class ModelBuilder {
    ...
    private GatewayEventDetail instance;

    public ModelBuilder() {
      this(new GatewayEventDetail());
    }

    protected ModelBuilder(GatewayEventDetail instance) {
      this.instance = instance;
    }

    public GatewayEventDetail.ModelBuilder id(UUID id) {
      this.instance.id = id;
      return this;
    }
    public GatewayEventDetail.ModelBuilder typeName(String typeName) {
      this.instance.typeName = typeName;
      return this;
    }
    public GatewayEventDetail.ModelBuilder state(EventState state) {
      this.instance.setState(state);
      return this;
    }
    public GatewayEventDetail.ModelBuilder startDate(OffsetDateTime startDate) {
      this.instance.startDate = startDate;
      return this;
    }
    public GatewayEventDetail.ModelBuilder endDate(OffsetDateTime endDate) {
      this.instance.endDate = endDate;
      return this;
    }
    public GatewayEventDetail.ModelBuilder severity(EventAlertSeverity severity) {
      this.instance.setSeverity(severity);
      return this;
    }
    public GatewayEventDetail.ModelBuilder aid(String aid) {
      this.instance.setAid(aid);
      return this;
    }
    public GatewayEventDetail.ModelBuilder summary(String summary) {
      this.instance.summary = summary;
      return this;
    }
    public GatewayEventDetail.ModelBuilder agentType(EventAgentType agentType) {
      this.instance.setAgentType(agentType);
      return this;
    }
    public GatewayEventDetail.ModelBuilder affectedTests(AffectedTests affectedTests) {
      this.instance.setAffectedTests(affectedTests);
      return this;
    }
    public GatewayEventDetail.ModelBuilder affectedTargets(AffectedTargets affectedTargets) {
      this.instance.setAffectedTargets(affectedTargets);
      return this;
    }
    public GatewayEventDetail.ModelBuilder affectedAgents(AffectedAgents affectedAgents) {
      this.instance.setAffectedAgents(affectedAgents);
      return this;
    }
    public GatewayEventDetail.ModelBuilder cause(Set<String> cause) {
      this.instance.setCause(cause);
      return this;
    }
    public GatewayEventDetail.ModelBuilder links(SelfLinks links) {
      this.instance.setLinks(links);
      return this;
    }
    public GatewayEventDetail.ModelBuilder type(String type) {
      this.instance.setType(type);
      return this;
    }
    public GatewayEventDetail.ModelBuilder grouping(GatewayEventGrouping grouping) {
      this.instance.setGrouping(grouping);
      return this;
    }

    /**
     * Returns a built GatewayEventDetail instance.
     *
     * <p>The builder is not reusable.</p>
     */
    public GatewayEventDetail build() {
      try {
   ...
   */
  public static GatewayEventDetail.ModelBuilder builder() {
    return new GatewayEventDetail.ModelBuilder();
  }

  /**
   * Create a builder with a shallow copy of this instance.
   */
  public GatewayEventDetail.ModelBuilder toBuilder() {
    GatewayEventDetail.ModelBuilder builder = new GatewayEventDetail.ModelBuilder()
      .id(getId())
