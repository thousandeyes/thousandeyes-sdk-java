 ...
 */
@JsonPropertyOrder({
  PaginationNextAndSelfLinks.JSON_PROPERTY_NEXT,
  PaginationNextAndSelfLinks.JSON_PROPERTY_SELF
})
@jakarta.annotation.Generated(value = "com.thousandeyes.api.codegen.ThousandeyesJavaGenerator")
public class PaginationNextAndSelfLinks {
  ...
  public PaginationNextAndSelfLinks() { 
  }

  public PaginationNextAndSelfLinks next(Link next) {
    this.next = next;
    return this;
  }
  ...
  **/
  ...
  public PaginationNextAndSelfLinks self(Link self) {
    this.self = self;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this PaginationNextAndSelfLinks object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PaginationNextAndSelfLinks paginationNextAndSelfLinks = (PaginationNextAndSelfLinks) o;
    return Objects.equals(this.next, paginationNextAndSelfLinks.next) &&
        Objects.equals(this.self, paginationNextAndSelfLinks.self);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaginationNextAndSelfLinks {\n");
