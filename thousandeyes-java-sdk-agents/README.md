...
- Build date: 2024-02-07T22:58:17.928625Z[Europe/Lisbon]
...
```groovy
compile "com.thousandeyes.api:thousandeyes-java-sdk-agents:7.0.0-SNAPSHOT"
```
...
- `target/thousandeyes-java-sdk-agents-7.0.0-SNAPSHOT.jar`
- `target/lib/*.jar`
