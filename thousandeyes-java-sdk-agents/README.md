# thousandeyes-java-sdk-agents

Agents API
- API version: 7.0.0
  - Build date: 2023-12-18T17:52:53.465396Z[Europe/Lisbon]
...
<dependency>
  ...
  <artifactId>thousandeyes-java-sdk-agents</artifactId>
...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'thousandeyes-java-sdk-agents' jar has been published to maven central.
    mavenLocal()       // Needed if the 'thousandeyes-java-sdk-agents' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "org.openapitools:thousandeyes-java-sdk-agents:7.0.0"
  }
```
...
* `target/thousandeyes-java-sdk-agents-7.0.0.jar`
* `target/lib/*.jar`
