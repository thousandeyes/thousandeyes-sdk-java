...
<a id="assignEnterpriseAgentCluster"></a>
# **assignEnterpriseAgentCluster**
> GetAgentDetails200Response assignEnterpriseAgentCluster(agentId, assignEnterpriseAgentClusterRequest, aid, expand)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      GetAgentDetails200Response result = apiInstance.assignEnterpriseAgentCluster(agentId, assignEnterpriseAgentClusterRequest, aid, expand);
...
<a id="unassignEnterpriseAgentFromCluster"></a>
