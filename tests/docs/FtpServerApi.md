...
import com.thousandeyes.sdk.tests.FtpServerApi;
...
> ApiResponse<FtpServerTest> createFtpServerTest createFtpServerTestWithHttpInfo(updateFtpServerTest, aid, expand)
...
ApiResponse<[**FtpServerTest**](FtpServerTest.md)>
...
> FtpServerTest getFtpServerTest(testId, aid, expand)
...
> ApiResponse<FtpServerTest> getFtpServerTest getFtpServerTestWithHttpInfo(testId, aid, expand)
...
> FtpServerTest updateFtpServerTest(testId, updateFtpServerTest, aid, expand)
...
> ApiResponse<FtpServerTest> updateFtpServerTest updateFtpServerTestWithHttpInfo(testId, updateFtpServerTest, aid, expand)
