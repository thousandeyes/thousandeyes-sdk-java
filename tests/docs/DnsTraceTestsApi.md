...
| [**createDnsTraceTestWithHttpInfo**](DnsTraceTestsApi.md#createDnsTraceTestWithHttpInfo) | **POST** /tests/dns-trace | Create DNS Trace test |
| [**deleteDnsTraceTest**](DnsTraceTestsApi.md#deleteDnsTraceTest) | **DELETE** /tests/dns-trace/{testId} | Delete DNS Trace test |
| [**deleteDnsTraceTestWithHttpInfo**](DnsTraceTestsApi.md#deleteDnsTraceTestWithHttpInfo) | **DELETE** /tests/dns-trace/{testId} | Delete DNS Trace test |
| [**getDnsTraceTest**](DnsTraceTestsApi.md#getDnsTraceTest) | **GET** /tests/dns-trace/{testId} | Get DNS Trace test |
| [**getDnsTraceTestWithHttpInfo**](DnsTraceTestsApi.md#getDnsTraceTestWithHttpInfo) | **GET** /tests/dns-trace/{testId} | Get DNS Trace test |
| [**getDnsTraceTests**](DnsTraceTestsApi.md#getDnsTraceTests) | **GET** /tests/dns-trace | List DNS Trace tests |
| [**getDnsTraceTestsWithHttpInfo**](DnsTraceTestsApi.md#getDnsTraceTestsWithHttpInfo) | **GET** /tests/dns-trace | List DNS Trace tests |
| [**updateDnsTraceTest**](DnsTraceTestsApi.md#updateDnsTraceTest) | **PUT** /tests/dns-trace/{testId} | Update DNS Trace test |
| [**updateDnsTraceTestWithHttpInfo**](DnsTraceTestsApi.md#updateDnsTraceTestWithHttpInfo) | **PUT** /tests/dns-trace/{testId} | Update DNS Trace test |
...
public class Example {
    public static void main(String[] args) {
        ...
        DnsTraceTestRequest dnsTraceTestRequest = new DnsTraceTestRequest(); // DnsTraceTestRequest | 
...
ApiResponse<[**DnsTraceTestResponse**](DnsTraceTestResponse.md)>
...
> DnsTraceTestResponse getDnsTraceTest(testId, aid, expand)
...
public class Example {
    public static void main(String[] args) {
        ...
        List<ExpandTestOptions> expand = Arrays.asList(); // List<ExpandTestOptions> | Optional parameter on whether or not to expand the test sub-resources. By default no expansion is going to take place if the query parameter is not present. If the user wishes to expand the `agents` sub-resource, they need to pass the `?expand=agent` query.
        try {
            DnsTraceTestResponse result = apiInstance.getDnsTraceTest(testId, aid, expand);
            System.out.println(result);
        } catch (ApiException e) {
...
> ApiResponse<DnsTraceTestResponse> getDnsTraceTest getDnsTraceTestWithHttpInfo(testId, aid, expand)
...
public class Example {
    public static void main(String[] args) {
        ...
        List<ExpandTestOptions> expand = Arrays.asList(); // List<ExpandTestOptions> | Optional parameter on whether or not to expand the test sub-resources. By default no expansion is going to take place if the query parameter is not present. If the user wishes to expand the `agents` sub-resource, they need to pass the `?expand=agent` query.
        try {
            ApiResponse<DnsTraceTestResponse> response = apiInstance.getDnsTraceTestWithHttpInfo(testId, aid, expand);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
