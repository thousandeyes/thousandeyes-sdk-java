...
import com.thousandeyes.sdk.tests.DnsTraceApi;
...
> ApiResponse<DnsTraceTest> createDnsTraceTest createDnsTraceTestWithHttpInfo(updateDnsTraceTest, aid, expand)
...
ApiResponse<[**DnsTraceTest**](DnsTraceTest.md)>
...
> DnsTraceTest getDnsTraceTest(testId, aid, expand)
...
> ApiResponse<DnsTraceTest> getDnsTraceTest getDnsTraceTestWithHttpInfo(testId, aid, expand)
...
> DnsTraceTest updateDnsTraceTest(testId, updateDnsTraceTest, aid, expand)
...
> ApiResponse<DnsTraceTest> updateDnsTraceTest updateDnsTraceTestWithHttpInfo(testId, updateDnsTraceTest, aid, expand)
