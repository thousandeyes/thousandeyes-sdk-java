...
| [**createApiTestWithHttpInfo**](ApiTestsApi.md#createApiTestWithHttpInfo) | **POST** /tests/api | Create API test |
| [**deleteApiTest**](ApiTestsApi.md#deleteApiTest) | **DELETE** /tests/api/{testId} | Delete API test |
| [**deleteApiTestWithHttpInfo**](ApiTestsApi.md#deleteApiTestWithHttpInfo) | **DELETE** /tests/api/{testId} | Delete API test |
| [**getApiTest**](ApiTestsApi.md#getApiTest) | **GET** /tests/api/{testId} | Get API test |
| [**getApiTestWithHttpInfo**](ApiTestsApi.md#getApiTestWithHttpInfo) | **GET** /tests/api/{testId} | Get API test |
| [**getApiTests**](ApiTestsApi.md#getApiTests) | **GET** /tests/api | List API tests |
| [**getApiTestsWithHttpInfo**](ApiTestsApi.md#getApiTestsWithHttpInfo) | **GET** /tests/api | List API tests |
| [**updateApiTest**](ApiTestsApi.md#updateApiTest) | **PUT** /tests/api/{testId} | Update API test |
| [**updateApiTestWithHttpInfo**](ApiTestsApi.md#updateApiTestWithHttpInfo) | **PUT** /tests/api/{testId} | Update API test |
...
public class Example {
    public static void main(String[] args) {
        ...
        ApiTestRequest apiTestRequest = new ApiTestRequest(); // ApiTestRequest | 
...
ApiResponse<[**ApiTestResponse**](ApiTestResponse.md)>
...
> ApiTestResponse getApiTest(testId, aid, expand)
...
public class Example {
    public static void main(String[] args) {
        ...
        List<ExpandTestOptions> expand = Arrays.asList(); // List<ExpandTestOptions> | Optional parameter on whether or not to expand the test sub-resources. By default no expansion is going to take place if the query parameter is not present. If the user wishes to expand the `agents` sub-resource, they need to pass the `?expand=agent` query.
        try {
            ApiTestResponse result = apiInstance.getApiTest(testId, aid, expand);
            System.out.println(result);
        } catch (ApiException e) {
...
> ApiResponse<ApiTestResponse> getApiTest getApiTestWithHttpInfo(testId, aid, expand)
...
public class Example {
    public static void main(String[] args) {
        ...
        List<ExpandTestOptions> expand = Arrays.asList(); // List<ExpandTestOptions> | Optional parameter on whether or not to expand the test sub-resources. By default no expansion is going to take place if the query parameter is not present. If the user wishes to expand the `agents` sub-resource, they need to pass the `?expand=agent` query.
        try {
            ApiResponse<ApiTestResponse> response = apiInstance.getApiTestWithHttpInfo(testId, aid, expand);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
