 ...
 */
@JsonPropertyOrder({
  UpdateAgentToServerTestRequest.JSON_PROPERTY_LABELS,
  UpdateAgentToServerTestRequest.JSON_PROPERTY_TAGS,
  UpdateAgentToServerTestRequest.JSON_PROPERTY_SHARED_WITH_ACCOUNTS,
  UpdateAgentToServerTestRequest.JSON_PROPERTY_ALERT_RULES,
  UpdateAgentToServerTestRequest.JSON_PROPERTY_MONITORS,
  UpdateAgentToServerTestRequest.JSON_PROPERTY_BANDWIDTH_MEASUREMENTS,
  UpdateAgentToServerTestRequest.JSON_PROPERTY_CONTINUOUS_MODE,
  UpdateAgentToServerTestRequest.JSON_PROPERTY_FIXED_PACKET_RATE,
  UpdateAgentToServerTestRequest.JSON_PROPERTY_MTU_MEASUREMENTS,
  UpdateAgentToServerTestRequest.JSON_PROPERTY_NUM_PATH_TRACES,
  UpdateAgentToServerTestRequest.JSON_PROPERTY_PATH_TRACE_MODE,
  UpdateAgentToServerTestRequest.JSON_PROPERTY_PROBE_MODE,
  UpdateAgentToServerTestRequest.JSON_PROPERTY_PROTOCOL,
  UpdateAgentToServerTestRequest.JSON_PROPERTY_RANDOMIZED_START_TIME,
  UpdateAgentToServerTestRequest.JSON_PROPERTY_SERVER,
  UpdateAgentToServerTestRequest.JSON_PROPERTY_DSCP,
  UpdateAgentToServerTestRequest.JSON_PROPERTY_DSCP_ID,
  UpdateAgentToServerTestRequest.JSON_PROPERTY_IPV6_POLICY,
  UpdateAgentToServerTestRequest.JSON_PROPERTY_PING_PAYLOAD_SIZE,
  UpdateAgentToServerTestRequest.JSON_PROPERTY_NETWORK_MEASUREMENTS,
  UpdateAgentToServerTestRequest.JSON_PROPERTY_AGENTS,
  UpdateAgentToServerTestRequest.JSON_PROPERTY_INTERVAL,
  UpdateAgentToServerTestRequest.JSON_PROPERTY_ALERTS_ENABLED,
  UpdateAgentToServerTestRequest.JSON_PROPERTY_ENABLED,
  UpdateAgentToServerTestRequest.JSON_PROPERTY_DESCRIPTION,
  UpdateAgentToServerTestRequest.JSON_PROPERTY_TEST_NAME,
  UpdateAgentToServerTestRequest.JSON_PROPERTY_BGP_MEASUREMENTS,
  UpdateAgentToServerTestRequest.JSON_PROPERTY_USE_PUBLIC_BGP,
  UpdateAgentToServerTestRequest.JSON_PROPERTY_PORT
})
@jakarta.annotation.Generated(value = "com.thousandeyes.api.codegen.ThousandeyesJavaGenerator")
public class UpdateAgentToServerTestRequest {
  ...
  public UpdateAgentToServerTestRequest addLabelsItem(String labelsItem) {
    if (this.labels == null) {
  ...
  **/
  ...
  public UpdateAgentToServerTestRequest tags(List<String> tags) {
    this.tags = tags;
    return this;
  }

  public UpdateAgentToServerTestRequest addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  **/
  ...
  public UpdateAgentToServerTestRequest sharedWithAccounts(List<String> sharedWithAccounts) {
    this.sharedWithAccounts = sharedWithAccounts;
    return this;
  }

  public UpdateAgentToServerTestRequest addSharedWithAccountsItem(String sharedWithAccountsItem) {
  ...
  **/
  ...
  public UpdateAgentToServerTestRequest alertRules(List<String> alertRules) {
    this.alertRules = alertRules;
    return this;
  }

  public UpdateAgentToServerTestRequest addAlertRulesItem(String alertRulesItem) {
  ...
  **/
  ...
  public UpdateAgentToServerTestRequest monitors(List<String> monitors) {
    this.monitors = monitors;
    return this;
  }

  public UpdateAgentToServerTestRequest addMonitorsItem(String monitorsItem) {
  ...
  **/
  ...
  public UpdateAgentToServerTestRequest bandwidthMeasurements(Boolean bandwidthMeasurements) {
  ...
  **/
  ...
  public UpdateAgentToServerTestRequest continuousMode(Boolean continuousMode) {
  ...
  **/
  ...
  public UpdateAgentToServerTestRequest fixedPacketRate(Integer fixedPacketRate) {
  ...
  **/
  ...
  public UpdateAgentToServerTestRequest mtuMeasurements(Boolean mtuMeasurements) {
  ...
  **/
  ...
  public UpdateAgentToServerTestRequest numPathTraces(Integer numPathTraces) {
  ...
  **/
  ...
  public UpdateAgentToServerTestRequest pathTraceMode(TestPathTraceMode pathTraceMode) {
  ...
  **/
  ...
  public UpdateAgentToServerTestRequest probeMode(TestProbeMode probeMode) {
  ...
  **/
  ...
  public UpdateAgentToServerTestRequest protocol(TestProtocol protocol) {
  ...
  **/
  ...
  public UpdateAgentToServerTestRequest randomizedStartTime(Boolean randomizedStartTime) {
  ...
  **/
  ...
  public UpdateAgentToServerTestRequest server(String server) {
    this.server = server;
    return this;
  }
  ...
  **/
  ...
  public UpdateAgentToServerTestRequest dscpId(TestDscpId dscpId) {
    this.dscpId = dscpId;
    return this;
  }
  ...
  **/
  ...
  public UpdateAgentToServerTestRequest ipv6Policy(TestIpv6Policy ipv6Policy) {
  ...
  **/
  ...
  public UpdateAgentToServerTestRequest pingPayloadSize(Integer pingPayloadSize) {
  ...
  **/
  ...
  public UpdateAgentToServerTestRequest networkMeasurements(Boolean networkMeasurements) {
  ...
  **/
  ...
  public UpdateAgentToServerTestRequest agents(List<TestAgentWithSourceIpRequest> agents) {
    this.agents = agents;
    return this;
  }

  public UpdateAgentToServerTestRequest addAgentsItem(TestAgentWithSourceIpRequest agentsItem) {
    if (this.agents == null) {
  ...
  **/
  ...
  public UpdateAgentToServerTestRequest interval(TestInterval interval) {
  ...
  **/
  ...
  public UpdateAgentToServerTestRequest alertsEnabled(Boolean alertsEnabled) {
  ...
  **/
  ...
  public UpdateAgentToServerTestRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public UpdateAgentToServerTestRequest description(String description) {
  ...
  **/
  ...
  public UpdateAgentToServerTestRequest testName(String testName) {
  ...
  **/
  ...
  public UpdateAgentToServerTestRequest bgpMeasurements(Boolean bgpMeasurements) {
  ...
  **/
  ...
  public UpdateAgentToServerTestRequest usePublicBgp(Boolean usePublicBgp) {
  ...
  **/
  ...
  public UpdateAgentToServerTestRequest port(Integer port) {
    this.port = port;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this UpdateAgentToServerTestRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    UpdateAgentToServerTestRequest updateAgentToServerTestRequest = (UpdateAgentToServerTestRequest) o;
    return Objects.equals(this.labels, updateAgentToServerTestRequest.labels) &&
        Objects.equals(this.tags, updateAgentToServerTestRequest.tags) &&
        Objects.equals(this.sharedWithAccounts, updateAgentToServerTestRequest.sharedWithAccounts) &&
        Objects.equals(this.alertRules, updateAgentToServerTestRequest.alertRules) &&
        Objects.equals(this.monitors, updateAgentToServerTestRequest.monitors) &&
        Objects.equals(this.bandwidthMeasurements, updateAgentToServerTestRequest.bandwidthMeasurements) &&
        Objects.equals(this.continuousMode, updateAgentToServerTestRequest.continuousMode) &&
        Objects.equals(this.fixedPacketRate, updateAgentToServerTestRequest.fixedPacketRate) &&
        Objects.equals(this.mtuMeasurements, updateAgentToServerTestRequest.mtuMeasurements) &&
        Objects.equals(this.numPathTraces, updateAgentToServerTestRequest.numPathTraces) &&
        Objects.equals(this.pathTraceMode, updateAgentToServerTestRequest.pathTraceMode) &&
        Objects.equals(this.probeMode, updateAgentToServerTestRequest.probeMode) &&
        Objects.equals(this.protocol, updateAgentToServerTestRequest.protocol) &&
        Objects.equals(this.randomizedStartTime, updateAgentToServerTestRequest.randomizedStartTime) &&
        Objects.equals(this.server, updateAgentToServerTestRequest.server) &&
        Objects.equals(this.dscp, updateAgentToServerTestRequest.dscp) &&
        Objects.equals(this.dscpId, updateAgentToServerTestRequest.dscpId) &&
        Objects.equals(this.ipv6Policy, updateAgentToServerTestRequest.ipv6Policy) &&
        Objects.equals(this.pingPayloadSize, updateAgentToServerTestRequest.pingPayloadSize) &&
        Objects.equals(this.networkMeasurements, updateAgentToServerTestRequest.networkMeasurements) &&
        Objects.equals(this.agents, updateAgentToServerTestRequest.agents) &&
        Objects.equals(this.interval, updateAgentToServerTestRequest.interval) &&
        Objects.equals(this.alertsEnabled, updateAgentToServerTestRequest.alertsEnabled) &&
        Objects.equals(this.enabled, updateAgentToServerTestRequest.enabled) &&
        Objects.equals(this.description, updateAgentToServerTestRequest.description) &&
        Objects.equals(this.testName, updateAgentToServerTestRequest.testName) &&
        Objects.equals(this.bgpMeasurements, updateAgentToServerTestRequest.bgpMeasurements) &&
        Objects.equals(this.usePublicBgp, updateAgentToServerTestRequest.usePublicBgp) &&
        Objects.equals(this.port, updateAgentToServerTestRequest.port);
  }

  @Override
  public int hashCode() {
    return Objects.hash(labels, tags, sharedWithAccounts, alertRules, monitors, bandwidthMeasurements, continuousMode, fixedPacketRate, mtuMeasurements, numPathTraces, pathTraceMode, probeMode, protocol, randomizedStartTime, server, dscp, dscpId, ipv6Policy, pingPayloadSize, networkMeasurements, agents, interval, alertsEnabled, enabled, description, testName, bgpMeasurements, usePublicBgp, port);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateAgentToServerTestRequest {\n");
  ...
  public static class ModelBuilder {
    ...
    public UpdateAgentToServerTestRequest.ModelBuilder agents(List<TestAgentWithSourceIpRequest> agents) {
