...
public class BgpTest {
  ...
  **/
  ...
  public static class ModelBuilder {
    ...
    private BgpTest instance;

    public ModelBuilder() {
      this(new BgpTest());
    }

    protected ModelBuilder(BgpTest instance) {
      this.instance = instance;
    }

    public BgpTest.ModelBuilder createdBy(String createdBy) {
      this.instance.createdBy = createdBy;
      return this;
    }
    public BgpTest.ModelBuilder createdDate(OffsetDateTime createdDate) {
      this.instance.createdDate = createdDate;
      return this;
    }
    public BgpTest.ModelBuilder description(String description) {
      this.instance.setDescription(description);
      return this;
    }
    public BgpTest.ModelBuilder liveShare(Boolean liveShare) {
      this.instance.liveShare = liveShare;
      return this;
    }
    public BgpTest.ModelBuilder modifiedBy(String modifiedBy) {
      this.instance.modifiedBy = modifiedBy;
      return this;
    }
    public BgpTest.ModelBuilder modifiedDate(OffsetDateTime modifiedDate) {
      this.instance.modifiedDate = modifiedDate;
      return this;
    }
    public BgpTest.ModelBuilder savedEvent(Boolean savedEvent) {
      this.instance.savedEvent = savedEvent;
      return this;
    }
    public BgpTest.ModelBuilder testId(String testId) {
      this.instance.testId = testId;
      return this;
    }
    public BgpTest.ModelBuilder testName(String testName) {
      this.instance.setTestName(testName);
      return this;
    }
    public BgpTest.ModelBuilder type(String type) {
      this.instance.type = type;
      return this;
    }
    public BgpTest.ModelBuilder links(TestLinks links) {
      this.instance.setLinks(links);
      return this;
    }
    public BgpTest.ModelBuilder labels(List<TestLabel> labels) {
      this.instance.labels = labels;
      return this;
    }
    public BgpTest.ModelBuilder tags(List<TestTag> tags) {
      this.instance.tags = tags;
      return this;
    }
    public BgpTest.ModelBuilder sharedWithAccounts(List<SharedWithAccount> sharedWithAccounts) {
      this.instance.sharedWithAccounts = sharedWithAccounts;
      return this;
    }
    public BgpTest.ModelBuilder enabled(Boolean enabled) {
      this.instance.setEnabled(enabled);
      return this;
    }
    public BgpTest.ModelBuilder monitors(List<Monitor> monitors) {
      this.instance.monitors = monitors;
      return this;
    }
    public BgpTest.ModelBuilder includeCoveredPrefixes(Boolean includeCoveredPrefixes) {
      this.instance.setIncludeCoveredPrefixes(includeCoveredPrefixes);
      return this;
    }
    public BgpTest.ModelBuilder usePublicBgp(Boolean usePublicBgp) {
      this.instance.setUsePublicBgp(usePublicBgp);
      return this;
    }
    public BgpTest.ModelBuilder alertsEnabled(Boolean alertsEnabled) {
      this.instance.setAlertsEnabled(alertsEnabled);
      return this;
    }
    public BgpTest.ModelBuilder alertRules(List<AlertRule> alertRules) {
      this.instance.setAlertRules(alertRules);
      return this;
    }
    public BgpTest.ModelBuilder prefix(String prefix) {
      this.instance.setPrefix(prefix);
      return this;
    }

    /**
     * Returns a built BgpTest instance.
     *
     * <p>The builder is not reusable.</p>
     */
    public BgpTest build() {
      try {
   ...
   */
  public static BgpTest.ModelBuilder builder() {
    return new BgpTest.ModelBuilder();
  }

  /**
   * Create a builder with a shallow copy of this instance.
   */
  public BgpTest.ModelBuilder toBuilder() {
    BgpTest.ModelBuilder builder = new BgpTest.ModelBuilder()
