...
@JsonPropertyOrder({
  ...
  DnsTraceInstantTest.JSON_PROPERTY_TAGS,
  ...
  DnsTraceInstantTest.JSON_PROPERTY_RANDOMIZED_START_TIME
})
...
public class DnsTraceInstantTest {
  ...
  **/
  ...
  public DnsTraceInstantTest randomizedStartTime(Boolean randomizedStartTime) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createdBy, dnsTraceInstantTest.createdBy) &&
        ...
        Objects.equals(this.tags, dnsTraceInstantTest.tags) &&
        ...
        Objects.equals(this.randomizedStartTime, dnsTraceInstantTest.randomizedStartTime);
  }

  @Override
  public int hashCode() {
    return Objects.hash(createdBy, createdDate, description, liveShare, modifiedBy, modifiedDate, savedEvent, testId, testName, type, links, labels, tags, sharedWithAccounts, dnsTransportProtocol, domain, dnsQueryClass, randomizedStartTime);
  }
  ...
  public static class ModelBuilder {
    ...
    private DnsTraceInstantTest instance;

    public ModelBuilder() {
      this(new DnsTraceInstantTest());
    }

    protected ModelBuilder(DnsTraceInstantTest instance) {
      this.instance = instance;
    }

    public DnsTraceInstantTest.ModelBuilder createdBy(String createdBy) {
      this.instance.createdBy = createdBy;
      return this;
    }
    public DnsTraceInstantTest.ModelBuilder createdDate(OffsetDateTime createdDate) {
      this.instance.createdDate = createdDate;
      return this;
    }
    public DnsTraceInstantTest.ModelBuilder description(String description) {
      this.instance.setDescription(description);
      return this;
    }
    public DnsTraceInstantTest.ModelBuilder liveShare(Boolean liveShare) {
      this.instance.liveShare = liveShare;
      return this;
    }
    public DnsTraceInstantTest.ModelBuilder modifiedBy(String modifiedBy) {
      this.instance.modifiedBy = modifiedBy;
      return this;
    }
    public DnsTraceInstantTest.ModelBuilder modifiedDate(OffsetDateTime modifiedDate) {
      this.instance.modifiedDate = modifiedDate;
      return this;
    }
    public DnsTraceInstantTest.ModelBuilder savedEvent(Boolean savedEvent) {
      this.instance.savedEvent = savedEvent;
      return this;
    }
    public DnsTraceInstantTest.ModelBuilder testId(String testId) {
      this.instance.testId = testId;
      return this;
    }
    public DnsTraceInstantTest.ModelBuilder testName(String testName) {
      this.instance.setTestName(testName);
      return this;
    }
    public DnsTraceInstantTest.ModelBuilder type(String type) {
      this.instance.type = type;
      return this;
    }
    public DnsTraceInstantTest.ModelBuilder links(TestLinks links) {
      this.instance.setLinks(links);
      return this;
    }
    public DnsTraceInstantTest.ModelBuilder labels(List<TestLabel> labels) {
      this.instance.labels = labels;
      return this;
    }
    public DnsTraceInstantTest.ModelBuilder tags(List<TestTag> tags) {
      this.instance.tags = tags;
      return this;
    }
    public DnsTraceInstantTest.ModelBuilder sharedWithAccounts(List<SharedWithAccount> sharedWithAccounts) {
      this.instance.sharedWithAccounts = sharedWithAccounts;
      return this;
    }
    public DnsTraceInstantTest.ModelBuilder dnsTransportProtocol(TestDnsTransportProtocol dnsTransportProtocol) {
      this.instance.setDnsTransportProtocol(dnsTransportProtocol);
      return this;
    }
    public DnsTraceInstantTest.ModelBuilder domain(String domain) {
      this.instance.setDomain(domain);
      return this;
    }
    public DnsTraceInstantTest.ModelBuilder dnsQueryClass(DnsQueryClass dnsQueryClass) {
      this.instance.setDnsQueryClass(dnsQueryClass);
      return this;
    }
    public DnsTraceInstantTest.ModelBuilder randomizedStartTime(Boolean randomizedStartTime) {
      this.instance.setRandomizedStartTime(randomizedStartTime);
      return this;
    }

    /**
     * Returns a built DnsTraceInstantTest instance.
     *
     * <p>The builder is not reusable.</p>
     */
    public DnsTraceInstantTest build() {
      try {
   ...
   */
  public static DnsTraceInstantTest.ModelBuilder builder() {
    return new DnsTraceInstantTest.ModelBuilder();
  }

  /**
   * Create a builder with a shallow copy of this instance.
   */
  public DnsTraceInstantTest.ModelBuilder toBuilder() {
    DnsTraceInstantTest.ModelBuilder builder = new DnsTraceInstantTest.ModelBuilder()
