 ...
 */
@JsonPropertyOrder({
  ApiInstantTest.JSON_PROPERTY_CREATED_BY,
  ApiInstantTest.JSON_PROPERTY_CREATED_DATE,
  ApiInstantTest.JSON_PROPERTY_DESCRIPTION,
  ApiInstantTest.JSON_PROPERTY_LIVE_SHARE,
  ApiInstantTest.JSON_PROPERTY_MODIFIED_BY,
  ApiInstantTest.JSON_PROPERTY_MODIFIED_DATE,
  ApiInstantTest.JSON_PROPERTY_SAVED_EVENT,
  ApiInstantTest.JSON_PROPERTY_TEST_ID,
  ApiInstantTest.JSON_PROPERTY_TEST_NAME,
  ApiInstantTest.JSON_PROPERTY_TYPE,
  ApiInstantTest.JSON_PROPERTY_LINKS,
  ApiInstantTest.JSON_PROPERTY_LABELS,
  ApiInstantTest.JSON_PROPERTY_TAGS,
  ApiInstantTest.JSON_PROPERTY_SHARED_WITH_ACCOUNTS,
  ApiInstantTest.JSON_PROPERTY_CLIENT_CERTIFICATE,
  ApiInstantTest.JSON_PROPERTY_CLIENT_CERT_DOMAINS_ALLOW_LIST,
  ApiInstantTest.JSON_PROPERTY_COLLECT_PROXY_NETWORK_DATA,
  ApiInstantTest.JSON_PROPERTY_DISTRIBUTED_TRACING,
  ...
  ApiInstantTest.JSON_PROPERTY_PROTOCOL,
  ApiInstantTest.JSON_PROPERTY_RANDOMIZED_START_TIME,
  ApiInstantTest.JSON_PROPERTY_REQUESTS,
  ApiInstantTest.JSON_PROPERTY_SSL_VERSION_ID,
  ...
  ApiInstantTest.JSON_PROPERTY_VAULT_CREDENTIALS
})
@jakarta.annotation.Generated(value = "com.thousandeyes.api.codegen.ThousandeyesJavaGenerator")
public class ApiInstantTest {
  ...
  **/
  ...
  public ApiInstantTest description(String description) {
  ...
  **/
  ...
  public ApiInstantTest testName(String testName) {
  ...
  **/
  ...
  public ApiInstantTest links(TestLinks links) {
    this.links = links;
    return this;
  }
  ...
  **/
  ...
  public ApiInstantTest clientCertificate(String clientCertificate) {
  ...
  **/
  ...
  public ApiInstantTest clientCertDomainsAllowList(String clientCertDomainsAllowList) {
  ...
  **/
  ...
  public ApiInstantTest distributedTracing(Boolean distributedTracing) {
  ...
  **/
  ...
  public ApiInstantTest mtuMeasurements(Boolean mtuMeasurements) {
  ...
  **/
  ...
  public ApiInstantTest networkMeasurements(Boolean networkMeasurements) {
  ...
  **/
  ...
  public ApiInstantTest numPathTraces(Integer numPathTraces) {
  ...
  **/
  ...
  public ApiInstantTest pathTraceMode(TestPathTraceMode pathTraceMode) {
  ...
  **/
  ...
  public ApiInstantTest predefinedVariables(List<ApiPredefinedVariable> predefinedVariables) {
    this.predefinedVariables = predefinedVariables;
    return this;
  }

  public ApiInstantTest addPredefinedVariablesItem(ApiPredefinedVariable predefinedVariablesItem) {
  ...
  **/
  ...
  public ApiInstantTest probeMode(TestProbeMode probeMode) {
  ...
  **/
  ...
  public ApiInstantTest protocol(TestProtocol protocol) {
  ...
  **/
  ...
  public ApiInstantTest randomizedStartTime(Boolean randomizedStartTime) {
  ...
  **/
  ...
  public ApiInstantTest requests(List<ApiRequest> requests) {
    this.requests = requests;
    return this;
  }

  public ApiInstantTest addRequestsItem(ApiRequest requestsItem) {
  ...
  **/
  ...
  public ApiInstantTest sslVersionId(TestSslVersionId sslVersionId) {
  ...
  **/
  ...
  public ApiInstantTest targetTime(Integer targetTime) {
  ...
  **/
  ...
  public ApiInstantTest timeLimit(Integer timeLimit) {
  ...
  **/
  ...
  public ApiInstantTest url(String url) {
    this.url = url;
    return this;
  }
  ...
  **/
  ...
  public ApiInstantTest addCredentialsItem(String credentialsItem) {
  ...
  **/
  ...
  public ApiInstantTest vaultCredentials(List<TestVaultCredential> vaultCredentials) {
    this.vaultCredentials = vaultCredentials;
    return this;
  }

  public ApiInstantTest addVaultCredentialsItem(TestVaultCredential vaultCredentialsItem) {
  ...
  **/
  ...
  /**
   * Return true if this ApiInstantTest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ApiInstantTest apiInstantTest = (ApiInstantTest) o;
    return Objects.equals(this.createdBy, apiInstantTest.createdBy) &&
        Objects.equals(this.createdDate, apiInstantTest.createdDate) &&
        Objects.equals(this.description, apiInstantTest.description) &&
        Objects.equals(this.liveShare, apiInstantTest.liveShare) &&
        Objects.equals(this.modifiedBy, apiInstantTest.modifiedBy) &&
        Objects.equals(this.modifiedDate, apiInstantTest.modifiedDate) &&
        Objects.equals(this.savedEvent, apiInstantTest.savedEvent) &&
        Objects.equals(this.testId, apiInstantTest.testId) &&
        Objects.equals(this.testName, apiInstantTest.testName) &&
        Objects.equals(this.type, apiInstantTest.type) &&
        Objects.equals(this.links, apiInstantTest.links) &&
        Objects.equals(this.labels, apiInstantTest.labels) &&
        Objects.equals(this.tags, apiInstantTest.tags) &&
        Objects.equals(this.sharedWithAccounts, apiInstantTest.sharedWithAccounts) &&
        Objects.equals(this.clientCertificate, apiInstantTest.clientCertificate) &&
        Objects.equals(this.clientCertDomainsAllowList, apiInstantTest.clientCertDomainsAllowList) &&
        Objects.equals(this.collectProxyNetworkData, apiInstantTest.collectProxyNetworkData) &&
        Objects.equals(this.distributedTracing, apiInstantTest.distributedTracing) &&
        ...
        Objects.equals(this.protocol, apiInstantTest.protocol) &&
        Objects.equals(this.randomizedStartTime, apiInstantTest.randomizedStartTime) &&
        Objects.equals(this.requests, apiInstantTest.requests) &&
        Objects.equals(this.sslVersionId, apiInstantTest.sslVersionId) &&
        ...
        Objects.equals(this.vaultCredentials, apiInstantTest.vaultCredentials);
  }

  @Override
  public int hashCode() {
    return Objects.hash(createdBy, createdDate, description, liveShare, modifiedBy, modifiedDate, savedEvent, testId, testName, type, links, labels, tags, sharedWithAccounts, clientCertificate, clientCertDomainsAllowList, collectProxyNetworkData, distributedTracing, followRedirects, mtuMeasurements, networkMeasurements, numPathTraces, overrideAgentProxy, overrideProxyId, pathTraceMode, predefinedVariables, probeMode, protocol, randomizedStartTime, requests, sslVersionId, targetTime, timeLimit, url, credentials, vaultCredentials);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ApiInstantTest {\n");
  ...
  public static class ModelBuilder {
    ...
    private ApiInstantTest instance;

    public ModelBuilder() {
      this(new ApiInstantTest());
    }

    protected ModelBuilder(ApiInstantTest instance) {
      this.instance = instance;
    }

    public ApiInstantTest.ModelBuilder createdBy(String createdBy) {
      this.instance.createdBy = createdBy;
      return this;
    }
    public ApiInstantTest.ModelBuilder createdDate(OffsetDateTime createdDate) {
      this.instance.createdDate = createdDate;
      return this;
    }
    public ApiInstantTest.ModelBuilder description(String description) {
      this.instance.setDescription(description);
      return this;
    }
    public ApiInstantTest.ModelBuilder liveShare(Boolean liveShare) {
      this.instance.liveShare = liveShare;
      return this;
    }
    public ApiInstantTest.ModelBuilder modifiedBy(String modifiedBy) {
      this.instance.modifiedBy = modifiedBy;
      return this;
    }
    public ApiInstantTest.ModelBuilder modifiedDate(OffsetDateTime modifiedDate) {
      this.instance.modifiedDate = modifiedDate;
      return this;
    }
    public ApiInstantTest.ModelBuilder savedEvent(Boolean savedEvent) {
      this.instance.savedEvent = savedEvent;
      return this;
    }
    public ApiInstantTest.ModelBuilder testId(String testId) {
      this.instance.testId = testId;
      return this;
    }
    public ApiInstantTest.ModelBuilder testName(String testName) {
      this.instance.setTestName(testName);
      return this;
    }
    public ApiInstantTest.ModelBuilder type(String type) {
      this.instance.type = type;
      return this;
    }
    public ApiInstantTest.ModelBuilder links(TestLinks links) {
      this.instance.setLinks(links);
      return this;
    }
    public ApiInstantTest.ModelBuilder labels(List<TestLabel> labels) {
      this.instance.labels = labels;
      return this;
    }
    public ApiInstantTest.ModelBuilder tags(List<TestTag> tags) {
      this.instance.tags = tags;
      return this;
    }
    public ApiInstantTest.ModelBuilder sharedWithAccounts(List<SharedWithAccount> sharedWithAccounts) {
      this.instance.sharedWithAccounts = sharedWithAccounts;
      return this;
    }
    public ApiInstantTest.ModelBuilder clientCertificate(String clientCertificate) {
      this.instance.setClientCertificate(clientCertificate);
      return this;
    }
    public ApiInstantTest.ModelBuilder clientCertDomainsAllowList(String clientCertDomainsAllowList) {
      this.instance.setClientCertDomainsAllowList(clientCertDomainsAllowList);
      return this;
    }
    public ApiInstantTest.ModelBuilder collectProxyNetworkData(Boolean collectProxyNetworkData) {
      this.instance.setCollectProxyNetworkData(collectProxyNetworkData);
      return this;
    }
    public ApiInstantTest.ModelBuilder distributedTracing(Boolean distributedTracing) {
      this.instance.setDistributedTracing(distributedTracing);
      return this;
    }
    public ApiInstantTest.ModelBuilder followRedirects(Boolean followRedirects) {
      this.instance.setFollowRedirects(followRedirects);
      return this;
    }
    public ApiInstantTest.ModelBuilder mtuMeasurements(Boolean mtuMeasurements) {
      this.instance.setMtuMeasurements(mtuMeasurements);
      return this;
    }
    public ApiInstantTest.ModelBuilder networkMeasurements(Boolean networkMeasurements) {
      this.instance.setNetworkMeasurements(networkMeasurements);
      return this;
    }
    public ApiInstantTest.ModelBuilder numPathTraces(Integer numPathTraces) {
      this.instance.setNumPathTraces(numPathTraces);
      return this;
    }
    public ApiInstantTest.ModelBuilder overrideAgentProxy(Boolean overrideAgentProxy) {
      this.instance.setOverrideAgentProxy(overrideAgentProxy);
      return this;
    }
    public ApiInstantTest.ModelBuilder overrideProxyId(String overrideProxyId) {
      this.instance.setOverrideProxyId(overrideProxyId);
      return this;
    }
    public ApiInstantTest.ModelBuilder pathTraceMode(TestPathTraceMode pathTraceMode) {
      this.instance.setPathTraceMode(pathTraceMode);
      return this;
    }
    public ApiInstantTest.ModelBuilder predefinedVariables(List<ApiPredefinedVariable> predefinedVariables) {
      this.instance.setPredefinedVariables(predefinedVariables);
      return this;
    }
    public ApiInstantTest.ModelBuilder probeMode(TestProbeMode probeMode) {
      this.instance.setProbeMode(probeMode);
      return this;
    }
    public ApiInstantTest.ModelBuilder protocol(TestProtocol protocol) {
      this.instance.setProtocol(protocol);
      return this;
    }
    public ApiInstantTest.ModelBuilder randomizedStartTime(Boolean randomizedStartTime) {
      this.instance.setRandomizedStartTime(randomizedStartTime);
      return this;
    }
    public ApiInstantTest.ModelBuilder requests(List<ApiRequest> requests) {
      this.instance.setRequests(requests);
      return this;
    }
    public ApiInstantTest.ModelBuilder sslVersionId(TestSslVersionId sslVersionId) {
      this.instance.setSslVersionId(sslVersionId);
      return this;
    }
    public ApiInstantTest.ModelBuilder targetTime(Integer targetTime) {
      this.instance.setTargetTime(targetTime);
      return this;
    }
    public ApiInstantTest.ModelBuilder timeLimit(Integer timeLimit) {
      this.instance.setTimeLimit(timeLimit);
      return this;
    }
    public ApiInstantTest.ModelBuilder url(String url) {
      this.instance.setUrl(url);
      return this;
    }
    public ApiInstantTest.ModelBuilder credentials(List<String> credentials) {
      this.instance.setCredentials(credentials);
      return this;
    }
    public ApiInstantTest.ModelBuilder vaultCredentials(List<TestVaultCredential> vaultCredentials) {
      this.instance.setVaultCredentials(vaultCredentials);
      return this;
    }

    /**
     * Returns a built ApiInstantTest instance.
     *
     * <p>The builder is not reusable.</p>
     */
    public ApiInstantTest build() {
      try {
   ...
   */
  public static ApiInstantTest.ModelBuilder builder() {
    return new ApiInstantTest.ModelBuilder();
  }

  /**
   * Create a builder with a shallow copy of this instance.
   */
  public ApiInstantTest.ModelBuilder toBuilder() {
    ApiInstantTest.ModelBuilder builder = new ApiInstantTest.ModelBuilder()
