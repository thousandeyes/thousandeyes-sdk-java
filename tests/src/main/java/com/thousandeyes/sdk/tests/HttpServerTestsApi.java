...
public class HttpServerTestsApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public HttpServerTestResponse getHttpServerTest(String testId, String aid, List<ExpandTestOptions> expand) throws ApiException {
    ApiResponse<HttpServerTestResponse> response = getHttpServerTestWithHttpInfo(testId, aid, expand);
    return response.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<HttpServerTestResponse> getHttpServerTestWithHttpInfo(String testId, String aid, List<ExpandTestOptions> expand) throws ApiException {
  ...
  private ApiRequest.ApiRequestBuilder getHttpServerTestRequestBuilder(String testId, String aid, List<ExpandTestOptions> expand) throws ApiException {
    ApiRequest.ApiRequestBuilder requestBuilder = ApiRequest.builder()
            .method("GET");
