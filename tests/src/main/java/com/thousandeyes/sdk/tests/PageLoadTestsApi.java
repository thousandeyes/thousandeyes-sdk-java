...
public class PageLoadTestsApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public PageLoadTestResponse getPageLoadTest(String testId, String aid, List<ExpandTestOptions> expand) throws ApiException {
    ApiResponse<PageLoadTestResponse> response = getPageLoadTestWithHttpInfo(testId, aid, expand);
    return response.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<PageLoadTestResponse> getPageLoadTestWithHttpInfo(String testId, String aid, List<ExpandTestOptions> expand) throws ApiException {
  ...
  private ApiRequest.ApiRequestBuilder getPageLoadTestRequestBuilder(String testId, String aid, List<ExpandTestOptions> expand) throws ApiException {
    ApiRequest.ApiRequestBuilder requestBuilder = ApiRequest.builder()
            .method("GET");
