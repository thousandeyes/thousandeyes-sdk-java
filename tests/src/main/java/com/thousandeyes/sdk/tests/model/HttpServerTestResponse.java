...
@JsonPropertyOrder({
  ...
  HttpServerTestResponse.JSON_PROPERTY_TAGS,
...
public class HttpServerTestResponse {
  ...
  **/
  ...
  public HttpServerTestResponse agents(List<TestAgentResponse> agents) {
    this.agents = agents;
    return this;
  }

  public HttpServerTestResponse addAgentsItem(TestAgentResponse agentsItem) {
    if (this.agents == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.interval, httpServerTestResponse.interval) &&
        ...
        Objects.equals(this.tags, httpServerTestResponse.tags) &&
  ...
  public static class ModelBuilder {
    ...
    private HttpServerTestResponse instance;

    public ModelBuilder() {
      this(new HttpServerTestResponse());
    }

    protected ModelBuilder(HttpServerTestResponse instance) {
      this.instance = instance;
    }

    public HttpServerTestResponse.ModelBuilder interval(TestInterval interval) {
      this.instance.setInterval(interval);
      return this;
    }
    public HttpServerTestResponse.ModelBuilder alertsEnabled(Boolean alertsEnabled) {
      this.instance.setAlertsEnabled(alertsEnabled);
      return this;
    }
    public HttpServerTestResponse.ModelBuilder enabled(Boolean enabled) {
      this.instance.setEnabled(enabled);
      return this;
    }
    public HttpServerTestResponse.ModelBuilder alertRules(List<AlertRule> alertRules) {
      this.instance.setAlertRules(alertRules);
      return this;
    }
    public HttpServerTestResponse.ModelBuilder createdBy(String createdBy) {
      this.instance.createdBy = createdBy;
      return this;
    }
    public HttpServerTestResponse.ModelBuilder createdDate(OffsetDateTime createdDate) {
      this.instance.createdDate = createdDate;
      return this;
    }
    public HttpServerTestResponse.ModelBuilder description(String description) {
      this.instance.setDescription(description);
      return this;
    }
    public HttpServerTestResponse.ModelBuilder liveShare(Boolean liveShare) {
      this.instance.liveShare = liveShare;
      return this;
    }
    public HttpServerTestResponse.ModelBuilder modifiedBy(String modifiedBy) {
      this.instance.modifiedBy = modifiedBy;
      return this;
    }
    public HttpServerTestResponse.ModelBuilder modifiedDate(OffsetDateTime modifiedDate) {
      this.instance.modifiedDate = modifiedDate;
      return this;
    }
    public HttpServerTestResponse.ModelBuilder savedEvent(Boolean savedEvent) {
      this.instance.savedEvent = savedEvent;
      return this;
    }
    public HttpServerTestResponse.ModelBuilder testId(String testId) {
      this.instance.testId = testId;
      return this;
    }
    public HttpServerTestResponse.ModelBuilder testName(String testName) {
      this.instance.setTestName(testName);
      return this;
    }
    public HttpServerTestResponse.ModelBuilder type(String type) {
      this.instance.type = type;
      return this;
    }
    public HttpServerTestResponse.ModelBuilder links(TestLinks links) {
      this.instance.setLinks(links);
      return this;
    }
    public HttpServerTestResponse.ModelBuilder labels(List<TestLabel> labels) {
      this.instance.labels = labels;
      return this;
    }
    public HttpServerTestResponse.ModelBuilder tags(List<TestTag> tags) {
      this.instance.tags = tags;
      return this;
    }
    public HttpServerTestResponse.ModelBuilder sharedWithAccounts(List<SharedWithAccount> sharedWithAccounts) {
      this.instance.sharedWithAccounts = sharedWithAccounts;
      return this;
    }
    public HttpServerTestResponse.ModelBuilder authType(TestAuthType authType) {
      this.instance.setAuthType(authType);
      return this;
    }
    public HttpServerTestResponse.ModelBuilder agentInterfaces(AgentInterfaces agentInterfaces) {
      this.instance.setAgentInterfaces(agentInterfaces);
      return this;
    }
    public HttpServerTestResponse.ModelBuilder bandwidthMeasurements(Boolean bandwidthMeasurements) {
      this.instance.setBandwidthMeasurements(bandwidthMeasurements);
      return this;
    }
    public HttpServerTestResponse.ModelBuilder clientCertificate(String clientCertificate) {
      this.instance.setClientCertificate(clientCertificate);
      return this;
    }
    public HttpServerTestResponse.ModelBuilder contentRegex(String contentRegex) {
      this.instance.setContentRegex(contentRegex);
      return this;
    }
    public HttpServerTestResponse.ModelBuilder customHeaders(TestCustomHeaders customHeaders) {
      this.instance.setCustomHeaders(customHeaders);
      return this;
    }
    public HttpServerTestResponse.ModelBuilder desiredStatusCode(String desiredStatusCode) {
      this.instance.setDesiredStatusCode(desiredStatusCode);
      return this;
    }
    public HttpServerTestResponse.ModelBuilder distributedTracing(Boolean distributedTracing) {
      this.instance.setDistributedTracing(distributedTracing);
      return this;
    }
    public HttpServerTestResponse.ModelBuilder downloadLimit(Integer downloadLimit) {
      this.instance.setDownloadLimit(downloadLimit);
      return this;
    }
    public HttpServerTestResponse.ModelBuilder dnsOverride(String dnsOverride) {
      this.instance.setDnsOverride(dnsOverride);
      return this;
    }
    public HttpServerTestResponse.ModelBuilder httpTargetTime(Integer httpTargetTime) {
      this.instance.setHttpTargetTime(httpTargetTime);
      return this;
    }
    public HttpServerTestResponse.ModelBuilder httpTimeLimit(Integer httpTimeLimit) {
      this.instance.setHttpTimeLimit(httpTimeLimit);
      return this;
    }
    public HttpServerTestResponse.ModelBuilder httpVersion(Integer httpVersion) {
      this.instance.setHttpVersion(httpVersion);
      return this;
    }
    public HttpServerTestResponse.ModelBuilder includeHeaders(Boolean includeHeaders) {
      this.instance.setIncludeHeaders(includeHeaders);
      return this;
    }
    public HttpServerTestResponse.ModelBuilder mtuMeasurements(Boolean mtuMeasurements) {
      this.instance.setMtuMeasurements(mtuMeasurements);
      return this;
    }
    public HttpServerTestResponse.ModelBuilder networkMeasurements(Boolean networkMeasurements) {
      this.instance.setNetworkMeasurements(networkMeasurements);
      return this;
    }
    public HttpServerTestResponse.ModelBuilder numPathTraces(Integer numPathTraces) {
      this.instance.setNumPathTraces(numPathTraces);
      return this;
    }
    public HttpServerTestResponse.ModelBuilder oAuth(OAuth oAuth) {
      this.instance.setoAuth(oAuth);
      return this;
    }
    public HttpServerTestResponse.ModelBuilder password(String password) {
      this.instance.setPassword(password);
      return this;
    }
    public HttpServerTestResponse.ModelBuilder pathTraceMode(TestPathTraceMode pathTraceMode) {
      this.instance.setPathTraceMode(pathTraceMode);
      return this;
    }
    public HttpServerTestResponse.ModelBuilder probeMode(TestProbeMode probeMode) {
      this.instance.setProbeMode(probeMode);
      return this;
    }
    public HttpServerTestResponse.ModelBuilder protocol(TestProtocol protocol) {
      this.instance.setProtocol(protocol);
      return this;
    }
    public HttpServerTestResponse.ModelBuilder sslVersion(String sslVersion) {
      this.instance.sslVersion = sslVersion;
      return this;
    }
    public HttpServerTestResponse.ModelBuilder sslVersionId(TestSslVersionId sslVersionId) {
      this.instance.setSslVersionId(sslVersionId);
      return this;
    }
    public HttpServerTestResponse.ModelBuilder url(String url) {
      this.instance.setUrl(url);
      return this;
    }
    public HttpServerTestResponse.ModelBuilder useNtlm(Boolean useNtlm) {
      this.instance.setUseNtlm(useNtlm);
      return this;
    }
    public HttpServerTestResponse.ModelBuilder userAgent(String userAgent) {
      this.instance.setUserAgent(userAgent);
      return this;
    }
    public HttpServerTestResponse.ModelBuilder username(String username) {
      this.instance.setUsername(username);
      return this;
    }
    public HttpServerTestResponse.ModelBuilder verifyCertificate(Boolean verifyCertificate) {
      this.instance.setVerifyCertificate(verifyCertificate);
      return this;
    }
    public HttpServerTestResponse.ModelBuilder allowUnsafeLegacyRenegotiation(Boolean allowUnsafeLegacyRenegotiation) {
      this.instance.setAllowUnsafeLegacyRenegotiation(allowUnsafeLegacyRenegotiation);
      return this;
    }
    public HttpServerTestResponse.ModelBuilder followRedirects(Boolean followRedirects) {
      this.instance.setFollowRedirects(followRedirects);
      return this;
    }
    public HttpServerTestResponse.ModelBuilder fixedPacketRate(Integer fixedPacketRate) {
      this.instance.setFixedPacketRate(fixedPacketRate);
      return this;
    }
    public HttpServerTestResponse.ModelBuilder overrideAgentProxy(Boolean overrideAgentProxy) {
      this.instance.setOverrideAgentProxy(overrideAgentProxy);
      return this;
    }
    public HttpServerTestResponse.ModelBuilder overrideProxyId(String overrideProxyId) {
      this.instance.setOverrideProxyId(overrideProxyId);
      return this;
    }
    public HttpServerTestResponse.ModelBuilder collectProxyNetworkData(Boolean collectProxyNetworkData) {
      this.instance.setCollectProxyNetworkData(collectProxyNetworkData);
      return this;
    }
    public HttpServerTestResponse.ModelBuilder vaultCredentials(List<TestVaultCredential> vaultCredentials) {
      this.instance.setVaultCredentials(vaultCredentials);
      return this;
    }
    public HttpServerTestResponse.ModelBuilder headers(List<String> headers) {
      this.instance.setHeaders(headers);
      return this;
    }
    public HttpServerTestResponse.ModelBuilder randomizedStartTime(Boolean randomizedStartTime) {
      this.instance.setRandomizedStartTime(randomizedStartTime);
      return this;
    }
    public HttpServerTestResponse.ModelBuilder requestMethod(RequestMethod requestMethod) {
      this.instance.setRequestMethod(requestMethod);
      return this;
    }
    public HttpServerTestResponse.ModelBuilder postBody(String postBody) {
      this.instance.setPostBody(postBody);
      return this;
    }
    public HttpServerTestResponse.ModelBuilder ipv6Policy(TestIpv6Policy ipv6Policy) {
      this.instance.setIpv6Policy(ipv6Policy);
      return this;
    }
    public HttpServerTestResponse.ModelBuilder bgpMeasurements(Boolean bgpMeasurements) {
      this.instance.setBgpMeasurements(bgpMeasurements);
      return this;
    }
    public HttpServerTestResponse.ModelBuilder usePublicBgp(Boolean usePublicBgp) {
      this.instance.setUsePublicBgp(usePublicBgp);
      return this;
    }
    public HttpServerTestResponse.ModelBuilder monitors(List<Monitor> monitors) {
      this.instance.monitors = monitors;
      return this;
    }
    public HttpServerTestResponse.ModelBuilder agents(List<TestAgentResponse> agents) {
      this.instance.setAgents(agents);
      return this;
    }

    /**
     * Returns a built HttpServerTestResponse instance.
     *
     * <p>The builder is not reusable.</p>
     */
    public HttpServerTestResponse build() {
      try {
   ...
   */
  public static HttpServerTestResponse.ModelBuilder builder() {
    return new HttpServerTestResponse.ModelBuilder();
  }

  /**
   * Create a builder with a shallow copy of this instance.
   */
  public HttpServerTestResponse.ModelBuilder toBuilder() {
    HttpServerTestResponse.ModelBuilder builder = new HttpServerTestResponse.ModelBuilder()
