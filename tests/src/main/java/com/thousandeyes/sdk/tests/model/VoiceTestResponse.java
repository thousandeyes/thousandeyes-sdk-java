 ...
 */
@JsonPropertyOrder({
  VoiceTestResponse.JSON_PROPERTY_INTERVAL,
  VoiceTestResponse.JSON_PROPERTY_ALERTS_ENABLED,
  VoiceTestResponse.JSON_PROPERTY_ENABLED,
  VoiceTestResponse.JSON_PROPERTY_ALERT_RULES,
  VoiceTestResponse.JSON_PROPERTY_CREATED_BY,
  VoiceTestResponse.JSON_PROPERTY_CREATED_DATE,
  VoiceTestResponse.JSON_PROPERTY_DESCRIPTION,
  VoiceTestResponse.JSON_PROPERTY_LIVE_SHARE,
  VoiceTestResponse.JSON_PROPERTY_MODIFIED_BY,
  VoiceTestResponse.JSON_PROPERTY_MODIFIED_DATE,
  VoiceTestResponse.JSON_PROPERTY_SAVED_EVENT,
  VoiceTestResponse.JSON_PROPERTY_TEST_ID,
  VoiceTestResponse.JSON_PROPERTY_TEST_NAME,
  ...
  VoiceTestResponse.JSON_PROPERTY_DSCP,
  VoiceTestResponse.JSON_PROPERTY_DSCP_ID,
  VoiceTestResponse.JSON_PROPERTY_DURATION,
  VoiceTestResponse.JSON_PROPERTY_JITTER_BUFFER,
  VoiceTestResponse.JSON_PROPERTY_NUM_PATH_TRACES,
  VoiceTestResponse.JSON_PROPERTY_PORT,
  VoiceTestResponse.JSON_PROPERTY_RANDOMIZED_START_TIME,
  VoiceTestResponse.JSON_PROPERTY_TARGET_AGENT_ID,
  VoiceTestResponse.JSON_PROPERTY_BGP_MEASUREMENTS,
  VoiceTestResponse.JSON_PROPERTY_USE_PUBLIC_BGP,
  VoiceTestResponse.JSON_PROPERTY_MONITORS,
  VoiceTestResponse.JSON_PROPERTY_AGENTS
})
...
public class VoiceTestResponse {
  ...
  public VoiceTestResponse interval(TestInterval interval) {
  ...
  **/
  ...
  public VoiceTestResponse alertsEnabled(Boolean alertsEnabled) {
  ...
  **/
  ...
  public VoiceTestResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public VoiceTestResponse alertRules(List<AlertRule> alertRules) {
    this.alertRules = alertRules;
    return this;
  }

  public VoiceTestResponse addAlertRulesItem(AlertRule alertRulesItem) {
  ...
  **/
  ...
  public VoiceTestResponse description(String description) {
  ...
  **/
  ...
  public VoiceTestResponse testName(String testName) {
  ...
  **/
  ...
  public VoiceTestResponse links(TestLinks links) {
    this.links = links;
    return this;
  }
  ...
  **/
  ...
  public VoiceTestResponse codecId(String codecId) {
  ...
  **/
  ...
  public VoiceTestResponse dscpId(TestDscpId dscpId) {
    this.dscpId = dscpId;
    return this;
  }
  ...
  **/
  ...
  public VoiceTestResponse duration(Integer duration) {
  ...
  **/
  ...
  public VoiceTestResponse jitterBuffer(Integer jitterBuffer) {
  ...
  **/
  ...
  public VoiceTestResponse numPathTraces(Integer numPathTraces) {
  ...
  **/
  ...
  public VoiceTestResponse port(Integer port) {
    this.port = port;
    return this;
  }
  ...
  **/
  ...
  public VoiceTestResponse randomizedStartTime(Boolean randomizedStartTime) {
  ...
  **/
  ...
  public VoiceTestResponse targetAgentId(String targetAgentId) {
  ...
  **/
  ...
  public VoiceTestResponse bgpMeasurements(Boolean bgpMeasurements) {
  ...
  **/
  ...
  public VoiceTestResponse usePublicBgp(Boolean usePublicBgp) {
  ...
  **/
  ...
  /**
   * Return true if this VoiceTestResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    VoiceTestResponse voiceTestResponse = (VoiceTestResponse) o;
    return Objects.equals(this.interval, voiceTestResponse.interval) &&
        Objects.equals(this.alertsEnabled, voiceTestResponse.alertsEnabled) &&
        Objects.equals(this.enabled, voiceTestResponse.enabled) &&
        Objects.equals(this.alertRules, voiceTestResponse.alertRules) &&
        Objects.equals(this.createdBy, voiceTestResponse.createdBy) &&
        Objects.equals(this.createdDate, voiceTestResponse.createdDate) &&
        Objects.equals(this.description, voiceTestResponse.description) &&
        Objects.equals(this.liveShare, voiceTestResponse.liveShare) &&
        Objects.equals(this.modifiedBy, voiceTestResponse.modifiedBy) &&
        Objects.equals(this.modifiedDate, voiceTestResponse.modifiedDate) &&
        Objects.equals(this.savedEvent, voiceTestResponse.savedEvent) &&
        Objects.equals(this.testId, voiceTestResponse.testId) &&
        Objects.equals(this.testName, voiceTestResponse.testName) &&
        ...
        Objects.equals(this.dscp, voiceTestResponse.dscp) &&
        Objects.equals(this.dscpId, voiceTestResponse.dscpId) &&
        Objects.equals(this.duration, voiceTestResponse.duration) &&
        Objects.equals(this.jitterBuffer, voiceTestResponse.jitterBuffer) &&
        Objects.equals(this.numPathTraces, voiceTestResponse.numPathTraces) &&
        Objects.equals(this.port, voiceTestResponse.port) &&
        Objects.equals(this.randomizedStartTime, voiceTestResponse.randomizedStartTime) &&
        Objects.equals(this.targetAgentId, voiceTestResponse.targetAgentId) &&
        Objects.equals(this.bgpMeasurements, voiceTestResponse.bgpMeasurements) &&
        Objects.equals(this.usePublicBgp, voiceTestResponse.usePublicBgp) &&
        Objects.equals(this.monitors, voiceTestResponse.monitors) &&
        Objects.equals(this.agents, voiceTestResponse.agents);
  }
  ...
  public String toString() {
    ...
    sb.append("class VoiceTestResponse {\n");
  ...
  public static class ModelBuilder {
    ...
    private VoiceTestResponse instance;

    public ModelBuilder() {
      this(new VoiceTestResponse());
    }

    protected ModelBuilder(VoiceTestResponse instance) {
      this.instance = instance;
    }

    public VoiceTestResponse.ModelBuilder interval(TestInterval interval) {
      this.instance.setInterval(interval);
      return this;
    }
    public VoiceTestResponse.ModelBuilder alertsEnabled(Boolean alertsEnabled) {
      this.instance.setAlertsEnabled(alertsEnabled);
      return this;
    }
    public VoiceTestResponse.ModelBuilder enabled(Boolean enabled) {
      this.instance.setEnabled(enabled);
      return this;
    }
    public VoiceTestResponse.ModelBuilder alertRules(List<AlertRule> alertRules) {
      this.instance.setAlertRules(alertRules);
      return this;
    }
    public VoiceTestResponse.ModelBuilder createdBy(String createdBy) {
      this.instance.createdBy = createdBy;
      return this;
    }
    public VoiceTestResponse.ModelBuilder createdDate(OffsetDateTime createdDate) {
      this.instance.createdDate = createdDate;
      return this;
    }
    public VoiceTestResponse.ModelBuilder description(String description) {
      this.instance.setDescription(description);
      return this;
    }
    public VoiceTestResponse.ModelBuilder liveShare(Boolean liveShare) {
      this.instance.liveShare = liveShare;
      return this;
    }
    public VoiceTestResponse.ModelBuilder modifiedBy(String modifiedBy) {
      this.instance.modifiedBy = modifiedBy;
      return this;
    }
    public VoiceTestResponse.ModelBuilder modifiedDate(OffsetDateTime modifiedDate) {
      this.instance.modifiedDate = modifiedDate;
      return this;
    }
    public VoiceTestResponse.ModelBuilder savedEvent(Boolean savedEvent) {
      this.instance.savedEvent = savedEvent;
      return this;
    }
    public VoiceTestResponse.ModelBuilder testId(String testId) {
      this.instance.testId = testId;
      return this;
    }
    public VoiceTestResponse.ModelBuilder testName(String testName) {
      this.instance.setTestName(testName);
      return this;
    }
    public VoiceTestResponse.ModelBuilder type(String type) {
      this.instance.type = type;
      return this;
    }
    public VoiceTestResponse.ModelBuilder links(TestLinks links) {
      this.instance.setLinks(links);
      return this;
    }
    public VoiceTestResponse.ModelBuilder labels(List<TestLabel> labels) {
      this.instance.labels = labels;
      return this;
    }
    public VoiceTestResponse.ModelBuilder tags(List<TestTag> tags) {
      this.instance.tags = tags;
      return this;
    }
    public VoiceTestResponse.ModelBuilder sharedWithAccounts(List<SharedWithAccount> sharedWithAccounts) {
      this.instance.sharedWithAccounts = sharedWithAccounts;
      return this;
    }
    public VoiceTestResponse.ModelBuilder codec(String codec) {
      this.instance.codec = codec;
      return this;
    }
    public VoiceTestResponse.ModelBuilder codecId(String codecId) {
      this.instance.setCodecId(codecId);
      return this;
    }
    public VoiceTestResponse.ModelBuilder dscp(String dscp) {
      this.instance.dscp = dscp;
      return this;
    }
    public VoiceTestResponse.ModelBuilder dscpId(TestDscpId dscpId) {
      this.instance.setDscpId(dscpId);
      return this;
    }
    public VoiceTestResponse.ModelBuilder duration(Integer duration) {
      this.instance.setDuration(duration);
      return this;
    }
    public VoiceTestResponse.ModelBuilder jitterBuffer(Integer jitterBuffer) {
      this.instance.setJitterBuffer(jitterBuffer);
      return this;
    }
    public VoiceTestResponse.ModelBuilder numPathTraces(Integer numPathTraces) {
      this.instance.setNumPathTraces(numPathTraces);
      return this;
    }
    public VoiceTestResponse.ModelBuilder port(Integer port) {
      this.instance.setPort(port);
      return this;
    }
    public VoiceTestResponse.ModelBuilder randomizedStartTime(Boolean randomizedStartTime) {
      this.instance.setRandomizedStartTime(randomizedStartTime);
      return this;
    }
    public VoiceTestResponse.ModelBuilder targetAgentId(String targetAgentId) {
      this.instance.setTargetAgentId(targetAgentId);
      return this;
    }
    public VoiceTestResponse.ModelBuilder bgpMeasurements(Boolean bgpMeasurements) {
      this.instance.setBgpMeasurements(bgpMeasurements);
      return this;
    }
    public VoiceTestResponse.ModelBuilder usePublicBgp(Boolean usePublicBgp) {
      this.instance.setUsePublicBgp(usePublicBgp);
      return this;
    }
    public VoiceTestResponse.ModelBuilder monitors(List<Monitor> monitors) {
      this.instance.monitors = monitors;
      return this;
    }
    public VoiceTestResponse.ModelBuilder agents(List<TestAgentResponse> agents) {
      this.instance.setAgents(agents);
      return this;
    }

    /**
     * Returns a built VoiceTestResponse instance.
     *
     * <p>The builder is not reusable.</p>
     */
    public VoiceTestResponse build() {
      try {
   ...
   */
  public static VoiceTestResponse.ModelBuilder builder() {
    return new VoiceTestResponse.ModelBuilder();
  }

  /**
   * Create a builder with a shallow copy of this instance.
   */
  public VoiceTestResponse.ModelBuilder toBuilder() {
    VoiceTestResponse.ModelBuilder builder = new VoiceTestResponse.ModelBuilder()
