...
@JsonPropertyOrder({
  ...
  UnexpandedSipServerTest.JSON_PROPERTY_RANDOMIZED_START_TIME,
...
public class UnexpandedSipServerTest {
  ...
  **/
  ...
  public UnexpandedSipServerTest randomizedStartTime(Boolean randomizedStartTime) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.interval, unexpandedSipServerTest.interval) &&
        ...
        Objects.equals(this.randomizedStartTime, unexpandedSipServerTest.randomizedStartTime) &&
  ...
  public static class ModelBuilder {
    ...
    private UnexpandedSipServerTest instance;

    public ModelBuilder() {
      this(new UnexpandedSipServerTest());
    }

    protected ModelBuilder(UnexpandedSipServerTest instance) {
      this.instance = instance;
    }

    public UnexpandedSipServerTest.ModelBuilder interval(TestInterval interval) {
      this.instance.setInterval(interval);
      return this;
    }
    public UnexpandedSipServerTest.ModelBuilder alertsEnabled(Boolean alertsEnabled) {
      this.instance.setAlertsEnabled(alertsEnabled);
      return this;
    }
    public UnexpandedSipServerTest.ModelBuilder enabled(Boolean enabled) {
      this.instance.setEnabled(enabled);
      return this;
    }
    public UnexpandedSipServerTest.ModelBuilder createdBy(String createdBy) {
      this.instance.createdBy = createdBy;
      return this;
    }
    public UnexpandedSipServerTest.ModelBuilder createdDate(OffsetDateTime createdDate) {
      this.instance.createdDate = createdDate;
      return this;
    }
    public UnexpandedSipServerTest.ModelBuilder description(String description) {
      this.instance.setDescription(description);
      return this;
    }
    public UnexpandedSipServerTest.ModelBuilder liveShare(Boolean liveShare) {
      this.instance.liveShare = liveShare;
      return this;
    }
    public UnexpandedSipServerTest.ModelBuilder modifiedBy(String modifiedBy) {
      this.instance.modifiedBy = modifiedBy;
      return this;
    }
    public UnexpandedSipServerTest.ModelBuilder modifiedDate(OffsetDateTime modifiedDate) {
      this.instance.modifiedDate = modifiedDate;
      return this;
    }
    public UnexpandedSipServerTest.ModelBuilder savedEvent(Boolean savedEvent) {
      this.instance.savedEvent = savedEvent;
      return this;
    }
    public UnexpandedSipServerTest.ModelBuilder testId(String testId) {
      this.instance.testId = testId;
      return this;
    }
    public UnexpandedSipServerTest.ModelBuilder testName(String testName) {
      this.instance.setTestName(testName);
      return this;
    }
    public UnexpandedSipServerTest.ModelBuilder type(String type) {
      this.instance.type = type;
      return this;
    }
    public UnexpandedSipServerTest.ModelBuilder links(TestLinks links) {
      this.instance.setLinks(links);
      return this;
    }
    public UnexpandedSipServerTest.ModelBuilder mtuMeasurements(Boolean mtuMeasurements) {
      this.instance.setMtuMeasurements(mtuMeasurements);
      return this;
    }
    public UnexpandedSipServerTest.ModelBuilder networkMeasurements(Boolean networkMeasurements) {
      this.instance.setNetworkMeasurements(networkMeasurements);
      return this;
    }
    public UnexpandedSipServerTest.ModelBuilder numPathTraces(Integer numPathTraces) {
      this.instance.setNumPathTraces(numPathTraces);
      return this;
    }
    public UnexpandedSipServerTest.ModelBuilder optionsRegex(String optionsRegex) {
      this.instance.setOptionsRegex(optionsRegex);
      return this;
    }
    public UnexpandedSipServerTest.ModelBuilder pathTraceMode(TestPathTraceMode pathTraceMode) {
      this.instance.setPathTraceMode(pathTraceMode);
      return this;
    }
    public UnexpandedSipServerTest.ModelBuilder probeMode(TestProbeMode probeMode) {
      this.instance.setProbeMode(probeMode);
      return this;
    }
    public UnexpandedSipServerTest.ModelBuilder randomizedStartTime(Boolean randomizedStartTime) {
      this.instance.setRandomizedStartTime(randomizedStartTime);
      return this;
    }
    public UnexpandedSipServerTest.ModelBuilder registerEnabled(Boolean registerEnabled) {
      this.instance.setRegisterEnabled(registerEnabled);
      return this;
    }
    public UnexpandedSipServerTest.ModelBuilder sipTargetTime(Integer sipTargetTime) {
      this.instance.setSipTargetTime(sipTargetTime);
      return this;
    }
    public UnexpandedSipServerTest.ModelBuilder sipTimeLimit(Integer sipTimeLimit) {
      this.instance.setSipTimeLimit(sipTimeLimit);
      return this;
    }
    public UnexpandedSipServerTest.ModelBuilder fixedPacketRate(Integer fixedPacketRate) {
      this.instance.setFixedPacketRate(fixedPacketRate);
      return this;
    }
    public UnexpandedSipServerTest.ModelBuilder ipv6Policy(TestIpv6Policy ipv6Policy) {
      this.instance.setIpv6Policy(ipv6Policy);
      return this;
    }
    public UnexpandedSipServerTest.ModelBuilder authUser(String authUser) {
      this.instance.setAuthUser(authUser);
      return this;
    }
    public UnexpandedSipServerTest.ModelBuilder password(String password) {
      this.instance.setPassword(password);
      return this;
    }
    public UnexpandedSipServerTest.ModelBuilder port(Integer port) {
      this.instance.setPort(port);
      return this;
    }
    public UnexpandedSipServerTest.ModelBuilder protocol(SipTestProtocol protocol) {
      this.instance.setProtocol(protocol);
      return this;
    }
    public UnexpandedSipServerTest.ModelBuilder sipRegistrar(String sipRegistrar) {
      this.instance.setSipRegistrar(sipRegistrar);
      return this;
    }
    public UnexpandedSipServerTest.ModelBuilder user(String user) {
      this.instance.setUser(user);
      return this;
    }
    public UnexpandedSipServerTest.ModelBuilder bgpMeasurements(Boolean bgpMeasurements) {
      this.instance.setBgpMeasurements(bgpMeasurements);
      return this;
    }
    public UnexpandedSipServerTest.ModelBuilder usePublicBgp(Boolean usePublicBgp) {
      this.instance.setUsePublicBgp(usePublicBgp);
      return this;
    }

    /**
     * Returns a built UnexpandedSipServerTest instance.
     *
     * <p>The builder is not reusable.</p>
     */
    public UnexpandedSipServerTest build() {
      try {
   ...
   */
  public static UnexpandedSipServerTest.ModelBuilder builder() {
    return new UnexpandedSipServerTest.ModelBuilder();
  }

  /**
   * Create a builder with a shallow copy of this instance.
   */
  public UnexpandedSipServerTest.ModelBuilder toBuilder() {
    UnexpandedSipServerTest.ModelBuilder builder = new UnexpandedSipServerTest.ModelBuilder()
