 ...
 */
@JsonPropertyOrder({
  DnsTraceTestResponse.JSON_PROPERTY_INTERVAL,
  DnsTraceTestResponse.JSON_PROPERTY_ALERTS_ENABLED,
  DnsTraceTestResponse.JSON_PROPERTY_ENABLED,
  DnsTraceTestResponse.JSON_PROPERTY_ALERT_RULES,
  DnsTraceTestResponse.JSON_PROPERTY_CREATED_BY,
  DnsTraceTestResponse.JSON_PROPERTY_CREATED_DATE,
  DnsTraceTestResponse.JSON_PROPERTY_DESCRIPTION,
  DnsTraceTestResponse.JSON_PROPERTY_LIVE_SHARE,
  DnsTraceTestResponse.JSON_PROPERTY_MODIFIED_BY,
  DnsTraceTestResponse.JSON_PROPERTY_MODIFIED_DATE,
  DnsTraceTestResponse.JSON_PROPERTY_SAVED_EVENT,
  DnsTraceTestResponse.JSON_PROPERTY_TEST_ID,
  DnsTraceTestResponse.JSON_PROPERTY_TEST_NAME,
  ...
  DnsTraceTestResponse.JSON_PROPERTY_DNS_QUERY_CLASS,
  DnsTraceTestResponse.JSON_PROPERTY_RANDOMIZED_START_TIME,
  DnsTraceTestResponse.JSON_PROPERTY_AGENTS
})
@jakarta.annotation.Generated(value = "com.thousandeyes.api.codegen.ThousandeyesJavaGenerator")
public class DnsTraceTestResponse {
  ...
  public DnsTraceTestResponse() { 
  }

  public DnsTraceTestResponse interval(TestInterval interval) {
  ...
  **/
  ...
  public DnsTraceTestResponse alertsEnabled(Boolean alertsEnabled) {
  ...
  **/
  ...
  public DnsTraceTestResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public DnsTraceTestResponse alertRules(List<AlertRule> alertRules) {
    this.alertRules = alertRules;
    return this;
  }

  public DnsTraceTestResponse addAlertRulesItem(AlertRule alertRulesItem) {
  ...
  **/
  ...
  public DnsTraceTestResponse description(String description) {
  ...
  **/
  ...
  public DnsTraceTestResponse testName(String testName) {
  ...
  **/
  ...
  public DnsTraceTestResponse links(TestLinks links) {
    this.links = links;
    return this;
  }
  ...
  **/
  ...
  public DnsTraceTestResponse dnsTransportProtocol(TestDnsTransportProtocol dnsTransportProtocol) {
  ...
  **/
  ...
  public DnsTraceTestResponse domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  **/
  ...
  public DnsTraceTestResponse dnsQueryClass(DnsQueryClass dnsQueryClass) {
  ...
  **/
  ...
  public DnsTraceTestResponse randomizedStartTime(Boolean randomizedStartTime) {
  ...
  **/
  ...
  public DnsTraceTestResponse agents(List<TestAgentResponse> agents) {
    this.agents = agents;
    return this;
  }

  public DnsTraceTestResponse addAgentsItem(TestAgentResponse agentsItem) {
    if (this.agents == null) {
  ...
  **/
  ...
  /**
   * Return true if this DnsTraceTestResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DnsTraceTestResponse dnsTraceTestResponse = (DnsTraceTestResponse) o;
    return Objects.equals(this.interval, dnsTraceTestResponse.interval) &&
        Objects.equals(this.alertsEnabled, dnsTraceTestResponse.alertsEnabled) &&
        Objects.equals(this.enabled, dnsTraceTestResponse.enabled) &&
        Objects.equals(this.alertRules, dnsTraceTestResponse.alertRules) &&
        Objects.equals(this.createdBy, dnsTraceTestResponse.createdBy) &&
        Objects.equals(this.createdDate, dnsTraceTestResponse.createdDate) &&
        Objects.equals(this.description, dnsTraceTestResponse.description) &&
        Objects.equals(this.liveShare, dnsTraceTestResponse.liveShare) &&
        Objects.equals(this.modifiedBy, dnsTraceTestResponse.modifiedBy) &&
        Objects.equals(this.modifiedDate, dnsTraceTestResponse.modifiedDate) &&
        Objects.equals(this.savedEvent, dnsTraceTestResponse.savedEvent) &&
        Objects.equals(this.testId, dnsTraceTestResponse.testId) &&
        Objects.equals(this.testName, dnsTraceTestResponse.testName) &&
        ...
        Objects.equals(this.dnsQueryClass, dnsTraceTestResponse.dnsQueryClass) &&
        Objects.equals(this.randomizedStartTime, dnsTraceTestResponse.randomizedStartTime) &&
        Objects.equals(this.agents, dnsTraceTestResponse.agents);
  }
  ...
  public String toString() {
    ...
    sb.append("class DnsTraceTestResponse {\n");
  ...
  public static class ModelBuilder {
    ...
    private DnsTraceTestResponse instance;

    public ModelBuilder() {
      this(new DnsTraceTestResponse());
    }

    protected ModelBuilder(DnsTraceTestResponse instance) {
      this.instance = instance;
    }

    public DnsTraceTestResponse.ModelBuilder interval(TestInterval interval) {
      this.instance.setInterval(interval);
      return this;
    }
    public DnsTraceTestResponse.ModelBuilder alertsEnabled(Boolean alertsEnabled) {
      this.instance.setAlertsEnabled(alertsEnabled);
      return this;
    }
    public DnsTraceTestResponse.ModelBuilder enabled(Boolean enabled) {
      this.instance.setEnabled(enabled);
      return this;
    }
    public DnsTraceTestResponse.ModelBuilder alertRules(List<AlertRule> alertRules) {
      this.instance.setAlertRules(alertRules);
      return this;
    }
    public DnsTraceTestResponse.ModelBuilder createdBy(String createdBy) {
      this.instance.createdBy = createdBy;
      return this;
    }
    public DnsTraceTestResponse.ModelBuilder createdDate(OffsetDateTime createdDate) {
      this.instance.createdDate = createdDate;
      return this;
    }
    public DnsTraceTestResponse.ModelBuilder description(String description) {
      this.instance.setDescription(description);
      return this;
    }
    public DnsTraceTestResponse.ModelBuilder liveShare(Boolean liveShare) {
      this.instance.liveShare = liveShare;
      return this;
    }
    public DnsTraceTestResponse.ModelBuilder modifiedBy(String modifiedBy) {
      this.instance.modifiedBy = modifiedBy;
      return this;
    }
    public DnsTraceTestResponse.ModelBuilder modifiedDate(OffsetDateTime modifiedDate) {
      this.instance.modifiedDate = modifiedDate;
      return this;
    }
    public DnsTraceTestResponse.ModelBuilder savedEvent(Boolean savedEvent) {
      this.instance.savedEvent = savedEvent;
      return this;
    }
    public DnsTraceTestResponse.ModelBuilder testId(String testId) {
      this.instance.testId = testId;
      return this;
    }
    public DnsTraceTestResponse.ModelBuilder testName(String testName) {
      this.instance.setTestName(testName);
      return this;
    }
    public DnsTraceTestResponse.ModelBuilder type(String type) {
      this.instance.type = type;
      return this;
    }
    public DnsTraceTestResponse.ModelBuilder links(TestLinks links) {
      this.instance.setLinks(links);
      return this;
    }
    public DnsTraceTestResponse.ModelBuilder labels(List<TestLabel> labels) {
      this.instance.labels = labels;
      return this;
    }
    public DnsTraceTestResponse.ModelBuilder tags(List<TestTag> tags) {
      this.instance.tags = tags;
      return this;
    }
    public DnsTraceTestResponse.ModelBuilder sharedWithAccounts(List<SharedWithAccount> sharedWithAccounts) {
      this.instance.sharedWithAccounts = sharedWithAccounts;
      return this;
    }
    public DnsTraceTestResponse.ModelBuilder dnsTransportProtocol(TestDnsTransportProtocol dnsTransportProtocol) {
      this.instance.setDnsTransportProtocol(dnsTransportProtocol);
      return this;
    }
    public DnsTraceTestResponse.ModelBuilder domain(String domain) {
      this.instance.setDomain(domain);
      return this;
    }
    public DnsTraceTestResponse.ModelBuilder dnsQueryClass(DnsQueryClass dnsQueryClass) {
      this.instance.setDnsQueryClass(dnsQueryClass);
      return this;
    }
    public DnsTraceTestResponse.ModelBuilder randomizedStartTime(Boolean randomizedStartTime) {
      this.instance.setRandomizedStartTime(randomizedStartTime);
      return this;
    }
    public DnsTraceTestResponse.ModelBuilder agents(List<TestAgentResponse> agents) {
      this.instance.setAgents(agents);
      return this;
    }

    /**
     * Returns a built DnsTraceTestResponse instance.
     *
     * <p>The builder is not reusable.</p>
     */
    public DnsTraceTestResponse build() {
      try {
   ...
   */
  public static DnsTraceTestResponse.ModelBuilder builder() {
    return new DnsTraceTestResponse.ModelBuilder();
  }

  /**
   * Create a builder with a shallow copy of this instance.
   */
  public DnsTraceTestResponse.ModelBuilder toBuilder() {
    DnsTraceTestResponse.ModelBuilder builder = new DnsTraceTestResponse.ModelBuilder()
