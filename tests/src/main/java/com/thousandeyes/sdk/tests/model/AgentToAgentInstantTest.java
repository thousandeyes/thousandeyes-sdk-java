...
public class AgentToAgentInstantTest {
  ...
  **/
  ...
  public static class ModelBuilder {
    ...
    private AgentToAgentInstantTest instance;

    public ModelBuilder() {
      this(new AgentToAgentInstantTest());
    }

    protected ModelBuilder(AgentToAgentInstantTest instance) {
      this.instance = instance;
    }

    public AgentToAgentInstantTest.ModelBuilder createdBy(String createdBy) {
      this.instance.createdBy = createdBy;
      return this;
    }
    public AgentToAgentInstantTest.ModelBuilder createdDate(OffsetDateTime createdDate) {
      this.instance.createdDate = createdDate;
      return this;
    }
    public AgentToAgentInstantTest.ModelBuilder description(String description) {
      this.instance.setDescription(description);
      return this;
    }
    public AgentToAgentInstantTest.ModelBuilder liveShare(Boolean liveShare) {
      this.instance.liveShare = liveShare;
      return this;
    }
    public AgentToAgentInstantTest.ModelBuilder modifiedBy(String modifiedBy) {
      this.instance.modifiedBy = modifiedBy;
      return this;
    }
    public AgentToAgentInstantTest.ModelBuilder modifiedDate(OffsetDateTime modifiedDate) {
      this.instance.modifiedDate = modifiedDate;
      return this;
    }
    public AgentToAgentInstantTest.ModelBuilder savedEvent(Boolean savedEvent) {
      this.instance.savedEvent = savedEvent;
      return this;
    }
    public AgentToAgentInstantTest.ModelBuilder testId(String testId) {
      this.instance.testId = testId;
      return this;
    }
    public AgentToAgentInstantTest.ModelBuilder testName(String testName) {
      this.instance.setTestName(testName);
      return this;
    }
    public AgentToAgentInstantTest.ModelBuilder type(String type) {
      this.instance.type = type;
      return this;
    }
    public AgentToAgentInstantTest.ModelBuilder links(TestLinks links) {
      this.instance.setLinks(links);
      return this;
    }
    public AgentToAgentInstantTest.ModelBuilder labels(List<TestLabel> labels) {
      this.instance.labels = labels;
      return this;
    }
    public AgentToAgentInstantTest.ModelBuilder tags(List<TestTag> tags) {
      this.instance.tags = tags;
      return this;
    }
    public AgentToAgentInstantTest.ModelBuilder sharedWithAccounts(List<SharedWithAccount> sharedWithAccounts) {
      this.instance.sharedWithAccounts = sharedWithAccounts;
      return this;
    }
    public AgentToAgentInstantTest.ModelBuilder direction(TestDirection direction) {
      this.instance.setDirection(direction);
      return this;
    }
    public AgentToAgentInstantTest.ModelBuilder dscp(String dscp) {
      this.instance.dscp = dscp;
      return this;
    }
    public AgentToAgentInstantTest.ModelBuilder dscpId(TestDscpId dscpId) {
      this.instance.setDscpId(dscpId);
      return this;
    }
    public AgentToAgentInstantTest.ModelBuilder mss(Integer mss) {
      this.instance.setMss(mss);
      return this;
    }
    public AgentToAgentInstantTest.ModelBuilder numPathTraces(Integer numPathTraces) {
      this.instance.setNumPathTraces(numPathTraces);
      return this;
    }
    public AgentToAgentInstantTest.ModelBuilder pathTraceMode(TestPathTraceMode pathTraceMode) {
      this.instance.setPathTraceMode(pathTraceMode);
      return this;
    }
    public AgentToAgentInstantTest.ModelBuilder port(Integer port) {
      this.instance.setPort(port);
      return this;
    }
    public AgentToAgentInstantTest.ModelBuilder protocol(AgentToAgentTestProtocol protocol) {
      this.instance.setProtocol(protocol);
      return this;
    }
    public AgentToAgentInstantTest.ModelBuilder randomizedStartTime(Boolean randomizedStartTime) {
      this.instance.setRandomizedStartTime(randomizedStartTime);
      return this;
    }
    public AgentToAgentInstantTest.ModelBuilder targetAgentId(String targetAgentId) {
      this.instance.setTargetAgentId(targetAgentId);
      return this;
    }
    public AgentToAgentInstantTest.ModelBuilder throughputMeasurements(Boolean throughputMeasurements) {
      this.instance.setThroughputMeasurements(throughputMeasurements);
      return this;
    }
    public AgentToAgentInstantTest.ModelBuilder throughputDuration(Integer throughputDuration) {
      this.instance.setThroughputDuration(throughputDuration);
      return this;
    }
    public AgentToAgentInstantTest.ModelBuilder throughputRate(Integer throughputRate) {
      this.instance.setThroughputRate(throughputRate);
      return this;
    }
    public AgentToAgentInstantTest.ModelBuilder fixedPacketRate(Integer fixedPacketRate) {
      this.instance.setFixedPacketRate(fixedPacketRate);
      return this;
    }

    /**
     * Returns a built AgentToAgentInstantTest instance.
     *
     * <p>The builder is not reusable.</p>
     */
    public AgentToAgentInstantTest build() {
      try {
   ...
   */
  public static AgentToAgentInstantTest.ModelBuilder builder() {
    return new AgentToAgentInstantTest.ModelBuilder();
  }

  /**
   * Create a builder with a shallow copy of this instance.
   */
  public AgentToAgentInstantTest.ModelBuilder toBuilder() {
    AgentToAgentInstantTest.ModelBuilder builder = new AgentToAgentInstantTest.ModelBuilder()
