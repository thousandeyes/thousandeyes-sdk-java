...
public class VoiceTestsApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public VoiceTestResponse getVoiceTest(String testId, String aid, List<ExpandTestOptions> expand) throws ApiException {
    ApiResponse<VoiceTestResponse> response = getVoiceTestWithHttpInfo(testId, aid, expand);
    return response.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<VoiceTestResponse> getVoiceTestWithHttpInfo(String testId, String aid, List<ExpandTestOptions> expand) throws ApiException {
  ...
  private ApiRequest.ApiRequestBuilder getVoiceTestRequestBuilder(String testId, String aid, List<ExpandTestOptions> expand) throws ApiException {
    ApiRequest.ApiRequestBuilder requestBuilder = ApiRequest.builder()
            .method("GET");
