...
@JsonPropertyOrder({
  ...
  WebTransactionTestRequest.JSON_PROPERTY_VAULT_CREDENTIALS,
  ...
  WebTransactionTestRequest.JSON_PROPERTY_FLAG_COLLECT_CONSOLE_LOGS,
  ...
  WebTransactionTestRequest.JSON_PROPERTY_CHROMIUM_TRACK,
...
public class WebTransactionTestRequest {
  ...
  **/
  ...
  public WebTransactionTestRequest vaultCredentials(List<TestVaultCredential> vaultCredentials) {
    this.vaultCredentials = vaultCredentials;
    return this;
  }

  public WebTransactionTestRequest addVaultCredentialsItem(TestVaultCredential vaultCredentialsItem) {
  ...
  **/
  ...
  public WebTransactionTestRequest flagCollectConsoleLogs(Boolean flagCollectConsoleLogs) {
  ...
  **/
  ...
  public WebTransactionTestRequest chromiumTrack(TestChromiumTrack chromiumTrack) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.interval, webTransactionTestRequest.interval) &&
        ...
        Objects.equals(this.vaultCredentials, webTransactionTestRequest.vaultCredentials) &&
        ...
        Objects.equals(this.flagCollectConsoleLogs, webTransactionTestRequest.flagCollectConsoleLogs) &&
        ...
        Objects.equals(this.chromiumTrack, webTransactionTestRequest.chromiumTrack) &&
  ...
  public static class ModelBuilder {
    ...
    private WebTransactionTestRequest instance;

    public ModelBuilder() {
      this(new WebTransactionTestRequest());
    }

    protected ModelBuilder(WebTransactionTestRequest instance) {
      this.instance = instance;
    }

    public WebTransactionTestRequest.ModelBuilder interval(TestInterval interval) {
      this.instance.setInterval(interval);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder alertsEnabled(Boolean alertsEnabled) {
      this.instance.setAlertsEnabled(alertsEnabled);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder enabled(Boolean enabled) {
      this.instance.setEnabled(enabled);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder createdBy(String createdBy) {
      this.instance.createdBy = createdBy;
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder createdDate(OffsetDateTime createdDate) {
      this.instance.createdDate = createdDate;
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder description(String description) {
      this.instance.setDescription(description);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder liveShare(Boolean liveShare) {
      this.instance.liveShare = liveShare;
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder modifiedBy(String modifiedBy) {
      this.instance.modifiedBy = modifiedBy;
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder modifiedDate(OffsetDateTime modifiedDate) {
      this.instance.modifiedDate = modifiedDate;
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder savedEvent(Boolean savedEvent) {
      this.instance.savedEvent = savedEvent;
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder testId(String testId) {
      this.instance.testId = testId;
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder testName(String testName) {
      this.instance.setTestName(testName);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder type(String type) {
      this.instance.type = type;
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder links(TestLinks links) {
      this.instance.setLinks(links);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder authType(TestAuthType authType) {
      this.instance.setAuthType(authType);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder agentInterfaces(AgentInterfaces agentInterfaces) {
      this.instance.setAgentInterfaces(agentInterfaces);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder bandwidthMeasurements(Boolean bandwidthMeasurements) {
      this.instance.setBandwidthMeasurements(bandwidthMeasurements);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder clientCertificate(String clientCertificate) {
      this.instance.setClientCertificate(clientCertificate);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder contentRegex(String contentRegex) {
      this.instance.setContentRegex(contentRegex);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder customHeaders(TestCustomHeaders customHeaders) {
      this.instance.setCustomHeaders(customHeaders);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder desiredStatusCode(String desiredStatusCode) {
      this.instance.setDesiredStatusCode(desiredStatusCode);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder distributedTracing(Boolean distributedTracing) {
      this.instance.setDistributedTracing(distributedTracing);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder downloadLimit(Integer downloadLimit) {
      this.instance.setDownloadLimit(downloadLimit);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder dnsOverride(String dnsOverride) {
      this.instance.setDnsOverride(dnsOverride);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder httpTargetTime(Integer httpTargetTime) {
      this.instance.setHttpTargetTime(httpTargetTime);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder httpTimeLimit(Integer httpTimeLimit) {
      this.instance.setHttpTimeLimit(httpTimeLimit);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder httpVersion(Integer httpVersion) {
      this.instance.setHttpVersion(httpVersion);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder includeHeaders(Boolean includeHeaders) {
      this.instance.setIncludeHeaders(includeHeaders);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder mtuMeasurements(Boolean mtuMeasurements) {
      this.instance.setMtuMeasurements(mtuMeasurements);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder networkMeasurements(Boolean networkMeasurements) {
      this.instance.setNetworkMeasurements(networkMeasurements);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder numPathTraces(Integer numPathTraces) {
      this.instance.setNumPathTraces(numPathTraces);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder oAuth(OAuth oAuth) {
      this.instance.setoAuth(oAuth);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder password(String password) {
      this.instance.setPassword(password);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder pathTraceMode(TestPathTraceMode pathTraceMode) {
      this.instance.setPathTraceMode(pathTraceMode);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder probeMode(TestProbeMode probeMode) {
      this.instance.setProbeMode(probeMode);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder protocol(TestProtocol protocol) {
      this.instance.setProtocol(protocol);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder sslVersion(String sslVersion) {
      this.instance.sslVersion = sslVersion;
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder sslVersionId(TestSslVersionId sslVersionId) {
      this.instance.setSslVersionId(sslVersionId);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder url(String url) {
      this.instance.setUrl(url);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder useNtlm(Boolean useNtlm) {
      this.instance.setUseNtlm(useNtlm);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder userAgent(String userAgent) {
      this.instance.setUserAgent(userAgent);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder username(String username) {
      this.instance.setUsername(username);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder verifyCertificate(Boolean verifyCertificate) {
      this.instance.setVerifyCertificate(verifyCertificate);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder allowUnsafeLegacyRenegotiation(Boolean allowUnsafeLegacyRenegotiation) {
      this.instance.setAllowUnsafeLegacyRenegotiation(allowUnsafeLegacyRenegotiation);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder followRedirects(Boolean followRedirects) {
      this.instance.setFollowRedirects(followRedirects);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder fixedPacketRate(Integer fixedPacketRate) {
      this.instance.setFixedPacketRate(fixedPacketRate);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder overrideAgentProxy(Boolean overrideAgentProxy) {
      this.instance.setOverrideAgentProxy(overrideAgentProxy);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder overrideProxyId(String overrideProxyId) {
      this.instance.setOverrideProxyId(overrideProxyId);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder collectProxyNetworkData(Boolean collectProxyNetworkData) {
      this.instance.setCollectProxyNetworkData(collectProxyNetworkData);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder vaultCredentials(List<TestVaultCredential> vaultCredentials) {
      this.instance.setVaultCredentials(vaultCredentials);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder emulatedDeviceId(String emulatedDeviceId) {
      this.instance.setEmulatedDeviceId(emulatedDeviceId);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder targetTime(Integer targetTime) {
      this.instance.setTargetTime(targetTime);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder timeLimit(Integer timeLimit) {
      this.instance.setTimeLimit(timeLimit);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder transactionScript(String transactionScript) {
      this.instance.setTransactionScript(transactionScript);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder flagCollectConsoleLogs(Boolean flagCollectConsoleLogs) {
      this.instance.setFlagCollectConsoleLogs(flagCollectConsoleLogs);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder blockDomains(String blockDomains) {
      this.instance.setBlockDomains(blockDomains);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder disableScreenshot(Boolean disableScreenshot) {
      this.instance.setDisableScreenshot(disableScreenshot);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder allowMicAndCamera(Boolean allowMicAndCamera) {
      this.instance.setAllowMicAndCamera(allowMicAndCamera);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder allowGeolocation(Boolean allowGeolocation) {
      this.instance.setAllowGeolocation(allowGeolocation);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder browserLanguage(String browserLanguage) {
      this.instance.setBrowserLanguage(browserLanguage);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder chromeOptions(String chromeOptions) {
      this.instance.setChromeOptions(chromeOptions);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder chromePolicies(String chromePolicies) {
      this.instance.setChromePolicies(chromePolicies);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder chromiumTrack(TestChromiumTrack chromiumTrack) {
      this.instance.setChromiumTrack(chromiumTrack);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder pageLoadingStrategy(TestPageLoadingStrategy pageLoadingStrategy) {
      this.instance.setPageLoadingStrategy(pageLoadingStrategy);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder randomizedStartTime(Boolean randomizedStartTime) {
      this.instance.setRandomizedStartTime(randomizedStartTime);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder identifyAgentTrafficWithUserAgent(Boolean identifyAgentTrafficWithUserAgent) {
      this.instance.setIdentifyAgentTrafficWithUserAgent(identifyAgentTrafficWithUserAgent);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder subinterval(TestSubInterval subinterval) {
      this.instance.setSubinterval(subinterval);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder bgpMeasurements(Boolean bgpMeasurements) {
      this.instance.setBgpMeasurements(bgpMeasurements);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder usePublicBgp(Boolean usePublicBgp) {
      this.instance.setUsePublicBgp(usePublicBgp);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder labels(List<String> labels) {
      this.instance.setLabels(labels);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder tags(List<String> tags) {
      this.instance.setTags(tags);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder sharedWithAccounts(List<String> sharedWithAccounts) {
      this.instance.setSharedWithAccounts(sharedWithAccounts);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder alertRules(List<String> alertRules) {
      this.instance.setAlertRules(alertRules);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder agents(List<TestAgentRequest> agents) {
      this.instance.setAgents(agents);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder monitors(List<String> monitors) {
      this.instance.setMonitors(monitors);
      return this;
    }
    public WebTransactionTestRequest.ModelBuilder credentials(List<String> credentials) {
      this.instance.setCredentials(credentials);
      return this;
    }

    /**
     * Returns a built WebTransactionTestRequest instance.
     *
     * <p>The builder is not reusable.</p>
     */
    public WebTransactionTestRequest build() {
      try {
   ...
   */
  public static WebTransactionTestRequest.ModelBuilder builder() {
    return new WebTransactionTestRequest.ModelBuilder();
  }

  /**
   * Create a builder with a shallow copy of this instance.
   */
  public WebTransactionTestRequest.ModelBuilder toBuilder() {
    WebTransactionTestRequest.ModelBuilder builder = new WebTransactionTestRequest.ModelBuilder()
