...
@JsonPropertyOrder({
  ...
  AgentToAgentTest.JSON_PROPERTY_TAGS,
  ...
  AgentToAgentTest.JSON_PROPERTY_RANDOMIZED_START_TIME,
...
public class AgentToAgentTest {
  ...
  **/
  ...
  public AgentToAgentTest randomizedStartTime(Boolean randomizedStartTime) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.interval, agentToAgentTest.interval) &&
        ...
        Objects.equals(this.tags, agentToAgentTest.tags) &&
        ...
        Objects.equals(this.randomizedStartTime, agentToAgentTest.randomizedStartTime) &&
  ...
  public static class ModelBuilder {
    ...
    private AgentToAgentTest instance;

    public ModelBuilder() {
      this(new AgentToAgentTest());
    }

    protected ModelBuilder(AgentToAgentTest instance) {
      this.instance = instance;
    }

    public AgentToAgentTest.ModelBuilder interval(TestInterval interval) {
      this.instance.setInterval(interval);
      return this;
    }
    public AgentToAgentTest.ModelBuilder alertsEnabled(Boolean alertsEnabled) {
      this.instance.setAlertsEnabled(alertsEnabled);
      return this;
    }
    public AgentToAgentTest.ModelBuilder enabled(Boolean enabled) {
      this.instance.setEnabled(enabled);
      return this;
    }
    public AgentToAgentTest.ModelBuilder alertRules(List<AlertRule> alertRules) {
      this.instance.setAlertRules(alertRules);
      return this;
    }
    public AgentToAgentTest.ModelBuilder createdBy(String createdBy) {
      this.instance.createdBy = createdBy;
      return this;
    }
    public AgentToAgentTest.ModelBuilder createdDate(OffsetDateTime createdDate) {
      this.instance.createdDate = createdDate;
      return this;
    }
    public AgentToAgentTest.ModelBuilder description(String description) {
      this.instance.setDescription(description);
      return this;
    }
    public AgentToAgentTest.ModelBuilder liveShare(Boolean liveShare) {
      this.instance.liveShare = liveShare;
      return this;
    }
    public AgentToAgentTest.ModelBuilder modifiedBy(String modifiedBy) {
      this.instance.modifiedBy = modifiedBy;
      return this;
    }
    public AgentToAgentTest.ModelBuilder modifiedDate(OffsetDateTime modifiedDate) {
      this.instance.modifiedDate = modifiedDate;
      return this;
    }
    public AgentToAgentTest.ModelBuilder savedEvent(Boolean savedEvent) {
      this.instance.savedEvent = savedEvent;
      return this;
    }
    public AgentToAgentTest.ModelBuilder testId(String testId) {
      this.instance.testId = testId;
      return this;
    }
    public AgentToAgentTest.ModelBuilder testName(String testName) {
      this.instance.setTestName(testName);
      return this;
    }
    public AgentToAgentTest.ModelBuilder type(String type) {
      this.instance.type = type;
      return this;
    }
    public AgentToAgentTest.ModelBuilder links(TestLinks links) {
      this.instance.setLinks(links);
      return this;
    }
    public AgentToAgentTest.ModelBuilder labels(List<TestLabel> labels) {
      this.instance.labels = labels;
      return this;
    }
    public AgentToAgentTest.ModelBuilder tags(List<TestTag> tags) {
      this.instance.tags = tags;
      return this;
    }
    public AgentToAgentTest.ModelBuilder sharedWithAccounts(List<SharedWithAccount> sharedWithAccounts) {
      this.instance.sharedWithAccounts = sharedWithAccounts;
      return this;
    }
    public AgentToAgentTest.ModelBuilder direction(TestDirection direction) {
      this.instance.setDirection(direction);
      return this;
    }
    public AgentToAgentTest.ModelBuilder dscp(String dscp) {
      this.instance.dscp = dscp;
      return this;
    }
    public AgentToAgentTest.ModelBuilder dscpId(TestDscpId dscpId) {
      this.instance.setDscpId(dscpId);
      return this;
    }
    public AgentToAgentTest.ModelBuilder mss(Integer mss) {
      this.instance.setMss(mss);
      return this;
    }
    public AgentToAgentTest.ModelBuilder numPathTraces(Integer numPathTraces) {
      this.instance.setNumPathTraces(numPathTraces);
      return this;
    }
    public AgentToAgentTest.ModelBuilder pathTraceMode(TestPathTraceMode pathTraceMode) {
      this.instance.setPathTraceMode(pathTraceMode);
      return this;
    }
    public AgentToAgentTest.ModelBuilder port(Integer port) {
      this.instance.setPort(port);
      return this;
    }
    public AgentToAgentTest.ModelBuilder protocol(AgentToAgentTestProtocol protocol) {
      this.instance.setProtocol(protocol);
      return this;
    }
    public AgentToAgentTest.ModelBuilder randomizedStartTime(Boolean randomizedStartTime) {
      this.instance.setRandomizedStartTime(randomizedStartTime);
      return this;
    }
    public AgentToAgentTest.ModelBuilder targetAgentId(String targetAgentId) {
      this.instance.setTargetAgentId(targetAgentId);
      return this;
    }
    public AgentToAgentTest.ModelBuilder throughputMeasurements(Boolean throughputMeasurements) {
      this.instance.setThroughputMeasurements(throughputMeasurements);
      return this;
    }
    public AgentToAgentTest.ModelBuilder throughputDuration(Integer throughputDuration) {
      this.instance.setThroughputDuration(throughputDuration);
      return this;
    }
    public AgentToAgentTest.ModelBuilder throughputRate(Integer throughputRate) {
      this.instance.setThroughputRate(throughputRate);
      return this;
    }
    public AgentToAgentTest.ModelBuilder fixedPacketRate(Integer fixedPacketRate) {
      this.instance.setFixedPacketRate(fixedPacketRate);
      return this;
    }
    public AgentToAgentTest.ModelBuilder bgpMeasurements(Boolean bgpMeasurements) {
      this.instance.setBgpMeasurements(bgpMeasurements);
      return this;
    }
    public AgentToAgentTest.ModelBuilder usePublicBgp(Boolean usePublicBgp) {
      this.instance.setUsePublicBgp(usePublicBgp);
      return this;
    }
    public AgentToAgentTest.ModelBuilder monitors(List<Monitor> monitors) {
      this.instance.monitors = monitors;
      return this;
    }

    /**
     * Returns a built AgentToAgentTest instance.
     *
     * <p>The builder is not reusable.</p>
     */
    public AgentToAgentTest build() {
      try {
   ...
   */
  public static AgentToAgentTest.ModelBuilder builder() {
    return new AgentToAgentTest.ModelBuilder();
  }

  /**
   * Create a builder with a shallow copy of this instance.
   */
  public AgentToAgentTest.ModelBuilder toBuilder() {
    AgentToAgentTest.ModelBuilder builder = new AgentToAgentTest.ModelBuilder()
