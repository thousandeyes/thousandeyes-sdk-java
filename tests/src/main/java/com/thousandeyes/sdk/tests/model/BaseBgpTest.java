...
@JsonPropertyOrder({
  ...
  BaseBgpTest.JSON_PROPERTY_TAGS,
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createdBy, baseBgpTest.createdBy) &&
        ...
        Objects.equals(this.tags, baseBgpTest.tags) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createdBy, createdDate, description, liveShare, modifiedBy, modifiedDate, savedEvent, testId, testName, type, links, labels, tags, sharedWithAccounts, enabled, monitors, includeCoveredPrefixes, usePublicBgp, alertsEnabled, alertRules);
  }
  ...
  public static class ModelBuilder {
    ...
    private BaseBgpTest instance;

    public ModelBuilder() {
      this(new BaseBgpTest());
    }

    protected ModelBuilder(BaseBgpTest instance) {
      this.instance = instance;
    }

    public BaseBgpTest.ModelBuilder createdBy(String createdBy) {
      this.instance.createdBy = createdBy;
      return this;
    }
    public BaseBgpTest.ModelBuilder createdDate(OffsetDateTime createdDate) {
      this.instance.createdDate = createdDate;
      return this;
    }
    public BaseBgpTest.ModelBuilder description(String description) {
      this.instance.setDescription(description);
      return this;
    }
    public BaseBgpTest.ModelBuilder liveShare(Boolean liveShare) {
      this.instance.liveShare = liveShare;
      return this;
    }
    public BaseBgpTest.ModelBuilder modifiedBy(String modifiedBy) {
      this.instance.modifiedBy = modifiedBy;
      return this;
    }
    public BaseBgpTest.ModelBuilder modifiedDate(OffsetDateTime modifiedDate) {
      this.instance.modifiedDate = modifiedDate;
      return this;
    }
    public BaseBgpTest.ModelBuilder savedEvent(Boolean savedEvent) {
      this.instance.savedEvent = savedEvent;
      return this;
    }
    public BaseBgpTest.ModelBuilder testId(String testId) {
      this.instance.testId = testId;
      return this;
    }
    public BaseBgpTest.ModelBuilder testName(String testName) {
      this.instance.setTestName(testName);
      return this;
    }
    public BaseBgpTest.ModelBuilder type(String type) {
      this.instance.type = type;
      return this;
    }
    public BaseBgpTest.ModelBuilder links(TestLinks links) {
      this.instance.setLinks(links);
      return this;
    }
    public BaseBgpTest.ModelBuilder labels(List<TestLabel> labels) {
      this.instance.labels = labels;
      return this;
    }
    public BaseBgpTest.ModelBuilder tags(List<TestTag> tags) {
      this.instance.tags = tags;
      return this;
    }
    public BaseBgpTest.ModelBuilder sharedWithAccounts(List<SharedWithAccount> sharedWithAccounts) {
      this.instance.sharedWithAccounts = sharedWithAccounts;
      return this;
    }
    public BaseBgpTest.ModelBuilder enabled(Boolean enabled) {
      this.instance.setEnabled(enabled);
      return this;
    }
    public BaseBgpTest.ModelBuilder monitors(List<Monitor> monitors) {
      this.instance.monitors = monitors;
      return this;
    }
    public BaseBgpTest.ModelBuilder includeCoveredPrefixes(Boolean includeCoveredPrefixes) {
      this.instance.setIncludeCoveredPrefixes(includeCoveredPrefixes);
      return this;
    }
    public BaseBgpTest.ModelBuilder usePublicBgp(Boolean usePublicBgp) {
      this.instance.setUsePublicBgp(usePublicBgp);
      return this;
    }
    public BaseBgpTest.ModelBuilder alertsEnabled(Boolean alertsEnabled) {
      this.instance.setAlertsEnabled(alertsEnabled);
      return this;
    }
    public BaseBgpTest.ModelBuilder alertRules(List<AlertRule> alertRules) {
      this.instance.setAlertRules(alertRules);
      return this;
    }

    /**
     * Returns a built BaseBgpTest instance.
     *
     * <p>The builder is not reusable.</p>
     */
    public BaseBgpTest build() {
      try {
   ...
   */
  public static BaseBgpTest.ModelBuilder builder() {
    return new BaseBgpTest.ModelBuilder();
  }

  /**
   * Create a builder with a shallow copy of this instance.
   */
  public BaseBgpTest.ModelBuilder toBuilder() {
    BaseBgpTest.ModelBuilder builder = new BaseBgpTest.ModelBuilder()
