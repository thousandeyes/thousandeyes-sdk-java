...
@JsonPropertyOrder({
  ...
  HttpServerTestRequest.JSON_PROPERTY_LIVE_SHARE,
  HttpServerTestRequest.JSON_PROPERTY_MODIFIED_BY,
  HttpServerTestRequest.JSON_PROPERTY_MODIFIED_DATE,
  HttpServerTestRequest.JSON_PROPERTY_SAVED_EVENT,
  HttpServerTestRequest.JSON_PROPERTY_TEST_ID,
  ...
  HttpServerTestRequest.JSON_PROPERTY_CUSTOM_HEADERS,
  HttpServerTestRequest.JSON_PROPERTY_DESIRED_STATUS_CODE,
  HttpServerTestRequest.JSON_PROPERTY_DISTRIBUTED_TRACING,
  HttpServerTestRequest.JSON_PROPERTY_DOWNLOAD_LIMIT,
  HttpServerTestRequest.JSON_PROPERTY_DNS_OVERRIDE,
  HttpServerTestRequest.JSON_PROPERTY_HTTP_TARGET_TIME,
  HttpServerTestRequest.JSON_PROPERTY_HTTP_TIME_LIMIT,
  HttpServerTestRequest.JSON_PROPERTY_HTTP_VERSION,
  HttpServerTestRequest.JSON_PROPERTY_INCLUDE_HEADERS,
  HttpServerTestRequest.JSON_PROPERTY_MTU_MEASUREMENTS,
  HttpServerTestRequest.JSON_PROPERTY_NETWORK_MEASUREMENTS,
  HttpServerTestRequest.JSON_PROPERTY_NUM_PATH_TRACES,
  HttpServerTestRequest.JSON_PROPERTY_O_AUTH,
  HttpServerTestRequest.JSON_PROPERTY_PASSWORD,
  HttpServerTestRequest.JSON_PROPERTY_PATH_TRACE_MODE,
  HttpServerTestRequest.JSON_PROPERTY_PROBE_MODE,
  HttpServerTestRequest.JSON_PROPERTY_PROTOCOL,
  HttpServerTestRequest.JSON_PROPERTY_SSL_VERSION,
  HttpServerTestRequest.JSON_PROPERTY_SSL_VERSION_ID,
  HttpServerTestRequest.JSON_PROPERTY_URL,
  HttpServerTestRequest.JSON_PROPERTY_USE_NTLM,
  HttpServerTestRequest.JSON_PROPERTY_USER_AGENT,
  HttpServerTestRequest.JSON_PROPERTY_USERNAME,
  HttpServerTestRequest.JSON_PROPERTY_VERIFY_CERTIFICATE,
  HttpServerTestRequest.JSON_PROPERTY_ALLOW_UNSAFE_LEGACY_RENEGOTIATION,
  HttpServerTestRequest.JSON_PROPERTY_FOLLOW_REDIRECTS,
  HttpServerTestRequest.JSON_PROPERTY_FIXED_PACKET_RATE,
...
public class HttpServerTestRequest {
  ...
  **/
  ...
  public HttpServerTestRequest alertsEnabled(Boolean alertsEnabled) {
  ...
  **/
  ...
  public HttpServerTestRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public HttpServerTestRequest description(String description) {
  ...
  **/
  ...
  public HttpServerTestRequest testName(String testName) {
  ...
  **/
  ...
  public HttpServerTestRequest links(TestLinks links) {
    this.links = links;
    return this;
  }
  ...
  **/
  ...
  public HttpServerTestRequest authType(TestAuthType authType) {
  ...
  **/
  ...
  public HttpServerTestRequest bandwidthMeasurements(Boolean bandwidthMeasurements) {
  ...
  **/
  ...
  public HttpServerTestRequest clientCertificate(String clientCertificate) {
  ...
  **/
  ...
  public HttpServerTestRequest contentRegex(String contentRegex) {
  ...
  **/
  ...
  public HttpServerTestRequest customHeaders(TestCustomHeaders customHeaders) {
  ...
  **/
  ...
  public HttpServerTestRequest desiredStatusCode(String desiredStatusCode) {
  ...
  **/
  ...
  public HttpServerTestRequest distributedTracing(Boolean distributedTracing) {
  ...
  **/
  ...
  public HttpServerTestRequest downloadLimit(Integer downloadLimit) {
  ...
  **/
  ...
  public HttpServerTestRequest dnsOverride(String dnsOverride) {
  ...
  **/
  ...
  public HttpServerTestRequest httpTargetTime(Integer httpTargetTime) {
  ...
  **/
  ...
  public HttpServerTestRequest httpTimeLimit(Integer httpTimeLimit) {
  ...
  **/
  ...
  public HttpServerTestRequest httpVersion(Integer httpVersion) {
  ...
  **/
  ...
  public HttpServerTestRequest includeHeaders(Boolean includeHeaders) {
  ...
  **/
  ...
  public HttpServerTestRequest mtuMeasurements(Boolean mtuMeasurements) {
  ...
  **/
  ...
  public HttpServerTestRequest networkMeasurements(Boolean networkMeasurements) {
  ...
  **/
  ...
  public HttpServerTestRequest numPathTraces(Integer numPathTraces) {
  ...
  **/
  ...
  public HttpServerTestRequest oAuth(OAuth oAuth) {
    this.oAuth = oAuth;
    return this;
  }
  ...
  **/
  ...
  public HttpServerTestRequest password(String password) {
  ...
  **/
  ...
  public HttpServerTestRequest pathTraceMode(TestPathTraceMode pathTraceMode) {
  ...
  **/
  ...
  public HttpServerTestRequest probeMode(TestProbeMode probeMode) {
  ...
  **/
  ...
  public HttpServerTestRequest protocol(TestProtocol protocol) {
  ...
  **/
  ...
  public HttpServerTestRequest sslVersionId(TestSslVersionId sslVersionId) {
  ...
  **/
  ...
  public HttpServerTestRequest url(String url) {
    this.url = url;
    return this;
  }
  ...
  **/
  ...
  public HttpServerTestRequest useNtlm(Boolean useNtlm) {
  ...
  **/
  ...
  public HttpServerTestRequest userAgent(String userAgent) {
  ...
  **/
  ...
  public HttpServerTestRequest username(String username) {
  ...
  **/
  ...
  public HttpServerTestRequest verifyCertificate(Boolean verifyCertificate) {
  ...
  **/
  ...
  public HttpServerTestRequest allowUnsafeLegacyRenegotiation(Boolean allowUnsafeLegacyRenegotiation) {
  ...
  **/
  ...
  public HttpServerTestRequest followRedirects(Boolean followRedirects) {
  ...
  **/
  ...
  public HttpServerTestRequest fixedPacketRate(Integer fixedPacketRate) {
  ...
  **/
  ...
  public HttpServerTestRequest overrideAgentProxy(Boolean overrideAgentProxy) {
  ...
  **/
  ...
  public HttpServerTestRequest overrideProxyId(String overrideProxyId) {
  ...
  **/
  ...
  public HttpServerTestRequest collectProxyNetworkData(Boolean collectProxyNetworkData) {
  ...
  **/
  ...
  public HttpServerTestRequest addHeadersItem(String headersItem) {
  ...
  **/
  ...
  public HttpServerTestRequest ipv6Policy(TestIpv6Policy ipv6Policy) {
  ...
  **/
  ...
  public HttpServerTestRequest bgpMeasurements(Boolean bgpMeasurements) {
  ...
  **/
  ...
  public HttpServerTestRequest usePublicBgp(Boolean usePublicBgp) {
  ...
  **/
  ...
  public HttpServerTestRequest tags(List<String> tags) {
    this.tags = tags;
    return this;
  }

  public HttpServerTestRequest addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    HttpServerTestRequest httpServerTestRequest = (HttpServerTestRequest) o;
    return Objects.equals(this.interval, httpServerTestRequest.interval) &&
        ...
        Objects.equals(this.liveShare, httpServerTestRequest.liveShare) &&
        Objects.equals(this.modifiedBy, httpServerTestRequest.modifiedBy) &&
        Objects.equals(this.modifiedDate, httpServerTestRequest.modifiedDate) &&
        Objects.equals(this.savedEvent, httpServerTestRequest.savedEvent) &&
        Objects.equals(this.testId, httpServerTestRequest.testId) &&
        ...
        Objects.equals(this.customHeaders, httpServerTestRequest.customHeaders) &&
        Objects.equals(this.desiredStatusCode, httpServerTestRequest.desiredStatusCode) &&
        Objects.equals(this.distributedTracing, httpServerTestRequest.distributedTracing) &&
        Objects.equals(this.downloadLimit, httpServerTestRequest.downloadLimit) &&
        Objects.equals(this.dnsOverride, httpServerTestRequest.dnsOverride) &&
        Objects.equals(this.httpTargetTime, httpServerTestRequest.httpTargetTime) &&
        Objects.equals(this.httpTimeLimit, httpServerTestRequest.httpTimeLimit) &&
        Objects.equals(this.httpVersion, httpServerTestRequest.httpVersion) &&
        Objects.equals(this.includeHeaders, httpServerTestRequest.includeHeaders) &&
        Objects.equals(this.mtuMeasurements, httpServerTestRequest.mtuMeasurements) &&
        Objects.equals(this.networkMeasurements, httpServerTestRequest.networkMeasurements) &&
        Objects.equals(this.numPathTraces, httpServerTestRequest.numPathTraces) &&
        Objects.equals(this.oAuth, httpServerTestRequest.oAuth) &&
        Objects.equals(this.password, httpServerTestRequest.password) &&
        Objects.equals(this.pathTraceMode, httpServerTestRequest.pathTraceMode) &&
        Objects.equals(this.probeMode, httpServerTestRequest.probeMode) &&
        Objects.equals(this.protocol, httpServerTestRequest.protocol) &&
        Objects.equals(this.sslVersion, httpServerTestRequest.sslVersion) &&
        Objects.equals(this.sslVersionId, httpServerTestRequest.sslVersionId) &&
        Objects.equals(this.url, httpServerTestRequest.url) &&
        Objects.equals(this.useNtlm, httpServerTestRequest.useNtlm) &&
        Objects.equals(this.userAgent, httpServerTestRequest.userAgent) &&
        Objects.equals(this.username, httpServerTestRequest.username) &&
        Objects.equals(this.verifyCertificate, httpServerTestRequest.verifyCertificate) &&
        Objects.equals(this.allowUnsafeLegacyRenegotiation, httpServerTestRequest.allowUnsafeLegacyRenegotiation) &&
        Objects.equals(this.followRedirects, httpServerTestRequest.followRedirects) &&
        Objects.equals(this.fixedPacketRate, httpServerTestRequest.fixedPacketRate) &&
