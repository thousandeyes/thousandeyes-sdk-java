 ...
 */
@JsonPropertyOrder({
  DnsServerRequestProperties.JSON_PROPERTY_BANDWIDTH_MEASUREMENTS,
  DnsServerRequestProperties.JSON_PROPERTY_DNS_SERVERS,
  DnsServerRequestProperties.JSON_PROPERTY_DNS_TRANSPORT_PROTOCOL,
  DnsServerRequestProperties.JSON_PROPERTY_DOMAIN,
  DnsServerRequestProperties.JSON_PROPERTY_MTU_MEASUREMENTS,
  DnsServerRequestProperties.JSON_PROPERTY_NETWORK_MEASUREMENTS,
  DnsServerRequestProperties.JSON_PROPERTY_NUM_PATH_TRACES,
  DnsServerRequestProperties.JSON_PROPERTY_PATH_TRACE_MODE,
  DnsServerRequestProperties.JSON_PROPERTY_PROBE_MODE,
  DnsServerRequestProperties.JSON_PROPERTY_PROTOCOL,
  DnsServerRequestProperties.JSON_PROPERTY_RANDOMIZED_START_TIME,
  DnsServerRequestProperties.JSON_PROPERTY_RECURSIVE_QUERIES,
  DnsServerRequestProperties.JSON_PROPERTY_IPV6_POLICY,
  DnsServerRequestProperties.JSON_PROPERTY_FIXED_PACKET_RATE,
  DnsServerRequestProperties.JSON_PROPERTY_DNS_QUERY_CLASS,
  DnsServerRequestProperties.JSON_PROPERTY_TYPE
})
@jakarta.annotation.Generated(value = "com.thousandeyes.api.codegen.ThousandeyesJavaGenerator")
public class DnsServerRequestProperties {
  ...
  public DnsServerRequestProperties() { 
  }

  public DnsServerRequestProperties bandwidthMeasurements(Boolean bandwidthMeasurements) {
  ...
  **/
  ...
  public DnsServerRequestProperties dnsServers(List<String> dnsServers) {
    this.dnsServers = dnsServers;
    return this;
  }

  public DnsServerRequestProperties addDnsServersItem(String dnsServersItem) {
  ...
  **/
  ...
  public DnsServerRequestProperties dnsTransportProtocol(TestDnsTransportProtocol dnsTransportProtocol) {
  ...
  **/
  ...
  public DnsServerRequestProperties domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  **/
  ...
  public DnsServerRequestProperties mtuMeasurements(Boolean mtuMeasurements) {
  ...
  **/
  ...
  public DnsServerRequestProperties networkMeasurements(Boolean networkMeasurements) {
  ...
  **/
  ...
  public DnsServerRequestProperties numPathTraces(Integer numPathTraces) {
  ...
  **/
  ...
  public DnsServerRequestProperties pathTraceMode(TestPathTraceMode pathTraceMode) {
  ...
  **/
  ...
  public DnsServerRequestProperties probeMode(TestProbeMode probeMode) {
  ...
  **/
  ...
  public DnsServerRequestProperties protocol(TestProtocol protocol) {
  ...
  **/
  ...
  public DnsServerRequestProperties randomizedStartTime(Boolean randomizedStartTime) {
  ...
  **/
  ...
  public DnsServerRequestProperties recursiveQueries(Boolean recursiveQueries) {
  ...
  **/
  ...
  public DnsServerRequestProperties ipv6Policy(TestIpv6Policy ipv6Policy) {
  ...
  **/
  ...
  public DnsServerRequestProperties fixedPacketRate(Integer fixedPacketRate) {
  ...
  **/
  ...
  public DnsServerRequestProperties dnsQueryClass(DnsQueryClass dnsQueryClass) {
  ...
  **/
  ...
  /**
   * Return true if this DnsServerRequestProperties object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DnsServerRequestProperties dnsServerRequestProperties = (DnsServerRequestProperties) o;
    return Objects.equals(this.bandwidthMeasurements, dnsServerRequestProperties.bandwidthMeasurements) &&
        Objects.equals(this.dnsServers, dnsServerRequestProperties.dnsServers) &&
        Objects.equals(this.dnsTransportProtocol, dnsServerRequestProperties.dnsTransportProtocol) &&
        Objects.equals(this.domain, dnsServerRequestProperties.domain) &&
        Objects.equals(this.mtuMeasurements, dnsServerRequestProperties.mtuMeasurements) &&
        Objects.equals(this.networkMeasurements, dnsServerRequestProperties.networkMeasurements) &&
        Objects.equals(this.numPathTraces, dnsServerRequestProperties.numPathTraces) &&
        Objects.equals(this.pathTraceMode, dnsServerRequestProperties.pathTraceMode) &&
        Objects.equals(this.probeMode, dnsServerRequestProperties.probeMode) &&
        Objects.equals(this.protocol, dnsServerRequestProperties.protocol) &&
        Objects.equals(this.randomizedStartTime, dnsServerRequestProperties.randomizedStartTime) &&
        Objects.equals(this.recursiveQueries, dnsServerRequestProperties.recursiveQueries) &&
        Objects.equals(this.ipv6Policy, dnsServerRequestProperties.ipv6Policy) &&
        Objects.equals(this.fixedPacketRate, dnsServerRequestProperties.fixedPacketRate) &&
        Objects.equals(this.dnsQueryClass, dnsServerRequestProperties.dnsQueryClass) &&
        Objects.equals(this.type, dnsServerRequestProperties.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class DnsServerRequestProperties {\n");
  ...
  public static class ModelBuilder {
    ...
    private DnsServerRequestProperties instance;

    public ModelBuilder() {
      this(new DnsServerRequestProperties());
    }

    protected ModelBuilder(DnsServerRequestProperties instance) {
      this.instance = instance;
    }

    public DnsServerRequestProperties.ModelBuilder bandwidthMeasurements(Boolean bandwidthMeasurements) {
      this.instance.setBandwidthMeasurements(bandwidthMeasurements);
      return this;
    }
    public DnsServerRequestProperties.ModelBuilder dnsServers(List<String> dnsServers) {
      this.instance.setDnsServers(dnsServers);
      return this;
    }
    public DnsServerRequestProperties.ModelBuilder dnsTransportProtocol(TestDnsTransportProtocol dnsTransportProtocol) {
      this.instance.setDnsTransportProtocol(dnsTransportProtocol);
      return this;
    }
    public DnsServerRequestProperties.ModelBuilder domain(String domain) {
      this.instance.setDomain(domain);
      return this;
    }
    public DnsServerRequestProperties.ModelBuilder mtuMeasurements(Boolean mtuMeasurements) {
      this.instance.setMtuMeasurements(mtuMeasurements);
      return this;
    }
    public DnsServerRequestProperties.ModelBuilder networkMeasurements(Boolean networkMeasurements) {
      this.instance.setNetworkMeasurements(networkMeasurements);
      return this;
    }
    public DnsServerRequestProperties.ModelBuilder numPathTraces(Integer numPathTraces) {
      this.instance.setNumPathTraces(numPathTraces);
      return this;
    }
    public DnsServerRequestProperties.ModelBuilder pathTraceMode(TestPathTraceMode pathTraceMode) {
      this.instance.setPathTraceMode(pathTraceMode);
      return this;
    }
    public DnsServerRequestProperties.ModelBuilder probeMode(TestProbeMode probeMode) {
      this.instance.setProbeMode(probeMode);
      return this;
    }
    public DnsServerRequestProperties.ModelBuilder protocol(TestProtocol protocol) {
      this.instance.setProtocol(protocol);
      return this;
    }
    public DnsServerRequestProperties.ModelBuilder randomizedStartTime(Boolean randomizedStartTime) {
      this.instance.setRandomizedStartTime(randomizedStartTime);
      return this;
    }
    public DnsServerRequestProperties.ModelBuilder recursiveQueries(Boolean recursiveQueries) {
      this.instance.setRecursiveQueries(recursiveQueries);
      return this;
    }
    public DnsServerRequestProperties.ModelBuilder ipv6Policy(TestIpv6Policy ipv6Policy) {
      this.instance.setIpv6Policy(ipv6Policy);
      return this;
    }
    public DnsServerRequestProperties.ModelBuilder fixedPacketRate(Integer fixedPacketRate) {
      this.instance.setFixedPacketRate(fixedPacketRate);
      return this;
    }
    public DnsServerRequestProperties.ModelBuilder dnsQueryClass(DnsQueryClass dnsQueryClass) {
      this.instance.setDnsQueryClass(dnsQueryClass);
      return this;
    }
    public DnsServerRequestProperties.ModelBuilder type(String type) {
      this.instance.type = type;
      return this;
    }

    /**
     * Returns a built DnsServerRequestProperties instance.
     *
     * <p>The builder is not reusable.</p>
     */
    public DnsServerRequestProperties build() {
      try {
   ...
   */
  public static DnsServerRequestProperties.ModelBuilder builder() {
    return new DnsServerRequestProperties.ModelBuilder();
  }

  /**
   * Create a builder with a shallow copy of this instance.
   */
  public DnsServerRequestProperties.ModelBuilder toBuilder() {
    DnsServerRequestProperties.ModelBuilder builder = new DnsServerRequestProperties.ModelBuilder()
