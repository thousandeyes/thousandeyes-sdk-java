# thousandeyes-java-sdk-alerts

Alerts API
- API version: 7.0.0
  - Build date: 2023-12-20T14:43:29.716346Z[Europe/Lisbon]
...
<dependency>
  ...
  <artifactId>thousandeyes-java-sdk-alerts</artifactId>
...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'thousandeyes-java-sdk-alerts' jar has been published to maven central.
    mavenLocal()       // Needed if the 'thousandeyes-java-sdk-alerts' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "org.openapitools:thousandeyes-java-sdk-alerts:7.0.0"
  }
```
...
* `target/thousandeyes-java-sdk-alerts-7.0.0.jar`
* `target/lib/*.jar`
