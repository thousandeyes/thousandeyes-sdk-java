...
public class CompleteAlertSuppressionWindow {
  ...
  * @throws IOException if the JSON Element is invalid with respect to CompleteAlertSuppressionWindow
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CompleteAlertSuppressionWindow.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CompleteAlertSuppressionWindow is not found in the empty JSON string", CompleteAlertSuppressionWindow.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CompleteAlertSuppressionWindow.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CompleteAlertSuppressionWindow` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CompleteAlertSuppressionWindow.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CompleteAlertSuppressionWindow' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CompleteAlertSuppressionWindow> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CompleteAlertSuppressionWindow.class));

       return (TypeAdapter<T>) new TypeAdapter<CompleteAlertSuppressionWindow>() {
           @Override
           public void write(JsonWriter out, CompleteAlertSuppressionWindow value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CompleteAlertSuppressionWindow read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CompleteAlertSuppressionWindow given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CompleteAlertSuppressionWindow
  * @throws IOException if the JSON string is invalid with respect to CompleteAlertSuppressionWindow
  */
  public static CompleteAlertSuppressionWindow fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CompleteAlertSuppressionWindow.class);
  }

 /**
  * Convert an instance of CompleteAlertSuppressionWindow to an JSON string
  *
  * @return JSON string
  */
