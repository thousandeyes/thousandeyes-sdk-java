...
import com.thousandeyes.api.alerts.model.DaysOfWeek;
import com.thousandeyes.api.alerts.model.IntervalType;
import com.thousandeyes.api.alerts.model.RepeatType;
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("type") != null && !jsonObj.get("type").isJsonNull()) {
        RepeatType.validateJsonElement(jsonObj.get("type"));
      }
      // validate the optional field `intervalType`
      if (jsonObj.get("intervalType") != null && !jsonObj.get("intervalType").isJsonNull()) {
        IntervalType.validateJsonElement(jsonObj.get("intervalType"));
      }
