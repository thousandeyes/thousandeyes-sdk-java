  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("alertState") != null && !jsonObj.get("alertState").isJsonNull()) {
        State.validateJsonElement(jsonObj.get("alertState"));
      }
      // validate the optional field `alertSeverity`
      if (jsonObj.get("alertSeverity") != null && !jsonObj.get("alertSeverity").isJsonNull()) {
        Severity.validateJsonElement(jsonObj.get("alertSeverity"));
      }
  }
