...
public class AlertSuppressionWindowRequest {
  ...
  * @throws IOException if the JSON Element is invalid with respect to AlertSuppressionWindowRequest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AlertSuppressionWindowRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AlertSuppressionWindowRequest is not found in the empty JSON string", AlertSuppressionWindowRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AlertSuppressionWindowRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AlertSuppressionWindowRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AlertSuppressionWindowRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AlertSuppressionWindowRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AlertSuppressionWindowRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AlertSuppressionWindowRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AlertSuppressionWindowRequest>() {
           @Override
           public void write(JsonWriter out, AlertSuppressionWindowRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AlertSuppressionWindowRequest read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of AlertSuppressionWindowRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AlertSuppressionWindowRequest
  * @throws IOException if the JSON string is invalid with respect to AlertSuppressionWindowRequest
  */
  public static AlertSuppressionWindowRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AlertSuppressionWindowRequest.class);
  }

 /**
  * Convert an instance of AlertSuppressionWindowRequest to an JSON string
  *
  * @return JSON string
  */
