...
public class EndpointHttpServerTestRequest {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(agentSelectorType, agents, endpointAgentLabels, maxMachines, port, testName, authType, hasPathTraceInSession, httpTimeLimit, protocol, url, username, sslVersionId, tcpProbeMode, verifyCertificate, hasPing, hasTraceroute, networkMeasurements, targetResponseTime, password, interval);
  }
