...
public class EndpointHttpServerTestRequest {
  ...
  **/
  ...
  public EndpointHttpServerTestRequest port(Integer port) {
   ...
   /**
   * **(Deprecated)** The port number to use for the test. It&#39;s recommended to specify the port directly in the &#x60;url&#x60; field instead. If this field is set, it will override the default protocol ports (HTTP: 80, HTTPS: 443) and any port specified in the &#x60;url&#x60;. 
   * @return port
   * @deprecated
  **/
  @Deprecated
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(agentSelectorType, agents, endpointAgentLabels, maxMachines, testName, authType, hasPathTraceInSession, httpTimeLimit, protocol, username, sslVersionId, tcpProbeMode, verifyCertificate, url, hasPing, hasTraceroute, networkMeasurements, targetResponseTime, password, port, interval);
  }
