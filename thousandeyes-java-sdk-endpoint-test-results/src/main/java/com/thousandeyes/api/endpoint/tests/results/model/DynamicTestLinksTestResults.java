...
public class DynamicTestLinksTestResults extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(DynamicTestLinksTestResults.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!DynamicTestLinksTestResults.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'DynamicTestLinksTestResults' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<DynamicTestLinksTestResults>() {
                @Override
                public void write(JsonWriter out, DynamicTestLinksTestResults value) throws IOException {
                ...
                @Override
                public DynamicTestLinksTestResults read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        DynamicTestLinksTestResults ret = new DynamicTestLinksTestResults();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for DynamicTestLinksTestResults: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public DynamicTestLinksTestResults() {
        super("oneOf", Boolean.FALSE);
    }

    public DynamicTestLinksTestResults(Link o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DynamicTestLinksTestResults(List<Link> o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return DynamicTestLinksTestResults.schemas;
    }
  ...
  * @throws IOException if the JSON Element is invalid with respect to DynamicTestLinksTestResults
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for DynamicTestLinksTestResults with oneOf schemas: Link, List<Link>. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
    }
  }

 /**
  * Create an instance of DynamicTestLinksTestResults given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DynamicTestLinksTestResults
  * @throws IOException if the JSON string is invalid with respect to DynamicTestLinksTestResults
  */
  public static DynamicTestLinksTestResults fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DynamicTestLinksTestResults.class);
  }

 /**
  * Convert an instance of DynamicTestLinksTestResults to an JSON string
  *
  * @return JSON string
  */
