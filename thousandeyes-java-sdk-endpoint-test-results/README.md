# thousandeyes-java-sdk-endpoint-test-results

Endpoint Test Results API
- API version: 7.0.0
  - Build date: 2023-12-20T14:43:32.305594Z[Europe/Lisbon]
...
<dependency>
  ...
  <artifactId>thousandeyes-java-sdk-endpoint-test-results</artifactId>
...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'thousandeyes-java-sdk-endpoint-test-results' jar has been published to maven central.
    mavenLocal()       // Needed if the 'thousandeyes-java-sdk-endpoint-test-results' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "org.openapitools:thousandeyes-java-sdk-endpoint-test-results:7.0.0"
  }
```
...
* `target/thousandeyes-java-sdk-endpoint-test-results-7.0.0.jar`
* `target/lib/*.jar`
...
## Documentation for Models
 ...
 - [DynamicTestHasPathTraceInSession](docs/DynamicTestHasPathTraceInSession.md)
 - [DynamicTestIsEnabled](docs/DynamicTestIsEnabled.md)
 ...
 - [DynamicTestNetworkMeasurements](docs/DynamicTestNetworkMeasurements.md)
 - [DynamicTestTcpProbeMode](docs/DynamicTestTcpProbeMode.md)
