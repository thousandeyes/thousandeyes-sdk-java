...
> FtpServerInstantTestResponse createFtpServerInstantTest(CreateFtpServerInstantTestRequest)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            FtpServerInstantTestsApi.CreateFtpServerInstantTestRequest request = FtpServerInstantTestsApi.CreateFtpServerInstantTestRequest.builder()
                .ftpServerInstantTestRequest(ftpServerInstantTestRequest)
                .aid(aid)
                .expand(expand)
                .build();
            FtpServerInstantTestResponse result = apiInstance.createFtpServerInstantTest(request);
...
|------------- | ------------- | ------------- | -------------|
| request | [**CreateFtpServerInstantTestRequest**](FtpServerInstantTestsApi.md#CreateFtpServerInstantTestRequest)|-|-|
...
> ApiResponse<FtpServerInstantTestResponse> createFtpServerInstantTest createFtpServerInstantTestWithHttpInfo(CreateFtpServerInstantTestRequest)
    ...
    public static void main(String[] args) {
        ...
        try {
            FtpServerInstantTestsApi.CreateFtpServerInstantTestRequest request = FtpServerInstantTestsApi.CreateFtpServerInstantTestRequest.builder()
                ...
                .expand(expand)
                .build();
            ApiResponse<FtpServerInstantTestResponse> response = apiInstance.createFtpServerInstantTestWithHttpInfo(request);
...
<a id="CreateFtpServerInstantTestRequest"></a>
## CreateFtpServerInstantTestRequest
### Properties
