...
| [**createDnsTraceInstantTestWithHttpInfo**](DnsTraceInstantTestsApi.md#createDnsTraceInstantTestWithHttpInfo) | **POST** /tests/dns-trace/instant | Create DNS trace instant test |



## createDnsTraceInstantTest

> DnsTraceInstantTestResponse createDnsTraceInstantTest(CreateDnsTraceInstantTestRequest)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            DnsTraceInstantTestsApi.CreateDnsTraceInstantTestRequest request = DnsTraceInstantTestsApi.CreateDnsTraceInstantTestRequest.builder()
                .dnsTraceInstantTestRequest(dnsTraceInstantTestRequest)
                .aid(aid)
                .expand(expand)
                .build();
            DnsTraceInstantTestResponse result = apiInstance.createDnsTraceInstantTest(request);
...
|------------- | ------------- | ------------- | -------------|
| request | [**CreateDnsTraceInstantTestRequest**](DnsTraceInstantTestsApi.md#CreateDnsTraceInstantTestRequest)|-|-|
...
> ApiResponse<DnsTraceInstantTestResponse> createDnsTraceInstantTest createDnsTraceInstantTestWithHttpInfo(CreateDnsTraceInstantTestRequest)
    ...
    public static void main(String[] args) {
        ...
        try {
            DnsTraceInstantTestsApi.CreateDnsTraceInstantTestRequest request = DnsTraceInstantTestsApi.CreateDnsTraceInstantTestRequest.builder()
                ...
                .expand(expand)
                .build();
            ApiResponse<DnsTraceInstantTestResponse> response = apiInstance.createDnsTraceInstantTestWithHttpInfo(request);
...
ApiResponse<[**DnsTraceInstantTestResponse**](DnsTraceInstantTestResponse.md)>
...
<a id="CreateDnsTraceInstantTestRequest"></a>
## CreateDnsTraceInstantTestRequest
### Properties
