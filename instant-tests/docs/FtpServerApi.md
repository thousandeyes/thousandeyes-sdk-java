...
|------------- | ------------- | -------------|
| [**createFtpServerInstantTest**](FtpServerApi.md#createFtpServerInstantTest) | **POST** /tests/ftp-server/instant | Create FTP server instant test |
| [**createFtpServerInstantTestWithHttpInfo**](FtpServerApi.md#createFtpServerInstantTestWithHttpInfo) | **POST** /tests/ftp-server/instant | Create FTP server instant test |
...
import com.thousandeyes.sdk.tests.instant.FtpServerApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        ServerInstantTestRequest serverInstantTestRequest = new ServerInstantTestRequest(); // ServerInstantTestRequest | 
...
|------------- | ------------- | ------------- | -------------|
| **serverInstantTestRequest** | [**ServerInstantTestRequest**](ServerInstantTestRequest.md)|  | |
...
ApiResponse<[**FtpServerInstantTest**](FtpServerInstantTest.md)>
