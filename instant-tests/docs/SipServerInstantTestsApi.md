...
| [**createSipServerInstantTestWithHttpInfo**](SipServerInstantTestsApi.md#createSipServerInstantTestWithHttpInfo) | **POST** /tests/sip-server/instant | Create SIP server instant test |
...
public class Example {
    public static void main(String[] args) {
        ...
        SipServerInstantTestsApi apiInstance = new SipServerInstantTestsApi(defaultClient);
