...
| [**runInstantTestWithHttpInfo**](InstantTestsApi.md#runInstantTestWithHttpInfo) | **POST** /tests/{testId}/run | Run instant test |
...
public class Example {
    public static void main(String[] args) {
        ...
        InstantTestsApi apiInstance = new InstantTestsApi(defaultClient);
