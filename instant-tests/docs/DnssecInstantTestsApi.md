...
> DnsSecInstantTestResponse createDnsSecInstantTest(CreateDnsSecInstantTestRequest)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            DnssecInstantTestsApi.CreateDnsSecInstantTestRequest request = DnssecInstantTestsApi.CreateDnsSecInstantTestRequest.builder()
                .dnsSecInstantTestRequest(dnsSecInstantTestRequest)
                .aid(aid)
                .expand(expand)
                .build();
            DnsSecInstantTestResponse result = apiInstance.createDnsSecInstantTest(request);
...
|------------- | ------------- | ------------- | -------------|
| request | [**CreateDnsSecInstantTestRequest**](DnssecInstantTestsApi.md#CreateDnsSecInstantTestRequest)|-|-|
...
> ApiResponse<DnsSecInstantTestResponse> createDnsSecInstantTest createDnsSecInstantTestWithHttpInfo(CreateDnsSecInstantTestRequest)
    ...
    public static void main(String[] args) {
        ...
        try {
            DnssecInstantTestsApi.CreateDnsSecInstantTestRequest request = DnssecInstantTestsApi.CreateDnsSecInstantTestRequest.builder()
                ...
                .expand(expand)
                .build();
            ApiResponse<DnsSecInstantTestResponse> response = apiInstance.createDnsSecInstantTestWithHttpInfo(request);
...
<a id="CreateDnsSecInstantTestRequest"></a>
## CreateDnsSecInstantTestRequest
### Properties
