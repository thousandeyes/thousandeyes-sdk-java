...
/**
 * Request and Response model deserialization tests for HttpServerInstantTestsApi
 */
@WireMockTest
public class HttpServerInstantTestsApiTest {
    private static final String TOKEN = "valid-token";
    private static final String BEARER_TOKEN = "Bearer %s".formatted(TOKEN);
    private static HttpServerInstantTestsApi api;
    ...
    public static void setup(WireMockRuntimeInfo wireMockRuntimeInfo) {
        ApiClient client = NativeApiClient.builder()
                                ...
                                .bearerToken(TOKEN)
                                .build();
        api = new HttpServerInstantTestsApi(client);
    }
            ...
            throws JsonProcessingException, ApiException
    {
        ...
        HttpServerInstantTestResponse mappedResponse = 
                mapper.readValue(responseBodyJson, HttpServerInstantTestResponse.class);
        assertNotNull(mappedResponse);

        var path = "/tests/http-server/instant";
