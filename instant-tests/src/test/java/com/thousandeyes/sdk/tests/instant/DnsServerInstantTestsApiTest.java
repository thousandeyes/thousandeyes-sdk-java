...
/**
 * Request and Response model deserialization tests for DnsServerInstantTestsApi
 */
@WireMockTest
public class DnsServerInstantTestsApiTest {
    private static final String TOKEN = "valid-token";
    private static final String BEARER_TOKEN = "Bearer %s".formatted(TOKEN);
    private static DnsServerInstantTestsApi api;
    ...
    public static void setup(WireMockRuntimeInfo wireMockRuntimeInfo) {
        ApiClient client = NativeApiClient.builder()
                                ...
                                .bearerToken(TOKEN)
                                .build();
        api = new DnsServerInstantTestsApi(client);
    }
            ...
            throws JsonProcessingException, ApiException
    {
        ...
        DnsServerInstantTestResponse mappedResponse = 
                mapper.readValue(responseBodyJson, DnsServerInstantTestResponse.class);
        assertNotNull(mappedResponse);

        var path = "/tests/dns-server/instant";
