...
/**
 * Request and Response model deserialization tests for DnsTraceInstantTestsApi
 */
@WireMockTest
public class DnsTraceInstantTestsApiTest {
    private static final String TOKEN = "valid-token";
    private static final String BEARER_TOKEN = "Bearer %s".formatted(TOKEN);
    private static DnsTraceInstantTestsApi api;
    ...
    public static void setup(WireMockRuntimeInfo wireMockRuntimeInfo) {
        ApiClient client = NativeApiClient.builder()
                                ...
                                .bearerToken(TOKEN)
                                .build();
        api = new DnsTraceInstantTestsApi(client);
    }
            ...
            throws JsonProcessingException, ApiException
    {
        ...
        DnsTraceInstantTestResponse mappedResponse = 
                mapper.readValue(responseBodyJson, DnsTraceInstantTestResponse.class);
        assertNotNull(mappedResponse);

        var path = "/tests/dns-trace/instant";
