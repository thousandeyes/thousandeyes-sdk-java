...
public class FtpServerInstantTestsApi {
  private final ApiClient apiClient;

  public FtpServerInstantTestsApi(ApiClient apiClient) {
  ...
  private void createFtpServerInstantTestValidateRequest(FtpServerInstantTestRequest ftpServerInstantTestRequest) throws ApiException {
      // verify the required parameter 'ftpServerInstantTestRequest' is set
      if (ftpServerInstantTestRequest == null) {
        throw new ApiException(400, "Missing the required parameter 'ftpServerInstantTestRequest' when calling createFtpServerInstantTest");
      }
  }
