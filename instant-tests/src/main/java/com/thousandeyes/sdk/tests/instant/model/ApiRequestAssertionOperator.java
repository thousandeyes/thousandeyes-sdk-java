...
public enum ApiRequestAssertionOperator {
  ...
  ApiRequestAssertionOperator(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static ApiRequestAssertionOperator fromValue(String value) {
    for (ApiRequestAssertionOperator b : ApiRequestAssertionOperator.values()) {
