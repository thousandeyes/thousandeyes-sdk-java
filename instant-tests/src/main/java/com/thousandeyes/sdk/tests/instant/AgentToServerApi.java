...
import com.thousandeyes.sdk.tests.instant.model.AgentToServerInstantTest;
...
public class AgentToServerApi {
   ...
   */
  public AgentToServerInstantTest createAgentToServerInstantTest(AgentToServerInstantTestRequest agentToServerInstantTestRequest, String aid, List<Expand> expand) throws ApiException {
    ApiResponse<AgentToServerInstantTest> response = createAgentToServerInstantTestWithHttpInfo(agentToServerInstantTestRequest, aid, expand);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<AgentToServerInstantTest> createAgentToServerInstantTestWithHttpInfo(AgentToServerInstantTestRequest agentToServerInstantTestRequest, String aid, List<Expand> expand) throws ApiException {
  ...
  private void createAgentToServerInstantTestValidateRequest(AgentToServerInstantTestRequest agentToServerInstantTestRequest) throws ApiException {
      // verify the required parameter 'agentToServerInstantTestRequest' is set
      if (agentToServerInstantTestRequest == null) {
        throw new ApiException(400, "Missing the required parameter 'agentToServerInstantTestRequest' when calling createAgentToServerInstantTest");
      }
  }

  private ApiRequest.ApiRequestBuilder createAgentToServerInstantTestRequestBuilder(AgentToServerInstantTestRequest agentToServerInstantTestRequest, String aid, List<Expand> expand) throws ApiException {
