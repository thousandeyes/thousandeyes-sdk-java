...
@JsonPropertyOrder({
  ...
  DnsServerInstantTestRequest.JSON_PROPERTY_RANDOMIZED_START_TIME,
...
public class DnsServerInstantTestRequest {
  ...
  **/
  ...
  public DnsServerInstantTestRequest randomizedStartTime(Boolean randomizedStartTime) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createdBy, dnsServerInstantTestRequest.createdBy) &&
        ...
        Objects.equals(this.randomizedStartTime, dnsServerInstantTestRequest.randomizedStartTime) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createdBy, createdDate, description, liveShare, modifiedBy, modifiedDate, savedEvent, testId, testName, type, links, bandwidthMeasurements, dnsServers, dnsTransportProtocol, domain, mtuMeasurements, networkMeasurements, numPathTraces, pathTraceMode, probeMode, protocol, randomizedStartTime, recursiveQueries, ipv6Policy, fixedPacketRate, dnsQueryClass, labels, tags, sharedWithAccounts, agents);
  }
  ...
  public static class ModelBuilder {
    ...
    private DnsServerInstantTestRequest instance;

    public ModelBuilder() {
      this(new DnsServerInstantTestRequest());
    }

    protected ModelBuilder(DnsServerInstantTestRequest instance) {
      this.instance = instance;
    }

    public DnsServerInstantTestRequest.ModelBuilder createdBy(String createdBy) {
      this.instance.createdBy = createdBy;
      return this;
    }
    public DnsServerInstantTestRequest.ModelBuilder createdDate(OffsetDateTime createdDate) {
      this.instance.createdDate = createdDate;
      return this;
    }
    public DnsServerInstantTestRequest.ModelBuilder description(String description) {
      this.instance.setDescription(description);
      return this;
    }
    public DnsServerInstantTestRequest.ModelBuilder liveShare(Boolean liveShare) {
      this.instance.liveShare = liveShare;
      return this;
    }
    public DnsServerInstantTestRequest.ModelBuilder modifiedBy(String modifiedBy) {
      this.instance.modifiedBy = modifiedBy;
      return this;
    }
    public DnsServerInstantTestRequest.ModelBuilder modifiedDate(OffsetDateTime modifiedDate) {
      this.instance.modifiedDate = modifiedDate;
      return this;
    }
    public DnsServerInstantTestRequest.ModelBuilder savedEvent(Boolean savedEvent) {
      this.instance.savedEvent = savedEvent;
      return this;
    }
    public DnsServerInstantTestRequest.ModelBuilder testId(String testId) {
      this.instance.testId = testId;
      return this;
    }
    public DnsServerInstantTestRequest.ModelBuilder testName(String testName) {
      this.instance.setTestName(testName);
      return this;
    }
    public DnsServerInstantTestRequest.ModelBuilder type(String type) {
      this.instance.type = type;
      return this;
    }
    public DnsServerInstantTestRequest.ModelBuilder links(TestLinks links) {
      this.instance.setLinks(links);
      return this;
    }
    public DnsServerInstantTestRequest.ModelBuilder bandwidthMeasurements(Boolean bandwidthMeasurements) {
      this.instance.setBandwidthMeasurements(bandwidthMeasurements);
      return this;
    }
    public DnsServerInstantTestRequest.ModelBuilder dnsServers(List<String> dnsServers) {
      this.instance.setDnsServers(dnsServers);
      return this;
    }
    public DnsServerInstantTestRequest.ModelBuilder dnsTransportProtocol(TestDnsTransportProtocol dnsTransportProtocol) {
      this.instance.setDnsTransportProtocol(dnsTransportProtocol);
      return this;
    }
    public DnsServerInstantTestRequest.ModelBuilder domain(String domain) {
      this.instance.setDomain(domain);
      return this;
    }
    public DnsServerInstantTestRequest.ModelBuilder mtuMeasurements(Boolean mtuMeasurements) {
      this.instance.setMtuMeasurements(mtuMeasurements);
      return this;
    }
    public DnsServerInstantTestRequest.ModelBuilder networkMeasurements(Boolean networkMeasurements) {
      this.instance.setNetworkMeasurements(networkMeasurements);
      return this;
    }
    public DnsServerInstantTestRequest.ModelBuilder numPathTraces(Integer numPathTraces) {
      this.instance.setNumPathTraces(numPathTraces);
      return this;
    }
    public DnsServerInstantTestRequest.ModelBuilder pathTraceMode(TestPathTraceMode pathTraceMode) {
      this.instance.setPathTraceMode(pathTraceMode);
      return this;
    }
    public DnsServerInstantTestRequest.ModelBuilder probeMode(TestProbeMode probeMode) {
      this.instance.setProbeMode(probeMode);
      return this;
    }
    public DnsServerInstantTestRequest.ModelBuilder protocol(TestProtocol protocol) {
      this.instance.setProtocol(protocol);
      return this;
    }
    public DnsServerInstantTestRequest.ModelBuilder randomizedStartTime(Boolean randomizedStartTime) {
      this.instance.setRandomizedStartTime(randomizedStartTime);
      return this;
    }
    public DnsServerInstantTestRequest.ModelBuilder recursiveQueries(Boolean recursiveQueries) {
      this.instance.setRecursiveQueries(recursiveQueries);
      return this;
    }
    public DnsServerInstantTestRequest.ModelBuilder ipv6Policy(TestIpv6Policy ipv6Policy) {
      this.instance.setIpv6Policy(ipv6Policy);
      return this;
    }
    public DnsServerInstantTestRequest.ModelBuilder fixedPacketRate(Integer fixedPacketRate) {
      this.instance.setFixedPacketRate(fixedPacketRate);
      return this;
    }
    public DnsServerInstantTestRequest.ModelBuilder dnsQueryClass(DnsQueryClass dnsQueryClass) {
      this.instance.setDnsQueryClass(dnsQueryClass);
      return this;
    }
    public DnsServerInstantTestRequest.ModelBuilder labels(List<String> labels) {
      this.instance.setLabels(labels);
      return this;
    }
    public DnsServerInstantTestRequest.ModelBuilder tags(List<String> tags) {
      this.instance.setTags(tags);
      return this;
    }
    public DnsServerInstantTestRequest.ModelBuilder sharedWithAccounts(List<String> sharedWithAccounts) {
      this.instance.setSharedWithAccounts(sharedWithAccounts);
      return this;
    }
    public DnsServerInstantTestRequest.ModelBuilder agents(List<TestAgent> agents) {
      this.instance.setAgents(agents);
      return this;
    }

    /**
     * Returns a built DnsServerInstantTestRequest instance.
     *
     * <p>The builder is not reusable.</p>
     */
    public DnsServerInstantTestRequest build() {
      try {
   ...
   */
  public static DnsServerInstantTestRequest.ModelBuilder builder() {
    return new DnsServerInstantTestRequest.ModelBuilder();
  }

  /**
   * Create a builder with a shallow copy of this instance.
   */
  public DnsServerInstantTestRequest.ModelBuilder toBuilder() {
    DnsServerInstantTestRequest.ModelBuilder builder = new DnsServerInstantTestRequest.ModelBuilder()
