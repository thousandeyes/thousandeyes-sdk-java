...
@JsonPropertyOrder({
  ...
  PageLoadInstantTestResponse.JSON_PROPERTY_DISTRIBUTED_TRACING,
  ...
  PageLoadInstantTestResponse.JSON_PROPERTY_CHROME_OPTIONS,
  PageLoadInstantTestResponse.JSON_PROPERTY_CHROME_POLICIES,
  PageLoadInstantTestResponse.JSON_PROPERTY_CHROMIUM_TRACK,
  PageLoadInstantTestResponse.JSON_PROPERTY_PAGE_LOADING_STRATEGY,
  PageLoadInstantTestResponse.JSON_PROPERTY_RANDOMIZED_START_TIME,
  PageLoadInstantTestResponse.JSON_PROPERTY_IDENTIFY_AGENT_TRAFFIC_WITH_USER_AGENT,
...
public class PageLoadInstantTestResponse {
  ...
  **/
  ...
  public PageLoadInstantTestResponse distributedTracing(Boolean distributedTracing) {
  ...
  **/
  ...
  public PageLoadInstantTestResponse chromeOptions(String chromeOptions) {
  ...
  **/
  ...
  public PageLoadInstantTestResponse chromePolicies(String chromePolicies) {
  ...
  **/
  ...
  public PageLoadInstantTestResponse chromiumTrack(TestChromiumTrack chromiumTrack) {
  ...
  **/
  ...
  public PageLoadInstantTestResponse randomizedStartTime(Boolean randomizedStartTime) {
  ...
  **/
  ...
  public PageLoadInstantTestResponse identifyAgentTrafficWithUserAgent(Boolean identifyAgentTrafficWithUserAgent) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createdBy, pageLoadInstantTestResponse.createdBy) &&
        ...
        Objects.equals(this.distributedTracing, pageLoadInstantTestResponse.distributedTracing) &&
        ...
        Objects.equals(this.chromeOptions, pageLoadInstantTestResponse.chromeOptions) &&
        Objects.equals(this.chromePolicies, pageLoadInstantTestResponse.chromePolicies) &&
        Objects.equals(this.chromiumTrack, pageLoadInstantTestResponse.chromiumTrack) &&
        Objects.equals(this.pageLoadingStrategy, pageLoadInstantTestResponse.pageLoadingStrategy) &&
        Objects.equals(this.randomizedStartTime, pageLoadInstantTestResponse.randomizedStartTime) &&
        Objects.equals(this.identifyAgentTrafficWithUserAgent, pageLoadInstantTestResponse.identifyAgentTrafficWithUserAgent) &&
  ...
  public static class ModelBuilder {
    ...
    private PageLoadInstantTestResponse instance;

    public ModelBuilder() {
      this(new PageLoadInstantTestResponse());
    }

    protected ModelBuilder(PageLoadInstantTestResponse instance) {
      this.instance = instance;
    }

    public PageLoadInstantTestResponse.ModelBuilder createdBy(String createdBy) {
      this.instance.createdBy = createdBy;
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder createdDate(OffsetDateTime createdDate) {
      this.instance.createdDate = createdDate;
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder description(String description) {
      this.instance.setDescription(description);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder liveShare(Boolean liveShare) {
      this.instance.liveShare = liveShare;
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder modifiedBy(String modifiedBy) {
      this.instance.modifiedBy = modifiedBy;
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder modifiedDate(OffsetDateTime modifiedDate) {
      this.instance.modifiedDate = modifiedDate;
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder savedEvent(Boolean savedEvent) {
      this.instance.savedEvent = savedEvent;
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder testId(String testId) {
      this.instance.testId = testId;
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder testName(String testName) {
      this.instance.setTestName(testName);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder type(String type) {
      this.instance.type = type;
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder links(TestLinks links) {
      this.instance.setLinks(links);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder labels(List<TestLabel> labels) {
      this.instance.labels = labels;
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder tags(List<TestTag> tags) {
      this.instance.tags = tags;
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder sharedWithAccounts(List<SharedWithAccount> sharedWithAccounts) {
      this.instance.sharedWithAccounts = sharedWithAccounts;
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder authType(TestAuthType authType) {
      this.instance.setAuthType(authType);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder agentInterfaces(AgentInterfaces agentInterfaces) {
      this.instance.setAgentInterfaces(agentInterfaces);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder bandwidthMeasurements(Boolean bandwidthMeasurements) {
      this.instance.setBandwidthMeasurements(bandwidthMeasurements);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder clientCertificate(String clientCertificate) {
      this.instance.setClientCertificate(clientCertificate);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder contentRegex(String contentRegex) {
      this.instance.setContentRegex(contentRegex);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder customHeaders(TestCustomHeaders customHeaders) {
      this.instance.setCustomHeaders(customHeaders);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder desiredStatusCode(String desiredStatusCode) {
      this.instance.setDesiredStatusCode(desiredStatusCode);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder distributedTracing(Boolean distributedTracing) {
      this.instance.setDistributedTracing(distributedTracing);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder downloadLimit(Integer downloadLimit) {
      this.instance.setDownloadLimit(downloadLimit);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder dnsOverride(String dnsOverride) {
      this.instance.setDnsOverride(dnsOverride);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder httpTargetTime(Integer httpTargetTime) {
      this.instance.setHttpTargetTime(httpTargetTime);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder httpTimeLimit(Integer httpTimeLimit) {
      this.instance.setHttpTimeLimit(httpTimeLimit);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder httpVersion(Integer httpVersion) {
      this.instance.setHttpVersion(httpVersion);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder includeHeaders(Boolean includeHeaders) {
      this.instance.setIncludeHeaders(includeHeaders);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder mtuMeasurements(Boolean mtuMeasurements) {
      this.instance.setMtuMeasurements(mtuMeasurements);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder networkMeasurements(Boolean networkMeasurements) {
      this.instance.setNetworkMeasurements(networkMeasurements);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder numPathTraces(Integer numPathTraces) {
      this.instance.setNumPathTraces(numPathTraces);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder oAuth(OAuth oAuth) {
      this.instance.setoAuth(oAuth);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder password(String password) {
      this.instance.setPassword(password);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder pathTraceMode(TestPathTraceMode pathTraceMode) {
      this.instance.setPathTraceMode(pathTraceMode);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder probeMode(TestProbeMode probeMode) {
      this.instance.setProbeMode(probeMode);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder protocol(TestProtocol protocol) {
      this.instance.setProtocol(protocol);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder sslVersion(String sslVersion) {
      this.instance.sslVersion = sslVersion;
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder sslVersionId(TestSslVersionId sslVersionId) {
      this.instance.setSslVersionId(sslVersionId);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder url(String url) {
      this.instance.setUrl(url);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder useNtlm(Boolean useNtlm) {
      this.instance.setUseNtlm(useNtlm);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder userAgent(String userAgent) {
      this.instance.setUserAgent(userAgent);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder username(String username) {
      this.instance.setUsername(username);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder verifyCertificate(Boolean verifyCertificate) {
      this.instance.setVerifyCertificate(verifyCertificate);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder allowUnsafeLegacyRenegotiation(Boolean allowUnsafeLegacyRenegotiation) {
      this.instance.setAllowUnsafeLegacyRenegotiation(allowUnsafeLegacyRenegotiation);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder followRedirects(Boolean followRedirects) {
      this.instance.setFollowRedirects(followRedirects);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder fixedPacketRate(Integer fixedPacketRate) {
      this.instance.setFixedPacketRate(fixedPacketRate);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder overrideAgentProxy(Boolean overrideAgentProxy) {
      this.instance.setOverrideAgentProxy(overrideAgentProxy);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder overrideProxyId(String overrideProxyId) {
      this.instance.setOverrideProxyId(overrideProxyId);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder collectProxyNetworkData(Boolean collectProxyNetworkData) {
      this.instance.setCollectProxyNetworkData(collectProxyNetworkData);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder vaultCredentials(List<TestVaultCredential> vaultCredentials) {
      this.instance.setVaultCredentials(vaultCredentials);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder emulatedDeviceId(String emulatedDeviceId) {
      this.instance.setEmulatedDeviceId(emulatedDeviceId);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder pageLoadTargetTime(Integer pageLoadTargetTime) {
      this.instance.setPageLoadTargetTime(pageLoadTargetTime);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder pageLoadTimeLimit(Integer pageLoadTimeLimit) {
      this.instance.setPageLoadTimeLimit(pageLoadTimeLimit);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder blockDomains(String blockDomains) {
      this.instance.setBlockDomains(blockDomains);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder disableScreenshot(Boolean disableScreenshot) {
      this.instance.setDisableScreenshot(disableScreenshot);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder allowMicAndCamera(Boolean allowMicAndCamera) {
      this.instance.setAllowMicAndCamera(allowMicAndCamera);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder allowGeolocation(Boolean allowGeolocation) {
      this.instance.setAllowGeolocation(allowGeolocation);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder browserLanguage(String browserLanguage) {
      this.instance.setBrowserLanguage(browserLanguage);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder chromeOptions(String chromeOptions) {
      this.instance.setChromeOptions(chromeOptions);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder chromePolicies(String chromePolicies) {
      this.instance.setChromePolicies(chromePolicies);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder chromiumTrack(TestChromiumTrack chromiumTrack) {
      this.instance.setChromiumTrack(chromiumTrack);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder pageLoadingStrategy(TestPageLoadingStrategy pageLoadingStrategy) {
      this.instance.setPageLoadingStrategy(pageLoadingStrategy);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder randomizedStartTime(Boolean randomizedStartTime) {
      this.instance.setRandomizedStartTime(randomizedStartTime);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder identifyAgentTrafficWithUserAgent(Boolean identifyAgentTrafficWithUserAgent) {
      this.instance.setIdentifyAgentTrafficWithUserAgent(identifyAgentTrafficWithUserAgent);
      return this;
    }
    public PageLoadInstantTestResponse.ModelBuilder agents(List<TestAgentResponse> agents) {
      this.instance.setAgents(agents);
      return this;
    }

    /**
     * Returns a built PageLoadInstantTestResponse instance.
     *
     * <p>The builder is not reusable.</p>
     */
    public PageLoadInstantTestResponse build() {
      try {
   ...
   */
  public static PageLoadInstantTestResponse.ModelBuilder builder() {
    return new PageLoadInstantTestResponse.ModelBuilder();
  }

  /**
   * Create a builder with a shallow copy of this instance.
   */
  public PageLoadInstantTestResponse.ModelBuilder toBuilder() {
    PageLoadInstantTestResponse.ModelBuilder builder = new PageLoadInstantTestResponse.ModelBuilder()
