...
public class VoiceInstantTestRequest {
  ...
  **/
  ...
  public VoiceInstantTestRequest randomizedStartTime(Boolean randomizedStartTime) {
  ...
  **/
  ...
  public VoiceInstantTestRequest agents(List<TestAgentWithSourceIpAddress> agents) {
    this.agents = agents;
    return this;
  }

  public VoiceInstantTestRequest addAgentsItem(TestAgentWithSourceIpAddress agentsItem) {
    if (this.agents == null) {
  ...
  **/
  ...
  public static class ModelBuilder {
    ...
    private VoiceInstantTestRequest instance;

    public ModelBuilder() {
      this(new VoiceInstantTestRequest());
    }

    protected ModelBuilder(VoiceInstantTestRequest instance) {
      this.instance = instance;
    }

    public VoiceInstantTestRequest.ModelBuilder createdBy(String createdBy) {
      this.instance.createdBy = createdBy;
      return this;
    }
    public VoiceInstantTestRequest.ModelBuilder createdDate(OffsetDateTime createdDate) {
      this.instance.createdDate = createdDate;
      return this;
    }
    public VoiceInstantTestRequest.ModelBuilder description(String description) {
      this.instance.setDescription(description);
      return this;
    }
    public VoiceInstantTestRequest.ModelBuilder liveShare(Boolean liveShare) {
      this.instance.liveShare = liveShare;
      return this;
    }
    public VoiceInstantTestRequest.ModelBuilder modifiedBy(String modifiedBy) {
      this.instance.modifiedBy = modifiedBy;
      return this;
    }
    public VoiceInstantTestRequest.ModelBuilder modifiedDate(OffsetDateTime modifiedDate) {
      this.instance.modifiedDate = modifiedDate;
      return this;
    }
    public VoiceInstantTestRequest.ModelBuilder savedEvent(Boolean savedEvent) {
      this.instance.savedEvent = savedEvent;
      return this;
    }
    public VoiceInstantTestRequest.ModelBuilder testId(String testId) {
      this.instance.testId = testId;
      return this;
    }
    public VoiceInstantTestRequest.ModelBuilder testName(String testName) {
      this.instance.setTestName(testName);
      return this;
    }
    public VoiceInstantTestRequest.ModelBuilder type(String type) {
      this.instance.type = type;
      return this;
    }
    public VoiceInstantTestRequest.ModelBuilder links(TestLinks links) {
      this.instance.setLinks(links);
      return this;
    }
    public VoiceInstantTestRequest.ModelBuilder codec(String codec) {
      this.instance.codec = codec;
      return this;
    }
    public VoiceInstantTestRequest.ModelBuilder codecId(String codecId) {
      this.instance.setCodecId(codecId);
      return this;
    }
    public VoiceInstantTestRequest.ModelBuilder dscp(String dscp) {
      this.instance.dscp = dscp;
      return this;
    }
    public VoiceInstantTestRequest.ModelBuilder dscpId(TestDscpId dscpId) {
      this.instance.setDscpId(dscpId);
      return this;
    }
    public VoiceInstantTestRequest.ModelBuilder duration(Integer duration) {
      this.instance.setDuration(duration);
      return this;
    }
    public VoiceInstantTestRequest.ModelBuilder jitterBuffer(Integer jitterBuffer) {
      this.instance.setJitterBuffer(jitterBuffer);
      return this;
    }
    public VoiceInstantTestRequest.ModelBuilder numPathTraces(Integer numPathTraces) {
      this.instance.setNumPathTraces(numPathTraces);
      return this;
    }
    public VoiceInstantTestRequest.ModelBuilder port(Integer port) {
      this.instance.setPort(port);
      return this;
    }
    public VoiceInstantTestRequest.ModelBuilder randomizedStartTime(Boolean randomizedStartTime) {
      this.instance.setRandomizedStartTime(randomizedStartTime);
      return this;
    }
    public VoiceInstantTestRequest.ModelBuilder targetAgentId(String targetAgentId) {
      this.instance.setTargetAgentId(targetAgentId);
      return this;
    }
    public VoiceInstantTestRequest.ModelBuilder labels(List<String> labels) {
      this.instance.setLabels(labels);
      return this;
    }
    public VoiceInstantTestRequest.ModelBuilder tags(List<String> tags) {
      this.instance.setTags(tags);
      return this;
    }
    public VoiceInstantTestRequest.ModelBuilder sharedWithAccounts(List<String> sharedWithAccounts) {
      this.instance.setSharedWithAccounts(sharedWithAccounts);
      return this;
    }
    public VoiceInstantTestRequest.ModelBuilder agents(List<TestAgentWithSourceIpAddress> agents) {
      this.instance.setAgents(agents);
      return this;
    }

    /**
     * Returns a built VoiceInstantTestRequest instance.
     *
     * <p>The builder is not reusable.</p>
     */
    public VoiceInstantTestRequest build() {
      try {
   ...
   */
  public static VoiceInstantTestRequest.ModelBuilder builder() {
    return new VoiceInstantTestRequest.ModelBuilder();
  }

  /**
   * Create a builder with a shallow copy of this instance.
   */
  public VoiceInstantTestRequest.ModelBuilder toBuilder() {
    VoiceInstantTestRequest.ModelBuilder builder = new VoiceInstantTestRequest.ModelBuilder()
