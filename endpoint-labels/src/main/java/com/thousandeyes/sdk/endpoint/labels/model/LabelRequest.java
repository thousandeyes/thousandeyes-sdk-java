...
public class LabelRequest {
  ...
  **/
  ...
  public static class ModelBuilder {
    ...
    public ModelBuilder() {
      this(new LabelRequest());
    }

    protected ModelBuilder(LabelRequest instance) {
      this.instance = instance;
    }

    public LabelRequest.ModelBuilder id(String id) {
      this.instance.id = id;
      return this;
    }
    public LabelRequest.ModelBuilder name(String name) {
      this.instance.setName(name);
      return this;
    }
    public LabelRequest.ModelBuilder color(String color) {
      this.instance.setColor(color);
      return this;
    }
    public LabelRequest.ModelBuilder matchType(MatchType matchType) {
      this.instance.setMatchType(matchType);
      return this;
    }
    public LabelRequest.ModelBuilder filters(List<Filter> filters) {
      this.instance.setFilters(filters);
      return this;
    }

    /**
     * Returns a built LabelRequest instance.
     *
   ...
   */
  public static LabelRequest.ModelBuilder builder() {
    return new LabelRequest.ModelBuilder();
  }

  /**
   * Create a builder with a shallow copy of this instance.
   */
  public LabelRequest.ModelBuilder toBuilder() {
    LabelRequest.ModelBuilder builder = new LabelRequest.ModelBuilder()
      .id(getId())
      .name(getName())
      .color(getColor())
