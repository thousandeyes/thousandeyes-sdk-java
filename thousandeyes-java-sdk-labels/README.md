...
<dependency>
  ...
  <artifactId>thousandeyes-java-sdk-labels</artifactId>
...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'thousandeyes-java-sdk-labels' jar has been published to maven central.
    mavenLocal()       // Needed if the 'thousandeyes-java-sdk-labels' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "org.openapitools:thousandeyes-java-sdk-labels:7.0.0"
  }
```
...
* `target/thousandeyes-java-sdk-labels-7.0.0.jar`
* `target/lib/*.jar`
