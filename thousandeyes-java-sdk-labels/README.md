...
- Build date: 2024-02-07T22:58:17.706427Z[Europe/Lisbon]
...
```groovy
compile "com.thousandeyes.api:thousandeyes-java-sdk-labels:7.0.0-SNAPSHOT"
```
...
- `target/thousandeyes-java-sdk-labels-7.0.0-SNAPSHOT.jar`
- `target/lib/*.jar`
