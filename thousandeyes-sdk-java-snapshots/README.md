...
- Build date: 2024-04-22T10:43:50.463370+01:00[Europe/London]
...
```groovy
compile "com.thousandeyes.api:thousandeyes-sdk-java-snapshots:7.0.0-SNAPSHOT"
```
...
- `target/thousandeyes-sdk-java-snapshots-7.0.0-SNAPSHOT.jar`
- `target/lib/*.jar`
