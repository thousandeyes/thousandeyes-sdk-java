...
- Build date: 2024-04-22T10:43:50.769480+01:00[Europe/London]
...
```groovy
compile "com.thousandeyes.api:thousandeyes-sdk-java-instant-tests:7.0.0-SNAPSHOT"
```
...
- `target/thousandeyes-sdk-java-instant-tests-7.0.0-SNAPSHOT.jar`
- `target/lib/*.jar`
