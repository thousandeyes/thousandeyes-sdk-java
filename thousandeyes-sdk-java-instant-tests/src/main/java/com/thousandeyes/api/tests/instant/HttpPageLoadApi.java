...
public class HttpPageLoadApi {
  ...
  public PageLoadInstantTest postInstantHTTPPageLoad(PageLoadInstantTestRequest pageLoadInstantTestRequest, String aid, List<Expand> expand) throws ApiException {
    ApiResponse<PageLoadInstantTest> response = postInstantHTTPPageLoadWithHttpInfo(pageLoadInstantTestRequest, aid, expand);
  ...
  public ApiResponse<PageLoadInstantTest> postInstantHTTPPageLoadWithHttpInfo(PageLoadInstantTestRequest pageLoadInstantTestRequest, String aid, List<Expand> expand) throws ApiException {
    postInstantHTTPPageLoadValidateRequest(pageLoadInstantTestRequest);

    var requestBuilder = postInstantHTTPPageLoadRequestBuilder(pageLoadInstantTestRequest, aid, expand);

    return apiClient.send(requestBuilder.build(), PageLoadInstantTest.class);
  }

  private void postInstantHTTPPageLoadValidateRequest(PageLoadInstantTestRequest pageLoadInstantTestRequest) throws ApiException {
      // verify the required parameter 'pageLoadInstantTestRequest' is set
      if (pageLoadInstantTestRequest == null) {
        throw new ApiException(400, "Missing the required parameter 'pageLoadInstantTestRequest' when calling postInstantHTTPPageLoad");
      }
  }

  private ApiRequest.ApiRequestBuilder postInstantHTTPPageLoadRequestBuilder(PageLoadInstantTestRequest pageLoadInstantTestRequest, String aid, List<Expand> expand) throws ApiException {
