...
public class SipServerInstantTestRequest {
  ...
  **/
  ...
  public SipServerInstantTestRequest addItem(String labelsItem) {
    if (this.labels == null) {
  ...
  **/
  ...
  public SipServerInstantTestRequest addItem(String sharedWithAccountsItem) {
  ...
  **/
  ...
  public SipServerInstantTestRequest addItem(TestAgent agentsItem) {
    if (this.agents == null) {
