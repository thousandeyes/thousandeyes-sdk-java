...
public class PageLoadInstantTestRequest {
  ...
  **/
  ...
  public PageLoadInstantTestRequest addItem(String labelsItem) {
    if (this.labels == null) {
  ...
  **/
  ...
  public PageLoadInstantTestRequest addItem(String sharedWithAccountsItem) {
  ...
  **/
  ...
  public PageLoadInstantTestRequest addItem(TestAgent agentsItem) {
    if (this.agents == null) {
