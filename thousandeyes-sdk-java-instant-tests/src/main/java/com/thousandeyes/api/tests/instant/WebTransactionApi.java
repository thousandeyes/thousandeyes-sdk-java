...
public class WebTransactionApi {
  ...
  public WebTransactionInstantTest postInstantWebTransactions(WebTransactionInstantTestRequest webTransactionInstantTestRequest, String aid, List<Expand> expand) throws ApiException {
    ApiResponse<WebTransactionInstantTest> response = postInstantWebTransactionsWithHttpInfo(webTransactionInstantTestRequest, aid, expand);
  ...
  public ApiResponse<WebTransactionInstantTest> postInstantWebTransactionsWithHttpInfo(WebTransactionInstantTestRequest webTransactionInstantTestRequest, String aid, List<Expand> expand) throws ApiException {
    postInstantWebTransactionsValidateRequest(webTransactionInstantTestRequest);

    var requestBuilder = postInstantWebTransactionsRequestBuilder(webTransactionInstantTestRequest, aid, expand);

    return apiClient.send(requestBuilder.build(), WebTransactionInstantTest.class);
  }

  private void postInstantWebTransactionsValidateRequest(WebTransactionInstantTestRequest webTransactionInstantTestRequest) throws ApiException {
      // verify the required parameter 'webTransactionInstantTestRequest' is set
      if (webTransactionInstantTestRequest == null) {
        throw new ApiException(400, "Missing the required parameter 'webTransactionInstantTestRequest' when calling postInstantWebTransactions");
      }
  }

  private ApiRequest.ApiRequestBuilder postInstantWebTransactionsRequestBuilder(WebTransactionInstantTestRequest webTransactionInstantTestRequest, String aid, List<Expand> expand) throws ApiException {
