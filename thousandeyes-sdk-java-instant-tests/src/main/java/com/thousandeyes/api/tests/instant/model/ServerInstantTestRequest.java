...
public class ServerInstantTestRequest {
  ...
  **/
  ...
  public ServerInstantTestRequest addItem(String labelsItem) {
    if (this.labels == null) {
  ...
  **/
  ...
  public ServerInstantTestRequest addItem(String sharedWithAccountsItem) {
  ...
  **/
  ...
  public ServerInstantTestRequest addItem(TestAgent agentsItem) {
    if (this.agents == null) {
