...
public class ApiApi {
   ...
   */
  public ApiInstantTest postInstantApi(ApiInstantTestRequest apiInstantTestRequest, String aid, List<Expand> expand) throws ApiException {
    ApiResponse<ApiInstantTest> response = postInstantApiWithHttpInfo(apiInstantTestRequest, aid, expand);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<ApiInstantTest> postInstantApiWithHttpInfo(ApiInstantTestRequest apiInstantTestRequest, String aid, List<Expand> expand) throws ApiException {
    postInstantApiValidateRequest(apiInstantTestRequest);

    var requestBuilder = postInstantApiRequestBuilder(apiInstantTestRequest, aid, expand);

    return apiClient.send(requestBuilder.build(), ApiInstantTest.class);
  }

  private void postInstantApiValidateRequest(ApiInstantTestRequest apiInstantTestRequest) throws ApiException {
      // verify the required parameter 'apiInstantTestRequest' is set
      if (apiInstantTestRequest == null) {
        throw new ApiException(400, "Missing the required parameter 'apiInstantTestRequest' when calling postInstantApi");
      }
  }

  private ApiRequest.ApiRequestBuilder postInstantApiRequestBuilder(ApiInstantTestRequest apiInstantTestRequest, String aid, List<Expand> expand) throws ApiException {
