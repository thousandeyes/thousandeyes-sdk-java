...
public class AgentToAgentInstantTestRequest {
  ...
  **/
  ...
  public AgentToAgentInstantTestRequest addItem(String labelsItem) {
    if (this.labels == null) {
  ...
  **/
  ...
  public AgentToAgentInstantTestRequest addItem(String sharedWithAccountsItem) {
  ...
  **/
  ...
  public AgentToAgentInstantTestRequest addItem(TestAgent agentsItem) {
    if (this.agents == null) {
