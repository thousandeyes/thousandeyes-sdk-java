...
public class DnsSecurityApi {
  ...
  public DnsSecInstantTest postInstantDnsSec(DnsSecInstantTestRequest dnsSecInstantTestRequest, String aid, List<Expand> expand) throws ApiException {
    ApiResponse<DnsSecInstantTest> response = postInstantDnsSecWithHttpInfo(dnsSecInstantTestRequest, aid, expand);
  ...
  public ApiResponse<DnsSecInstantTest> postInstantDnsSecWithHttpInfo(DnsSecInstantTestRequest dnsSecInstantTestRequest, String aid, List<Expand> expand) throws ApiException {
    postInstantDnsSecValidateRequest(dnsSecInstantTestRequest);

    var requestBuilder = postInstantDnsSecRequestBuilder(dnsSecInstantTestRequest, aid, expand);

    return apiClient.send(requestBuilder.build(), DnsSecInstantTest.class);
  }

  private void postInstantDnsSecValidateRequest(DnsSecInstantTestRequest dnsSecInstantTestRequest) throws ApiException {
      // verify the required parameter 'dnsSecInstantTestRequest' is set
      if (dnsSecInstantTestRequest == null) {
        throw new ApiException(400, "Missing the required parameter 'dnsSecInstantTestRequest' when calling postInstantDnsSec");
      }
  }

  private ApiRequest.ApiRequestBuilder postInstantDnsSecRequestBuilder(DnsSecInstantTestRequest dnsSecInstantTestRequest, String aid, List<Expand> expand) throws ApiException {
