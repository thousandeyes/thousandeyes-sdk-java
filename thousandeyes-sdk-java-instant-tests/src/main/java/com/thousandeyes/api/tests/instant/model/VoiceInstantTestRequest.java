...
public class VoiceInstantTestRequest {
  ...
  **/
  ...
  public VoiceInstantTestRequest addItem(String labelsItem) {
    if (this.labels == null) {
  ...
  **/
  ...
  public VoiceInstantTestRequest addItem(String sharedWithAccountsItem) {
  ...
  **/
  ...
  public VoiceInstantTestRequest addItem(TestAgent agentsItem) {
    if (this.agents == null) {
