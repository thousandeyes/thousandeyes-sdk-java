...
public class InstantTestRequest {
  ...
  public InstantTestRequest addItem(String labelsItem) {
    if (this.labels == null) {
  ...
  **/
  ...
  public InstantTestRequest addItem(String sharedWithAccountsItem) {
  ...
  **/
  ...
  public InstantTestRequest addItem(TestAgent agentsItem) {
    if (this.agents == null) {
