...
public class TestCustomHeaders {
  ...
  public TestCustomHeaders putItem(String key, String rootItem) {
    if (this.root == null) {
  ...
  **/
  ...
  public TestCustomHeaders putItem(String key, Map<String, String> domainsItem) {
  ...
  **/
  ...
  public TestCustomHeaders putItem(String key, String allItem) {
    if (this.all == null) {
