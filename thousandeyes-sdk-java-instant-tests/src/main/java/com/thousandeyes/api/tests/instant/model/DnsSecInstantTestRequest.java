...
public class DnsSecInstantTestRequest {
  ...
  **/
  ...
  public DnsSecInstantTestRequest addItem(String labelsItem) {
    if (this.labels == null) {
  ...
  **/
  ...
  public DnsSecInstantTestRequest addItem(String sharedWithAccountsItem) {
  ...
  **/
  ...
  public DnsSecInstantTestRequest addItem(TestAgent agentsItem) {
    if (this.agents == null) {
