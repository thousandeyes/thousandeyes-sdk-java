 ...
 */
public enum AzureResourceGroupType {
  ...
  AzureResourceGroupType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static AzureResourceGroupType fromValue(String value) {
    for (AzureResourceGroupType b : AzureResourceGroupType.values()) {
