 ...
 */
public enum SubscriptionsPolicyRuleField {
  ...
  SubscriptionsPolicyRuleField(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static SubscriptionsPolicyRuleField fromValue(String value) {
    for (SubscriptionsPolicyRuleField b : SubscriptionsPolicyRuleField.values()) {
