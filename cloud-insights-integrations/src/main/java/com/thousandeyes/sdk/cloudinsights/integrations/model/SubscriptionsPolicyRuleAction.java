 ...
 */
public enum SubscriptionsPolicyRuleAction {
  ...
  SubscriptionsPolicyRuleAction(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static SubscriptionsPolicyRuleAction fromValue(String value) {
    for (SubscriptionsPolicyRuleAction b : SubscriptionsPolicyRuleAction.values()) {
