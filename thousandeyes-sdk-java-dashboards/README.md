# thousandeyes-sdk-java-dashboards

Dashboards API

- API version: 7.0.0

- Build date: 2024-04-16T16:28:26.668782+01:00[Europe/Lisbon]
...
```groovy
compile "com.thousandeyes.api:thousandeyes-sdk-java-dashboards:7.0.0-SNAPSHOT"
```
...
- `target/thousandeyes-sdk-java-dashboards-7.0.0-SNAPSHOT.jar`
- `target/lib/*.jar`
