...
public class ApiMultiMetricColumnData {
  ...
  **/
  ...
  public ApiMultiMetricColumnData addItem(ApiWidgetDataPoint pointsItem) {
    if (this.points == null) {
  ...
  **/
  ...
  public ApiMultiMetricColumnData addItem(ApiDashboardAsw alertSuppressionWindowsItem) {
