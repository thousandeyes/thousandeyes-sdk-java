...
public class DashboardsApi {
  ...
  public ApiDashboard getDashboardById(String dashboardId, String aid) throws ApiException {
    ApiResponse<ApiDashboard> response = getDashboardByIdWithHttpInfo(dashboardId, aid);
    return response.getData();
  }
  ...
  private void getDashboardByIdValidateRequest(String dashboardId) throws ApiException {
      // verify the required parameter 'dashboardId' is set
      if (dashboardId == null) {
        throw new ApiException(400, "Missing the required parameter 'dashboardId' when calling getDashboardById");
      }
  }

  private ApiRequest.ApiRequestBuilder getDashboardByIdRequestBuilder(String dashboardId, String aid) throws ApiException {
    ApiRequest.ApiRequestBuilder requestBuilder = ApiRequest.builder()
            .method("GET");
  ...
  public GetDashboardData200Response getDashboardData(String dashboardId, String widgetId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, BigDecimal max, String cursor, String sort, DashboardOrder order) throws ApiException {
    ApiResponse<GetDashboardData200Response> response = getDashboardDataWithHttpInfo(dashboardId, widgetId, aid, window, startDate, endDate, max, cursor, sort, order);
    return response.getData();
  }
  ...
  private void getDashboardDataValidateRequest(String dashboardId, String widgetId) throws ApiException {
      ...
      if (widgetId == null) {
        throw new ApiException(400, "Missing the required parameter 'widgetId' when calling getDashboardData");
      }
  }

  private ApiRequest.ApiRequestBuilder getDashboardDataRequestBuilder(String dashboardId, String widgetId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, BigDecimal max, String cursor, String sort, DashboardOrder order) throws ApiException {
    ApiRequest.ApiRequestBuilder requestBuilder = ApiRequest.builder()
            .method("GET");
  ...
  public List<ApiDashboard> getDashboardsForUser(String aid) throws ApiException {
    ApiResponse<List<ApiDashboard>> response = getDashboardsForUserWithHttpInfo(aid);
    return response.getData();
  }
  ...
  public ApiResponse<List<ApiDashboard>> getDashboardsForUserWithHttpInfo(String aid) throws ApiException {
    ...
    return apiClient.send(requestBuilder.build(), List<ApiDashboard>.class);
  }

  private void getDashboardsForUserValidateRequest() throws ApiException {
  }

  private ApiRequest.ApiRequestBuilder getDashboardsForUserRequestBuilder(String aid) throws ApiException {
    ApiRequest.ApiRequestBuilder requestBuilder = ApiRequest.builder()
            .method("GET");
