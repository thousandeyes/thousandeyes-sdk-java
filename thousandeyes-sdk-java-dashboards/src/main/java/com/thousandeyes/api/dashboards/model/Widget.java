...
public class Widget {
  ...
  **/
  ...
  public Widget filters(Map<String, Set<ApiMultiMetricColumnFiltersValueInner>> filters) {
    this.filters = filters;
    return this;
  }

  public Widget putFiltersItem(String key, Set<ApiMultiMetricColumnFiltersValueInner> filtersItem) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(links, id, title, visualMode, embedUrl, isEmbedded, metricGroup, direction, metric, filters, measure, fixedTimespan, apiLink, shouldExcludeAlertSuppressionWindows);
  }
