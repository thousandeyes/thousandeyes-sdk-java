...
public class ApiWidgetsDataV2 {
  ...
  public ApiWidgetsDataV2 addItem(ApiNumbersCardData cardsItem) {
    if (this.cards == null) {
  ...
  **/
  ...
  public ApiWidgetsDataV2 addItem(ApiMultiMetricColumnData columnsItem) {
  ...
  **/
  ...
  public ApiWidgetsDataV2 addItem(ApiWidgetDataPoint pointsItem) {
    if (this.points == null) {
  ...
  **/
  ...
  public ApiWidgetsDataV2 addItem(ApiTestTableData testsItem) {
    if (this.tests == null) {
  ...
  **/
  ...
  public ApiWidgetsDataV2 addItem(ApiDashboardAsw alertSuppressionWindowsItem) {
  ...
  **/
  ...
  public ApiWidgetsDataV2 addItem(ApiAlertListAlert alertsItem) {
    if (this.alerts == null) {
  ...
  **/
  ...
  public ApiWidgetsDataV2 addItem(ApiAgentStatusAgent agentsItem) {
    if (this.agents == null) {
