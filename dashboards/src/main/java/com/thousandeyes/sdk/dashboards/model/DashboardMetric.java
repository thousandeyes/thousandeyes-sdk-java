...
public enum DashboardMetric {
  ...
  CLOUD_NATIVE_MONITORING_ACCEPTED_TOTAL_THROUGHPUT("CLOUD_NATIVE_MONITORING-ACCEPTED_TOTAL_THROUGHPUT"),
  
  CLOUD_NATIVE_MONITORING_ACCEPTED_OUTBOUND_THROUGHPUT("CLOUD_NATIVE_MONITORING-ACCEPTED_OUTBOUND_THROUGHPUT"),
  ...
  CLOUD_NATIVE_MONITORING_AUTOSCALING_EVENTS("CLOUD_NATIVE_MONITORING-AUTOSCALING_EVENTS"),
  
  TRAFFIC_INSIGHTS_MONITORING_TOTAL_THROUGHPUT("TRAFFIC_INSIGHTS_MONITORING-TOTAL_THROUGHPUT"),
  
  TRAFFIC_INSIGHTS_MONITORING_DOWNSTREAM_THROUGHPUT("TRAFFIC_INSIGHTS_MONITORING-DOWNSTREAM_THROUGHPUT"),
  
  TRAFFIC_INSIGHTS_MONITORING_UPSTREAM_THROUGHPUT("TRAFFIC_INSIGHTS_MONITORING-UPSTREAM_THROUGHPUT"),
  
  TRAFFIC_INSIGHTS_MONITORING_CONNECTION_RATE("TRAFFIC_INSIGHTS_MONITORING-CONNECTION_RATE"),
