...
public class ApiPieChartWidget {
  ...
  **/
  ...
  public ApiPieChartWidget links(SelfLinks links) {
    this.links = links;
    return this;
  }
  ...
  **/
  ...
  public static class ModelBuilder {
    ...
    private ApiPieChartWidget instance;

    public ModelBuilder() {
      this(new ApiPieChartWidget());
    }

    protected ModelBuilder(ApiPieChartWidget instance) {
      this.instance = instance;
    }

    public ApiPieChartWidget.ModelBuilder id(String id) {
      this.instance.id = id;
      return this;
    }
    public ApiPieChartWidget.ModelBuilder title(String title) {
      this.instance.setTitle(title);
      return this;
    }
    public ApiPieChartWidget.ModelBuilder visualMode(VisualMode visualMode) {
      this.instance.setVisualMode(visualMode);
      return this;
    }
    public ApiPieChartWidget.ModelBuilder embedUrl(String embedUrl) {
      this.instance.embedUrl = embedUrl;
      return this;
    }
    public ApiPieChartWidget.ModelBuilder isEmbedded(Boolean isEmbedded) {
      this.instance.setIsEmbedded(isEmbedded);
      return this;
    }
    public ApiPieChartWidget.ModelBuilder metricGroup(MetricGroup metricGroup) {
      this.instance.setMetricGroup(metricGroup);
      return this;
    }
    public ApiPieChartWidget.ModelBuilder direction(DashboardMetricDirection direction) {
      this.instance.setDirection(direction);
      return this;
    }
    public ApiPieChartWidget.ModelBuilder metric(DashboardMetric metric) {
      this.instance.setMetric(metric);
      return this;
    }
    public ApiPieChartWidget.ModelBuilder filters(Map<String, Set<Object>> filters) {
      this.instance.setFilters(filters);
      return this;
    }
    public ApiPieChartWidget.ModelBuilder measure(ApiWidgetMeasure measure) {
      this.instance.setMeasure(measure);
      return this;
    }
    public ApiPieChartWidget.ModelBuilder fixedTimespan(ApiDuration fixedTimespan) {
      this.instance.setFixedTimespan(fixedTimespan);
      return this;
    }
    public ApiPieChartWidget.ModelBuilder apiLink(String apiLink) {
      this.instance.apiLink = apiLink;
      return this;
    }
    public ApiPieChartWidget.ModelBuilder shouldExcludeAlertSuppressionWindows(Boolean shouldExcludeAlertSuppressionWindows) {
      this.instance.setShouldExcludeAlertSuppressionWindows(shouldExcludeAlertSuppressionWindows);
      return this;
    }
    public ApiPieChartWidget.ModelBuilder links(SelfLinks links) {
      this.instance.setLinks(links);
      return this;
    }
    public ApiPieChartWidget.ModelBuilder type(String type) {
      this.instance.setType(type);
      return this;
    }
    public ApiPieChartWidget.ModelBuilder groupBy(ApiAggregateProperty groupBy) {
      this.instance.setGroupBy(groupBy);
      return this;
    }
    public ApiPieChartWidget.ModelBuilder dataSource(PieChartDatasource dataSource) {
      this.instance.setDataSource(dataSource);
      return this;
    }
    public ApiPieChartWidget.ModelBuilder showSubmetrics(Boolean showSubmetrics) {
      this.instance.setShowSubmetrics(showSubmetrics);
      return this;
    }

    /**
     * Returns a built ApiPieChartWidget instance.
     *
     * <p>The builder is not reusable.</p>
     */
    public ApiPieChartWidget build() {
      try {
   ...
   */
  public static ApiPieChartWidget.ModelBuilder builder() {
    return new ApiPieChartWidget.ModelBuilder();
  }

  /**
   * Create a builder with a shallow copy of this instance.
   */
  public ApiPieChartWidget.ModelBuilder toBuilder() {
    ApiPieChartWidget.ModelBuilder builder = new ApiPieChartWidget.ModelBuilder()
      .id(getId())
      .title(getTitle())
