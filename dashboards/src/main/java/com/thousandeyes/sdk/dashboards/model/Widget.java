...
public class Widget {
  ...
  **/
  ...
  public static class ModelBuilder {
    ...
    protected ModelBuilder(Widget instance) {
      this.instance = instance;
    }

    public Widget.ModelBuilder id(String id) {
      this.instance.id = id;
      return this;
    }
    public Widget.ModelBuilder title(String title) {
      this.instance.setTitle(title);
      return this;
    }
    public Widget.ModelBuilder visualMode(VisualMode visualMode) {
      this.instance.setVisualMode(visualMode);
      return this;
    }
    public Widget.ModelBuilder embedUrl(String embedUrl) {
      this.instance.embedUrl = embedUrl;
      return this;
    }
    public Widget.ModelBuilder isEmbedded(Boolean isEmbedded) {
      this.instance.setIsEmbedded(isEmbedded);
      return this;
    }
    public Widget.ModelBuilder metricGroup(MetricGroup metricGroup) {
      this.instance.setMetricGroup(metricGroup);
      return this;
    }
    public Widget.ModelBuilder direction(DashboardMetricDirection direction) {
      this.instance.setDirection(direction);
      return this;
    }
    public Widget.ModelBuilder metric(DashboardMetric metric) {
      this.instance.setMetric(metric);
      return this;
    }
    public Widget.ModelBuilder filters(Map<String, Set<Object>> filters) {
      this.instance.setFilters(filters);
      return this;
    }
    public Widget.ModelBuilder measure(ApiWidgetMeasure measure) {
      this.instance.setMeasure(measure);
      return this;
    }
    public Widget.ModelBuilder fixedTimespan(ApiDuration fixedTimespan) {
      this.instance.setFixedTimespan(fixedTimespan);
      return this;
    }
    public Widget.ModelBuilder apiLink(String apiLink) {
      this.instance.apiLink = apiLink;
      return this;
    }
    public Widget.ModelBuilder shouldExcludeAlertSuppressionWindows(Boolean shouldExcludeAlertSuppressionWindows) {
      this.instance.setShouldExcludeAlertSuppressionWindows(shouldExcludeAlertSuppressionWindows);
      return this;
    }
    public Widget.ModelBuilder links(SelfLinks links) {
      this.instance.setLinks(links);
      return this;
    }

    /**
     * Returns a built Widget instance.
     *
   ...
   */
  public static Widget.ModelBuilder builder() {
    return new Widget.ModelBuilder();
  }

  /**
   * Create a builder with a shallow copy of this instance.
   */
  public Widget.ModelBuilder toBuilder() {
    Widget.ModelBuilder builder = new Widget.ModelBuilder()
      .id(getId())
      .title(getTitle())
