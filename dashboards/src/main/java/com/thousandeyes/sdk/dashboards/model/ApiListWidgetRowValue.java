...
@JsonDeserialize(using = ApiListWidgetRowValue.ApiListWidgetRowValueDeserializer.class)
@JsonSerialize(using = ApiListWidgetRowValue.ApiListWidgetRowValueSerializer.class)
public class ApiListWidgetRowValue extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ApiListWidgetRowValue.class.getName());

    public static class ApiListWidgetRowValueSerializer extends StdSerializer<ApiListWidgetRowValue> {
        public ApiListWidgetRowValueSerializer(Class<ApiListWidgetRowValue> t) {
            super(t);
        }

        public ApiListWidgetRowValueSerializer() {
            this(null);
        }
    ...
    public static class ApiListWidgetRowValueDeserializer extends StdDeserializer<ApiListWidgetRowValue> {
        public ApiListWidgetRowValueDeserializer() {
            this(ApiListWidgetRowValue.class);
        }

        public ApiListWidgetRowValueDeserializer(Class<?> vc) {
            super(vc);
        }
        ...
        public ApiListWidgetRowValue deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            if (match == 1) {
                ApiListWidgetRowValue ret = new ApiListWidgetRowValue();
    ...
    public ApiListWidgetRowValue() {
        super("oneOf", Boolean.FALSE);
    }

    public ApiListWidgetRowValue(BigDecimal o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ApiListWidgetRowValue(Boolean o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ApiListWidgetRowValue(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(ApiListWidgetRowValue.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, Class<?>> getSchemas() {
        return ApiListWidgetRowValue.schemas;
    }
