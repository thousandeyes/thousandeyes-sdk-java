...
public class ApiHeatmapWidget {
  ...
  **/
  ...
  public static class ModelBuilder {
    ...
    private ApiHeatmapWidget instance;

    public ModelBuilder() {
      this(new ApiHeatmapWidget());
    }

    protected ModelBuilder(ApiHeatmapWidget instance) {
      this.instance = instance;
    }

    public ApiHeatmapWidget.ModelBuilder id(String id) {
      this.instance.id = id;
      return this;
    }
    public ApiHeatmapWidget.ModelBuilder title(String title) {
      this.instance.setTitle(title);
      return this;
    }
    public ApiHeatmapWidget.ModelBuilder visualMode(VisualMode visualMode) {
      this.instance.setVisualMode(visualMode);
      return this;
    }
    public ApiHeatmapWidget.ModelBuilder embedUrl(String embedUrl) {
      this.instance.embedUrl = embedUrl;
      return this;
    }
    public ApiHeatmapWidget.ModelBuilder isEmbedded(Boolean isEmbedded) {
      this.instance.setIsEmbedded(isEmbedded);
      return this;
    }
    public ApiHeatmapWidget.ModelBuilder metricGroup(MetricGroup metricGroup) {
      this.instance.setMetricGroup(metricGroup);
      return this;
    }
    public ApiHeatmapWidget.ModelBuilder direction(DashboardMetricDirection direction) {
      this.instance.setDirection(direction);
      return this;
    }
    public ApiHeatmapWidget.ModelBuilder metric(DashboardMetric metric) {
      this.instance.setMetric(metric);
      return this;
    }
    public ApiHeatmapWidget.ModelBuilder filters(Map<String, Set<Object>> filters) {
      this.instance.setFilters(filters);
      return this;
    }
    public ApiHeatmapWidget.ModelBuilder measure(ApiWidgetMeasure measure) {
      this.instance.setMeasure(measure);
      return this;
    }
    public ApiHeatmapWidget.ModelBuilder fixedTimespan(ApiDuration fixedTimespan) {
      this.instance.setFixedTimespan(fixedTimespan);
      return this;
    }
    public ApiHeatmapWidget.ModelBuilder apiLink(String apiLink) {
      this.instance.apiLink = apiLink;
      return this;
    }
    public ApiHeatmapWidget.ModelBuilder shouldExcludeAlertSuppressionWindows(Boolean shouldExcludeAlertSuppressionWindows) {
      this.instance.setShouldExcludeAlertSuppressionWindows(shouldExcludeAlertSuppressionWindows);
      return this;
    }
    public ApiHeatmapWidget.ModelBuilder links(SelfLinks links) {
      this.instance.setLinks(links);
      return this;
    }
    public ApiHeatmapWidget.ModelBuilder type(String type) {
      this.instance.setType(type);
      return this;
    }
    public ApiHeatmapWidget.ModelBuilder rowGroupBy(ApiAggregateProperty rowGroupBy) {
      this.instance.setRowGroupBy(rowGroupBy);
      return this;
    }
    public ApiHeatmapWidget.ModelBuilder columnGroupBy(ApiAggregateProperty columnGroupBy) {
      this.instance.setColumnGroupBy(columnGroupBy);
      return this;
    }
    public ApiHeatmapWidget.ModelBuilder sortBy(LegacyWidgetSortProperty sortBy) {
      this.instance.setSortBy(sortBy);
      return this;
    }
    public ApiHeatmapWidget.ModelBuilder sortDirection(LegacyWidgetSortDirection sortDirection) {
      this.instance.setSortDirection(sortDirection);
      return this;
    }
    public ApiHeatmapWidget.ModelBuilder limit(Integer limit) {
      this.instance.setLimit(limit);
      return this;
    }
    public ApiHeatmapWidget.ModelBuilder dataSource(HeatmapDatasource dataSource) {
      this.instance.setDataSource(dataSource);
      return this;
    }

    /**
     * Returns a built ApiHeatmapWidget instance.
     *
     * <p>The builder is not reusable.</p>
     */
    public ApiHeatmapWidget build() {
      try {
   ...
   */
  public static ApiHeatmapWidget.ModelBuilder builder() {
    return new ApiHeatmapWidget.ModelBuilder();
  }

  /**
   * Create a builder with a shallow copy of this instance.
   */
  public ApiHeatmapWidget.ModelBuilder toBuilder() {
    ApiHeatmapWidget.ModelBuilder builder = new ApiHeatmapWidget.ModelBuilder()
      .id(getId())
      .title(getTitle())
