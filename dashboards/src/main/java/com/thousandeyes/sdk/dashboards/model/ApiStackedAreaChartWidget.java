...
public class ApiStackedAreaChartWidget {
  ...
  **/
  ...
  public static class ModelBuilder {
    ...
    private ApiStackedAreaChartWidget instance;

    public ModelBuilder() {
      this(new ApiStackedAreaChartWidget());
    }

    protected ModelBuilder(ApiStackedAreaChartWidget instance) {
      this.instance = instance;
    }

    public ApiStackedAreaChartWidget.ModelBuilder id(String id) {
      this.instance.id = id;
      return this;
    }
    public ApiStackedAreaChartWidget.ModelBuilder title(String title) {
      this.instance.setTitle(title);
      return this;
    }
    public ApiStackedAreaChartWidget.ModelBuilder visualMode(VisualMode visualMode) {
      this.instance.setVisualMode(visualMode);
      return this;
    }
    public ApiStackedAreaChartWidget.ModelBuilder embedUrl(String embedUrl) {
      this.instance.embedUrl = embedUrl;
      return this;
    }
    public ApiStackedAreaChartWidget.ModelBuilder isEmbedded(Boolean isEmbedded) {
      this.instance.setIsEmbedded(isEmbedded);
      return this;
    }
    public ApiStackedAreaChartWidget.ModelBuilder metricGroup(MetricGroup metricGroup) {
      this.instance.setMetricGroup(metricGroup);
      return this;
    }
    public ApiStackedAreaChartWidget.ModelBuilder direction(DashboardMetricDirection direction) {
      this.instance.setDirection(direction);
      return this;
    }
    public ApiStackedAreaChartWidget.ModelBuilder metric(DashboardMetric metric) {
      this.instance.setMetric(metric);
      return this;
    }
    public ApiStackedAreaChartWidget.ModelBuilder filters(Map<String, Set<Object>> filters) {
      this.instance.setFilters(filters);
      return this;
    }
    public ApiStackedAreaChartWidget.ModelBuilder measure(ApiWidgetMeasure measure) {
      this.instance.setMeasure(measure);
      return this;
    }
    public ApiStackedAreaChartWidget.ModelBuilder fixedTimespan(ApiDuration fixedTimespan) {
      this.instance.setFixedTimespan(fixedTimespan);
      return this;
    }
    public ApiStackedAreaChartWidget.ModelBuilder apiLink(String apiLink) {
      this.instance.apiLink = apiLink;
      return this;
    }
    public ApiStackedAreaChartWidget.ModelBuilder shouldExcludeAlertSuppressionWindows(Boolean shouldExcludeAlertSuppressionWindows) {
      this.instance.setShouldExcludeAlertSuppressionWindows(shouldExcludeAlertSuppressionWindows);
      return this;
    }
    public ApiStackedAreaChartWidget.ModelBuilder links(SelfLinks links) {
      this.instance.setLinks(links);
      return this;
    }
    public ApiStackedAreaChartWidget.ModelBuilder minScale(Float minScale) {
      this.instance.setMinScale(minScale);
      return this;
    }
    public ApiStackedAreaChartWidget.ModelBuilder maxScale(Float maxScale) {
      this.instance.setMaxScale(maxScale);
      return this;
    }
    public ApiStackedAreaChartWidget.ModelBuilder unit(ApiWidgetFixedYScalePrefix unit) {
      this.instance.setUnit(unit);
      return this;
    }
    public ApiStackedAreaChartWidget.ModelBuilder type(String type) {
      this.instance.setType(type);
      return this;
    }
    public ApiStackedAreaChartWidget.ModelBuilder groupBy(ApiAggregateProperty groupBy) {
      this.instance.setGroupBy(groupBy);
      return this;
    }
    public ApiStackedAreaChartWidget.ModelBuilder dataSource(StackedAreaChartDatasource dataSource) {
      this.instance.setDataSource(dataSource);
      return this;
    }
    public ApiStackedAreaChartWidget.ModelBuilder showSubmetrics(Boolean showSubmetrics) {
      this.instance.setShowSubmetrics(showSubmetrics);
      return this;
    }

    /**
     * Returns a built ApiStackedAreaChartWidget instance.
     *
     * <p>The builder is not reusable.</p>
     */
    public ApiStackedAreaChartWidget build() {
      try {
   ...
   */
  public static ApiStackedAreaChartWidget.ModelBuilder builder() {
    return new ApiStackedAreaChartWidget.ModelBuilder();
  }

  /**
   * Create a builder with a shallow copy of this instance.
   */
  public ApiStackedAreaChartWidget.ModelBuilder toBuilder() {
    ApiStackedAreaChartWidget.ModelBuilder builder = new ApiStackedAreaChartWidget.ModelBuilder()
      .id(getId())
      .title(getTitle())
