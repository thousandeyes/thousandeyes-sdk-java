...
public enum HeatmapDatasource {
  ...
  HeatmapDatasource(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static HeatmapDatasource fromValue(String value) {
    for (HeatmapDatasource b : HeatmapDatasource.values()) {
