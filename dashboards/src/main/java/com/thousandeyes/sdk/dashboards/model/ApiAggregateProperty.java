...
public enum ApiAggregateProperty {
  ...
  CLOUD_NATIVE_MONITORING_ALL("CLOUD_NATIVE_MONITORING-ALL"),
  
  CLOUD_NATIVE_MONITORING_ACCOUNT("CLOUD_NATIVE_MONITORING-ACCOUNT"),
  
  CLOUD_NATIVE_MONITORING_REGION("CLOUD_NATIVE_MONITORING-REGION"),
  
  CLOUD_NATIVE_MONITORING_AVAILABILITY_ZONE("CLOUD_NATIVE_MONITORING-AVAILABILITY_ZONE"),
  
  CLOUD_NATIVE_MONITORING_VPC("CLOUD_NATIVE_MONITORING-VPC"),
  
  CLOUD_NATIVE_MONITORING_SUBNET("CLOUD_NATIVE_MONITORING-SUBNET"),
  
  CLOUD_NATIVE_MONITORING_TYPE("CLOUD_NATIVE_MONITORING-TYPE"),
  
  CLOUD_NATIVE_MONITORING_SERVICE_PROVIDER("CLOUD_NATIVE_MONITORING-SERVICE_PROVIDER"),
  
  CLOUD_NATIVE_MONITORING_REMOTE_ACCOUNT("CLOUD_NATIVE_MONITORING-REMOTE_ACCOUNT"),
  
  CLOUD_NATIVE_MONITORING_REMOTE_REGION("CLOUD_NATIVE_MONITORING-REMOTE_REGION"),
  
  CLOUD_NATIVE_MONITORING_REMOTE_AVAILABILITY_ZONE("CLOUD_NATIVE_MONITORING-REMOTE_AVAILABILITY_ZONE"),
  
  CLOUD_NATIVE_MONITORING_REMOTE_VPC("CLOUD_NATIVE_MONITORING-REMOTE_VPC"),
  
  CLOUD_NATIVE_MONITORING_REMOTE_SUBNET("CLOUD_NATIVE_MONITORING-REMOTE_SUBNET"),
  
  CLOUD_NATIVE_MONITORING_REMOTE_TYPE("CLOUD_NATIVE_MONITORING-REMOTE_TYPE"),
  
  CLOUD_NATIVE_MONITORING_REMOTE_SERVICE_PROVIDER("CLOUD_NATIVE_MONITORING-REMOTE_SERVICE_PROVIDER"),
  
  TRAFFIC_INSIGHTS_MONITORING_ALL("TRAFFIC_INSIGHTS_MONITORING-ALL"),
  
  TRAFFIC_INSIGHTS_MONITORING_GEOLOC("TRAFFIC_INSIGHTS_MONITORING-GEOLOC"),
  
  TRAFFIC_INSIGHTS_MONITORING_DEVICE("TRAFFIC_INSIGHTS_MONITORING-DEVICE"),
  
  TRAFFIC_INSIGHTS_MONITORING_DEVICE_IFNAME("TRAFFIC_INSIGHTS_MONITORING-DEVICE_IFNAME"),
  
  TRAFFIC_INSIGHTS_MONITORING_APPLICATION("TRAFFIC_INSIGHTS_MONITORING-APPLICATION"),
