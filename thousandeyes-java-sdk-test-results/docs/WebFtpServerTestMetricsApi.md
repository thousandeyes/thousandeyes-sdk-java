...
|------------- | ------------- | -------------|
| [**getTestResultFtpServer**](WebFtpServerTestMetricsApi.md#getTestResultFtpServer) | **GET** /v7/test-results/{testId}/ftp-server | Get FTP server test results |


<a id="getTestResultFtpServer"></a>
...
import com.thousandeyes.api.test.results.WebFtpServerTestMetricsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    WebFtpServerTestMetricsApi apiInstance = new WebFtpServerTestMetricsApi(defaultClient);
