...
import com.thousandeyes.api.test.results.VoiceRtpServerTestMetricsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    VoiceRtpServerTestMetricsApi apiInstance = new VoiceRtpServerTestMetricsApi(defaultClient);
