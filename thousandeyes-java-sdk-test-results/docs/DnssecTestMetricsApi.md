...
import com.thousandeyes.api.test.results.DnssecTestMetricsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    DnssecTestMetricsApi apiInstance = new DnssecTestMetricsApi(defaultClient);
