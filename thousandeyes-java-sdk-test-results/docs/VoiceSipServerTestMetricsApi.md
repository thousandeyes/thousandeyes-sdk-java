...
import com.thousandeyes.api.test.results.VoiceSipServerTestMetricsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    VoiceSipServerTestMetricsApi apiInstance = new VoiceSipServerTestMetricsApi(defaultClient);
