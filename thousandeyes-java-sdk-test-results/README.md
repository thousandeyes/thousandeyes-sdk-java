# thousandeyes-java-sdk-test-results

Test Results API
- API version: 7.0.0
  - Build date: 2023-12-20T14:43:31.504596Z[Europe/Lisbon]
...
<dependency>
  ...
  <artifactId>thousandeyes-java-sdk-test-results</artifactId>
...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'thousandeyes-java-sdk-test-results' jar has been published to maven central.
    mavenLocal()       // Needed if the 'thousandeyes-java-sdk-test-results' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "org.openapitools:thousandeyes-java-sdk-test-results:7.0.0"
  }
```
...
* `target/thousandeyes-java-sdk-test-results-7.0.0.jar`
* `target/lib/*.jar`
