...
Dashboards API
- API version: 7.0.0
  - Build date: 2023-12-20T14:43:29.147613Z[Europe/Lisbon]
...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'thousandeyes-java-sdk-dashboards' jar has been published to maven central.
    mavenLocal()       // Needed if the 'thousandeyes-java-sdk-dashboards' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "org.openapitools:thousandeyes-java-sdk-dashboards:7.0.0"
  }
```
...
* `target/thousandeyes-java-sdk-dashboards-7.0.0.jar`
* `target/lib/*.jar`
