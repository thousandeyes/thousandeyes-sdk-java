 ...
 */
@JsonAdapter(MultiMetricsTableDatasource.Adapter.class)
public enum MultiMetricsTableDatasource {
  ...
  public static class Adapter extends TypeAdapter<MultiMetricsTableDatasource> {
    @Override
    public void write(final JsonWriter jsonWriter, final MultiMetricsTableDatasource enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public MultiMetricsTableDatasource read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return MultiMetricsTableDatasource.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    MultiMetricsTableDatasource.fromValue(value);
  }
}
