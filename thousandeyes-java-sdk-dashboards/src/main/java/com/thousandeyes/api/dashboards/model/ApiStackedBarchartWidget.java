...
import com.thousandeyes.api.dashboards.model.StackedBarChartDatasource;
...
public class ApiStackedBarchartWidget {
  ...
  public ApiStackedBarchartWidget id(String id) {
  ...
  **/
  ...
  public ApiStackedBarchartWidget type(WidgetType type) {
  ...
  **/
  ...
  public ApiStackedBarchartWidget links(SelfLinksLinks links) {
  ...
  **/
  ...
  public ApiStackedBarchartWidget sortBy(WidgetSortProperty sortBy) {
  ...
  **/
  ...
  public ApiStackedBarchartWidget sortDirection(WidgetSortDirection sortDirection) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, type, title, visualMode, embedUrl, isEmbedded, metricGroup, direction, metric, filters, measure, fixedTimespan, apiLink, shouldExcludeAlertSuppressionWindows, links, axisGroupBy, sortBy, sortDirection, limit, showLabels, isHorizontalBarChart, dataSource);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to ApiStackedBarchartWidget
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApiStackedBarchartWidget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApiStackedBarchartWidget is not found in the empty JSON string", ApiStackedBarchartWidget.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApiStackedBarchartWidget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApiStackedBarchartWidget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `axisGroupBy`
      if (jsonObj.get("axisGroupBy") != null && !jsonObj.get("axisGroupBy").isJsonNull()) {
        ApiAggregateProperty.validateJsonElement(jsonObj.get("axisGroupBy"));
      }
      ...
      if (jsonObj.get("dataSource") != null && !jsonObj.get("dataSource").isJsonNull()) {
        StackedBarChartDatasource.validateJsonElement(jsonObj.get("dataSource"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApiStackedBarchartWidget.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApiStackedBarchartWidget' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApiStackedBarchartWidget> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApiStackedBarchartWidget.class));

       return (TypeAdapter<T>) new TypeAdapter<ApiStackedBarchartWidget>() {
           @Override
           public void write(JsonWriter out, ApiStackedBarchartWidget value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApiStackedBarchartWidget read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ApiStackedBarchartWidget given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ApiStackedBarchartWidget
  * @throws IOException if the JSON string is invalid with respect to ApiStackedBarchartWidget
  */
  public static ApiStackedBarchartWidget fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApiStackedBarchartWidget.class);
  }

 /**
  * Convert an instance of ApiStackedBarchartWidget to an JSON string
  *
  * @return JSON string
  */
