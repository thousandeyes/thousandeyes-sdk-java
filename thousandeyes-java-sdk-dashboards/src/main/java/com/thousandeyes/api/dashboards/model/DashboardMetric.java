 ...
 */
@JsonAdapter(DashboardMetric.Adapter.class)
public enum DashboardMetric {
  ...
  public static class Adapter extends TypeAdapter<DashboardMetric> {
    @Override
    public void write(final JsonWriter jsonWriter, final DashboardMetric enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public DashboardMetric read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return DashboardMetric.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    DashboardMetric.fromValue(value);
  }
}
