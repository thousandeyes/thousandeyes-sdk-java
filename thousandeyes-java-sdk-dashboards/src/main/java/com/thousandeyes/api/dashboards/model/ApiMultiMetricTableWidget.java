...
public class ApiMultiMetricTableWidget {
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the optional field `rowGroupBy`
      if (jsonObj.get("rowGroupBy") != null && !jsonObj.get("rowGroupBy").isJsonNull()) {
        ApiAggregateProperty.validateJsonElement(jsonObj.get("rowGroupBy"));
      }
      ...
      if (jsonObj.get("dataSource") != null && !jsonObj.get("dataSource").isJsonNull()) {
        MultiMetricsTableDatasource.validateJsonElement(jsonObj.get("dataSource"));
      }
  }
