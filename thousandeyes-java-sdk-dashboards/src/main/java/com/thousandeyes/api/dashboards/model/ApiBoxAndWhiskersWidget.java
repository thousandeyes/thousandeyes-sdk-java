...
public class ApiBoxAndWhiskersWidget {
  ...
  public ApiBoxAndWhiskersWidget id(String id) {
  ...
  **/
  ...
  public ApiBoxAndWhiskersWidget type(WidgetType type) {
  ...
  * @throws IOException if the JSON Element is invalid with respect to ApiBoxAndWhiskersWidget
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApiBoxAndWhiskersWidget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApiBoxAndWhiskersWidget is not found in the empty JSON string", ApiBoxAndWhiskersWidget.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApiBoxAndWhiskersWidget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApiBoxAndWhiskersWidget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("dataSource") != null && !jsonObj.get("dataSource").isJsonNull()) {
        BoxAndWhiskersDatasource.validateJsonElement(jsonObj.get("dataSource"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApiBoxAndWhiskersWidget.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApiBoxAndWhiskersWidget' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApiBoxAndWhiskersWidget> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApiBoxAndWhiskersWidget.class));

       return (TypeAdapter<T>) new TypeAdapter<ApiBoxAndWhiskersWidget>() {
           @Override
           public void write(JsonWriter out, ApiBoxAndWhiskersWidget value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApiBoxAndWhiskersWidget read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ApiBoxAndWhiskersWidget given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ApiBoxAndWhiskersWidget
  * @throws IOException if the JSON string is invalid with respect to ApiBoxAndWhiskersWidget
  */
  public static ApiBoxAndWhiskersWidget fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApiBoxAndWhiskersWidget.class);
  }

 /**
  * Convert an instance of ApiBoxAndWhiskersWidget to an JSON string
  *
  * @return JSON string
  */
