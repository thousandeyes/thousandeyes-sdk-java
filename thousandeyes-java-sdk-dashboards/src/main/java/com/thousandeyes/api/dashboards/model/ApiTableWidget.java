...
public class ApiTableWidget {
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the optional field `columnGroupBy`
      if (jsonObj.get("columnGroupBy") != null && !jsonObj.get("columnGroupBy").isJsonNull()) {
        ApiAggregateProperty.validateJsonElement(jsonObj.get("columnGroupBy"));
      }
      ...
      if (jsonObj.get("dataSource") != null && !jsonObj.get("dataSource").isJsonNull()) {
        TableDatasource.validateJsonElement(jsonObj.get("dataSource"));
      }
  }
