 ...
 */
@JsonAdapter(PieChartDatasource.Adapter.class)
public enum PieChartDatasource {
  ...
  public static class Adapter extends TypeAdapter<PieChartDatasource> {
    @Override
    public void write(final JsonWriter jsonWriter, final PieChartDatasource enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PieChartDatasource read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PieChartDatasource.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    PieChartDatasource.fromValue(value);
  }
}
