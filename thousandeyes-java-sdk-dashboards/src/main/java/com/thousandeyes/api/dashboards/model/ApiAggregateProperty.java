 ...
 */
@JsonAdapter(ApiAggregateProperty.Adapter.class)
public enum ApiAggregateProperty {
  ...
  public static class Adapter extends TypeAdapter<ApiAggregateProperty> {
    @Override
    public void write(final JsonWriter jsonWriter, final ApiAggregateProperty enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ApiAggregateProperty read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ApiAggregateProperty.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ApiAggregateProperty.fromValue(value);
  }
}
