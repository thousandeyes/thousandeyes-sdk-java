  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("repeat") != null && !jsonObj.get("repeat").isJsonNull()) {
        AswRepeat.validateJsonElement(jsonObj.get("repeat"));
      }
      // validate the optional field `repeatUnit`
      if (jsonObj.get("repeatUnit") != null && !jsonObj.get("repeatUnit").isJsonNull()) {
        AswRepeatUnit.validateJsonElement(jsonObj.get("repeatUnit"));
      }
  }
