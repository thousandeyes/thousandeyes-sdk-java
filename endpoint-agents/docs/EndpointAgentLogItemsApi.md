...
| [**getEndpointAgentLogItemsWithHttpInfo**](EndpointAgentLogItemsApi.md#getEndpointAgentLogItemsWithHttpInfo) | **GET** /endpoint/agents/{agentId}/logs | List endpoint agent log items |
...
ApiResponse<[**EndpointAgentLogItemsResponse**](EndpointAgentLogItemsResponse.md)>
