 ...
 */
public enum EndpointAgentLogItemType {
  ...
  EndpointAgentLogItemType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static EndpointAgentLogItemType fromValue(String value) {
    for (EndpointAgentLogItemType b : EndpointAgentLogItemType.values()) {
