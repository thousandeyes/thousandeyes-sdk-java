 ...
 * Wi-Fi log item type.
 */
public enum EndpointWifiLogItemType {
  
  WIFI_CHANGE("wifi-change"),
  
  WIFI_CONNECT("wifi-connect"),
  
  WIFI_DISCONNECT("wifi-disconnect"),
  
  WIFI_CONNECTION_FAILURE("wifi-connection-failure"),
  
  UNKNOWN("unknown");

  private String value;

  EndpointWifiLogItemType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static EndpointWifiLogItemType fromValue(String value) {
    for (EndpointWifiLogItemType b : EndpointWifiLogItemType.values()) {
