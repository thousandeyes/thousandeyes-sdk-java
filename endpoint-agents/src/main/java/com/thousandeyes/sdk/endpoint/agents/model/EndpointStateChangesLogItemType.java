 ...
 */
public enum EndpointStateChangesLogItemType {
  ...
  EndpointStateChangesLogItemType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static EndpointStateChangesLogItemType fromValue(String value) {
    for (EndpointStateChangesLogItemType b : EndpointStateChangesLogItemType.values()) {
