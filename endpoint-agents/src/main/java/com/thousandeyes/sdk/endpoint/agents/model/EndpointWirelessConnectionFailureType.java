 ...
 */
public enum EndpointWirelessConnectionFailureType {
  ...
  EndpointWirelessConnectionFailureType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static EndpointWirelessConnectionFailureType fromValue(String value) {
    for (EndpointWirelessConnectionFailureType b : EndpointWirelessConnectionFailureType.values()) {
