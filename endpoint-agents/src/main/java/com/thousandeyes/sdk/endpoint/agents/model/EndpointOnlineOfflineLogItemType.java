 ...
 */
public enum EndpointOnlineOfflineLogItemType {
  ...
  EndpointOnlineOfflineLogItemType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static EndpointOnlineOfflineLogItemType fromValue(String value) {
    for (EndpointOnlineOfflineLogItemType b : EndpointOnlineOfflineLogItemType.values()) {
