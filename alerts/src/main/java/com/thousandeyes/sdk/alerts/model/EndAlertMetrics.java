...
public class EndAlertMetrics {
  ...
  **/
  ...
  public static class ModelBuilder {
    ...
    private EndAlertMetrics instance;

    public ModelBuilder() {
      this(new EndAlertMetrics());
    }

    protected ModelBuilder(EndAlertMetrics instance) {
      this.instance = instance;
    }

    public EndAlertMetrics.ModelBuilder metrics(String metrics) {
      this.instance.setMetrics(metrics);
      return this;
    }

    /**
     * Returns a built EndAlertMetrics instance.
     *
     * <p>The builder is not reusable.</p>
     */
    public EndAlertMetrics build() {
      try {
   ...
   */
  public static EndAlertMetrics.ModelBuilder builder() {
    return new EndAlertMetrics.ModelBuilder();
  }

  /**
   * Create a builder with a shallow copy of this instance.
   */
  public EndAlertMetrics.ModelBuilder toBuilder() {
    EndAlertMetrics.ModelBuilder builder = new EndAlertMetrics.ModelBuilder()
      .metrics(getMetrics());
    return builder;
  }
