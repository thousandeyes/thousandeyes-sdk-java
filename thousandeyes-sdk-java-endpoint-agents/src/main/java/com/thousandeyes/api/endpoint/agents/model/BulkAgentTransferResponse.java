...
import com.thousandeyes.api.endpoint.agents.model.AgentTransferStatus;
...
public class BulkAgentTransferResponse {
  ...
  private List<AgentTransferStatus> items;
  ...
  public BulkAgentTransferResponse addItem(AgentTransferStatus itemsItem) {
    if (this.items == null) {
