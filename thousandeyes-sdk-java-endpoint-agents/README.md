...
- Build date: 2024-04-17T14:20:01.720354+01:00[Europe/Lisbon]
...
```groovy
compile "com.thousandeyes.api:thousandeyes-sdk-java-endpoint-agents:7.0.0-SNAPSHOT"
```
...
- `target/thousandeyes-sdk-java-endpoint-agents-7.0.0-SNAPSHOT.jar`
- `target/lib/*.jar`
