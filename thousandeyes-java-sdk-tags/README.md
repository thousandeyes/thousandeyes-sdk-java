# thousandeyes-java-sdk-tags

Tags API
- API version: 7.0.0
  - Build date: 2023-12-18T17:52:52.169959Z[Europe/Lisbon]
...
<dependency>
  ...
  <artifactId>thousandeyes-java-sdk-tags</artifactId>
...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'thousandeyes-java-sdk-tags' jar has been published to maven central.
    mavenLocal()       // Needed if the 'thousandeyes-java-sdk-tags' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "org.openapitools:thousandeyes-java-sdk-tags:7.0.0"
  }
```
...
* `target/thousandeyes-java-sdk-tags-7.0.0.jar`
* `target/lib/*.jar`
