...
public class DnssecTestResult {
  ...
  * @throws IOException if the JSON Element is invalid with respect to DnssecTestResult
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DnssecTestResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DnssecTestResult is not found in the empty JSON string", DnssecTestResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DnssecTestResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DnssecTestResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DnssecTestResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DnssecTestResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DnssecTestResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DnssecTestResult.class));

       return (TypeAdapter<T>) new TypeAdapter<DnssecTestResult>() {
           @Override
           public void write(JsonWriter out, DnssecTestResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DnssecTestResult read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of DnssecTestResult given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DnssecTestResult
  * @throws IOException if the JSON string is invalid with respect to DnssecTestResult
  */
  public static DnssecTestResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DnssecTestResult.class);
  }

 /**
  * Convert an instance of DnssecTestResult to an JSON string
  *
  * @return JSON string
  */
