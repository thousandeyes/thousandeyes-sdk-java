...
public class PageLoadTestResult {
  ...
  * @throws IOException if the JSON Element is invalid with respect to PageLoadTestResult
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PageLoadTestResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PageLoadTestResult is not found in the empty JSON string", PageLoadTestResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PageLoadTestResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PageLoadTestResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PageLoadTestResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PageLoadTestResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PageLoadTestResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PageLoadTestResult.class));

       return (TypeAdapter<T>) new TypeAdapter<PageLoadTestResult>() {
           @Override
           public void write(JsonWriter out, PageLoadTestResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PageLoadTestResult read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PageLoadTestResult given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PageLoadTestResult
  * @throws IOException if the JSON string is invalid with respect to PageLoadTestResult
  */
  public static PageLoadTestResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PageLoadTestResult.class);
  }

 /**
  * Convert an instance of PageLoadTestResult to an JSON string
  *
  * @return JSON string
  */
