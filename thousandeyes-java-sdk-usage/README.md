...
<dependency>
  ...
  <artifactId>thousandeyes-java-sdk-usage</artifactId>
...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'thousandeyes-java-sdk-usage' jar has been published to maven central.
    mavenLocal()       // Needed if the 'thousandeyes-java-sdk-usage' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "org.openapitools:thousandeyes-java-sdk-usage:7.0.0"
  }
```
...
* `target/thousandeyes-java-sdk-usage-7.0.0.jar`
* `target/lib/*.jar`
