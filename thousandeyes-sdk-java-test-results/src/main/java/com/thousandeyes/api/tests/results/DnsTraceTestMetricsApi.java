...
public class DnsTraceTestMetricsApi {
   ...
   */
  public DnsTraceTestResults getTestResultDnsTrace(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor) throws ApiException {
    ApiResponse<DnsTraceTestResults> response = getTestResultDnsTraceWithHttpInfo(testId, aid, window, startDate, endDate, cursor);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<DnsTraceTestResults> getTestResultDnsTraceWithHttpInfo(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor) throws ApiException {
    getTestResultDnsTraceValidateRequest(testId);

    var requestBuilder = getTestResultDnsTraceRequestBuilder(testId, aid, window, startDate, endDate, cursor);

    return apiClient.send(requestBuilder.build(), DnsTraceTestResults.class);
  }

  private void getTestResultDnsTraceValidateRequest(String testId) throws ApiException {
      // verify the required parameter 'testId' is set
      if (testId == null) {
        throw new ApiException(400, "Missing the required parameter 'testId' when calling getTestResultDnsTrace");
      }
  }

  private ApiRequest.ApiRequestBuilder getTestResultDnsTraceRequestBuilder(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor) throws ApiException {
