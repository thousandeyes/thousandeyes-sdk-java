...
import com.thousandeyes.api.tests.results.model.WebTransactionDetailTestResults;
import com.thousandeyes.api.tests.results.model.WebTransactionPageDetailTestResults;
import com.thousandeyes.api.tests.results.model.WebTransactionTestResults;
...
public class WebTransactionsTestMetricsApi {
   ...
   */
  public WebTransactionTestResults getTestResultWebTransactions(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor) throws ApiException {
    ApiResponse<WebTransactionTestResults> response = getTestResultWebTransactionsWithHttpInfo(testId, aid, window, startDate, endDate, cursor);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<WebTransactionTestResults> getTestResultWebTransactionsWithHttpInfo(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public WebTransactionDetailTestResults getTestResultWebTransactionsComponentDetail(String testId, String agentId, String roundId, String aid) throws ApiException {
    ApiResponse<WebTransactionDetailTestResults> response = getTestResultWebTransactionsComponentDetailWithHttpInfo(testId, agentId, roundId, aid);
    return response.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<WebTransactionDetailTestResults> getTestResultWebTransactionsComponentDetailWithHttpInfo(String testId, String agentId, String roundId, String aid) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public WebTransactionPageDetailTestResults getTestResultWebTransactionsComponentPageDetail(String testId, String agentId, String roundId, String pageId, String aid) throws ApiException {
    ApiResponse<WebTransactionPageDetailTestResults> response = getTestResultWebTransactionsComponentPageDetailWithHttpInfo(testId, agentId, roundId, pageId, aid);
    return response.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<WebTransactionPageDetailTestResults> getTestResultWebTransactionsComponentPageDetailWithHttpInfo(String testId, String agentId, String roundId, String pageId, String aid) throws ApiException {
