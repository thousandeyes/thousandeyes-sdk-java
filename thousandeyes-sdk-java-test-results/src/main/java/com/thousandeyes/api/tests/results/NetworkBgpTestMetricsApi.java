...
public class NetworkBgpTestMetricsApi {
   ...
   */
  public BgpTestResults getTestResultsBgp(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor) throws ApiException {
    ApiResponse<BgpTestResults> response = getTestResultsBgpWithHttpInfo(testId, aid, window, startDate, endDate, cursor);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<BgpTestResults> getTestResultsBgpWithHttpInfo(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public BgpTestRouteInformationResults getTestResultsBgpPrefix(String testId, String prefixId, String roundId, String aid) throws ApiException {
    ApiResponse<BgpTestRouteInformationResults> response = getTestResultsBgpPrefixWithHttpInfo(testId, prefixId, roundId, aid);
    return response.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<BgpTestRouteInformationResults> getTestResultsBgpPrefixWithHttpInfo(String testId, String prefixId, String roundId, String aid) throws ApiException {
