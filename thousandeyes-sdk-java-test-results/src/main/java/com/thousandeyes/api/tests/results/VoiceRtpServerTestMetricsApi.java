...
public class VoiceRtpServerTestMetricsApi {
   ...
   */
  public RtpStreamTestResults getTestResultRtpStream(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor) throws ApiException {
    ApiResponse<RtpStreamTestResults> response = getTestResultRtpStreamWithHttpInfo(testId, aid, window, startDate, endDate, cursor);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<RtpStreamTestResults> getTestResultRtpStreamWithHttpInfo(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor) throws ApiException {
