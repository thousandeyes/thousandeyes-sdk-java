...
import com.thousandeyes.api.tests.results.model.GetTestResultRtpStream200Response;
...
public class VoiceRtpServerTestMetricsApi {
  ...
  public GetTestResultRtpStream200Response getTestResultRtpStream(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor) throws ApiException {
    ApiResponse<GetTestResultRtpStream200Response> response = getTestResultRtpStreamWithHttpInfo(testId, aid, window, startDate, endDate, cursor);
  ...
  public ApiResponse<GetTestResultRtpStream200Response> getTestResultRtpStreamWithHttpInfo(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor) throws ApiException {
    getTestResultRtpStreamValidateRequest(testId);

    var requestBuilder = getTestResultRtpStreamRequestBuilder(testId, aid, window, startDate, endDate, cursor);

    return apiClient.send(requestBuilder.build(), GetTestResultRtpStream200Response.class);
  }

  private void getTestResultRtpStreamValidateRequest(String testId) throws ApiException {
      // verify the required parameter 'testId' is set
      if (testId == null) {
        throw new ApiException(400, "Missing the required parameter 'testId' when calling getTestResultRtpStream");
      }
  }

  private ApiRequest.ApiRequestBuilder getTestResultRtpStreamRequestBuilder(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor) throws ApiException {
