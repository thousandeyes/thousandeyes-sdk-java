...
import com.thousandeyes.api.tests.results.model.DnssecTestResults;
...
public class DnssecTestMetricsApi {
   ...
   */
  public DnssecTestResults getTestResultDnssec(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor) throws ApiException {
    ApiResponse<DnssecTestResults> response = getTestResultDnssecWithHttpInfo(testId, aid, window, startDate, endDate, cursor);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<DnssecTestResults> getTestResultDnssecWithHttpInfo(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor) throws ApiException {
