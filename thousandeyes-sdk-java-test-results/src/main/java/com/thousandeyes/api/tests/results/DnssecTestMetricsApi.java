...
import com.thousandeyes.api.tests.results.model.GetTestResultDnssec200Response;
...
public class DnssecTestMetricsApi {
  ...
  public GetTestResultDnssec200Response getTestResultDnssec(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor) throws ApiException {
    ApiResponse<GetTestResultDnssec200Response> response = getTestResultDnssecWithHttpInfo(testId, aid, window, startDate, endDate, cursor);
  ...
  public ApiResponse<GetTestResultDnssec200Response> getTestResultDnssecWithHttpInfo(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor) throws ApiException {
    getTestResultDnssecValidateRequest(testId);

    var requestBuilder = getTestResultDnssecRequestBuilder(testId, aid, window, startDate, endDate, cursor);

    return apiClient.send(requestBuilder.build(), GetTestResultDnssec200Response.class);
  }

  private void getTestResultDnssecValidateRequest(String testId) throws ApiException {
      // verify the required parameter 'testId' is set
      if (testId == null) {
        throw new ApiException(400, "Missing the required parameter 'testId' when calling getTestResultDnssec");
      }
  }

  private ApiRequest.ApiRequestBuilder getTestResultDnssecRequestBuilder(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor) throws ApiException {
