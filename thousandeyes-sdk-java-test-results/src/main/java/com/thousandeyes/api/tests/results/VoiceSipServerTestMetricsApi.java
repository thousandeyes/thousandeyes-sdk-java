...
import com.thousandeyes.api.tests.results.model.GetTestResultSipServer200Response;
...
public class VoiceSipServerTestMetricsApi {
  ...
  public GetTestResultSipServer200Response getTestResultSipServer(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor) throws ApiException {
    ApiResponse<GetTestResultSipServer200Response> response = getTestResultSipServerWithHttpInfo(testId, aid, window, startDate, endDate, cursor);
  ...
  public ApiResponse<GetTestResultSipServer200Response> getTestResultSipServerWithHttpInfo(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor) throws ApiException {
    ...
    return apiClient.send(requestBuilder.build(), GetTestResultSipServer200Response.class);
  }
