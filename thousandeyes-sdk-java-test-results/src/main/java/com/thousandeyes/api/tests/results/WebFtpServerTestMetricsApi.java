...
public class WebFtpServerTestMetricsApi {
  ...
  public GetTestResultFtpServer200Response getTestResultFtpServer(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor) throws ApiException {
    ApiResponse<GetTestResultFtpServer200Response> response = getTestResultFtpServerWithHttpInfo(testId, aid, window, startDate, endDate, cursor);
  ...
  public ApiResponse<GetTestResultFtpServer200Response> getTestResultFtpServerWithHttpInfo(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor) throws ApiException {
    getTestResultFtpServerValidateRequest(testId);

    var requestBuilder = getTestResultFtpServerRequestBuilder(testId, aid, window, startDate, endDate, cursor);

    return apiClient.send(requestBuilder.build(), GetTestResultFtpServer200Response.class);
  }

  private void getTestResultFtpServerValidateRequest(String testId) throws ApiException {
      // verify the required parameter 'testId' is set
      if (testId == null) {
        throw new ApiException(400, "Missing the required parameter 'testId' when calling getTestResultFtpServer");
      }
  }

  private ApiRequest.ApiRequestBuilder getTestResultFtpServerRequestBuilder(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor) throws ApiException {
