...
public class WebFtpServerTestMetricsApi {
   ...
   */
  public FtpServerTestResults getTestResultFtpServer(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor) throws ApiException {
    ApiResponse<FtpServerTestResults> response = getTestResultFtpServerWithHttpInfo(testId, aid, window, startDate, endDate, cursor);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<FtpServerTestResults> getTestResultFtpServerWithHttpInfo(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor) throws ApiException {
