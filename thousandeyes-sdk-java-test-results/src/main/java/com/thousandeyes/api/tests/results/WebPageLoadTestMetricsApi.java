...
public class WebPageLoadTestMetricsApi {
  ...
  public GetTestResultPageLoad200Response getTestResultPageLoad(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor) throws ApiException {
    ApiResponse<GetTestResultPageLoad200Response> response = getTestResultPageLoadWithHttpInfo(testId, aid, window, startDate, endDate, cursor);
  ...
  public ApiResponse<GetTestResultPageLoad200Response> getTestResultPageLoadWithHttpInfo(String testId, String aid, String window, OffsetDateTime startDate, OffsetDateTime endDate, String cursor) throws ApiException {
    ...
    return apiClient.send(requestBuilder.build(), GetTestResultPageLoad200Response.class);
  }
  ...
  public GetTestResultPageLoadComponentDetail200Response getTestResultPageLoadComponentDetail(String testId, String agentId, String roundId, String aid) throws ApiException {
    ApiResponse<GetTestResultPageLoadComponentDetail200Response> response = getTestResultPageLoadComponentDetailWithHttpInfo(testId, agentId, roundId, aid);
    return response.getData();
  }
  ...
  public ApiResponse<GetTestResultPageLoadComponentDetail200Response> getTestResultPageLoadComponentDetailWithHttpInfo(String testId, String agentId, String roundId, String aid) throws ApiException {
    ...
    return apiClient.send(requestBuilder.build(), GetTestResultPageLoadComponentDetail200Response.class);
  }
