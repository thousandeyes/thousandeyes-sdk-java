# thousandeyes-java-sdk-bgp-monitors

BGP Monitors API

- API version: 7.0.0

- Build date: 2024-02-07T22:58:17.069730Z[Europe/Lisbon]
...
<dependency>
  ...
  <artifactId>thousandeyes-java-sdk-bgp-monitors</artifactId>
...
```groovy
compile "com.thousandeyes.api:thousandeyes-java-sdk-bgp-monitors:7.0.0-SNAPSHOT"
```
...
- `target/thousandeyes-java-sdk-bgp-monitors-7.0.0-SNAPSHOT.jar`
- `target/lib/*.jar`
