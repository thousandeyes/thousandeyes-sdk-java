...
public class AccountGroupRolesRequestBodyInner {
  ...
  * @throws IOException if the JSON Element is invalid with respect to AccountGroupRolesRequestBodyInner
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccountGroupRolesRequestBodyInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccountGroupRolesRequestBodyInner is not found in the empty JSON string", AccountGroupRolesRequestBodyInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccountGroupRolesRequestBodyInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccountGroupRolesRequestBodyInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccountGroupRolesRequestBodyInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccountGroupRolesRequestBodyInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccountGroupRolesRequestBodyInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccountGroupRolesRequestBodyInner.class));

       return (TypeAdapter<T>) new TypeAdapter<AccountGroupRolesRequestBodyInner>() {
           @Override
           public void write(JsonWriter out, AccountGroupRolesRequestBodyInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AccountGroupRolesRequestBodyInner read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of AccountGroupRolesRequestBodyInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AccountGroupRolesRequestBodyInner
  * @throws IOException if the JSON string is invalid with respect to AccountGroupRolesRequestBodyInner
  */
  public static AccountGroupRolesRequestBodyInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccountGroupRolesRequestBodyInner.class);
  }

 /**
  * Convert an instance of AccountGroupRolesRequestBodyInner to an JSON string
  *
  * @return JSON string
  */
