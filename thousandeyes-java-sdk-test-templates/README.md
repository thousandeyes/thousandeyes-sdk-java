# thousandeyes-java-sdk-test-templates
...
<dependency>
  ...
  <artifactId>thousandeyes-java-sdk-test-templates</artifactId>
...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'thousandeyes-java-sdk-test-templates' jar has been published to maven central.
    mavenLocal()       // Needed if the 'thousandeyes-java-sdk-test-templates' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "org.openapitools:thousandeyes-java-sdk-test-templates:7.0.1"
  }
```
...
* `target/thousandeyes-java-sdk-test-templates-7.0.1.jar`
* `target/lib/*.jar`
